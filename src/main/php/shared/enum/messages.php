...
enum messages: string
{
    ...
    */
    ...
    // database table names (code id from change_tables.csv), translated via Translator::text_db_table
    case SYSTEM_DB_TABLE_USERS = 'system_db_table_users';
    case SYSTEM_DB_TABLE_VALUES = 'system_db_table_values';
    case SYSTEM_DB_TABLE_USER_VALUES = 'system_db_table_user_values';
    case SYSTEM_DB_TABLE_VALUE_LINKS = 'system_db_table_value_links';
    case SYSTEM_DB_TABLE_WORDS = 'system_db_table_words';
    case SYSTEM_DB_TABLE_USER_WORDS = 'system_db_table_user_words';
    case SYSTEM_DB_TABLE_TRIPLES = 'system_db_table_triples';
    case SYSTEM_DB_TABLE_USER_TRIPLES = 'system_db_table_user_triples';
    case SYSTEM_DB_TABLE_VERBS = 'system_db_table_verbs';
    case SYSTEM_DB_TABLE_FORMULAS = 'system_db_table_formulas';
    case SYSTEM_DB_TABLE_USER_FORMULAS = 'system_db_table_user_formulas';
    case SYSTEM_DB_TABLE_FORMULA_LINKS = 'system_db_table_formula_links';
    case SYSTEM_DB_TABLE_USER_FORMULA_LINKS = 'system_db_table_user_formula_links';
    case SYSTEM_DB_TABLE_VIEWS = 'system_db_table_views';
    case SYSTEM_DB_TABLE_USER_VIEWS = 'system_db_table_user_views';
    case SYSTEM_DB_TABLE_COMPONENT_LINKS = 'system_db_table_component_links';
    case SYSTEM_DB_TABLE_USER_COMPONENT_LINKS = 'system_db_table_user_component_links';
    case SYSTEM_DB_TABLE_COMPONENTS = 'system_db_table_components';
    case SYSTEM_DB_TABLE_USER_COMPONENTS = 'system_db_table_user_components';
    case SYSTEM_DB_TABLE_SOURCES = 'system_db_table_sources';
    case SYSTEM_DB_TABLE_USER_SOURCES = 'system_db_table_user_sources';
    case SYSTEM_DB_TABLE_REFS = 'system_db_table_refs';
    case SYSTEM_DB_TABLE_IP_RANGE = 'system_db_table_ip_range';
    case SYSTEM_DB_TABLE_USER_REFS = 'system_db_table_user_refs';
    case SYSTEM_DB_TABLE_CONFIG = 'system_db_table_config';
    case SYSTEM_DB_TABLE_USER_OFFICIAL_TYPES = 'system_db_table_user_official_types';
    case SYSTEM_DB_TABLE_IP_RANGES = 'system_db_table_ip_ranges';
    case SYSTEM_DB_TABLE_PROTECTION_TYPES = 'system_db_table_protection_types';
    case SYSTEM_DB_TABLE_SHARE_TYPES = 'system_db_table_share_types';
    case SYSTEM_DB_TABLE_VALUE_TS_DATA = 'system_db_table_value_ts_data';
    case SYSTEM_DB_TABLE_SYS_LOG = 'system_db_table_sys_log';
    case SYSTEM_DB_TABLE_JOB_TYPES = 'system_db_table_job_types';
    case SYSTEM_DB_TABLE_JOB_TIMES = 'system_db_table_job_times';
    case SYSTEM_DB_TABLE_USER_PROFILES = 'system_db_table_user_profiles';
    case SYSTEM_DB_TABLE_USER_TYPES = 'system_db_table_user_types';
    case SYSTEM_DB_TABLE_POD_TYPES = 'system_db_table_pod_types';
    case SYSTEM_DB_TABLE_PODS = 'system_db_table_pods';
    case SYSTEM_DB_TABLE_POD_STATUS = 'system_db_table_pod_status';
    case SYSTEM_DB_TABLE_LANGUAGES = 'system_db_table_languages';
    case SYSTEM_DB_TABLE_LANGUAGE_FORMS = 'system_db_table_language_forms';
    case SYSTEM_DB_TABLE_GROUPS = 'system_db_table_groups';
    case SYSTEM_DB_TABLE_USER_GROUPS = 'system_db_table_user_groups';
    case SYSTEM_DB_TABLE_GROUPS_PRIME = 'system_db_table_groups_prime';
    case SYSTEM_DB_TABLE_USER_GROUPS_PRIME = 'system_db_table_user_groups_prime';
    case SYSTEM_DB_TABLE_GROUPS_BIG = 'system_db_table_groups_big';
    case SYSTEM_DB_TABLE_USER_GROUPS_BIG = 'system_db_table_user_groups_big';
    case SYSTEM_DB_TABLE_SOURCE_TYPES = 'system_db_table_source_types';
    case SYSTEM_DB_TABLE_REF_TYPES = 'system_db_table_ref_types';
    case SYSTEM_DB_TABLE_VALUES_STANDARD_PRIME = 'system_db_table_values_standard_prime';
    case SYSTEM_DB_TABLE_VALUES_STANDARD = 'system_db_table_values_standard';
    case SYSTEM_DB_TABLE_VALUES_PRIME = 'system_db_table_values_prime';
    case SYSTEM_DB_TABLE_USER_VALUES_PRIME = 'system_db_table_user_values_prime';
    case SYSTEM_DB_TABLE_VALUES_BIG = 'system_db_table_values_big';
    case SYSTEM_DB_TABLE_USER_VALUES_BIG = 'system_db_table_user_values_big';
    case SYSTEM_DB_TABLE_VALUES_TEXT_STANDARD_PRIME = 'system_db_table_values_text_standard_prime';
    case SYSTEM_DB_TABLE_VALUES_TEXT_STANDARD = 'system_db_table_values_text_standard';
    case SYSTEM_DB_TABLE_VALUES_TEXT = 'system_db_table_values_text';
    case SYSTEM_DB_TABLE_USER_VALUES_TEXT = 'system_db_table_user_values_text';
    case SYSTEM_DB_TABLE_VALUES_TEXT_PRIME = 'system_db_table_values_text_prime';
    case SYSTEM_DB_TABLE_USER_VALUES_TEXT_PRIME = 'system_db_table_user_values_text_prime';
    case SYSTEM_DB_TABLE_VALUES_TEXT_BIG = 'system_db_table_values_text_big';
    case SYSTEM_DB_TABLE_USER_VALUES_TEXT_BIG = 'system_db_table_user_values_text_big';
    case SYSTEM_DB_TABLE_VALUES_TIME_STANDARD_PRIME = 'system_db_table_values_time_standard_prime';
    case SYSTEM_DB_TABLE_VALUES_TIME_STANDARD = 'system_db_table_values_time_standard';
    case SYSTEM_DB_TABLE_VALUES_TIME = 'system_db_table_values_time';
    case SYSTEM_DB_TABLE_USER_VALUES_TIME = 'system_db_table_user_values_time';
    case SYSTEM_DB_TABLE_VALUES_TIME_PRIME = 'system_db_table_values_time_prime';
    case SYSTEM_DB_TABLE_USER_VALUES_TIME_PRIME = 'system_db_table_user_values_time_prime';
    case SYSTEM_DB_TABLE_VALUES_TIME_BIG = 'system_db_table_values_time_big';
    case SYSTEM_DB_TABLE_USER_VALUES_TIME_BIG = 'system_db_table_user_values_time_big';
    case SYSTEM_DB_TABLE_VALUES_GEO_STANDARD_PRIME = 'system_db_table_values_geo_standard_prime';
    case SYSTEM_DB_TABLE_VALUES_GEO_STANDARD = 'system_db_table_values_geo_standard';
    case SYSTEM_DB_TABLE_VALUES_GEO = 'system_db_table_values_geo';
    case SYSTEM_DB_TABLE_USER_VALUES_GEO = 'system_db_table_user_values_geo';
    case SYSTEM_DB_TABLE_VALUES_GEO_PRIME = 'system_db_table_values_geo_prime';
    case SYSTEM_DB_TABLE_USER_VALUES_GEO_PRIME = 'system_db_table_user_values_geo_prime';
    case SYSTEM_DB_TABLE_VALUES_GEO_BIG = 'system_db_table_values_geo_big';
    case SYSTEM_DB_TABLE_USER_VALUES_GEO_BIG = 'system_db_table_user_values_geo_big';
    case SYSTEM_DB_TABLE_VALUES_TIME_SERIES = 'system_db_table_values_time_series';
    case SYSTEM_DB_TABLE_USER_VALUES_TIME_SERIES = 'system_db_table_user_values_time_series';
    case SYSTEM_DB_TABLE_VALUES_TIME_SERIES_PRIME = 'system_db_table_values_time_series_prime';
    case SYSTEM_DB_TABLE_USER_VALUES_TIME_SERIES_PRIME = 'system_db_table_user_values_time_series_prime';
    case SYSTEM_DB_TABLE_VALUES_TIME_SERIES_BIG = 'system_db_table_values_time_series_big';
    case SYSTEM_DB_TABLE_USER_VALUES_TIME_SERIES_BIG = 'system_db_table_user_values_time_series_big';
    case SYSTEM_DB_TABLE_ELEMENT_TYPES = 'system_db_table_element_types';
    case SYSTEM_DB_TABLE_FORMULA_TYPES = 'system_db_table_formula_types';
    case SYSTEM_DB_TABLE_FORMULA_LINK_TYPES = 'system_db_table_formula_link_types';
    case SYSTEM_DB_TABLE_VIEW_TYPES = 'system_db_table_view_types';
    case SYSTEM_DB_TABLE_TERM_VIEWS = 'system_db_table_term_views';
    case SYSTEM_DB_TABLE_VIEW_LINK_TYPES = 'system_db_table_view_link_types';
    case SYSTEM_DB_TABLE_USER_TERM_VIEWS = 'system_db_table_user_term_views';
    case SYSTEM_DB_TABLE_COMPONENT_TYPES = 'system_db_table_component_types';
    case SYSTEM_DB_TABLE_COMPONENT_LINK_TYPES = 'system_db_table_component_link_types';
    case SYSTEM_DB_TABLE_POSITION_TYPES = 'system_db_table_position_types';
    case SYSTEM_DB_TABLE_VALUES_NORM = 'system_db_table_values_norm';
    case SYSTEM_DB_TABLE_GROUPS_NORM = 'system_db_table_groups_norm';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_PRIME = 'system_db_table_change_values_prime';
    case SYSTEM_DB_TABLE_VIEW_STYLES = 'system_db_table_view_styles';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_TIME_PRIME = 'system_db_table_change_values_time_prime';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_TIME_NORM = 'system_db_table_change_values_time_norm';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_TIME_BIG = 'system_db_table_change_values_time_big';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_TEXT_PRIME = 'system_db_table_change_values_text_prime';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_TEXT_NORM = 'system_db_table_change_values_text_norm';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_TEXT_BIG = 'system_db_table_change_values_text_big';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_GEO_PRIME = 'system_db_table_change_values_geo_prime';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_GEO_NORM = 'system_db_table_change_values_geo_norm';
    case SYSTEM_DB_TABLE_CHANGE_VALUES_GEO_BIG = 'system_db_table_change_values_geo_big';
    case SYSTEM_DB_TABLE_VIEW_RELATIONS = 'system_db_table_view_relations';
    case SYSTEM_DB_TABLE_VIEW_RELATION_TYPES = 'system_db_table_view_relation_types';
    case SYSTEM_DB_TABLE_USER_VIEW_RELATIONS = 'system_db_table_user_view_relations';
    case SYSTEM_DB_TABLE_RESULTS = 'system_db_table_results';
    case SYSTEM_DB_TABLE_PHRASE_TYPES = 'system_db_table_phrase_types';
    case SYSTEM_DB_TABLE_SYS_LOG_LEVELS = 'system_db_table_sys_log_levels';
    case SYSTEM_DB_TABLE_SYS_LOG_STATUUM = 'system_db_table_sys_log_statuum';
    case SYSTEM_DB_TABLE_SYS_LOG_FUNCTIONS = 'system_db_table_sys_log_functions';
    case SYSTEM_DB_TABLE_CHANGE_ACTIONS = 'system_db_table_change_actions';
    case SYSTEM_DB_TABLE_JOB_STATUUM = 'system_db_table_job_statuum';
    case SYSTEM_DB_TABLE_SYSTEM_TIME_TYPES = 'system_db_table_system_time_types';
    case SYSTEM_DB_TABLE_USER_STATUUM = 'system_db_table_user_statuum';
    case SYSTEM_DB_TABLE_DB_CACHE_STATUUM = 'system_db_table_db_cache_statuum';
    case SYSTEM_DB_TABLE_DB_CACHE_TYPES = 'system_db_table_db_cache_types';
    case SYSTEM_DB_TABLE_DB_CACHES = 'system_db_table_db_caches';

    // database change actions (code id from change_actions.csv), translated via Translator::text_db_action
    case SYSTEM_DB_ACTION_ADD = 'system_db_action_add';
    case SYSTEM_DB_ACTION_UPDATE = 'system_db_action_update';
    case SYSTEM_DB_ACTION_DEL = 'system_db_action_del';

    // database field names (code id from change_fields.csv), translated via Translator::text_db_field
    case SYSTEM_DB_FIELD_ACTION = 'system_db_field_action';
    case SYSTEM_DB_FIELD_ACTIVATION_KEY = 'system_db_field_activation_key';
    case SYSTEM_DB_FIELD_ACTIVATION_TIMEOUT = 'system_db_field_activation_timeout';
    case SYSTEM_DB_FIELD_ALL_VALUES_NEEDED = 'system_db_field_all_values_needed';
    case SYSTEM_DB_FIELD_BASE_URL = 'system_db_field_base_url';
    case SYSTEM_DB_FIELD_CHANGE_ACTION_ID = 'system_db_field_change_action_id';
    case SYSTEM_DB_FIELD_CHARACTER_MAXIMUM_LENGTH = 'system_db_field_character_maximum_length';
    case SYSTEM_DB_FIELD_CHARACTER_OCTET_LENGTH = 'system_db_field_character_octet_length';
    case SYSTEM_DB_FIELD_CHARACTER_SET_CATALOG = 'system_db_field_character_set_catalog';
    case SYSTEM_DB_FIELD_CHARACTER_SET_NAME = 'system_db_field_character_set_name';
    case SYSTEM_DB_FIELD_CHARACTER_SET_SCHEMA = 'system_db_field_character_set_schema';
    case SYSTEM_DB_FIELD_CHECK_OPTION = 'system_db_field_check_option';
    case SYSTEM_DB_FIELD_CHILD_VIEW_ID = 'system_db_field_child_view_id';
    case SYSTEM_DB_FIELD_CODE_ID = 'system_db_field_code_id';
    case SYSTEM_DB_FIELD_COLLATION_CATALOG = 'system_db_field_collation_catalog';
    case SYSTEM_DB_FIELD_COLLATION_NAME = 'system_db_field_collation_name';
    case SYSTEM_DB_FIELD_COLLATION_SCHEMA = 'system_db_field_collation_schema';
    case SYSTEM_DB_FIELD_COLLECTION_TYPE_IDENTIFIER = 'system_db_field_collection_type_identifier';
    case SYSTEM_DB_FIELD_COMPONENT_ID = 'system_db_field_component_id';
    case SYSTEM_DB_FIELD_COMPONENT_LINK_ID = 'system_db_field_component_link_id';
    case SYSTEM_DB_FIELD_COMPONENT_LINK_TYPE_ID = 'system_db_field_component_link_type_id';
    case SYSTEM_DB_FIELD_COMPONENT_NAME = 'system_db_field_component_name';
    case SYSTEM_DB_FIELD_COMPONENT_TYPE_ID = 'system_db_field_component_type_id';
    case SYSTEM_DB_FIELD_CONDITION_FORMULA_ID = 'system_db_field_condition_formula_id';
    case SYSTEM_DB_FIELD_CONDITION_TYPE = 'system_db_field_condition_type';
    case SYSTEM_DB_FIELD_CONFIG_ID = 'system_db_field_config_id';
    case SYSTEM_DB_FIELD_CONFIG_NAME = 'system_db_field_config_name';
    case SYSTEM_DB_FIELD_CREATED = 'system_db_field_created';
    case SYSTEM_DB_FIELD_DATA = 'system_db_field_data';
    case SYSTEM_DB_FIELD_DATA_TYPE = 'system_db_field_data_type';
    ...
    case SYSTEM_DB_FIELD_EMAIL = 'system_db_field_email';
    case SYSTEM_DB_FIELD_EMAIL_ALTERNATIVE = 'system_db_field_email_alternative';
    case SYSTEM_DB_FIELD_EMAIL_STATUS = 'system_db_field_email_status';
    case SYSTEM_DB_FIELD_EXCLUDED = 'system_db_field_excluded';
    case SYSTEM_DB_FIELD_EXTERNAL_KEY = 'system_db_field_external_key';
    case SYSTEM_DB_FIELD_FIRST_NAME = 'system_db_field_first_name';
    case SYSTEM_DB_FIELD_FORMULA_ID = 'system_db_field_formula_id';
    case SYSTEM_DB_FIELD_FORMULA_LINK_ID = 'system_db_field_formula_link_id';
    case SYSTEM_DB_FIELD_FORMULA_LINK_TYPE_ID = 'system_db_field_formula_link_type_id';
    case SYSTEM_DB_FIELD_FORMULA_NAME = 'system_db_field_formula_name';
    case SYSTEM_DB_FIELD_FORMULA_TEXT = 'system_db_field_formula_text';
    case SYSTEM_DB_FIELD_FORMULA_TYPE_ID = 'system_db_field_formula_type_id';
    case SYSTEM_DB_FIELD_FROM_PHRASE_ID = 'system_db_field_from_phrase_id';
    case SYSTEM_DB_FIELD_GEO_STATUS_ID = 'system_db_field_geo_status_id';
    ...
    case SYSTEM_DB_FIELD_INTERVAL_PRECISION = 'system_db_field_interval_precision';
    case SYSTEM_DB_FIELD_INTERVAL_TYPE = 'system_db_field_interval_type';
    case SYSTEM_DB_FIELD_IP_ADDRESS = 'system_db_field_ip_address';
    case SYSTEM_DB_FIELD_IP_FROM = 'system_db_field_ip_from';
    case SYSTEM_DB_FIELD_IP_FROM_IP_TO = 'system_db_field_ip_from_ip_to';
    case SYSTEM_DB_FIELD_IP_RANGE_ID = 'system_db_field_ip_range_id';
    case SYSTEM_DB_FIELD_IP_RANGE_KEY = 'system_db_field_ip_range_key';
    case SYSTEM_DB_FIELD_IP_TO = 'system_db_field_ip_to';
    case SYSTEM_DB_FIELD_IS_ACTIVE = 'system_db_field_is_active';
    case SYSTEM_DB_FIELD_IS_INSERTABLE_INTO = 'system_db_field_is_insertable_into';
    case SYSTEM_DB_FIELD_IS_TRIGGER_DELETABLE = 'system_db_field_is_trigger_deletable';
    case SYSTEM_DB_FIELD_IS_TRIGGER_INSERTABLE_INTO = 'system_db_field_is_trigger_insertable_into';
    case SYSTEM_DB_FIELD_IS_TRIGGER_UPDATABLE = 'system_db_field_is_trigger_updatable';
    case SYSTEM_DB_FIELD_IS_UPDATABLE = 'system_db_field_is_updatable';
    case SYSTEM_DB_FIELD_JOB_STATUS_ID = 'system_db_field_job_status_id';
    case SYSTEM_DB_FIELD_JOB_TIME_ID = 'system_db_field_job_time_id';
    case SYSTEM_DB_FIELD_JOB_TYPE_ID = 'system_db_field_job_type_id';
    case SYSTEM_DB_FIELD_LANGUAGE_FORM_ID = 'system_db_field_language_form_id';
    case SYSTEM_DB_FIELD_LANGUAGE_FORM_NAME = 'system_db_field_language_form_name';
    case SYSTEM_DB_FIELD_LANGUAGE_ID = 'system_db_field_language_id';
    case SYSTEM_DB_FIELD_LANGUAGE_NAME = 'system_db_field_language_name';
    case SYSTEM_DB_FIELD_LAST_LOGIN = 'system_db_field_last_login';
    case SYSTEM_DB_FIELD_LAST_LOGOFF = 'system_db_field_last_logoff';
    case SYSTEM_DB_FIELD_LAST_NAME = 'system_db_field_last_name';
    case SYSTEM_DB_FIELD_LAST_UPDATE = 'system_db_field_last_update';
    case SYSTEM_DB_FIELD_LATEX = 'system_db_field_latex';
    case SYSTEM_DB_FIELD_LEVEL_NAME = 'system_db_field_level_name';
    case SYSTEM_DB_FIELD_LINKED_COMPONENT_ID = 'system_db_field_linked_component_id';
    case SYSTEM_DB_FIELD_LINK_TYPE_ID = 'system_db_field_link_type_id';
    case SYSTEM_DB_FIELD_LOCAL_NAME = 'system_db_field_local_name';
    case SYSTEM_DB_FIELD_MAXIMUM_CARDINALITY = 'system_db_field_maximum_cardinality';
    case SYSTEM_DB_FIELD_MOBILE_NUMBER = 'system_db_field_mobile_number';
    case SYSTEM_DB_FIELD_MOBILE_STATUS = 'system_db_field_mobile_status';
    case SYSTEM_DB_FIELD_NAME_GENERATED = 'system_db_field_name_generated';
    case SYSTEM_DB_FIELD_NAME_GIVEN = 'system_db_field_name_given';
    case SYSTEM_DB_FIELD_NAME_PLURAL = 'system_db_field_name_plural';
    case SYSTEM_DB_FIELD_NAME_PLURAL_REVERSE = 'system_db_field_name_plural_reverse';
    case SYSTEM_DB_FIELD_NAME_REVERSE = 'system_db_field_name_reverse';
    case SYSTEM_DB_FIELD_NAME_TRIPLE_ID = 'system_db_field_name_triple_id';
    case SYSTEM_DB_FIELD_NUMBER = 'system_db_field_number';
    case SYSTEM_DB_FIELD_NUMERIC_PRECISION = 'system_db_field_numeric_precision';
    case SYSTEM_DB_FIELD_NUMERIC_PRECISION_RADIX = 'system_db_field_numeric_precision_radix';
    case SYSTEM_DB_FIELD_NUMERIC_SCALE = 'system_db_field_numeric_scale';
    case SYSTEM_DB_FIELD_NUMERIC_VALUE = 'system_db_field_numeric_value';
    case SYSTEM_DB_FIELD_OBJECT_CATALOG = 'system_db_field_object_catalog';
    case SYSTEM_DB_FIELD_OBJECT_NAME = 'system_db_field_object_name';
    case SYSTEM_DB_FIELD_OBJECT_SCHEMA = 'system_db_field_object_schema';
    case SYSTEM_DB_FIELD_OBJECT_TYPE = 'system_db_field_object_type';
    case SYSTEM_DB_FIELD_OFFICIAL_ID = 'system_db_field_official_id';
    case SYSTEM_DB_FIELD_OFFICIAL_ID_STATUS = 'system_db_field_official_id_status';
    case SYSTEM_DB_FIELD_OFFICIAL_ID_TYPE = 'system_db_field_official_id_type';
    case SYSTEM_DB_FIELD_ORDER_NBR = 'system_db_field_order_nbr';
    case SYSTEM_DB_FIELD_PARAMETER = 'system_db_field_parameter';
    case SYSTEM_DB_FIELD_PARAM_TRIPLE_ID = 'system_db_field_param_triple_id';
    case SYSTEM_DB_FIELD_PARENT_VIEW_ID = 'system_db_field_parent_view_id';
    case SYSTEM_DB_FIELD_PASSWORD = 'system_db_field_password';
    case SYSTEM_DB_FIELD_PHRASE_ID = 'system_db_field_phrase_id';
    case SYSTEM_DB_FIELD_PHRASE_ID_1 = 'system_db_field_phrase_id_1';
    case SYSTEM_DB_FIELD_PHRASE_ID_2 = 'system_db_field_phrase_id_2';
    case SYSTEM_DB_FIELD_PHRASE_ID_3 = 'system_db_field_phrase_id_3';
    case SYSTEM_DB_FIELD_PHRASE_ID_4 = 'system_db_field_phrase_id_4';
    case SYSTEM_DB_FIELD_PHRASE_TYPE_ID = 'system_db_field_phrase_type_id';
    case SYSTEM_DB_FIELD_PLURAL = 'system_db_field_plural';
    case SYSTEM_DB_FIELD_POD_ID = 'system_db_field_pod_id';
    case SYSTEM_DB_FIELD_POD_STATUS_ID = 'system_db_field_pod_status_id';
    case SYSTEM_DB_FIELD_POD_TYPE_ID = 'system_db_field_pod_type_id';
    case SYSTEM_DB_FIELD_POD_URL = 'system_db_field_pod_url';
    case SYSTEM_DB_FIELD_POSITION_TYPE_ID = 'system_db_field_position_type_id';
    case SYSTEM_DB_FIELD_PRIORITY = 'system_db_field_priority';
    case SYSTEM_DB_FIELD_PROTECT_ID = 'system_db_field_protect_id';
    case SYSTEM_DB_FIELD_PROTECTION_TYPE_ID = 'system_db_field_protection_type_id';
    case SYSTEM_DB_FIELD_REASON = 'system_db_field_reason';
    case SYSTEM_DB_FIELD_REF_ID = 'system_db_field_ref_id';
    case SYSTEM_DB_FIELD_REF_TYPE_ID = 'system_db_field_ref_type_id';
    case SYSTEM_DB_FIELD_RESOLVED_TEXT = 'system_db_field_resolved_text';
    case SYSTEM_DB_FIELD_RIGHT_LEVEL = 'system_db_field_right_level';
    case SYSTEM_DB_FIELD_SCHEDULE = 'system_db_field_schedule';
    case SYSTEM_DB_FIELD_SCOPE_CATALOG = 'system_db_field_scope_catalog';
    case SYSTEM_DB_FIELD_SCOPE_NAME = 'system_db_field_scope_name';
    case SYSTEM_DB_FIELD_SCOPE_SCHEMA = 'system_db_field_scope_schema';
    case SYSTEM_DB_FIELD_SHARE_TYPE_ID = 'system_db_field_share_type_id';
    case SYSTEM_DB_FIELD_SOLVER_ID = 'system_db_field_solver_id';
    case SYSTEM_DB_FIELD_SOURCE_ID = 'system_db_field_source_id';
    case SYSTEM_DB_FIELD_SOURCE_NAME = 'system_db_field_source_name';
    case SYSTEM_DB_FIELD_SOURCE_TYPE_ID = 'system_db_field_source_type_id';
    case SYSTEM_DB_FIELD_START = 'system_db_field_start';
    case SYSTEM_DB_FIELD_START_POS = 'system_db_field_start_pos';
    case SYSTEM_DB_FIELD_STATUS_ID = 'system_db_field_status_id';
    case SYSTEM_DB_FIELD_STATUS_NAME = 'system_db_field_status_name';
    case SYSTEM_DB_FIELD_SYMBOL = 'system_db_field_symbol';
    case SYSTEM_DB_FIELD_SYS_LOG_DESCRIPTION = 'system_db_field_sys_log_description';
    case SYSTEM_DB_FIELD_SYS_LOG_FUNCTION_ID = 'system_db_field_sys_log_function_id';
    case SYSTEM_DB_FIELD_SYS_LOG_FUNCTION_NAME = 'system_db_field_sys_log_function_name';
    case SYSTEM_DB_FIELD_SYS_LOG_ID = 'system_db_field_sys_log_id';
    case SYSTEM_DB_FIELD_SYS_LOG_LEVEL_ID = 'system_db_field_sys_log_level_id';
    case SYSTEM_DB_FIELD_SYS_LOG_STATUS_ID = 'system_db_field_sys_log_status_id';
    case SYSTEM_DB_FIELD_SYS_LOG_TEXT = 'system_db_field_sys_log_text';
    case SYSTEM_DB_FIELD_SYS_LOG_TIME = 'system_db_field_sys_log_time';
    case SYSTEM_DB_FIELD_SYS_LOG_TRACE = 'system_db_field_sys_log_trace';
    case SYSTEM_DB_FIELD_SYS_LOG_UPDATE_TIME = 'system_db_field_sys_log_update_time';
    case SYSTEM_DB_FIELD_SYSTEM_TIME_TYPE_ID = 'system_db_field_system_time_type_id';
    case SYSTEM_DB_FIELD_TABLE_CATALOG = 'system_db_field_table_catalog';
    case SYSTEM_DB_FIELD_TABLE_NAME = 'system_db_field_table_name';
    case SYSTEM_DB_FIELD_TABLE_SCHEMA = 'system_db_field_table_schema';
    case SYSTEM_DB_FIELD_TERM_ID = 'system_db_field_term_id';
    case SYSTEM_DB_FIELD_TERM_VIEW_ID = 'system_db_field_term_view_id';
    case SYSTEM_DB_FIELD_TEXT_VALUE = 'system_db_field_text_value';
    case SYSTEM_DB_FIELD_TIME_VALUE = 'system_db_field_time_value';
    case SYSTEM_DB_FIELD_TO_PHRASE_ID = 'system_db_field_to_phrase_id';
    case SYSTEM_DB_FIELD_TRIPLE_CONDITION_ID = 'system_db_field_triple_condition_id';
    case SYSTEM_DB_FIELD_TRIPLE_ID = 'system_db_field_triple_id';
    case SYSTEM_DB_FIELD_TRIPLE_NAME = 'system_db_field_triple_name';
    case SYSTEM_DB_FIELD_TYPE_ID = 'system_db_field_type_id';
    case SYSTEM_DB_FIELD_TYPE_NAME = 'system_db_field_type_name';
    case SYSTEM_DB_FIELD_UDT_CATALOG = 'system_db_field_udt_catalog';
    case SYSTEM_DB_FIELD_UDT_NAME = 'system_db_field_udt_name';
    case SYSTEM_DB_FIELD_UDT_SCHEMA = 'system_db_field_udt_schema';
    case SYSTEM_DB_FIELD_UI_MSG_CODE_ID = 'system_db_field_ui_msg_code_id';
    case SYSTEM_DB_FIELD_UI_MSG_CODE_ID_EXCEPTION = 'system_db_field_ui_msg_code_id_exception';
    case SYSTEM_DB_FIELD_UI_MSG_CODE_ID_VARS = 'system_db_field_ui_msg_code_id_vars';
    case SYSTEM_DB_FIELD_UI_MSG_VALUE_EXCEPTION = 'system_db_field_ui_msg_value_exception';
    case SYSTEM_DB_FIELD_URL = 'system_db_field_url';
    case SYSTEM_DB_FIELD_USAGE = 'system_db_field_usage';
    case SYSTEM_DB_FIELD_USER_ID = 'system_db_field_user_id';
    case SYSTEM_DB_FIELD_USER_NAME = 'system_db_field_user_name';
    case SYSTEM_DB_FIELD_USER_OFFICIAL_TYPE_ID = 'system_db_field_user_official_type_id';
    case SYSTEM_DB_FIELD_USER_PROFILE_ID = 'system_db_field_user_profile_id';
    case SYSTEM_DB_FIELD_USER_PROFILE_NAME = 'system_db_field_user_profile_name';
    case SYSTEM_DB_FIELD_USER_STATUS_ID = 'system_db_field_user_status_id';
    case SYSTEM_DB_FIELD_USER_STATUS_NAME = 'system_db_field_user_status_name';
    case SYSTEM_DB_FIELD_USER_TYPE_ID = 'system_db_field_user_type_id';
    case SYSTEM_DB_FIELD_VAL_TIME = 'system_db_field_val_time';
    case SYSTEM_DB_FIELD_VALUE = 'system_db_field_value';
    case SYSTEM_DB_FIELD_VALUES = 'system_db_field_values';
    case SYSTEM_DB_FIELD_VALUE_TIME_SERIES_ID = 'system_db_field_value_time_series_id';
    case SYSTEM_DB_FIELD_VERB_ID = 'system_db_field_verb_id';
    case SYSTEM_DB_FIELD_VERB_NAME = 'system_db_field_verb_name';
    case SYSTEM_DB_FIELD_VIEW_DEFINITION = 'system_db_field_view_definition';
    case SYSTEM_DB_FIELD_VIEW_ID = 'system_db_field_view_id';
    case SYSTEM_DB_FIELD_VIEW_LINK_TYPE_ID = 'system_db_field_view_link_type_id';
    case SYSTEM_DB_FIELD_VIEW_NAME = 'system_db_field_view_name';
    case SYSTEM_DB_FIELD_VIEW_RELATION_ID = 'system_db_field_view_relation_id';
    case SYSTEM_DB_FIELD_VIEW_RELATION_TYPE_ID = 'system_db_field_view_relation_type_id';
    case SYSTEM_DB_FIELD_VIEW_STYLE_ID = 'system_db_field_view_style_id';
    case SYSTEM_DB_FIELD_VIEW_STYLE_NAME = 'system_db_field_view_style_name';
    ...
    case SYSTEM_DB_FIELD_WORD_ID_ROW = 'system_db_field_word_id_row';
    case SYSTEM_DB_FIELD_WORD_NAME = 'system_db_field_word_name';
    case SYSTEM_DB_FIELD_WORDS = 'system_db_field_words';
