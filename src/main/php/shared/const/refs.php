...
class refs
{
    ...
    // *_EXT is the url part to be added after the external key
    const string WIKIDATA_TYPE = 'wikidata';
    const string WIKIDATA_URL = 'https://www.wikidata.org/wiki/Special:EntityData/';
    const string WIKIDATA_EXT = '.json';
