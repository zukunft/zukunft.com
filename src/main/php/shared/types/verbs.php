...
class verbs
{
    ...
    const string FOLLOW_COM = "the time order of two phrases e.g. 2025 is follower of 2024; for the table column order use 'is next main column after' or 'is explaining column for'";
    ...
    const string BEFORE = "before"; // to chain the main table columns e.g. the solution column follows the problem column
    const string BEFORE_NAME = "is next main column after";
    const int BEFORE_ID = 44;
    const string BEFORE_COM = "to chain the main table columns e.g. the solution column is the next main column after the problem column and all columns explaining the problem; for a time order use 'is follower of'";
    const string BEFORE_PLURAL = "are next main columns after";
    const string BEFORE_REVERSE = "is main column before";
    const string BEFORE_REV_PLURAL = "are main columns before";
    const string AFTER = "after"; // to attach a column that explains a main table column e.g. the loss column explains the problem column
    const string AFTER_NAME = "is explaining column for";
    const int AFTER_ID = 45;
    const string AFTER_COM = "to attach a column that explains a main table column e.g. the loss column gives the size of the problem column; an explaining column is shown between its main column and the next main column";
    const string AFTER_PLURAL = "are explaining columns for";
    const string AFTER_REVERSE = "is explained by column";
    const string AFTER_REV_PLURAL = "are explained by columns";
