...
class api
{
    ...
    const HOST_SAME = '/';
    const BS_PATH_DEV = 'bootstrap/dist/';
    const BS_PATH_UAT = 'bootstrap/dist/';
    const BS_PATH_PROD = 'bootstrap/dist/';
    const BS_JS = 'js' . DIRECTORY_SEPARATOR . 'bootstrap.js';
    const BS_CSS_PATH_DEV = 'bootstrap/dist/';
    const BS_CSS_PATH_UAT = 'bootstrap/dist/';
    const BS_CSS_PATH_PROD = 'bootstrap/dist/';
