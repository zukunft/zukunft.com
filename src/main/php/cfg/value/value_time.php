...
class value_time extends value_base
{
     ...
     *
     * @param value_time|sandbox_multi|db_object_multi $std_obj the norm object as saved in the database
     * @param value_time|sandbox_multi|db_object_multi $result empty clone of the target user object
     * @return value_time|sandbox_multi|db_object_multi the object where only the vars are set that are changed compared to the given $obj
     */
    function delta(
        value_time|sandbox_multi|db_object_multi $std_obj,
        value_time|sandbox_multi|db_object_multi $result
    ): value_time|sandbox_multi|db_object_multi
    {
        parent::delta($std_obj, $result);
        if ($std_obj->time_val !== $this->time_val) {
            $result->time_val = $this->time_val;
        }
        return $result;
    }
     ...
     *
     * @param value_time|sandbox_multi|db_object_multi $obj sandbox object with the values that should be updated e.g. based on the import
