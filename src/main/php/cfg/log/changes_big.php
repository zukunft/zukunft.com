...
class changes_big extends change
{
    ...
    const string TBL_COMMENT = 'to log all changes done by any user on the group name for values with more than 16 phrases';
    ...
    const array FLD_LST_CHANGE = array(
        ...
        [self::FLD_OLD_ID, self::FLD_OLD_ID_BIG_SQL_TYP, sql_field_default::NULL, '', '', self::FLD_OLD_ID_COM],
        [self::FLD_NEW_ID, self::FLD_OLD_ID_BIG_SQL_TYP, sql_field_default::NULL, '', '', self::FLD_NEW_ID_COM],
    );
