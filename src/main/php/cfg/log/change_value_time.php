...
class change_value_time extends change_value
{
    ...
    const string TBL_COMMENT = 'to log all time value changes done by any user on all kind of values (table, prime, big and standard';
    ...
    const array FLD_LST_CHANGE = array(
        ...
        [change::FLD_OLD_VALUE, sql_field_type::TIME, sql_field_default::NULL, '', '', change_value::FLD_OLD_VALUE_COM],
        [change::FLD_NEW_VALUE, sql_field_type::TIME, sql_field_default::NULL, '', '', change_value::FLD_NEW_VALUE_COM],
    ...
    function db_field_values_types(
        ...
        sql_par_type $val_typ = sql_par_type::TIME
    ): sql_par_field_list
    {
