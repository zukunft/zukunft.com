...
class change_value_geo extends change_value
{
    ...
    const array FLD_LST_CHANGE = array(
        ...
        [change::FLD_OLD_VALUE, sql_field_type::POINT, sql_field_default::NULL, '', '', change_value::FLD_OLD_VALUE_COM],
        [change::FLD_NEW_VALUE, sql_field_type::POINT, sql_field_default::NULL, '', '', change_value::FLD_NEW_VALUE_COM],
