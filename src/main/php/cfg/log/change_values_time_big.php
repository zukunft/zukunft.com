...
class change_values_time_big extends change_value_time
{
    ...
    const string TBL_COMMENT = 'to log all time value changes done by any user on values with a big group id';
