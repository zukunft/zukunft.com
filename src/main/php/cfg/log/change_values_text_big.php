...
class change_values_text_big extends change_value_text
{
    ...
    const string TBL_COMMENT = 'to log all text value changes done by any user on values with a big group id';
