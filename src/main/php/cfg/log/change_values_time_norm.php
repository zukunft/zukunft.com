...
/*
    ...
    model/log/change_values_time_norm.php - log object for changes of values with a standard group id
    -------------------------------------
...
class change_values_time_norm extends change_value_time
{
    ...
    const string TBL_COMMENT = 'to log all time value changes done by any user on values with a standard group id';
