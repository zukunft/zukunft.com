...
/*
    ...
    model/log/change_values_geo_norm.php - log object for changes of values with a standard group id
    ------------------------------------
...
class change_values_geo_norm extends change_value_geo
{
    ...
    const string TBL_COMMENT = 'to log all geo value changes done by any user on values with a standard group id';
