...
class sandbox_code_id extends sandbox_typed
{
     ...
     * @param sandbox|CombineObject|IdObject $db_obj the word as saved in the database
     * @param user_message $msg to collect the messages
     * @return bool true if this word has infos that should be saved in the database
     */
    function needs_db_update(sandbox|CombineObject|IdObject $db_obj, user_message $msg): bool
    {
