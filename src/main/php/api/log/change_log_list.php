...
class change_log_list_api extends list_api
{
    ...
    {
        $result = new change_log_list_api();
        foreach ($this->lst as $wrd) {
            if ($wrd->is_type($type)) {
                $result->add($wrd);
            }
     ...
     */
    function time_lst(): change_log_list_api
    {
     ...
     */
    function measure_lst(): change_log_list_api
    {
     ...
     */
    function scaling_lst(): change_log_list_api
    {
        $result = new change_log_list_api();
        foreach ($this->lst as $wrd) {
            if ($wrd->is_scaling()) {
     ...
     * get all measure words from this list of words
     */
    function percent_lst(): change_log_list_api
    {
