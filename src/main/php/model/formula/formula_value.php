    ...
    function save_if_updated($debug)
    {
        ...
        if ($this->val_missing) {
            ...
            if ($this->last_val_update <= $this->last_update) {
                ...
                if (!isset($this->phr_lst)) {
                    log_warning('The result phrases for ' . $this->dsp_id() . ' are missing.', 'formula_value->save_if_updated', '', (new Exception)->getTraceAsString(), $this->usr);
                }
                if (!isset($this->src_phr_lst)) {
                    log_warning('The source phrases for ' . $this->dsp_id() . ' are missing.', 'formula_value->save_if_updated', '', (new Exception)->getTraceAsString(), $this->usr);
                }
