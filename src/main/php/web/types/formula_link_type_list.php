...
/*
    ...
    web/types/formula_link_type_list.php - the preloaded data formula link types used for the html frontend
    ------------------------------------
...
class formula_link_type_list extends type_list
{
    ...
    {
        return parent::type_selector($form, $selected, $name, msg_id::LABEL_FORMULA_LINK_TYPE, $style);
    }
