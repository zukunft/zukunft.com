...
class component_exe extends component
{
    ...
    ): string
    {
        ...
        $result .= match ($tc_id) {
            ...
            component_types::FORM_SELECT_SOURCE => $form->form_source($dbo, $form_name, $cfg->source_list(), $pattern, $test_mode),
            component_types::FORM_SELECT_SOURCES => $form->form_sources($dbo, $form_name, $cfg->source_list(), $test_mode),
            component_types::FORM_SELECT_REF => $form->form_ref($dbo, $form_name, $cfg->ref_list(), $pattern),
            component_types::FORM_SELECT_REFS => $form->form_refs($dbo, $form_name, $cfg->ref_list()),
            ...
            component_types::SYSTEM_BODY_SEARCH => $page->body_search($url_arr),
