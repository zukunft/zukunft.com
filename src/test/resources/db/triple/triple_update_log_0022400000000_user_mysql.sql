DROP PROCEDURE IF EXISTS triple_update_log_0022400000000_user;
CREATE PROCEDURE triple_update_log_0022400000000_user
        (_user_id                 bigint,
...
PREPARE triple_update_log_0022400000000_user_call FROM
    'SELECT triple_update_log_0022400000000_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
