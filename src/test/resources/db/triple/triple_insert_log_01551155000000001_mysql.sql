DROP PROCEDURE IF EXISTS triple_insert_log_01551155000000001;
CREATE PROCEDURE triple_insert_log_01551155000000001
...
PREPARE triple_insert_log_01551155000000001_call FROM
'SELECT triple_insert_log_01551155000000001 (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
