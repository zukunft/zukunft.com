DROP PROCEDURE IF EXISTS triple_insert_log_015511550000000;
CREATE PROCEDURE triple_insert_log_015511550000000
...
PREPARE triple_insert_log_015511550000000_call FROM
'SELECT triple_insert_log_015511550000000 (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
