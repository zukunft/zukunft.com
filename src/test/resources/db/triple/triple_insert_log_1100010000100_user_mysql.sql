DROP PROCEDURE IF EXISTS triple_insert_log_1100010000100_user;
CREATE PROCEDURE triple_insert_log_1100010000100_user
    (_user_id           bigint,
...
PREPARE triple_insert_log_1100010000100_user_call FROM
