DROP PROCEDURE IF EXISTS triple_insert_log_1111500000000001_user;
CREATE PROCEDURE triple_insert_log_1111500000000001_user
    (_user_id                 bigint,
...
PREPARE triple_insert_log_1111500000000001_user_call FROM
