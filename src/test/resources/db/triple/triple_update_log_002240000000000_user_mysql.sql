DROP PROCEDURE IF EXISTS triple_update_log_002240000000000_user;
CREATE PROCEDURE triple_update_log_002240000000000_user
    (_user_id                 bigint,
...
PREPARE triple_update_log_002240000000000_user_call FROM
    'SELECT triple_update_log_002240000000000_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
