DROP PROCEDURE IF EXISTS triple_update_log_0000224000000100;
CREATE PROCEDURE triple_update_log_0000224000000100
        (_user_id                 bigint,
...
PREPARE triple_update_log_0000224000000100_call FROM
