DROP PROCEDURE IF EXISTS triple_insert_log_11115000000001_user;
CREATE PROCEDURE triple_insert_log_11115000000001_user
    (_user_id                 bigint,
...
PREPARE triple_insert_log_11115000000001_user_call FROM
