DROP PROCEDURE IF EXISTS triple_update_log_002240000000002_user;
CREATE PROCEDURE triple_update_log_002240000000002_user
        (_user_id                 bigint,
...
PREPARE triple_update_log_002240000000002_user_call FROM
    'SELECT triple_update_log_002240000000002_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
