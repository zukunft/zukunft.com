DROP PROCEDURE IF EXISTS triple_insert_log_015511550000000001;
CREATE PROCEDURE triple_insert_log_015511550000000001
...
BEGIN
    ...
    SELECT LAST_INSERT_ID() AS @new_triple_id;
...
PREPARE triple_insert_log_015511550000000001_call FROM
    'SELECT triple_insert_log_015511550000000001 (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
