DROP PROCEDURE IF EXISTS triple_update_log_00442244000000002;
CREATE PROCEDURE triple_update_log_00442244000000002
        (_user_id                 bigint,
...
PREPARE triple_update_log_00442244000000002_call FROM
