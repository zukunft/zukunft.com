CREATE OR REPLACE FUNCTION triple_update_log_00442244000000002
        (_user_id                 bigint,
...
PREPARE triple_update_log_00442244000000002_call
        (bigint, smallint, smallint, text, bigint, text, bigint, bigint, smallint, text, bigint, text, bigint, smallint, text, text, smallint, text, text, smallint, text, smallint, text, smallint, smallint, text, smallint, text, smallint, smallint, smallint, smallint) AS
SELECT triple_update_log_00442244000000002
