DROP PROCEDURE IF EXISTS triple_update_log_0022400000000100_user;
CREATE PROCEDURE triple_update_log_0022400000000100_user
    (_user_id                 bigint,
...
PREPARE triple_update_log_0022400000000100_user_call FROM
    'SELECT triple_update_log_0022400000000100_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
