DROP PROCEDURE IF EXISTS triple_insert_log_110004000000101_user;
CREATE PROCEDURE triple_insert_log_110004000000101_user
    (_user_id             bigint,
...
PREPARE triple_insert_log_110004000000101_user_call FROM
'SELECT triple_insert_log_110004000000101_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
