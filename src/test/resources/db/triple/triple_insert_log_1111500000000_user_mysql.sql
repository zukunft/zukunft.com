DROP PROCEDURE IF EXISTS triple_insert_log_1111500000000_user;
CREATE PROCEDURE triple_insert_log_1111500000000_user
    (_user_id                 bigint,
...
PREPARE triple_insert_log_1111500000000_user_call FROM
'SELECT triple_insert_log_1111500000000_user (?,?,?,?,?,?,?,?,?,?)';
