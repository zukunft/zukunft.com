DROP PROCEDURE IF EXISTS triple_update_log_00002240000000000;
CREATE PROCEDURE triple_update_log_00002240000000000
    (_user_id                 bigint,
...
PREPARE triple_update_log_00002240000000000_call FROM
    'SELECT triple_update_log_00002240000000000 (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
