DROP PROCEDURE IF EXISTS triple_update_log_000022400000000100;
CREATE PROCEDURE triple_update_log_000022400000000100
    (_user_id                 bigint,
...
PREPARE triple_update_log_000022400000000100_call FROM
    'SELECT triple_update_log_000022400000000100 (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
