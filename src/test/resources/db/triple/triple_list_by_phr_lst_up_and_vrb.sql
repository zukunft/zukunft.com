PREPARE triple_list_by_phr_lst_up_and_vrb (bigint, bigint[], bigint) AS
    SELECT     s.triple_id,
     ...
     LEFT JOIN user_triples u ON s.triple_id = u.triple_id
                             ...
                             AND ul2.user_id = $1
         WHERE s.from_phrase_id = ANY ($2) AND s.verb_id = $3 ORDER BY s.verb_id, triple_name, s.triple_id;