CREATE OR REPLACE FUNCTION source_type_insert_log_1111
    (_type_name               text,
     _user_id                 bigint,
...
$$
DECLARE new_source_type_id bigint;
BEGIN

        INSERT INTO source_types (type_name)
             SELECT              _type_name
          RETURNING source_type_id INTO new_source_type_id;
