CREATE OR REPLACE FUNCTION formula_type_insert_log_1111
    (_type_name               text,
     _user_id                 bigint,
...
$$
DECLARE new_formula_type_id bigint;
BEGIN

        INSERT INTO formula_types (type_name)
             SELECT              _type_name
          RETURNING formula_type_id INTO new_formula_type_id;
