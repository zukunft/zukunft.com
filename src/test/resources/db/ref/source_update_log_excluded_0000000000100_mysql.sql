DROP PROCEDURE IF EXISTS source_update_log_excluded_0000000000100;
CREATE PROCEDURE source_update_log_excluded_0000000000100
    (_user_id              bigint,
...
PREPARE source_update_log_excluded_0000000000100_call FROM
