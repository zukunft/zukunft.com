DROP PROCEDURE IF EXISTS source_update_log_excluded_00000000100_user;
CREATE PROCEDURE source_update_log_excluded_00000000100_user
    (_user_id                 bigint,
...
PREPARE source_update_log_excluded_00000000100_user_call FROM
