DROP PROCEDURE IF EXISTS source_update_log_excluded_0022022100_user;
CREATE PROCEDURE source_update_log_excluded_0022022100_user
    (_user_id                 bigint,
...
PREPARE source_update_log_excluded_0022022100_user_call FROM
