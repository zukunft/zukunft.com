DROP PROCEDURE IF EXISTS source_insert_log_011100110000;
CREATE PROCEDURE source_insert_log_011100110000
    (_source_name             text,
     _user_id                 bigint,
...
PREPARE source_insert_log_011100110000_call FROM
    'SELECT source_insert_log_011100110000 (?,?,?,?,?,?,?,?,?,?,?)';
