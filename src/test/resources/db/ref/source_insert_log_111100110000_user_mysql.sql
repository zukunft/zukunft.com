DROP PROCEDURE IF EXISTS source_insert_log_111100110000_user;
CREATE PROCEDURE source_insert_log_111100110000_user
    (_user_id                 bigint,
...
PREPARE source_insert_log_111100110000_user_call FROM
    'SELECT source_insert_log_111100110000_user (?,?,?,?,?,?,?,?,?,?,?)';
