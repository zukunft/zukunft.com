DROP PROCEDURE IF EXISTS source_update_log_0022002020001;
CREATE PROCEDURE source_update_log_0022002020001
    (_user_id                 bigint,
...
PREPARE source_update_log_0022002020001_call FROM
