CREATE OR REPLACE FUNCTION source_update_log_0022002020001
    (_user_id                 bigint,
...
BEGIN
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,         old_value,          new_value,      row_id)
         SELECT          _user_id,_change_action_id,_field_id_protect_id,    _protect_id_old,    _protect_id,    _source_id ;
...
PREPARE source_update_log_0022002020001_call
        (bigint, smallint, smallint, text, text, bigint, smallint, text, text, smallint, smallint, smallint, smallint, text, text, smallint, smallint, smallint) AS
SELECT source_update_log_0022002020001
