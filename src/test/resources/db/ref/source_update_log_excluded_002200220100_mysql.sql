DROP PROCEDURE IF EXISTS source_update_log_excluded_002200220100;
CREATE PROCEDURE source_update_log_excluded_002200220100
    (_user_id                 bigint,
...
PREPARE source_update_log_excluded_002200220100_call FROM
