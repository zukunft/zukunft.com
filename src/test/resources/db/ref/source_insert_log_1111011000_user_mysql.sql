DROP PROCEDURE IF EXISTS source_insert_log_1111011000_user;
CREATE PROCEDURE source_insert_log_1111011000_user
    (_user_id                 bigint,
...
PREPARE source_insert_log_1111011000_user_call FROM
