DROP PROCEDURE IF EXISTS source_update_log_0022002020000_user;
CREATE PROCEDURE source_update_log_0022002020000_user
    (_user_id                 bigint,
...
PREPARE source_update_log_0022002020000_user_call FROM
    'SELECT source_update_log_0022002020000_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
