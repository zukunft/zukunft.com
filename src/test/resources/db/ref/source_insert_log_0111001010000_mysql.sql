DROP PROCEDURE IF EXISTS source_insert_log_0111001010000;
CREATE PROCEDURE source_insert_log_0111001010000
    (_source_name             text,
     _user_id                 bigint,
...
PREPARE source_insert_log_0111001010000_call FROM
    'SELECT source_insert_log_0111001010000 (?,?,?,?,?,?,?,?,?,?,?)';
