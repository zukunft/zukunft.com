DROP PROCEDURE IF EXISTS source_update_log_excluded_00220022100;
CREATE PROCEDURE source_update_log_excluded_00220022100
    (_user_id                 bigint,
...
PREPARE source_update_log_excluded_00220022100_call FROM
