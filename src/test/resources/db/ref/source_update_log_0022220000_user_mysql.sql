DROP PROCEDURE IF EXISTS source_update_log_0022220000_user;
CREATE PROCEDURE source_update_log_0022220000_user
    (_user_id                 bigint,
...
PREPARE source_update_log_0022220000_user_call FROM
