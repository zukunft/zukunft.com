DROP PROCEDURE IF EXISTS source_update_log_0022220000;
CREATE PROCEDURE source_update_log_0022220000
    (_user_id                 bigint,
...
PREPARE source_update_log_0022220000_call FROM
    'SELECT source_update_log_0022220000 (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
