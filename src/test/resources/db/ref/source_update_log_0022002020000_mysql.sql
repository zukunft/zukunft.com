DROP PROCEDURE IF EXISTS source_update_log_0022002020000;
CREATE PROCEDURE source_update_log_0022002020000
    (_user_id                 bigint,
...
PREPARE source_update_log_0022002020000_call FROM
    'SELECT source_update_log_0022002020000 (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
