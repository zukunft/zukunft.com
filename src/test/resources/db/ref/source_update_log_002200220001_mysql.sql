DROP PROCEDURE IF EXISTS source_update_log_002200220001;
CREATE PROCEDURE source_update_log_002200220001
    (_user_id                 bigint,
...
PREPARE source_update_log_002200220001_call FROM
