...
BEGIN
    ...
    INSERT INTO user_view_relations ( view_relation_id, user_id, view_relation_type_id, start_pos, description, share_type_id, protect_id)
...
PREPARE view_relation_insert_log_11511011_user_call
        (bigint, smallint, smallint, text, smallint, bigint, smallint, bigint, smallint, text, smallint, smallint, smallint, smallint) AS
