CREATE OR REPLACE FUNCTION view_relation_insert_log_0155511011
...
PREPARE view_relation_insert_log_0155511011_call
    (bigint, smallint, bigint, bigint, smallint, smallint, text, text, text, smallint, smallint, bigint, smallint, text, smallint, smallint, smallint, smallint) AS
