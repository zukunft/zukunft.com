DROP PROCEDURE IF EXISTS user_insert_log_110000005000000000000;
CREATE PROCEDURE user_insert_log_110000005000000000000
    (_user_name                text,
     _user_id                  bigint,
...
PREPARE user_insert_log_110000005000000000000_call FROM
    'SELECT user_insert_log_110000005000000000000 (?,?, ?, ?, ?, ?, ?, ?, ?)';
