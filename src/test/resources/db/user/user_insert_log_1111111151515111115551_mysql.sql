DROP PROCEDURE IF EXISTS user_insert_log_1111111151515111115551;
CREATE PROCEDURE user_insert_log_1111111151515111115551
    (_user_name                   text,
     _user_id                     bigint,
...
PREPARE user_insert_log_1111111151515111115551_call FROM
