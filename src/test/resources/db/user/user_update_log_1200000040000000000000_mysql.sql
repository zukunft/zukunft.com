DROP PROCEDURE IF EXISTS user_update_log_1200000040000000000000;
CREATE PROCEDURE user_update_log_1200000040000000000000
    (_user_id                  bigint,
...
PREPARE user_update_log_1200000040000000000000_call FROM
    'SELECT user_update_log_1200000040000000000000 (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
