CREATE OR REPLACE FUNCTION user_insert_log_1010000051000011000000
    (_user_name                text,
     _user_id                  bigint,
...
PREPARE user_insert_log_1010000051000011000000_call
        (text, bigint, smallint, smallint, smallint, text, smallint, text, smallint, smallint, text, smallint, timestamp, smallint, text) AS
