CREATE OR REPLACE FUNCTION user_insert_log_1101051000000
    (_user_name                text,
     _user_id                  bigint,
...
PREPARE user_insert_log_1101051000000_call
    (text, bigint, smallint, smallint, smallint, text, smallint, text, smallint, text, smallint, smallint, text) AS
