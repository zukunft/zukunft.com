CREATE OR REPLACE FUNCTION user_insert_log_1111111151515111115551
    (_user_name                   text,
     _user_id                     bigint,
     ...
     _source_name                 text,
     _source_id                   bigint,
     _field_id_uses_sandbox       smallint,
     _uses_sandbox_old            smallint,
     _uses_sandbox                smallint) RETURNS bigint AS
$$
...
BEGIN
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,             old_value,          new_value,      row_id)
         SELECT          _user_id,_change_action_id,_field_id_uses_sandbox,      _uses_sandbox_old,  _uses_sandbox,   new_user_id ;
...
PREPARE user_insert_log_1111111151515111115551_call
        (text, bigint, smallint, smallint, smallint, text, smallint, text, smallint, text, smallint, text, smallint, timestamp, smallint, timestamp, smallint, timestamp, smallint, text, smallint, smallint, text, smallint, text, smallint, smallint, smallint, smallint, text, smallint, smallint, smallint, smallint, timestamp, smallint, text, smallint, text, smallint, text, smallint, text, bigint, smallint, text, bigint, smallint, text, bigint, smallint, smallint, smallint) AS
SELECT user_insert_log_1111111151515111115551
