CREATE OR REPLACE FUNCTION user_insert_log_101000005000000100000
      (_user_name                text,
       _user_id                  bigint,
...
PREPARE user_insert_log_101000005000000100000_call
    (text, bigint, smallint, smallint, smallint, text, smallint, text, smallint, smallint, text) AS
SELECT user_insert_log_101000005000000100000
