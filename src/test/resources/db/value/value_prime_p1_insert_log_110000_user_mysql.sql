DROP PROCEDURE IF EXISTS value_prime_p1_insert_log_110000_user;
CREATE PROCEDURE value_prime_p1_insert_log_110000_user
    (_user_id                 bigint,
...
PREPARE value_prime_p1_insert_log_110000_user_call FROM

    'SELECT value_prime_p1_insert_log_110000_user
       (?,?, ?, ?, ?, ?, ?, ?, ?)';
