DROP PROCEDURE IF EXISTS value_standard_prime_p1_insert_log_011;
CREATE PROCEDURE value_standard_prime_p1_insert_log_011
    (_user_id                 bigint,
...
PREPARE value_standard_prime_p1_insert_log_011_call FROM

    'SELECT value_standard_prime_p1_insert_log_011
       (?,?, ?, ?, ?, ?, ?, ?, ?)';
