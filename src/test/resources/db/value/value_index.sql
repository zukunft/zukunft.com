...
--
ALTER TABLE user_values_text_prime ADD CONSTRAINT user_values_text_prime_pkey PRIMARY KEY (group_id, user_id);
...
--
ALTER TABLE user_values_time_prime ADD CONSTRAINT user_values_time_prime_pkey PRIMARY KEY (group_id, user_id);
...
--
ALTER TABLE user_values_geo_prime ADD CONSTRAINT user_values_geo_prime_pkey PRIMARY KEY (group_id, user_id);
