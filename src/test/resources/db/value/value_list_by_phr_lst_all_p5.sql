PREPARE value_list_by_phr_lst_all_p5 (bigint, bigint, bigint, bigint, bigint, text, text, text, text, text, bigint) AS
    SELECT '' AS group_id,
           '' AS user_group_id,
           phrase_id_1,
           phrase_id_2,
     ...
     WHERE (phrase_id_1 = $1 OR phrase_id_2 = $1 OR phrase_id_3 = $1 OR phrase_id_4 = $1
        OR  phrase_id_1 = $2 OR phrase_id_2 = $2 OR phrase_id_3 = $2 OR phrase_id_4 = $2
        OR  phrase_id_1 = $3 OR phrase_id_2 = $3 OR phrase_id_3 = $3 OR phrase_id_4 = $3
        OR  phrase_id_1 = $4 OR phrase_id_2 = $4 OR phrase_id_3 = $4 OR phrase_id_4 = $4
        OR  phrase_id_1 = $5 OR phrase_id_2 = $5 OR phrase_id_3 = $5 OR phrase_id_4 = $5)
UNION
    SELECT group_id,
           '' AS user_group_id,
           0 AS phrase_id_1,
...
UNION
    SELECT s.group_id,
           ...
           u.share_type_id
      FROM values s
 LEFT JOIN user_values u ON s.group_id = u.group_id AND u.user_id = $11
...
UNION
 ...
 LEFT JOIN user_values_prime u ON s.phrase_id_1 = u.phrase_id_1
       ...
       AND s.phrase_id_4 = u.phrase_id_4 AND u.user_id = $11
     WHERE (s.phrase_id_1 = $1 OR s.phrase_id_2 = $1 OR s.phrase_id_3 = $1 OR s.phrase_id_4 = $1
        OR  s.phrase_id_1 = $2 OR s.phrase_id_2 = $2 OR s.phrase_id_3 = $2 OR s.phrase_id_4 = $2
        OR  s.phrase_id_1 = $3 OR s.phrase_id_2 = $3 OR s.phrase_id_3 = $3 OR s.phrase_id_4 = $3
        OR  s.phrase_id_1 = $4 OR s.phrase_id_2 = $4 OR s.phrase_id_3 = $4 OR s.phrase_id_4 = $4
        OR  s.phrase_id_1 = $5 OR s.phrase_id_2 = $5 OR s.phrase_id_3 = $5 OR s.phrase_id_4 = $5)
UNION
    SELECT s.group_id,
           u.group_id AS user_group_id,
           0 AS phrase_id_1,
           ...
           u.share_type_id
      FROM values_big s
 LEFT JOIN user_values_big u ON s.group_id = u.group_id AND u.user_id = $11
     WHERE (s.group_id like $6
        OR  s.group_id like $7
        OR  s.group_id like $8
        OR  s.group_id like $9
