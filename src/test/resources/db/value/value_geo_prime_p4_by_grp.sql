PREPARE value_geo_prime_p4_by_grp (bigint, bigint, bigint, bigint, bigint) AS
    SELECT     s.phrase_id_1,
               s.phrase_id_2,
               s.phrase_id_3,
               s.phrase_id_4,
               s.user_id,
               CASE WHEN (u.geo_value <> ''  IS NOT TRUE) THEN s.geo_value   ELSE u.geo_value   END AS geo_value,
     ...
     LEFT JOIN user_values_geo_prime u ON s.phrase_id_1 = u.phrase_id_1
