CREATE OR REPLACE FUNCTION value_update_log_0014222
    (_user_id                bigint,
...
PREPARE value_update_log_0014222_call
        (bigint, smallint, smallint, text, bigint, text, bigint, smallint, smallint, smallint, smallint, smallint, smallint, smallint, smallint, smallint, text) AS
