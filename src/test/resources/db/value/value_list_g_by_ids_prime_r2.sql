PREPARE value_list_g_by_ids_prime_r2 (bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint,bigint) AS
    SELECT s.phrase_id_1,
           ...
           CASE WHEN (point_eq(u.geo_value, NULL)) THEN s.geo_value   ELSE u.geo_value   END AS geo_value,
           u.user_id AS change_user_id,
           u.share_type_id
      FROM values_geo_prime s
 LEFT JOIN user_values_geo_prime u
