PREPARE value_list_t_by_ids_prime_r2 FROM
 ...
 LEFT JOIN user_values_text_prime u ON s.phrase_id_1 = u.phrase_id_1 AND s.phrase_id_2 = u.phrase_id_2 AND s.phrase_id_3 = u.phrase_id_3 AND s.phrase_id_4 = u.phrase_id_4 AND u.user_id = ?
