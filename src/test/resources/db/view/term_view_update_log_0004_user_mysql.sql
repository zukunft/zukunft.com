DROP PROCEDURE IF EXISTS term_view_update_log_0004_user;
CREATE PROCEDURE term_view_update_log_0004_user
    (_user_id bigint,
...
PREPARE term_view_update_log_0004_user_call FROM
