DROP PROCEDURE IF EXISTS term_view_update_log_00000400001;
CREATE PROCEDURE term_view_update_log_00000400001
    (_user_id                    bigint,
...
PREPARE term_view_update_log_00000400001_call FROM
