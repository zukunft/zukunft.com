DROP PROCEDURE IF EXISTS term_view_update_log_000004000;
CREATE PROCEDURE term_view_update_log_000004000
    (_user_id bigint,
...
PREPARE term_view_update_log_000004000_call FROM
    'SELECT term_view_update_log_000004000 (?,?,?,?,?,?,?,?)';
