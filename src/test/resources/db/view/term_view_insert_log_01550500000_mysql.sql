DROP PROCEDURE IF EXISTS term_view_insert_log_01550500000;
CREATE PROCEDURE term_view_insert_log_01550500000
    (_view_id           bigint,
...
PREPARE term_view_insert_log_01550500000_call FROM
