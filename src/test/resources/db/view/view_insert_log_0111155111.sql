CREATE OR REPLACE FUNCTION view_insert_log_0111155111
    (_view_name               text,
     _user_id                 bigint,
...
PREPARE view_insert_log_0111155111_call
    (text, bigint, smallint, smallint, smallint, smallint, text, smallint, text, smallint, text, smallint, smallint, text, smallint, smallint, smallint, smallint, smallint, smallint, smallint) AS
SELECT view_insert_log_0111155111
