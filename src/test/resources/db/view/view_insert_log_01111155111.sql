CREATE OR REPLACE FUNCTION view_insert_log_01111155111
    (_view_name               text,
     _user_id                 bigint,
...
BEGIN
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,  new_value, row_id)
         SELECT          _user_id,_change_action_id,_field_id_usage, _usage,   new_view_id ;
...
PREPARE view_insert_log_01111155111_call
    (text, bigint, smallint, smallint, smallint, smallint, text, smallint, bigint, smallint, text, smallint, text, smallint, smallint, text, smallint, smallint, smallint, smallint, smallint, smallint, smallint) AS
SELECT view_insert_log_01111155111
