DROP PROCEDURE IF EXISTS view_insert_log_11110000000_user;
CREATE PROCEDURE view_insert_log_11110000000_user
    (_user_id                 bigint,
...
PREPARE view_insert_log_11110000000_user_call FROM
