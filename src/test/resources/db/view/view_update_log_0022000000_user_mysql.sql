DROP PROCEDURE IF EXISTS view_update_log_0022000000_user;
CREATE PROCEDURE view_update_log_0022000000_user
    (_user_id                 bigint,
...
PREPARE view_update_log_0022000000_user_call FROM
