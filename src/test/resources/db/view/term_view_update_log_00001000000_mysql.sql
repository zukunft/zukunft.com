DROP PROCEDURE IF EXISTS term_view_update_log_00001000000;
CREATE PROCEDURE term_view_update_log_00001000000
    (_user_id              bigint,
...
PREPARE term_view_update_log_00001000000_call FROM
