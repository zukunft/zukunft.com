DROP PROCEDURE IF EXISTS view_term_link_update_log_000004;
CREATE PROCEDURE view_term_link_update_log_000004
    (_user_id bigint,
...
PREPARE view_term_link_update_log_000004_call FROM
    'SELECT view_term_link_update_log_000004 (?,?,?,?,?,?,?,?)';
