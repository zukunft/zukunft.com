DROP PROCEDURE IF EXISTS term_view_insert_log_01551500000;
CREATE PROCEDURE term_view_insert_log_01551500000
    (_view_id              bigint,
...
BEGIN
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,      new_value,   row_id)
         SELECT          _user_id,_change_action_id,_field_id_description,_description,@new_term_view_id ;
...
PREPARE term_view_insert_log_01551500000_call FROM
    'SELECT term_view_insert_log_01551500000 (?,?,?,?,?,?,?,?,?,?,?,?)';
