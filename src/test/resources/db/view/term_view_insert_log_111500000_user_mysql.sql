DROP PROCEDURE IF EXISTS term_view_insert_log_111500000_user;
CREATE PROCEDURE term_view_insert_log_111500000_user
    (_user_id                    bigint,
...
PREPARE term_view_insert_log_111500000_user_call FROM
