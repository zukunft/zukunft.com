DROP PROCEDURE IF EXISTS view_term_link_update_log_0004_user;
CREATE PROCEDURE view_term_link_update_log_0004_user
    (_user_id bigint,
...
PREPARE view_term_link_update_log_0004_user_call FROM
