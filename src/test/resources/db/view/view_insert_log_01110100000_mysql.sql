DROP PROCEDURE IF EXISTS view_insert_log_01110100000;
CREATE PROCEDURE view_insert_log_01110100000
    (_view_name               text,
     _user_id                 bigint,
...
PREPARE view_insert_log_01110100000_call FROM
    'SELECT view_insert_log_01110100000 (?,?, ?, ?, ?, ?, ?, ?, ?)';
