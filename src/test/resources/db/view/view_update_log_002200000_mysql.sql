DROP PROCEDURE IF EXISTS view_update_log_002200000;
CREATE PROCEDURE view_update_log_002200000
    (_user_id                 bigint,
...
PREPARE view_update_log_002200000_call FROM
    'SELECT view_update_log_002200000 (?,?,?,?,?,?,?,?,?)';
