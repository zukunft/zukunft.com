CREATE OR REPLACE FUNCTION group_insert_log_110
       (_user_id            bigint,
...
$$ BEGIN
    ...
    INSERT INTO changes_norm ( user_id, change_action_id, change_field_id,     new_value,  row_id)
    ...
    INSERT INTO groups ( group_id, group_name, user_id)
         SELECT         _group_id,_group_name,_user_id ;

END
$$ LANGUAGE plpgsql;

PREPARE group_insert_log_110_call
    (bigint, smallint, smallint, text, smallint, text) AS
