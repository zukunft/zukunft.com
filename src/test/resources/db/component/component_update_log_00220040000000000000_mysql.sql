DROP PROCEDURE IF EXISTS component_update_log_00220040000000000000;
CREATE PROCEDURE component_update_log_00220040000000000000
    (_user_id                    bigint,
...
PREPARE component_update_log_00220040000000000000_call FROM
