PREPARE component_link_list_by_component_id (bigint, bigint) AS
    SELECT s.component_link_id,
           ...
           CASE WHEN (ul2.view_style_id    IS     NULL) THEN l2.view_style_id   ELSE ul2.view_style_id  END AS view_style_id2,           CASE WHEN (ul2.excluded         IS     NULL) THEN l2.excluded        ELSE ul2.excluded       END AS excluded2,
