DROP PROCEDURE IF EXISTS component_link_insert_log_0155810000;
CREATE PROCEDURE component_link_insert_log_0155810000
    (_view_id                bigint,
...
PREPARE component_link_insert_log_0155810000_call FROM
    'SELECT component_link_insert_log_0155810000 (?,?,?,?,?,?,?,?,?,?,?,?)';
