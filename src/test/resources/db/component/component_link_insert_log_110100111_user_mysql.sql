DROP PROCEDURE IF EXISTS component_link_insert_log_110100111_user;
CREATE PROCEDURE component_link_insert_log_110100111_user
    (_user_id                bigint,
...
PREPARE component_link_insert_log_110100111_user_call FROM
