DROP PROCEDURE IF EXISTS component_insert_log_111150000000000_user;
CREATE PROCEDURE component_insert_log_111150000000000_user
    (_user_id                    bigint,
...
PREPARE component_insert_log_111150000000000_user_call FROM
    'SELECT component_insert_log_111150000000000_user (?,?,?,?,?,?,?,?,?,?)';
