DROP PROCEDURE IF EXISTS component_link_insert_log_0155818111;
CREATE PROCEDURE component_link_insert_log_0155818111
    (_view_id                   bigint,
...
PREPARE component_link_insert_log_0155818111_call FROM
