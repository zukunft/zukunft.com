DROP PROCEDURE IF EXISTS component_update_log_0022400000000000_user;
CREATE PROCEDURE component_update_log_0022400000000000_user
    (_user_id                    bigint,
...
PREPARE component_update_log_0022400000000000_user_call FROM
    'SELECT component_update_log_0022400000000000_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
