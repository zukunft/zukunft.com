DROP PROCEDURE IF EXISTS component_link_insert_log_01555100000;
CREATE PROCEDURE component_link_insert_log_01555100000
    (_view_id                bigint,
...
PREPARE component_link_insert_log_01555100000_call FROM
