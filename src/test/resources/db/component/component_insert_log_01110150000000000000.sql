CREATE OR REPLACE FUNCTION component_insert_log_01110150000000000000
...
PREPARE component_insert_log_01110150000000000000_call
    (text, bigint, smallint, smallint, smallint, smallint, text, smallint, text, smallint, text, smallint) AS
SELECT component_insert_log_01110150000000000000
