DROP PROCEDURE IF EXISTS component_link_insert_log_11010100_user;
CREATE PROCEDURE component_link_insert_log_11010100_user
    (_user_id                bigint,
...
PREPARE component_link_insert_log_11010100_user_call FROM
