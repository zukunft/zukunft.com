DROP PROCEDURE IF EXISTS component_link_insert_log_11010000_user;
CREATE PROCEDURE component_link_insert_log_11010000_user
    (_user_id                bigint,
...
PREPARE component_link_insert_log_11010000_user_call FROM
