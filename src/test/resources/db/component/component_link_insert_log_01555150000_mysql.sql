DROP PROCEDURE IF EXISTS component_link_insert_log_01555150000;
CREATE PROCEDURE component_link_insert_log_01555150000
    (_view_id                   bigint,
...
PREPARE component_link_insert_log_01555150000_call FROM
