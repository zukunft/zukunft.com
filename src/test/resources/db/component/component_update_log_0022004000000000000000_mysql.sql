DROP PROCEDURE IF EXISTS component_update_log_0022004000000000000000;
CREATE PROCEDURE component_update_log_0022004000000000000000
    (_user_id                    bigint,
...
PREPARE component_update_log_0022004000000000000000_call FROM
    'SELECT component_update_log_0022004000000000000000 (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
