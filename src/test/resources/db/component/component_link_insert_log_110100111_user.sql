CREATE OR REPLACE FUNCTION component_link_insert_log_110100111_user
    (_user_id                bigint,
...
PREPARE component_link_insert_log_110100111_user_call
    (bigint,smallint,smallint,text,text,text,text,text,text,bigint,smallint,bigint,bigint,smallint,bigint,smallint,bigint,bigint,smallint,smallint,smallint,smallint,smallint,smallint) AS
SELECT component_link_insert_log_110100111_user
