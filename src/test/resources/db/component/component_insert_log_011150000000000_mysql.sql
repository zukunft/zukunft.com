DROP PROCEDURE IF EXISTS component_insert_log_011150000000000;
CREATE PROCEDURE component_insert_log_011150000000000
...
PREPARE component_insert_log_011150000000000_call FROM
    'SELECT component_insert_log_011150000000000 (?,?, ?, ?, ?, ?, ?, ?, ?, ?)';
