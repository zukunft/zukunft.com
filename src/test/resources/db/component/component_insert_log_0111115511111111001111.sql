CREATE OR REPLACE FUNCTION component_insert_log_0111115511111111001111
    (_component_name                    text,
     ...
     _field_id_ui_msg_code_id_vars      smallint,
     _ui_msg_code_id_vars               text,
     _field_id_ui_msg_code_id_exception smallint,
     _ui_msg_code_id_exception          text,
     _field_id_ui_msg_value_exception   smallint,
     _ui_msg_value_exception            numeric,
...
BEGIN
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,                   new_value,                                  row_id)
         SELECT          _user_id,_change_action_id,_field_id_usage,                   _usage,                                      new_component_id ;
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,                   new_value,                                  row_id)
         SELECT          _user_id,_change_action_id,_field_id_ui_msg_code_id_vars,     _ui_msg_code_id_vars,                        new_component_id ;

    INSERT INTO changes ( user_id, change_action_id, change_field_id,                   new_value,                                  row_id)
         SELECT          _user_id,_change_action_id,_field_id_ui_msg_code_id_exception,_ui_msg_code_id_exception,                   new_component_id ;

    INSERT INTO changes ( user_id, change_action_id, change_field_id,                   new_value,                                  row_id)
         SELECT          _user_id,_change_action_id,_field_id_ui_msg_value_exception,  _ui_msg_value_exception,                     new_component_id ;
    ...
    UPDATE components
       SET user_id                  = _user_id,
           ...
           ui_msg_code_id_vars      = _ui_msg_code_id_vars,
           ui_msg_code_id_exception = _ui_msg_code_id_exception,
           ui_msg_value_exception   = _ui_msg_value_exception,
...
PREPARE component_insert_log_0111115511111111001111_call
        (text, bigint, smallint, smallint, smallint, smallint, text, smallint, bigint, smallint, text, smallint, text, smallint, smallint, text, smallint, smallint, text, smallint, text, smallint, text, smallint, numeric, smallint, bigint, smallint, bigint, smallint, bigint, smallint, bigint, smallint, smallint, smallint, smallint, smallint, smallint, smallint, smallint) AS
SELECT component_insert_log_0111115511111111001111
