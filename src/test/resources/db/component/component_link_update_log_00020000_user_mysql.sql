DROP PROCEDURE IF EXISTS component_link_update_log_00020000_user;
CREATE PROCEDURE component_link_update_log_00020000_user
    (_user_id                bigint,
...
PREPARE component_link_update_log_00020000_user_call FROM
