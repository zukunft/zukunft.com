CREATE OR REPLACE FUNCTION component_link_insert_log_0155818111
    (_view_id                   bigint,
...
PREPARE component_link_insert_log_0155818111_call
        (bigint,smallint,bigint,bigint,smallint,smallint,text,text,text,smallint,smallint,bigint,smallint,text,smallint,text,smallint,smallint,smallint,smallint,smallint,smallint,smallint) AS
SELECT component_link_insert_log_0155818111
