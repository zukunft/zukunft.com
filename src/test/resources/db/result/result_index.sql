...
--
ALTER TABLE results_standard_prime ADD CONSTRAINT results_standard_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE results_prime ADD CONSTRAINT results_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE user_results_prime ADD CONSTRAINT user_results_prime_pkey PRIMARY KEY (phrase_id_1,phrase_id_2,phrase_id_3,phrase_id_4, user_id);
...
--
ALTER TABLE results_text_standard_prime ADD CONSTRAINT results_text_standard_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE results_text_prime ADD CONSTRAINT results_text_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE user_results_text_prime ADD CONSTRAINT user_results_text_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4, user_id);
...
--
ALTER TABLE results_time_standard_prime ADD CONSTRAINT results_time_standard_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE results_time_prime ADD CONSTRAINT results_time_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE user_results_time_prime ADD CONSTRAINT user_results_time_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4, user_id);
...
--
ALTER TABLE results_geo_standard_prime ADD CONSTRAINT results_geo_standard_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE results_geo_prime ADD CONSTRAINT results_geo_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4);
...
--
ALTER TABLE user_results_geo_prime ADD CONSTRAINT user_results_geo_prime_pkey PRIMARY KEY (phrase_id_1, phrase_id_2, phrase_id_3, phrase_id_4, user_id);
