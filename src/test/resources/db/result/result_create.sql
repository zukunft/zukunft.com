...
COMMENT ON TABLE results_standard_prime                IS 'for public unprotected numeric results related up to four prime phrase that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_standard_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_standard                IS 'for public unprotected numeric results that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_standard.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results                IS 'for numeric results related to up to 16 phrases';
...
COMMENT ON COLUMN results.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results.user_id       IS 'the owner / creator of the value';
...
COMMENT ON TABLE user_results                IS 'for user specific changes of numeric results related to up to 16 phrases';
COMMENT ON COLUMN user_results.group_id      IS 'the 512-bit prime index to find the user numeric result';
COMMENT ON COLUMN user_results.user_id       IS 'the changer of the numeric result';
COMMENT ON COLUMN user_results.numeric_value IS 'the user specific numeric value change';
COMMENT ON COLUMN user_results.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_prime                IS 'for the most often requested numeric results related up to four prime phrase';
...
COMMENT ON COLUMN results_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_prime.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_prime.group_id      IS 'the 64-bit prime index to find the user values';
COMMENT ON COLUMN user_results_prime.user_id       IS 'the changer of the numeric result';
COMMENT ON COLUMN user_results_prime.numeric_value IS 'the user specific numeric value change';
COMMENT ON COLUMN user_results_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_big                IS 'for numeric results related to more than 16 phrases';
...
COMMENT ON COLUMN results_big.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_big.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_big.group_id      IS 'the text index to find the user values related to more than 16 phrases';
COMMENT ON COLUMN user_results_big.user_id       IS 'the changer of the numeric result';
COMMENT ON COLUMN user_results_big.numeric_value IS 'the user specific numeric value change';
COMMENT ON COLUMN user_results_big.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_text_standard_prime             IS 'for public unprotected text results related up to four prime phrase that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_text_standard_prime.source_id  IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_text_standard             IS 'for public unprotected text results that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_text_standard.source_id  IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_text                IS 'for text results related to up to 16 phrases';
...
COMMENT ON COLUMN results_text.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_text.user_id       IS 'the owner / creator of the value';
...
COMMENT ON TABLE user_results_text                IS 'for user specific changes of text results related to up to 16 phrases';
COMMENT ON COLUMN user_results_text.group_id      IS 'the 512-bit prime index to find the user text result';
COMMENT ON COLUMN user_results_text.user_id       IS 'the changer of the text result';
COMMENT ON COLUMN user_results_text.text_value    IS 'the user specific text value change';
COMMENT ON COLUMN user_results_text.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_text_prime                IS 'for the most often requested text results related up to four prime phrase';
...
COMMENT ON COLUMN results_text_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_text_prime.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_text_prime.group_id      IS 'the 64-bit prime index to find the user values';
COMMENT ON COLUMN user_results_text_prime.user_id       IS 'the changer of the text result';
COMMENT ON COLUMN user_results_text_prime.text_value    IS 'the user specific text value change';
COMMENT ON COLUMN user_results_text_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_text_big                IS 'for text results related to more than 16 phrases';
...
COMMENT ON COLUMN results_text_big.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_text_big.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_text_big.group_id      IS 'the text index to find the user values related to more than 16 phrases';
COMMENT ON COLUMN user_results_text_big.user_id       IS 'the changer of the text result';
COMMENT ON COLUMN user_results_text_big.text_value    IS 'the user specific text value change';
COMMENT ON COLUMN user_results_text_big.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_time_standard_prime             IS 'for public unprotected time results related up to four prime phrase that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_time_standard_prime.source_id  IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_time_standard             IS 'for public unprotected time results that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_time_standard.source_id  IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_time                IS 'for time results related to up to 16 phrases';
...
COMMENT ON COLUMN results_time.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_time.user_id       IS 'the owner / creator of the value';
...
COMMENT ON TABLE user_results_time                IS 'for user specific changes of time results related to up to 16 phrases';
COMMENT ON COLUMN user_results_time.group_id      IS 'the 512-bit prime index to find the user time result';
COMMENT ON COLUMN user_results_time.user_id       IS 'the changer of the time result';
COMMENT ON COLUMN user_results_time.time_value    IS 'the user specific timestamp change';
COMMENT ON COLUMN user_results_time.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_time_prime                IS 'for the most often requested time results related up to four prime phrase';
...
COMMENT ON COLUMN results_time_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_time_prime.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_time_prime.group_id      IS 'the 64-bit prime index to find the user values';
COMMENT ON COLUMN user_results_time_prime.user_id       IS 'the changer of the time result';
COMMENT ON COLUMN user_results_time_prime.time_value    IS 'the user specific timestamp change';
COMMENT ON COLUMN user_results_time_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_time_big                IS 'for time results related to more than 16 phrases';
...
COMMENT ON COLUMN results_time_big.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_time_big.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_time_big.group_id      IS 'the text index to find the user values related to more than 16 phrases';
COMMENT ON COLUMN user_results_time_big.user_id       IS 'the changer of the time result';
COMMENT ON COLUMN user_results_time_big.time_value    IS 'the user specific timestamp change';
COMMENT ON COLUMN user_results_time_big.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_geo_standard_prime             IS 'for public unprotected geo results related up to four prime phrase that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_geo_standard_prime.source_id  IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_geo_standard             IS 'for public unprotected geo results that have never changed the owner, does not have a description and are rarely updated';
...
COMMENT ON COLUMN results_geo_standard.source_id  IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_geo                IS 'for geo results related to up to 16 phrases';
...
COMMENT ON COLUMN results_geo.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_geo.user_id       IS 'the owner / creator of the value';
...
COMMENT ON TABLE user_results_geo                IS 'for user specific changes of geo results related to up to 16 phrases';
COMMENT ON COLUMN user_results_geo.group_id      IS 'the 512-bit prime index to find the user geo result';
COMMENT ON COLUMN user_results_geo.user_id       IS 'the changer of the geo result';
COMMENT ON COLUMN user_results_geo.geo_value     IS 'the user specific geolocation change';
COMMENT ON COLUMN user_results_geo.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_geo_prime                IS 'for the most often requested geo results related up to four prime phrase';
...
COMMENT ON COLUMN results_geo_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_geo_prime.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_geo_prime.group_id      IS 'the 64-bit prime index to find the user values';
COMMENT ON COLUMN user_results_geo_prime.user_id       IS 'the changer of the geo result';
COMMENT ON COLUMN user_results_geo_prime.geo_value     IS 'the user specific geolocation change';
COMMENT ON COLUMN user_results_geo_prime.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON TABLE results_geo_big                IS 'for geo results related to more than 16 phrases';
...
COMMENT ON COLUMN results_geo_big.source_id     IS 'the source of the value as given by the user';
...
COMMENT ON COLUMN results_geo_big.user_id       IS 'the owner / creator of the value';
...
COMMENT ON COLUMN user_results_geo_big.group_id      IS 'the text index to find the user values related to more than 16 phrases';
COMMENT ON COLUMN user_results_geo_big.user_id       IS 'the changer of the geo result';
COMMENT ON COLUMN user_results_geo_big.geo_value     IS 'the user specific geolocation change';
COMMENT ON COLUMN user_results_geo_big.source_id     IS 'the source of the value as given by the user';
