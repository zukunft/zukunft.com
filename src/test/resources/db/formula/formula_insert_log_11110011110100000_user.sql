CREATE OR REPLACE FUNCTION formula_insert_log_11110011110100000_user
    (_user_id                  bigint,
...
PREPARE formula_insert_log_11110011110100000_user_call
        (bigint, smallint, smallint, text, bigint, smallint, text, smallint, smallint, smallint, text, smallint, text, smallint, text) AS
