DROP PROCEDURE IF EXISTS formula_link_insert_log_1110000_user;
CREATE PROCEDURE formula_link_insert_log_1110000_user
    (_user_id            bigint,
...
PREPARE formula_link_insert_log_1110000_user_call FROM
