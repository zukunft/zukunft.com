DROP PROCEDURE IF EXISTS formula_insert_log_011001110100000;
CREATE PROCEDURE formula_insert_log_011001110100000
(_formula_name             text,
 _user_id                  bigint,
...
PREPARE formula_insert_log_011001110100000_call FROM
