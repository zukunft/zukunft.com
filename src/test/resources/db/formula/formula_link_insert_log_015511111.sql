CREATE OR REPLACE FUNCTION formula_link_insert_log_015511111
    (_formula_id             bigint,
...
BEGIN
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,        new_value,    row_id)
         SELECT          _user_id,_change_action_id,_field_id_description,  _description,  new_formula_link_id ;
...
PREPARE formula_link_insert_log_015511111_call
        (bigint, smallint, bigint, bigint, smallint, smallint, text, text, text, smallint, smallint, bigint, smallint, text, smallint, smallint, smallint, smallint, smallint, smallint) AS
SELECT formula_link_insert_log_015511111
