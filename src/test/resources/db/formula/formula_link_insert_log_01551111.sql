CREATE OR REPLACE FUNCTION formula_link_insert_log_01551111
    (_formula_id             bigint,
...
PREPARE formula_link_insert_log_01551111_call
    (bigint,smallint,bigint,bigint,smallint,smallint,text,text,text,smallint,smallint,bigint, smallint, smallint, smallint, smallint, smallint, smallint) AS
