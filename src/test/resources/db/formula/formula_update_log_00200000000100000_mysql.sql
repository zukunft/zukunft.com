DROP PROCEDURE IF EXISTS formula_update_log_00200000000100000;
CREATE PROCEDURE formula_update_log_00200000000100000
    (_user_id               bigint,
...
PREPARE formula_update_log_00200000000100000_call FROM
