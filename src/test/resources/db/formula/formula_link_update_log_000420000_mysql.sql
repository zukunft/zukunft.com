DROP PROCEDURE IF EXISTS formula_link_update_log_000420000;
CREATE PROCEDURE formula_link_update_log_000420000
    (_user_id            bigint,
...
PREPARE formula_link_update_log_000420000_call FROM
