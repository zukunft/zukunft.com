DROP PROCEDURE IF EXISTS formula_link_insert_log_015510000;
CREATE PROCEDURE formula_link_insert_log_015510000
    (_formula_id           bigint,
...
PREPARE formula_link_insert_log_015510000_call FROM
    'SELECT formula_link_insert_log_015510000 (?,?,?,?,?,?,?,?,?,?,?,?)';
