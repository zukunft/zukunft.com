DROP PROCEDURE IF EXISTS formula_insert_log_1110000000100000_user;
CREATE PROCEDURE formula_insert_log_1110000000100000_user
    (_user_id                 bigint,
...
PREPARE formula_insert_log_1110000000100000_user_call FROM
    'SELECT formula_insert_log_1110000000100000_user (?,?,?,?,?)';
