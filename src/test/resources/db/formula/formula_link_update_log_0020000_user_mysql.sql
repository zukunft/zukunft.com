DROP PROCEDURE IF EXISTS formula_link_update_log_0020000_user;
CREATE PROCEDURE formula_link_update_log_0020000_user
    (_user_id            bigint,
...
PREPARE formula_link_update_log_0020000_user_call FROM
