DROP PROCEDURE IF EXISTS formula_update_log_00200020000100000;
CREATE PROCEDURE formula_update_log_00200020000100000
    (_user_id                  bigint,
...
PREPARE formula_update_log_00200020000100000_call FROM
