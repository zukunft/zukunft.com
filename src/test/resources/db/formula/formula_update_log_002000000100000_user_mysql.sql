DROP PROCEDURE IF EXISTS formula_update_log_002000000100000_user;
CREATE PROCEDURE formula_update_log_002000000100000_user
    (_user_id bigint,
...
PREPARE formula_update_log_002000000100000_user_call FROM
