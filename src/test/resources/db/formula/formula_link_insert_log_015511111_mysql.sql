DROP PROCEDURE IF EXISTS formula_link_insert_log_015511111;
CREATE PROCEDURE formula_link_insert_log_015511111
    (_formula_id             bigint,
...
PREPARE formula_link_insert_log_015511111_call FROM
