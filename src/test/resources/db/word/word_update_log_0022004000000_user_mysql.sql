DROP PROCEDURE IF EXISTS word_update_log_0022004000000_user;
CREATE PROCEDURE word_update_log_0022004000000_user
    (_user_id                 bigint,
...
PREPARE word_update_log_0022004000000_user_call FROM
    'SELECT word_update_log_0022004000000_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
