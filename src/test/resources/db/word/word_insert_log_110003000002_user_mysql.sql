DROP PROCEDURE IF EXISTS word_insert_log_110003000002_user;
CREATE PROCEDURE word_insert_log_110003000002_user
    (_user_id                 bigint,
...
PREPARE word_insert_log_110003000002_user_call FROM
    'SELECT word_insert_log_110003000002_user (?,?,?,?,?,?,?,?,?,?,?)';
