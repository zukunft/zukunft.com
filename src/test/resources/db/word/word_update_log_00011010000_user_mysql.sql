DROP PROCEDURE IF EXISTS word_update_log_00011010000_user;
CREATE PROCEDURE word_update_log_00011010000_user
    (_user_id                 bigint,
...
PREPARE word_update_log_00011010000_user_call FROM
    'SELECT word_update_log_00011010000_user (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
