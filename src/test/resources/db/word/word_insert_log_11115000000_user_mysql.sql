DROP PROCEDURE IF EXISTS word_insert_log_11115000000_user;
CREATE PROCEDURE word_insert_log_11115000000_user
    (_user_id                 bigint,
...
PREPARE word_insert_log_11115000000_user_call FROM
    'SELECT word_insert_log_11115000000_user (?,?,?,?,?,?,?,?,?,?)';
