DROP PROCEDURE IF EXISTS word_update_log_0202008010000_user;
CREATE PROCEDURE word_update_log_0202008010000_user
    (_user_id                 bigint,
...
PREPARE word_update_log_0202008010000_user_call FROM
