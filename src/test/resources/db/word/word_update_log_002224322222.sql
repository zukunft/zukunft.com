CREATE OR REPLACE FUNCTION word_update_log_002224322222
    (_user_id                 bigint,
...
PREPARE word_update_log_002224322222_call
        (bigint, smallint, smallint, text, text, bigint, smallint, text, text, smallint, text, text, smallint, text, smallint, text, smallint, smallint, text, bigint, text, bigint, smallint, text, text, smallint, bigint, bigint, smallint, smallint, smallint, smallint, smallint, smallint, smallint, smallint, smallint) AS
SELECT word_update_log_002224322222
