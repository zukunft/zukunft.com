DROP PROCEDURE IF EXISTS word_update_log_00224000000;
CREATE PROCEDURE word_update_log_00224000000
    (_user_id                 bigint,
...
PREPARE word_update_log_00224000000_call FROM
    'SELECT word_update_log_00224000000 (?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
