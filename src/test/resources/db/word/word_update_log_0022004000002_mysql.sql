DROP PROCEDURE IF EXISTS word_update_log_0022004000002;
CREATE PROCEDURE word_update_log_0022004000002
    (_user_id                 bigint,
...
PREPARE word_update_log_0022004000002_call FROM
    'SELECT word_update_log_0022004000002 (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)';
