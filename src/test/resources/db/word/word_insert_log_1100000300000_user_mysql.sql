DROP PROCEDURE IF EXISTS word_insert_log_1100000300000_user;
CREATE PROCEDURE word_insert_log_1100000300000_user
    (_user_id          bigint,
...
PREPARE word_insert_log_1100000300000_user_call FROM
