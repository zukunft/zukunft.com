CREATE OR REPLACE FUNCTION word_update_log_0022224422200
    (_user_id                 bigint,
...
BEGIN
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,         old_value,            new_value,                                            row_id)
         SELECT          _user_id,_change_action_id,_field_id_usage,         _usage_old,           _usage,                                               _word_id ;
    INSERT INTO changes ( user_id, change_action_id, change_field_id,         old_value,            new_value,                                            row_id)
    ...
    INSERT INTO changes ( user_id, change_action_id, change_field_id,         old_value,            new_value,                                            row_id)
         SELECT          _user_id,_change_action_id,_field_id_impact,        _impact_old,          _impact,                                              _word_id ;
    INSERT INTO changes ( user_id, change_action_id, change_field_id,         old_value,            new_value,                                            row_id)
...
PREPARE word_update_log_0022224422200_call
        (bigint, smallint, smallint, text, text, bigint, smallint, text, text, smallint, bigint, bigint, smallint, text, text, smallint, text, smallint, text, smallint, smallint, text, bigint, text, bigint, smallint, text, text, smallint, numeric, numeric, smallint, smallint, smallint) AS
SELECT word_update_log_0022224422200
