DROP PROCEDURE IF EXISTS word_insert_log_1111005000001_user;
CREATE PROCEDURE word_insert_log_1111005000001_user
    (_user_id                 bigint,
...
PREPARE word_insert_log_1111005000001_user_call FROM
