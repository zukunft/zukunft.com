DROP PROCEDURE IF EXISTS word_insert_log_111000500001_user;
CREATE PROCEDURE word_insert_log_111000500001_user
    (_user_id                 bigint,
...
PREPARE word_insert_log_111000500001_user_call FROM
