DROP PROCEDURE IF EXISTS word_insert_log_01115000000;
CREATE PROCEDURE word_insert_log_01115000000
    (_word_name               text,
     _user_id                 bigint,
...
PREPARE word_insert_log_01115000000_call FROM
    'SELECT word_insert_log_01115000000 (?,?, ?, ?, ?, ?, ?, ?, ?, ?)';
