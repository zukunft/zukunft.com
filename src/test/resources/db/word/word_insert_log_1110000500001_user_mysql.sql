DROP PROCEDURE IF EXISTS word_insert_log_1110000500001_user;
CREATE PROCEDURE word_insert_log_1110000500001_user
    (_user_id             bigint,
...
BEGIN
    ...
    INSERT INTO user_words ( word_id, user_id, word_name, view_id, protect_id)
         SELECT             _word_id,_user_id,_word_name,_view_id,_protect_id ;

END;

PREPARE word_insert_log_1110000500001_user_call FROM
