...
class system_unit_tests
{
    function run(test_cleanup $t): void
    {
        ...
        $res = $t->dummy_result();
        $target = '123456 "Mathematics" (1) (1) for user 1 (zukunft.com system test)';
        $t->assert($test_name, $res->dsp_id(), $target);
        $test_name = 'debug result_list id';
        $res_lst = $t->dummy_result_list();
        $target = '123456 "Mathematics" (1) (1) for user 1 (zukunft.com system test) (1) - ';
