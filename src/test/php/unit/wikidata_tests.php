...
/*
    ...
    test/unit/wikidata_tests.php - unit tests of the wikidata data conversion
    ----------------------------
...
class wikidata_tests
{
    ...
    function run(test_cleanup $t): void
    {
        ...
        $wd_api = new wikidata();
        $json_str = file_get_contents(test_files::WIKIDATA_ZURICH);
        $ref_lst = $t->ref_list_zh_ui();
        $json = $wd_api->convert(json_decode($json_str, true), $ref_lst, $usr_msg);
