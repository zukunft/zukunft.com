...
class group_tests
{
    function run(test_cleanup $t): void
    {
        ...
        $t->assert('group_id triple list', $grp_id->get_id($t->triple_list_short()->phrase_list()),values::PI_SYMBOL_ID);
        $t->assert('triple ids 64 bit group_id ', $grp_id->get_array(values::PI_SYMBOL_ID), $t->triple_list_short()->phrase_list()->ids());
