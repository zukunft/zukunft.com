...
function run_word_display_test () {
  ...
  $direction = 'up';
  $target = TW_ABB.' is a';
  $result = substr($wrd_ABB->dsp_graph ($direction, 0),0,8);
  ...
  $wrd_ABB->load();
  $direction = 'down';
  $target = zut_html_list_related ($wrd_ABB->id, $direction, $usr->id);
  $result = $wrd_ABB->dsp_graph ($direction, 0);
  ...
  $wrd_ZH->load();
  $direction = 'down';
  $target = zut_html_list_related ($wrd_ZH->id, $direction, $usr->id);
  ...
  $wrd_year->load();
  /*
  $target = zut_dsp_list_wrd_val($wrd_ABB->id, $wrd_year->id, $usr->id);
  $target = substr($target,0,208);
  */
  $target = "ABB";
  $result = $wrd_ABB->dsp_val_list ($wrd_year, 0);
