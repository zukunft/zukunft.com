...
class triple_names
{
    ...
    const int SPEED_OF_LIGHT_ID = 28;
    ...
    const int U_S_DOLLAR_ALIAS_ID = 216;
    const string IN_USD = "in USD";
    const int IN_USD_ID = 211;
    const string EUR_SYMBOL = "EUR is symbol for Euro";
    const int EUR_SYMBOL_ID = 224;
    ...
    const int COMPANY_VESTAS_ID = 429;
    const string COMPANY_ABB = "ABB (company)";
    const int COMPANY_ABB_ID = 426;
