...
class triple_names
{
    ...
    const int REDUCE_EMISSIONS_ID = 181;
    ...
    const int REDUCE_EMISSIONS_SOLUTION_ID = 203;
    const string AVOID_WRONG_DECISIONS_SOLUTION = 'avoid wrong decisions (solution)';
    const int AVOID_WRONG_DECISIONS_SOLUTION_ID = 182;
    ...
    const int COLUMN_PROBLEM_ID = 187;
    const string COLUMN_SOLUTION = 'column solution (high prio)';
    const int COLUMN_SOLUTION_ID = 188;
    ...
    const int COLUMN_COST_ID = 189;
    const string COLUMN_GAIN = 'column gain';
    const int COLUMN_GAIN_ID = 190;
    ...
    const int COLUMN_POTENTIAL_LOSS_ID = 200;
    ...
    const int GRAM_PER_KWH_ID = 1046;
    ...
    const int CASH_FLOW_ID = 551;
    const string CASH_FLOW_STATEMENT = 'cash flow statement';
    const int CASH_FLOW_STATEMENT_ID = 554;
    const string INCOME_TAX = 'income taxes';
    const int INCOME_TAX_ID = 552;
    ...
    const int COMPANY_ZURICH_ID = 227;
    ...
    const int SWISS_FRANC_CURRENCY_ID = 383;
    const string US_DOLLAR_NAME = 'US dollar';
    const string U_S_DOLLAR_NAME = 'U.S. dollar';
    const int U_S_DOLLAR_ID = 286;
    const int US_DOLLAR_ID = 285;
