...
class triple_names
{
    ...
    const int CASH_FLOW_ID = 533;
    const string CASH_FLOW_STATEMENT = 'cash flow statement';
    const int CASH_FLOW_STATEMENT_ID = 536;
    const string INCOME_TAX = 'income taxes';
    const int INCOME_TAX_ID = 534;
    ...
    const int COMPANY_ZURICH_ID = 209;
    ...
    const int SWISS_FRANC_CURRENCY_ID = 365;
    const string US_DOLLAR_NAME = 'US dollar';
    const string U_S_DOLLAR_NAME = 'U.S. dollar';
    const int U_S_DOLLAR_ID = 268;
    const int US_DOLLAR_ID = 267;
