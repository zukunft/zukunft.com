...
class triple_names
{
    ...
    const int HAPPY_TIME_POINTS_ID = 151;
    const string GLOBAL_WARMING_PROBLEM = 'global warming (global problem)';
    const int GLOBAL_WARMING_PROBLEM_ID = 152;
    ...
    const int REDUCE_EMISSIONS_ID = 180;
    const string AVOID_WRONG_DECISIONS = 'avoid wrong decisions';
    const int AVOID_WRONG_DECISIONS_ID = 159;
    ...
    const int REDUCE_EMISSIONS_SOLUTION_ID = 202;
    const string AVOID_WRONG_DECISIONS_SOLUTION = 'avoid wrong decisions (solution)';
    const int AVOID_WRONG_DECISIONS_SOLUTION_ID = 181;
    ...
    const int GROSS_DOMESTIC_USAGE_ID = 162;
    ...
    const int COLUMN_COST_ID = 188;
    const string COLUMN_GAIN = 'column gain';
    const int COLUMN_GAIN_ID = 189;
    ...
    const int COLUMN_POTENTIAL_LOSS_ID = 199;
    ...
    const int GRAM_PER_KWH_ID = 1000;
    ...
    const int CASH_FLOW_ID = 550;
    const string CASH_FLOW_STATEMENT = 'cash flow statement';
    const int CASH_FLOW_STATEMENT_ID = 553;
    const string INCOME_TAX = 'income taxes';
    const int INCOME_TAX_ID = 551;
    ...
    const int COMPANY_ZURICH_ID = 226;
    ...
    const int SWISS_FRANC_CURRENCY_ID = 382;
    const string US_DOLLAR_NAME = 'US dollar';
    const string U_S_DOLLAR_NAME = 'U.S. dollar';
    const int U_S_DOLLAR_ID = 285;
    const int US_DOLLAR_ID = 284;
