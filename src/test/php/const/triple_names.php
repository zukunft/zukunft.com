...
class triple_names
{
    ...
    const int HAPPY_TIME_POINTS_ID = 147;
    const string GLOBAL_WARMING_PROBLEM = 'global warming (global problem)';
    const int GLOBAL_WARMING_PROBLEM_ID = 148;
    ...
    const int REDUCE_EMISSIONS_ID = 165;
    const string AVOID_WRONG_DECISIONS = 'avoid wrong decisions';
    const int AVOID_WRONG_DECISIONS_ID = 155;
    ...
    const int COMPANY_ZURICH_ID = 203;
    ...
    const int SWISS_FRANC_CURRENCY_ID = 359;
    const string US_DOLLAR_NAME = 'US dollar';
    const string U_S_DOLLAR_NAME = 'U.S. dollar';
    const int U_S_DOLLAR_ID = 262;
    const int US_DOLLAR_ID = 261;
