...
class triple_names
{
    ...
    const int HAPPY_TIME_POINTS_ID = 117;
    const string GLOBAL_WARMING_PROBLEM = 'global warming (global problem)';
    const int GLOBAL_WARMING_PROBLEM_ID = 118;
    ...
    const int CASH_FLOW_ID = 393;
    const string CASH_FLOW_STATEMENT = 'cash flow statement';
    const int CASH_FLOW_STATEMENT_ID = 396;
    ...
    const int COMPANY_ZURICH_ID = 128;
    const string CHF_SYMBOL = "CHF is symbol for Swiss franc";
    const int CHF_SYMBOL_ID = 227;
    ...
    const int COMPANY_VESTAS_ID = 402;
    const string COMPANY_ABB = "ABB (company)";
    const int COMPANY_ABB_ID = 399;
