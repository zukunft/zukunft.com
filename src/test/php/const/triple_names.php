...
class triple_names
{
    ...
    const int REDUCE_EMISSIONS_ID = 182;
    const string AVOID_WRONG_DECISIONS = 'avoid wrong decisions';
    const int AVOID_WRONG_DECISIONS_ID = 160;
    ...
    const int COLUMN_COST_ID = 195;
    const string COLUMN_GAIN = 'column gain';
    const int COLUMN_GAIN_ID = 193;
    const string COLUMN_LOSS = 'column loss';
    const int COLUMN_LOSS_ID = 190;
    ...
    const int POTENTIAL_LOSS_ID = 124;
    const string COLUMN_POTENTIAL_LOSS = 'column potential loss';
    const int COLUMN_POTENTIAL_LOSS_ID = 189;
    ...
    const int GRAM_PER_KWH_ID = 1546;
    ...
    const int CASH_FLOW_ID = 552;
    const string CASH_FLOW_STATEMENT = 'cash flow statement';
    const int CASH_FLOW_STATEMENT_ID = 555;
    const string INCOME_TAX = 'income taxes';
    const int INCOME_TAX_ID = 553;
    ...
    const int CANTON_ZURICH_ID = 106;
    const string CITY_ZH = 'Zurich (city)';
    const int CITY_ZH_ID = 105;
    ...
    const int CITY_BE_ID = 107;
    const string CITY_GE = 'Geneva (city)';
    const int CITY_GE_ID = 108;
    ...
    const int COMPANY_ZURICH_ID = 228;
    const string MIO_SYMBOL = 'mio is symbol for million';
    const int MIO_SYMBOL_ID = 116;
    ...
    const int SWISS_FRANC_CURRENCY_ID = 384;
    const string US_DOLLAR_NAME = 'US dollar';
    const string U_S_DOLLAR_NAME = 'U.S. dollar';
    const int U_S_DOLLAR_ID = 287;
    const int US_DOLLAR_ID = 286;
