...
function run_term_test ($debug) {
  ...
  echo "<br><br><h2>Test the term class (classes/term.php)</h2><br>";
  ...
  $exe_start_time = test_show_contains(', term->load for id '.TEST_WORD_ID, $target, $result, $exe_start_time, TIMEOUT_LIMIT);
