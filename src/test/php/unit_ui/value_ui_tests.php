...
class value_ui_tests
{
    function run(test_cleanup $t): void
    {
        ...
        $t->assert_text_contains($test_name, $few_html, 'name="' . url_var::PHRASE . '"');
        ...
        $sel_html = $select->phrase_steps($steps_form, $sel_url, $msg_ui, $steps_dto, true);
        ...
        $none_html = $select->phrase_steps($steps_form, [url_var::PATTERN => $none_pattern], $msg_ui, $steps_dto, true);
        ...
        $empty_html = $select->value_add_simple($simple_form, $bad_url, $msg_ui, $steps_dto, true);
