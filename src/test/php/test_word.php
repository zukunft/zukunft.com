...
function create_base_words()
{
    ...
    test_word(TW_PRICE);
    test_word(TW_SHARE);
    test_word(TW_CHF, DBL_WORD_TYPE_MEASURE);
    test_word(TW_EUR, DBL_WORD_TYPE_MEASURE);
    test_word(TW_YEAR);
    test_word(TW_2012, DBL_WORD_TYPE_TIME);
    test_word(TW_2013, DBL_WORD_TYPE_TIME);
    test_word(TW_2014, DBL_WORD_TYPE_TIME);
    test_word(TW_2015, DBL_WORD_TYPE_TIME);
    test_word(TW_2016, DBL_WORD_TYPE_TIME);
    test_word(TW_2017, DBL_WORD_TYPE_TIME);
    test_word(TW_2020, DBL_WORD_TYPE_TIME);
    test_word(TW_BIL, DBL_WORD_TYPE_SCALING);
    test_word(TW_MIO, DBL_WORD_TYPE_SCALING);
    test_word(TW_K, DBL_WORD_TYPE_SCALING);
    test_word(TW_M, DBL_WORD_TYPE_SCALING);
    test_word(TW_PCT, DBL_WORD_TYPE_SCALING_PCT);
    test_word(TW_CF);
    test_word(TW_TAX);
...
function run_word_test()
{
    ...
    $target = TEST_WORD;
    $result = $wrd2->name;
    $exe_start_time = test_show_result('word->load of ' . $wrd_company->id . ' by id ' . $wrd1->id, $target, $result, $exe_start_time, TIMEOUT_LIMIT);
