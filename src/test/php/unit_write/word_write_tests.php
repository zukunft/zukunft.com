...
class word_write_tests
{
    ...
    function run(test_cleanup $t): void
    {
        ...
        $target = users::SYSTEM_TEST_NAME . ' added "' . word_names::TEST_ADD . '"';
        ...
        */
        ...
        $target = users::SYSTEM_TEST_NAME . ' added "' . word_names::TEST_RENAMED . 's"';
        ...
        $target = users::SYSTEM_TEST_NAME . ' changed "' . word_names::TEST_ADD_COM . '" to "' . word_names::TEST_RENAMED . ' description"';
