...
(
    ...
    ` calc_and_cleanup_task_type_id ` int
(
    11
) NOT NULL,
    ` row_id ` int
...
(
    ...
    ` calc_and_cleanup_task_type_name ` varchar
(
    200
) NOT NULL,
    ` description ` text,
...
(
    11
) DEFAULT NULL COMMENT 'old value id',
    ` new_id ` int
(
    11
) DEFAULT NULL COMMENT 'new value id'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='to log all changes';
...
(
    11
) NOT NULL COMMENT 'because every field must only be unique within a table',
    ` description ` text,
    ` code_id ` varchar
(
    100
...
(
    11
) DEFAULT NULL COMMENT 'either internal row id or the ref type id of the external system e.g. 2 for wikidata',
    ` new_text_from ` text,
    ` new_text_link ` text,
...
(
    ...
    ` change_table_name ` varchar
(
    100
) NOT NULL COMMENT 'the real name',
    ` description ` varchar
(
    1000
) NOT NULL COMMENT 'the user readable name',
    ` code_id ` varchar
(
    50
) DEFAULT NULL COMMENT 'with this field tables can be combined in case of renaming'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='to avoid log changes in case a table is renamed';
...
(
    100
) NOT NULL COMMENT 'short name of the formula',
    ` user_id ` int
(
    11
) DEFAULT NULL,
...
(
    ...
    ` all_values_needed ` tinyint
(
    4
) DEFAULT NULL COMMENT 'calculate the result only if all values used in the formula are not null',
...
(
    11
) DEFAULT NULL COMMENT 'either a term, verb or formula id',
    ` resolved_text ` varchar
(
    200
) DEFAULT NULL
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='cache for fast update of formula resolved text';
...
(
    ...
    ` formula_element_type_name ` varchar
(
    200
) NOT NULL,
    ` code_id ` varchar
...
(
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='if the term pattern of a value matches this term pattern ';
...
(
    ...
    ` source_phrase_group_id ` int
(
    11
) DEFAULT NULL,
    ` source_time_word_id ` int
(
    11
) DEFAULT NULL,
    ` phrase_group_id ` int
(
    11
) DEFAULT '0' COMMENT 'temp field for fast data collection; no single links to terms because this is just a cache table and can be recreated by the underlying tables',
    ` time_word_id ` int
(
    11
) DEFAULT '0' COMMENT 'special field just to speed up queries',
...
(
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='temp table to cache the formula results';
...
(
    11
) NOT NULL COMMENT 'the name as a term'
...
(
    `languages_form_id` int
(
    11
) NOT NULL,
    ` languages_form_name ` varchar
(
    200
) DEFAULT NULL COMMENT 'type of adjustment of a term in a language e.g. plural',
    ` code_id ` varchar
(
    50
) DEFAULT NULL,
...
(
    ...
    ` phrase_group_name ` varchar
(
    1000
) DEFAULT NULL COMMENT 'if this is set a manual group for fast selection',
    ` auto_description ` varchar
(
    4000
) DEFAULT NULL COMMENT 'the automatic created user readable description',
    ` word_ids ` varchar
(
    255
) DEFAULT NULL,
...
(
    255
) DEFAULT NULL COMMENT 'one field link to the table term_links',
    ` id_order ` varchar
(
    512
) DEFAULT NULL COMMENT 'the phrase ids in the order that the user wants to see them'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='to reduce the number of value to term links';
...
(
    `phrase_group_phrase_link_id` int
(
    11
)
    ,` phrase_group_id ` int
...
(
    `phrase_group_triple_link_id` int
(
    11
) NOT NULL,
    ` phrase_group_id ` int
...
(
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='master to link words to a term_group';
...
(
    100
) NOT NULL COMMENT 'the code link',
...
(
    200
) DEFAULT NULL COMMENT 'description of the action to get to this status'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='Status of internal errors';
...
(
    50
) DEFAULT NULL COMMENT 'to select e.g. the system batch user',
    ` password ` varchar
(
    200
) DEFAULT NULL,
...
(
    200
) DEFAULT NULL COMMENT 'such as the passport id',
    ` user_official_id_type_id ` int
(
    11
) DEFAULT NULL,
...
(
    11
) DEFAULT NULL COMMENT 'the last term that the user had used',
    ` last_mask_id ` int
(
    11
...
(
    11
) DEFAULT NULL COMMENT 'the last source used by this user to have a default for the next value',
    ` activation_key ` varchar
(
    200
) DEFAULT NULL,
    ` activation_key_timeout ` timestamp NULL DEFAULT NULL
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='only users can add data';
...
(
    ...
    ` view_component_name ` varchar
(
    200
) DEFAULT NULL,
    ` comment ` text,
    ` view_component_type_id ` int
(
    11
) DEFAULT NULL,
    ` word_id_row ` int
...
(
    ...
    ` description ` text,
    ` word_link_name ` varchar
(
    200
) DEFAULT NULL COMMENT 'the used unique name (either user created or generic based on the underlying)',
    ` excluded ` tinyint
(
    4
) DEFAULT NULL
...
(
    11
) DEFAULT NULL COMMENT 'the owner / creator of the value',
...
(
    11
) DEFAULT NULL COMMENT 'temp field to increase speed created by the value term links',
    ` time_word_id ` int
(
    11
) DEFAULT NULL COMMENT 'special field just to speed up queries',
...
(
    4
) NOT NULL COMMENT 'the default exclude setting for most users',
    ` protection_type_id ` int
(
    11
) NOT NULL DEFAULT '1'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='long list';
...
(
    11
) DEFAULT NULL COMMENT 'if true or 1  to formula is preferred',
    ` comment ` text
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='used to select if a saved value should be used or a calculated value';
...
(
    200
) DEFAULT NULL COMMENT 'naming used in formulas',
    ` name_plural_reverse ` varchar
(
    200
) DEFAULT NULL COMMENT 'english description for the reverse list, e.g. Companies are ...',
    ` name_plural ` varchar
(
    200
) DEFAULT NULL,
    ` name_reverse ` varchar
(
    200
) DEFAULT NULL,
    ` words ` int
(
    11
) DEFAULT NULL COMMENT 'used for how many terms'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='it is fixed coded how to behavior for each type is';
...
(
    100
) NOT NULL COMMENT 'for easy selection',
    ` comment ` text NOT NULL,
    ` view_type_id ` int
(
    11
...
(
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='all user interfaces should be listed here';
...
(
    100
) NOT NULL COMMENT 'just for easy selection',
    ` comment ` text,
    ` view_component_type_id ` int
(
    11
...
(
    11
) DEFAULT NULL COMMENT 'for a tree the related value the start node',
    ` formula_id ` int
(
    11
) DEFAULT NULL COMMENT 'used for type 6',
    ` word_id_col ` int
(
    11
) DEFAULT NULL COMMENT 'to define the type for the table columns',
    ` word_id_col2 ` int
(
    11
) DEFAULT NULL COMMENT 'e.g. "quarter" to show the quarters between the year columns or the second axis of a chart',
    ` excluded ` tinyint
(
    4
) DEFAULT NULL,
    ` linked_view_component_id ` int
(
    11
) DEFAULT NULL COMMENT 'to link this mask entry to another mask entry',
    ` view_component_link_type_id ` int
(
    11
) DEFAULT NULL COMMENT 'to define how this entry links to the other entry',
    ` link_type_id ` int
(
    11
) DEFAULT NULL COMMENT 'e.g. for type 4 to select possible terms'
...
(
    11
) NOT NULL DEFAULT '2' COMMENT '1=side, 2 =below',
    ` excluded ` tinyint
(
    4
) DEFAULT NULL
    ) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COMMENT ='A named mask entry can be used in several masks e.g. the company name';
...
(
    `view_component_position_type_id` int
(
    11
) NOT NULL,
    ` type_name ` varchar
...
(
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT ='fixed text, term or formula result';
...
(
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='to group the masks a link a basic format';
...
(
    11
) NOT NULL DEFAULT '1' COMMENT '1 = from_term_id is link the terms table; 2=link to the term_links table;3=to term_groups',
    ` link_type_id ` int
(
    11
) DEFAULT NULL,
...
(
    11
) DEFAULT NULL COMMENT 'user_id of the user that has created the term',
    ` word_name ` varchar
(
    200
) NOT NULL,
...
(
    200
) DEFAULT NULL COMMENT 'to be replaced by a language form entry',
...
(
    11
) DEFAULT NULL COMMENT 'the default mask for this term',
    ` values ` int
(
    11
) DEFAULT NULL COMMENT 'number of values linked to the term, which gives an indication of the importance',
    ` excluded ` tinyint
(
    4
) DEFAULT NULL
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT ='probably all text of th db';
...
(
    11
) NOT NULL COMMENT 'the user who has requested the term deletion'
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(
    11
) DEFAULT NULL COMMENT 'e.g. for percent the scaling factor is 100',
    ` word_symbol ` varchar
(
    5
) NOT NULL COMMENT 'e.g. for percent the symbol is %'
    ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
...
ALTER TABLE ` formulas `
    ADD PRIMARY KEY (` formula_id `), ADD UNIQUE KEY ` name ` (` formula_name `), ADD KEY ` user_id ` (` user_id `), ADD KEY ` formula_type_id ` (` formula_type_id `), ADD KEY ` protection_type_id ` (` protection_type_id `);
...
ALTER TABLE ` protection_types `
    ADD PRIMARY KEY (` protection_type_id `), ADD UNIQUE KEY ` protection_type_id ` (` protection_type_id `);
...
ALTER TABLE ` ref_types `
    ADD PRIMARY KEY (` ref_type_id `), ADD UNIQUE KEY ` ref_type_name ` (` ref_type_name `,` code_id `);
...
ALTER TABLE ` source_values `
    ADD PRIMARY KEY (` value_id `,` source_id `,` user_id `), ADD KEY ` value_id ` (` value_id `), ADD KEY ` source_id ` (` source_id `), ADD KEY ` user_id ` (` user_id `);
...
ALTER TABLE ` user_formulas `
    ADD UNIQUE KEY ` formula_id ` (` formula_id `,` user_id `), ADD KEY ` formula_id_2 ` (` formula_id `), ADD KEY ` user_id ` (` user_id `), ADD KEY ` formula_type_id ` (` formula_type_id `), ADD KEY ` share_type ` (` share_type_id `);
...
ALTER TABLE ` user_values `
    ADD PRIMARY KEY (` value_id `,` user_id `), ADD KEY ` user_id ` (` user_id `), ADD KEY ` source_id ` (` source_id `), ADD KEY ` value_id ` (` value_id `), ADD KEY ` share_type ` (` share_type_id `), ADD KEY ` protection_type_id ` (` protection_type_id `);
...
ALTER TABLE ` user_view_components `
    ADD PRIMARY KEY (` view_component_id `,` user_id `), ADD KEY ` user_id ` (` user_id `), ADD KEY ` view_component_id ` (` view_component_id `), ADD KEY ` view_component_type_id ` (` view_component_type_id `);

--
-- Indexes for table `user_view_component_links`
--
ALTER TABLE ` user_view_component_links `
    ADD PRIMARY KEY (` view_component_link_id `,` user_id `), ADD KEY ` user_id ` (` user_id `), ADD KEY ` position_type ` (` position_type `), ADD KEY ` view_entry_link_id ` (` view_component_link_id `);
...
--
ALTER TABLE ` values `
    ADD PRIMARY KEY (` value_id `), ADD KEY ` user_id ` (` user_id `), ADD KEY ` source_id ` (` source_id `), ADD KEY ` phrase_group_id ` (` phrase_group_id `), ADD KEY ` time_word_id ` (` time_word_id `), ADD KEY ` protection_type_id ` (` protection_type_id `);
...
ALTER TABLE ` view_components `
    ADD PRIMARY KEY (` view_component_id `), ADD KEY ` formula_id ` (` formula_id `);

--
-- Indexes for table `view_component_links`
--
ALTER TABLE ` view_component_links `
    ADD PRIMARY KEY (` view_component_link_id `), ADD KEY ` view_id ` (` view_id `), ADD KEY ` view_component_id ` (` view_component_id `), ADD KEY ` view_position_type_id ` (` position_type `);
...
--
ALTER TABLE ` words `
    ADD PRIMARY KEY (` word_id `), ADD UNIQUE KEY ` word_name ` (` word_name `), ADD KEY ` word_type_id ` (` word_type_id `), ADD KEY ` view_id ` (` view_id `);
