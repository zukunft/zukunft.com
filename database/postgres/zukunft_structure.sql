...
CREATE TABLE IF NOT EXISTS user_values (
    value_id BIGSERIAL PRIMARY KEY,
    user_id bigint NOT NULL,
    user_value double precision DEFAULT NULL,
    source_id bigint DEFAULT NULL,
    excluded smallint DEFAULT NULL,
    share_type_id bigint DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS value_time_series (
    value_time_serie_id BIGSERIAL PRIMARY KEY,
    user_id bigint NOT NULL,
    source_id bigint DEFAULT NULL,
    phrase_group_id bigint NOT NULL,
    excluded smallint DEFAULT NULL,
...
CREATE OR REPLACE VIEW phrase_group_phrase_links AS
    SELECT
        w.phrase_group_word_link_id   AS phrase_group_phrase_link_id,
        w.phrase_group_id             AS phrase_group_id,
        w.word_id                     AS phrase_id
    FROM phrase_group_word_links AS w
    UNION SELECT
        t.phrase_group_triple_link_id AS phrase_group_phrase_link_id,
...
--
ALTER TABLE changes
    ADD KEY table_id (change_field_id,row_id), ADD KEY change_action_id (change_action_id);
...
ALTER TABLE change_links
    ADD KEY user (user_id), ADD KEY change_table_id (change_table_id), ADD KEY change_action_id (change_action_id);
...
ALTER TABLE formulas
    ADD CONSTRAINT name UNIQUE (formula_name), ADD  user_id_key KEY (user_id), ADD KEY formula_type_id (formula_type_id), ADD KEY protection_type_id (protection_type_id);

--
-- Indexes for table formula_elements
--
ALTER TABLE formula_elements
    ADD KEY formula_id (formula_id), ADD KEY formula_element_type_id (formula_element_type_id);
