...
user_message: $act_msg, $activate_msg, $add_msg, $adm_msg, $anon_msg, $cac_msg, $change_msg, $code_msg, $db_msg, $err_msg, $fail_msg, $fld_msg, $frm_msg, $frm_usr_msg, $import_result, $ins_usr_msg, $ip_msg, $job_msg, $login_msg, $logoff_msg, $logout_msg, $lst_ins, $map_msg, $msg2, $msg_2, $msg_activate_ui, $msg_chk, $msg_err, $msg_ins, $msg_load, $msg_login_ui, $msg_logoff_ui, $msg_missing, $msg_no_usr, $msg_reload, $msg_signup_ui, $msg_sys, $msg_ui, $msg_usr2, $no_usr_msg, $ok_msg, $owner_msg, $p, $pw_msg, $ref_usr_msg, $reset_msg, $result, $save_msg, $setup_msg, $signup_msg, $sim_msg, $sim_name_msg, $sys_msg, $tbl_msg, $trm_usr_msg, $ui_msg, $undo_msg, $upd_usr_msg, $url_msg, $usr_msg, $usr_msg_calc, $usr_msg_del, $usr_msg_map, $usr_msg_ui, $usr_no, $usr_no_2, $usr_ok, $val_msg
