...
phrase: $country, $dbo, $dbo_ui, $debug_phr, $from, $max_phr, $new_phrase, $phr2, $phr_canton_ui, $phr_ch_ui, $phr_city_ui, $phr_new, $phr_sys_cfg, $phr_to, $phr_to_add, $phr_ui, $phr_zh, $rank_phr, $result, $switzerland, $time_phr, $to, $to_add, $to_dsp, $trp, $val_phr, $val_time_phr, $wrd, $wrd_by_id, $zurich
...
source: $dbo, $dbo_ui, $msk, $obj, $scr_dsp, $src1, $src2, $src_usr2, $src_usr2_reloaded, $usr_ui
sys_log: $dbo, $dbo_ui, $err, $err_entry, $log, $log_dsp, $new, $sys_log
term: $frm, $term, $trm_back, $trm_by_obj_id, $trp, $vrb, $wrd
triple: $bare_trp_ui, $db_trp, $dbo, $dbo_ui, $lnk, $lnk2, $lnk_canton, $lnk_company, $lnk_dsp, $lnk_test, $obj, $phr_canton_ui, $phr_city_ui, $result, $similar_trp, $trp_by_id, $trp_del, $trp_dsp, $trp_in, $trp_ins, $trp_sec, $trp_ui, $trp_usr, $trp_zh, $wrd, $wrd_lnk, $wrd_or_trp
...
view: $cld, $dbo, $dbo_ui, $msk_db, $msk_dsp, $msk_new, $msk_old, $msk_reloaded, $msk_renamed, $msk_ui, $msk_usr2, $msk_usr2_reloaded, $obj, $prt, $result, $sc, $trp_view, $usr_ui, $view_obj, $wrd_view
...
component_link: $cmp_lnk, $dbo, $dbo_ui, $dsp_lnk, $lnk, $new_lnk, $obj, $usr_ui, $vcl
