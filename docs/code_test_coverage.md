...
1124 of 5470 public functions have at least 2 unit test calls; the 4346 functions below do not
...
\-- component
    ...
    \-- set_row_phrase - 0 unit test calls
...
\-- expression
    ...
    \-- element_lst_all - 0 unit test calls
    ...
    \-- get_formula_symbol - 0 unit test calls
    \-- get_ref_id - 0 unit test calls
    \-- get_triple_symbol - 0 unit test calls
    \-- get_verb_symbol - 0 unit test calls
    \-- get_word_symbol - 0 unit test calls
    \-- has_ref - 0 unit test calls
    \-- is_valid - 0 unit test calls
    \-- load_formula - 0 unit test calls
    \-- load_triple - 0 unit test calls
    \-- load_verb - 0 unit test calls
    \-- load_word - 0 unit test calls
...
\-- phrase_list
    ...
    \-- import_map_names - 0 unit test calls
...
\-- sandbox_typed
    ...
    \-- set_type_by_name - 0 unit test calls
    \-- set_type_id - 0 unit test calls
    \-- type_change_allowed - 0 unit test calls
    \-- type_code_id - 0 unit test calls
    \-- type_name - 0 unit test calls
\-- sandbox_value
    \-- changer - 0 unit test calls
...
\-- user
    ...
    \-- can_set_code_id - 0 unit test calls
...
\-- user_log_display
    \-- dsp_hist - 0 unit test calls
    \-- dsp_hist_links - 0 unit test calls
    \-- dsp_hist_links_sql - 0 unit test calls
    \-- dsp_hist_old - 0 unit test calls
\-- user_message
