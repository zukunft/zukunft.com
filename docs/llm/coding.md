...
- A truncated list's "… and n more" tail is always a link to the view that shows the full list (e.g. the values tail links to the `phrase_values` view), never dead text. → `docs/llm/frontend.md`
