...
```
frontend: /value/value.php:505 - $msg = new user_message(); // a local buffer, the tooltip lookup has no user relevant message
frontend: /value/value.php:562 - $warning = new user_message();
