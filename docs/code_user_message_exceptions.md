...
frontend: /value/value.php:565 - $msg = new user_message(); // a local buffer, the tooltip lookup has no user relevant message
frontend: /value/value.php:622 - $warning = new user_message();
