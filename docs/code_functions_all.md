...
```
\-- component
    \-- delta - section for function delta is expected to be del in /component/component.php
\-- component_link
    \-- view_id - section for function view_id not yet defined that it should be set and get in /component/component_lin
            k.php
    \-- component_id - section for function component_id not yet defined that it should be set and get in /component/com
            ponent_link.php
...
\-- formula
    ...
    \-- user_exp_is_valid - section for function user_exp_is_valid not yet defined that it should be info in /formula/fo
            rmula.php
    \-- expression_may_match - section for function expression_may_match not yet defined that it should be info in /form
            ula/formula.php
    \-- special_time_phr - section for function special_time_phr not yet defined that it should be predefined in /formul
            a/formula.php
    \-- special_phr_lst - section for function special_phr_lst not yet defined that it should be predefined in /formula/
            formula.php
    \-- assign_phr_glst_direct - section for function assign_phr_glst_direct not yet defined that it should be assign in
             /formula/formula.php
    \-- assign_phr_lst_direct - section for function assign_phr_lst_direct not yet defined that it should be assign in /
            formula/formula.php
    \-- assign_phr_ulst_direct - section for function assign_phr_ulst_direct not yet defined that it should be assign in
             /formula/formula.php
    ...
    \-- assign_phr_lst - section for function assign_phr_lst not yet defined that it should be assign in /formula/formul
            a.php
    \-- assign_phr_ulst - section for function assign_phr_ulst not yet defined that it should be assign in /formula/form
            ula.php
    ...
    \-- fill_element_group - section for function fill_element_group not yet defined that it should be calc in /formula/
            formula.php
    \-- fill_results_with_one_figure - section for function fill_results_with_one_figure not yet defined that it should 
            be calc in /formula/formula.php
    \-- fill_results_with_figures - section for function fill_results_with_figures not yet defined that it should be cal
            c in /formula/formula.php
    \-- fill_first_figure - section for function fill_first_figure not yet defined that it should be calc in /formula/fo
            rmula.php
    \-- fill_next_figure - section for function fill_next_figure not yet defined that it should be calc in /formula/form
            ula.php
    \-- switch_off_incomplete_results - section for function switch_off_incomplete_results not yet defined that it shoul
            d be calc in /formula/formula.php
    \-- calc_results - section for function calc_results not yet defined that it should be calc in /formula/formula.php
    \-- calc_result - section for function calc_result not yet defined that it should be calc in /formula/formula.php
    \-- result_can_calc - section for function result_can_calc not yet defined that it should be calc in /formula/formul
            a.php
    ...
    \-- calc_requests - section for function calc_requests not yet defined that it should be calc in /formula/formula.ph
            p
    \-- calc - section for function calc not yet defined that it should be calc in /formula/formula.php
    \-- reload_if_incomplete - section for function reload_if_incomplete is expected to be related in /formula/formula.p
            hp
    \-- build_result_list - section for function build_result_list not yet defined that it should be calc in /formula/fo
            rmula.php
    ...
    \-- apply_result_phrases - section for function apply_result_phrases not yet defined that it should be calc in /form
            ula/formula.php
    \-- add_formula_name_phrase - section for function add_formula_name_phrase not yet defined that it should be calc in
             /formula/formula.php
    \-- calc_with - section for function calc_with not yet defined that it should be calc in /formula/formula.php
    \-- expression_new - section for function expression_new not yet defined that it should be calc in /formula/formula.
            php
    ...
    \-- generate_ref_text - section for function generate_ref_text not yet defined that it should be save in /formula/fo
            rmula.php
    \-- generate_usr_text - section for function generate_usr_text not yet defined that it should be save in /formula/fo
            rmula.php
\-- formula_link
    \-- formula - section for function formula not yet defined that it should be set and get in /formula/formula_link.ph
            p
    \-- phrase - section for function phrase is expected to be cast in /formula/formula_link.php
    \-- formula_id - section for function formula_id not yet defined that it should be set and get in /formula/formula_l
            ink.php
    \-- phrase_id - section for function phrase_id not yet defined that it should be set and get in /formula/formula_lin
            k.php
    \-- pos - section for function pos not yet defined that it should be set and get in /formula/formula_link.php
    \-- load_sql_user_changes - section for function load_sql_user_changes is expected to be load sql in /formula/formul
            a_link.php
    \-- load_sql - section for function load_sql is expected to be load sql in /formula/formula_link.php
    \-- reload_objects - section for function reload_objects is expected to be related in /formula/formula_link.php
    \-- from_field - section for function from_field is expected to be sql fields in /formula/formula_link.php
    \-- to_field - section for function to_field is expected to be sql fields in /formula/formula_link.php
    \-- type_field - section for function type_field is expected to be sql fields in /formula/formula_link.php
    \-- name_field - section for function name_field is expected to be sql fields in /formula/formula_link.php
    \-- delta - section for function delta is expected to be del in /formula/formula_link.php
    \-- not_used - section for function not_used is expected to be sandbox in /formula/formula_link.php
    \-- not_changed - section for function not_changed is expected to be sandbox in /formula/formula_link.php
    \-- not_changed_sql - section for function not_changed_sql is expected to be sandbox in /formula/formula_link.php
    \-- log_upd_field - section for function log_upd_field is expected to be log in /formula/formula_link.php
    \-- order error - order of section set and get has difference at get_predicate_code_id should be before set_phrase
\-- formula_map
    \-- uses_following - section for function uses_following not yet defined that it should be info in /formula/formula_
            map.php
    \-- expression - section for function expression not yet defined that it should be related in /formula/formula_map.p
            hp
    ...
    \-- delta - section for function delta is expected to be del in /formula/formula_map.php
    \-- no_ref_needed - section for function no_ref_needed not yet defined that it should be info in /formula/formula_ma
            p.php
    ...
    \-- is_used - section for function is_used is expected to be info in /formula/formula_map.php
    \-- not_used - section for function not_used is expected to be sandbox in /formula/formula_map.php
    \-- not_changed - section for function not_changed is expected to be sandbox in /formula/formula_map.php
    \-- not_changed_sql - section for function not_changed_sql is expected to be sandbox in /formula/formula_map.php
    \-- load_sql_user_changes_frm - section for function load_sql_user_changes_frm is expected to be load sql in /formul
            a/formula_map.php
    \-- load_sql_user_changes - section for function load_sql_user_changes is expected to be load sql in /formula/formul
            a_map.php
    ...
    \-- add - section for function add not yet defined that it should be true if no other user has modified the formula 
            in /formula/formula_map.php
    \-- generate_ref_text - section for function generate_ref_text not yet defined that it should be true if no other us
            er has modified the formula in /formula/formula_map.php
    \-- save_fields_func - section for function save_fields_func is expected to be save in /formula/formula_map.php
    \-- element_refresh - section for function element_refresh not yet defined that it should be save helper in /formula
            /formula_map.php
    ...
    \-- elements - section for function elements not yet defined that it should be save helper in /formula/formula_map.p
            hp
    \-- elements_incl_result_phrases - section for function elements_incl_result_phrases not yet defined that it should 
            be save helper in /formula/formula_map.php
    \-- formula_word - section for function formula_word not yet defined that it should be save helper in /formula/formu
            la_map.php
    \-- wrd_add - section for function wrd_add not yet defined that it should be save helper in /formula/formula_map.php
    \-- wrd_rename - section for function wrd_rename not yet defined that it should be save helper in /formula/formula_m
            ap.php
    \-- wrd_del - section for function wrd_del not yet defined that it should be save helper in /formula/formula_map.php
    \-- wrd_add_fix - section for function wrd_add_fix not yet defined that it should be save helper in /formula/formula
            _map.php
\-- group
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /group/group
            .php
    \-- phrase_list - section for function phrase_list is expected to be cast in /group/group.php
    \-- has_phrase_list - section for function has_phrase_list not yet defined that it should be set and get in /group/g
            roup.php
    ...
    \-- table_extension - section for function table_extension not yet defined that it should be set and get in /group/g
            roup.php
    \-- table_type - section for function table_type not yet defined that it should be set and get in /group/group.php
    \-- is_id_set - section for function is_id_set is expected to be info in /group/group.php
    ...
    \-- sql_foreign_key - section for function sql_foreign_key not yet defined that it should be sql create in /group/gr
            oup.php
    \-- sql_truncate - section for function sql_truncate not yet defined that it should be sql create in /group/group.ph
            p
    ...
    \-- load_sql_by_name_single - section for function load_sql_by_name_single is expected to be load sql in /group/grou
            p.php
    \-- load_sql_by_phrase_list - section for function load_sql_by_phrase_list is expected to be load sql in /group/grou
            p.php
    \-- load_sql_standard - section for function load_sql_standard is expected to be load sql in /group/group.php
    \-- load_sql_standard_by_name - section for function load_sql_standard_by_name is expected to be load sql in /group/
            group.php
    \-- load_sql_user_changes - section for function load_sql_user_changes is expected to be load sql in /group/group.ph
            p
    \-- all_sandbox_fields - section for function all_sandbox_fields is expected to be sql fields in /group/group.php
    ...
    \-- get - section for function get not yet defined that it should be get functions - to load or create with one call
             in /group/group.php
    ...
    \-- import_mapper - section for function import_mapper is expected to be construct and map in /group/group.php
    ...
    \-- value_type - section for function value_type not yet defined that it should be sql helper in /group/group.php
    \-- id_fvt_lst - section for function id_fvt_lst not yet defined that it should be sql helper in /group/group.php
    \-- load_link_ids_for_testing - section for function load_link_ids_for_testing is expected to be load in /group/grou
            p.php
    ...
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper,
            order of section load has difference at load_by_name should be before load_by_id,
            order of section debug has difference at name should be before dsp_id_medium
\-- ref
    \-- phrase - section for function phrase is expected to be cast in /ref/ref.php
    \-- phrase_id - section for function phrase_id not yet defined that it should be set and get in /ref/ref.php
    \-- phrase_name - section for function phrase_name not yet defined that it should be set and get in /ref/ref.php
    \-- from_id - section for function from_id not yet defined that it should be set and get in /ref/ref.php
    \-- to_id - section for function to_id not yet defined that it should be set and get in /ref/ref.php
    ...
    \-- get_predicate_code_id - section for function get_predicate_code_id is expected to be set and get in /ref/ref.php
    ...
    \-- to_field - section for function to_field is expected to be sql fields in /ref/ref.php
    \-- to_value - section for function to_value not yet defined that it should be load in /ref/ref.php
    \-- type_field - section for function type_field is expected to be sql fields in /ref/ref.php
    \-- name_field - section for function name_field is expected to be sql fields in /ref/ref.php
...
\-- result
    ...
    \-- phr_lst - section for function phr_lst not yet defined that it should be reduce code line length in /result/resu
            lt.php
    \-- phr_names - section for function phr_names not yet defined that it should be reduce code line length in /result/
            result.php
    \-- load_sql_standard - section for function load_sql_standard is expected to be load sql in /result/result.php
    \-- load_sql_multi - section for function load_sql_multi is expected to be load sql in /result/result.php
    \-- load_sql_by_grp - section for function load_sql_by_grp is expected to be load sql in /result/result.php
    \-- load_sql_std_by_grp - section for function load_sql_std_by_grp is expected to be load sql in /result/result.php
    ...
    \-- update_depending - section for function update_depending not yet defined that it should be display in /result/re
            sult.php
...
\-- user
    ...
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /user/user.p
            hp
    \-- api_json_core - section for function api_json_core not yet defined that it should be api in /user/user.php
    \-- api_json_array_core - section for function api_json_array_core not yet defined that it should be api in /user/us
            er.php
    \-- log_object - section for function log_object is expected to be log in /user/user.php
    \-- has_active_activation_key - section for function has_active_activation_key not yet defined that it should be set
             and get in /user/user.php
    \-- activation_key_valid - section for function activation_key_valid not yet defined that it should be set and get i
            n /user/user.php
    ...
    \-- name_and_profile - section for function name_and_profile not yet defined that it should be set and get in /user/
            user.php
    \-- profile_name - section for function profile_name not yet defined that it should be set and get in /user/user.php
    \-- type_name - section for function type_name is expected to be preloaded in /user/user.php
    \-- status_name - section for function status_name not yet defined that it should be set and get in /user/user.php
    \-- term_id - section for function term_id not yet defined that it should be set and get in /user/user.php
    \-- term_name - section for function term_name not yet defined that it should be set and get in /user/user.php
    \-- source_id - section for function source_id not yet defined that it should be set and get in /user/user.php
    \-- unique_value - section for function unique_value not yet defined that it should be set and get in /user/user.php
    ...
    \-- data_user - section for function data_user not yet defined that it should be loading / database access object (D
            AO) functions in /user/user.php
    ...
    \-- load_by_name_or_email - section for function load_by_name_or_email is expected to be load in /user/user.php
    \-- load_by_ip - section for function load_by_ip is expected to be load in /user/user.php
    \-- load_by_profile - section for function load_by_profile is expected to be load in /user/user.php
    \-- load_by_profile_code - section for function load_by_profile_code is expected to be load in /user/user.php
    \-- load_usr_data - section for function load_usr_data is expected to be load in /user/user.php
    \-- has_any_user_this_profile - section for function has_any_user_this_profile not yet defined that it should be loa
            d sql in /user/user.php
    \-- ip_check - section for function ip_check not yet defined that it should be load sql in /user/user.php
    \-- needs_ip_update - section for function needs_ip_update not yet defined that it should be load sql in /user/user.
            php
    \-- get - section for function get not yet defined that it should be load sql in /user/user.php
    \-- create_system_user - section for function create_system_user not yet defined that it should be load sql in /user
            /user.php
    ...
    \-- no_non_id_diff - section for function no_non_id_diff not yet defined that it should be compare in /user/user.php
    \-- can_add - section for function can_add not yet defined that it should be owner and access in /user/user.php
    \-- can_be_changed_by - section for function can_be_changed_by not yet defined that it should be owner and access in
             /user/user.php
    \-- can_change - section for function can_change is expected to be sandbox in /user/user.php
    \-- can_set_profile - section for function can_set_profile not yet defined that it should be owner and access in /us
            er/user.php
    \-- enforce_profile_privilege - section for function enforce_profile_privilege not yet defined that it should be own
            er and access in /user/user.php
    \-- can_set_type_id - section for function can_set_type_id not yet defined that it should be owner and access in /us
            er/user.php
    \-- can_set_code_id - section for function can_set_code_id not yet defined that it should be owner and access in /us
            er/user.php
    \-- can_set_ui_msg_id - section for function can_set_ui_msg_id not yet defined that it should be owner and access in
             /user/user.php
    \-- delta - section for function delta is expected to be del in /user/user.php
    \-- never_used - section for function never_used not yet defined that it should be info in /user/user.php
    \-- profile_code_id - section for function profile_code_id not yet defined that it should be info in /user/user.php
    \-- profile_id - section for function profile_id not yet defined that it should be info in /user/user.php
    \-- can_import - section for function can_import not yet defined that it should be info in /user/user.php
    \-- last_term - section for function last_term not yet defined that it should be info in /user/user.php
    ...
    \-- exclude_from_standard - section for function exclude_from_standard not yet defined that it should be info in /us
            er/user.php
    ...
    \-- check_sandbox_usage - section for function check_sandbox_usage not yet defined that it should be save in /user/u
            ser.php
    ...
    \-- db_update_user - section for function db_update_user not yet defined that it should be update in /user/user.php
    ...
    \-- check - section for function check not yet defined that it should be db helper in /user/user.php
...
\-- verb
    ...
    \-- check - section for function check not yet defined that it should be db helper in /verb/verb.php
\-- term_view
    \-- term - section for function term is expected to be cast in /view/term_view.php
    \-- delta - section for function delta is expected to be del in /view/term_view.php
    \-- from_field - section for function from_field is expected to be sql fields in /view/term_view.php
    \-- to_field - section for function to_field is expected to be sql fields in /view/term_view.php
    \-- to_value - section for function to_value not yet defined that it should be fields in /view/term_view.php
    \-- type_field - section for function type_field is expected to be sql fields in /view/term_view.php
    \-- name_field - section for function name_field is expected to be sql fields in /view/term_view.php
    \-- load_sql - section for function load_sql is expected to be load sql in /view/term_view.php
    \-- reload_objects - section for function reload_objects is expected to be related in /view/term_view.php
    \-- order error - order of section set and get has difference at get_view should be before set
\-- view
    \-- components - section for function components not yet defined that it should be set and get in /view/view.php
    ...
    \-- set_join - section for function set_join is expected to be set and get in /view/view.php
    \-- add_component - section for function add_component not yet defined that it should be components in /view/view.ph
            p
    \-- entry_up - section for function entry_up not yet defined that it should be components in /view/view.php
    \-- entry_down - section for function entry_down not yet defined that it should be components in /view/view.php
    \-- add_term_db - section for function add_term_db not yet defined that it should be assign in /view/view.php
    \-- add_term - section for function add_term not yet defined that it should be assign in /view/view.php
    \-- del_term - section for function del_term is expected to be del in /view/view.php
    \-- delta - section for function delta is expected to be del in /view/view.php
    \-- has_components - section for function has_components not yet defined that it should be info in /view/view.php
...
\-- view_relation
    ...
    \-- from_field - section for function from_field is expected to be sql fields in /view/view_relation.php
    \-- to_field - section for function to_field is expected to be sql fields in /view/view_relation.php
    \-- type_field - section for function type_field is expected to be sql fields in /view/view_relation.php
    \-- name_field - section for function name_field is expected to be sql fields in /view/view_relation.php
    \-- delta - section for function delta is expected to be del in /view/view_relation.php
    \-- relation_type_code_id - section for function relation_type_code_id not yet defined that it should be preloaded i
            n /view/view_relation.php
    \-- relation_type_id - section for function relation_type_id not yet defined that it should be preloaded in /view/vi
            ew_relation.php
    \-- load_sql - section for function load_sql is expected to be load sql in /view/view_relation.php
    \-- reload_objects - section for function reload_objects is expected to be related in /view/view_relation.php
    \-- order error - order of section set and get has difference at get_predicate_code_id should be before set
\-- triple
    ...
    \-- load_references_related - section for function load_references_related is expected to be load in /word/triple.ph
            p
    ...
    \-- link_key - section for function link_key is expected to be link in /word/triple.php
    \-- name_generated - section for function name_generated not yet defined that it should be set and get in /word/trip
            le.php
    \-- type_id - section for function type_id not yet defined that it should be set and get in /word/triple.php
    \-- cloned_named - section for function cloned_named not yet defined that it should be set and get in /word/triple.p
            hp
    \-- needs_from - section for function needs_from not yet defined that it should be info in /word/triple.php
    \-- has_verb - section for function has_verb not yet defined that it should be info in /word/triple.php
    \-- delta - section for function delta is expected to be del in /word/triple.php
    \-- load_standard_by_link - section for function load_standard_by_link is expected to be load in /word/triple.php
    \-- load_standard_by_type_link - section for function load_standard_by_type_link is expected to be load in /word/tri
            ple.php
    \-- wrd_lst - section for function wrd_lst not yet defined that it should be related in /word/triple.php
    \-- check - section for function check not yet defined that it should be info in /word/triple.php
    \-- can_be_ready - section for function can_be_ready is expected to be check in /word/triple.php
    \-- db_ready - section for function db_ready is expected to be check in /word/triple.php
    \-- diff_msg - section for function diff_msg is expected to be info in /word/triple.php
    \-- needs_db_update - section for function needs_db_update is expected to be info in /word/triple.php
    \-- generate_name - section for function generate_name not yet defined that it should be internal in /word/triple.ph
            p
    \-- get_similar_named - section for function get_similar_named is expected to be set and get in /word/triple.php
    \-- add - section for function add not yet defined that it should be save in /word/triple.php
    \-- is_key_updated - section for function is_key_updated is expected to be info in /word/triple.php
    \-- del_links - section for function del_links is expected to be del in /word/triple.php
    \-- name_ex_generated - section for function name_ex_generated not yet defined that it should be debug in /word/trip
            le.php
    \-- order error - order of section api has difference at api_json_array should be before load_views_related,
            order of section set and get has difference at get_predicate_code_id should be before set,
            order of section preloaded has difference at type_code_id should be before type_name,
            order of section load sql has difference at load_sql should be before load_sql_user_changes
\-- word
    \-- update_usage - section for function update_usage not yet defined that it should be related in /word/word.php
    \-- calc_usage - section for function calc_usage is expected to be ui support in /word/word.php
    \-- load_related - section for function load_related is expected to be load in /word/word.php
    ...
    \-- load_parent_formulas_related - section for function load_parent_formulas_related is expected to be load in /word
            /word.php
    ...
    \-- select_phrases_related - section for function select_phrases_related not yet defined that it should be related i
            n /word/word.php
    \-- load_by_id_with_related - section for function load_by_id_with_related is expected to be load in /word/word.php
    \-- delta - section for function delta is expected to be del in /word/word.php
    \-- calc_usage_old - section for function calc_usage_old not yet defined that it should be ui support in /word/word.
            php
    \-- order error - order of section info has difference at delta should be before needs_db_update
```
...
\-- construct and map
    \-- __construct
        ...
        \-- component_link - set the user and fix the setting of this component link object
        \-- formula - define the settings for this formula object
        \-- formula_map - define the settings for this formula object
        \-- value - set the user, which is needed in all cases and the main vars with the object creation
        \-- verb - set the main mandatory vars of this verb object
        \-- view - define the settings for this view object
    \-- reset
        \-- component - clear the view component object values
        \-- component_link - set the vars of this component link object to the default values
        \-- formula - clear the view component object values
        \-- formula_map - clear the view component object values
        \-- verb - set the vars of this verb object to the default values
        \-- view - define the settings for this view object
    \-- row_mapper_sandbox
        \-- component - map the database fields to the object fields
        \-- component_link - map the database fields to the object fields
        \-- formula_map - map the database fields to the object fields
        \-- view - map the database fields to the object fields
    \-- api_mapper
        \-- component - map a component api json to this model component object
        \-- component_link - map a component api json to this model component link object
        ...
        \-- view - map a view api json to this model view object
    \-- import_mapper
        \-- component - import a view component from a JSON object
        \-- component_link - set the vars of this component link object based on the given json without writing to the d
                atabase
        \-- formula_map - set the vars of this formula object based on the given json without writing to the database
        \-- verb - function to import the core user sandbox object values from a json string
        \-- view - set the vars of this view object based on the given json without writing to the database
    \-- common_mapper
        \-- verb - function to import the core user sandbox object values from a json string
    \-- row_mapper_typ_obj
        \-- verb - interface function for initial csv import
    \-- row_mapper_verb
        \-- verb - set the class vars based on a database record
\-- api
    \-- api_json_array
        \-- component - create an array for the api json creation
        \-- component_link - create an array for the api json creation
        \-- formula_map - create an array for the api json creation
        \-- value - create an array for the api json creation
        \-- verb - create an array for the api json creation
...
\-- im- and export
    \-- 1
        ...
        \-- verb - add a verb in the database from an imported json object of external database from
        \-- view - import a view from a JSON object
    \-- export_json
        ...
        \-- formula_map - create an array with the export json fields
        \-- value - create an array with the export json fields
        \-- verb - create an array with the export json fields
        \-- view - create an array with the export json fields
\-- set and get
    \-- set_type
        \-- component - set the predefined view component type by the given code id or name
        \-- formula_map - set the predefined type of this formula by the given code id or name
        \-- view - set the view type by the given code id or name
    \-- 10
        \-- component_link - @return string|null the code id of the position type for the component in the linked view b
                y the database id
    \-- set_style
        \-- component - set the default style for this component by the code id
        \-- component_link - set the style for this component link that overwrites the view and component style
        \-- view - set the default style for this view by the code id
    \-- set_style_by_id
        \-- component - set the default style for this component by the database id
        \-- component_link - set the style for this component link by the database id
        \-- view - set the default style for this view by the database id
    \-- get_style
        \-- component - @return view_style|type_object|null the view style for this component or null if the parent styl
                e should be used
        \-- component_link - @return type_object|null the view style or null
        \-- view - @return view_style|type_object|null the view style for this component or null if the parent style sho
                uld be used
    \-- get_style_id
        \-- component - @return int|null the database id of the view style or null
        \-- component_link - @return int|null the database id of the view style or null
        \-- view - @return int|null the database id of the view style or null
    \-- set_row_phrase
        \-- component - define or remove the phrase that is used to select the table rows
    \-- set_row_phrase_by_id
        \-- component - set the phrase that defines the row names by its id e.g. based on an api message, without
    \-- set_col_phrase_by_id
        \-- component - set the phrase that defines the column names by its id without a database load
    \-- set_col_sub_phrase_by_id
        \-- component - set the phrase that defines the sub column names by its id without a database load
    \-- get_row_phrase_id
        \-- component - @param int|null $id the phrase id (positive for a word, negative for a triple) or null
    \-- get_row_phrase_name
        \-- component - @param int|null $id the phrase id (positive for a word, negative for a triple) or null
    \-- set_col_phrase
    ...
    \-- get_view
        \-- component_link - rename to standard link from object to view
    \-- view_id
        \-- component_link - rename to standard link from object to view
    \-- component_id
        \-- component_link - rename to standard link from object to view
    \-- get_component
        \-- component_link - rename to standard link to object to component
    \-- get_pos
        \-- component_link - expose the order number as pos
    \-- set_link_objects
        \-- component_link - copy the link objects from this object to the given component_link
    \-- get_key
        \-- component_link - @return string a unique key including the position of the component link based on the names
                 of the view and component
    \-- get_predicate_code_id
        \-- component_link - overwrite the link type function
    \-- set_view_id
        \-- formula_map - @param int $id the id of the default view that should be remembered
    \-- get_view_id
        \-- formula_map - @return int the id of the default view for this word or null if no view is preferred
    \-- set_user_text
        \-- formula_map - update the expression by setting the human-readable format and try to update the database refe
                rence format
    \-- get_usr_text
        \-- formula_map - update the expression by setting the human-readable format and try to update the database refe
                rence format
    ...
    \-- get_latex
        \-- formula_map - @return string|null the formula in latex format
    \-- set_value
    ...
    \-- set
        \-- verb - set the most used object vars with one set statement
    \-- set_name
        \-- verb - @param string|null $name the unique name of the verb
    \-- set_user
        \-- verb - set the user of the verb
    \-- get_code_id
        \-- verb - @return string a unique name for the verb that is also used in the code
    \-- get_description
        \-- verb - @return string the description of the verb
    \-- get_user
        \-- verb - @return user|null the person who wants to see this verb
    \-- components
        \-- view - @return component_list the list of the linked components of this view
    \-- component_links
        \-- view - @return int the number of linked components of this view
\-- preloaded
    \-- type_code_id
        \-- component - @return string|null the code_id of the component type
        \-- formula_map - @return string|null the code_id of the formula type
        \-- view - get the view type code id based on the database id set in this object
    \-- type_name
        \-- component - @return string the name of the component type
        \-- formula_map - @return string the name of the formula type
        \-- view - @return string the name of the view type
    \-- type_name_or_null
        \-- component - get the name of the component type or null if no type is set
    \-- predicate_name
        \-- component_link - @return string the name of the preloaded view component link type
\-- load
    \-- load_by_name
        \-- component - just set the class name for the user sandbox function
        \-- verb - load a verb by the verb name
    \-- load_by_id
        \-- component - just set the class name for the user sandbox function
    \-- load_by_link
        \-- component_link - load a named user sandbox object by name
    \-- load_by_link_and_pos
        \-- component_link - load the component link by the unique link ids including the pos
    \-- load_by_link_and_type
        \-- component_link - load the component_link by the link id
    \-- load_standard_by_type_link
        \-- component_link - load the object parameters for all users by the link ids
    \-- load_max_pos_by_view
        \-- component_link - load the component_link by the link id
    \-- load_standard_by_link
        \-- component_link - load the object parameters for all users by the link id
    \-- load_by_code_id
        \-- verb - load a verb by the verb name
    \-- load_by_phrase
        \-- view - load the suggested view for a phrase
    \-- load_by_term
        \-- view - load the suggested view for a term
\-- load sql
    \-- 3
        \-- verb - create an SQL statement to retrieve a verb by code id from the database
    \-- 1
        \-- view - create an SQL statement to retrieve a view by the phrase from the database
    \-- load_sql
        \-- component - create the common part of an SQL statement to retrieve the parameters of a view component from t
                he database
        \-- component_link - create the common part of an SQL statement to retrieve the parameters of a view component l
                ink from the database
        \-- formula_map - create the common part of an SQL statement to retrieve
        \-- verb - create the common part of an SQL statement to retrieve the parameters of a verb from the database
        \-- view - create the common part of an SQL statement to retrieve the parameters of a view from the database
    \-- load_sql_user_changes
        \-- component - create an SQL statement to retrieve the user changes of the current view component
        \-- component_link - create an SQL statement to retrieve the user changes of the current view component link
    \-- load_sql_by_link_and_type
        \-- component_link - create an SQL statement to load the component_link by the link id
    \-- load_sql_by_link_and_pos
        \-- component_link - create an SQL statement to retrieve a user sandbox link by the ids of the linked objects fr
                om the database
    \-- load_sql_max_pos
        \-- component_link - create a simple SQL statement to retrieve the max order number of one view
\-- sql fields
    \-- 3
        \-- component_link - to load the related objects if the link object is loaded by an external query like in user_
                display to show the sandbox
    \-- name_field
        \-- component - create an SQL statement to retrieve the user changes of the current view component
    ...
    \-- all_sandbox_fields
        \-- component - @return array with all fields names of this object
        \-- component_link - @return array with all fields names of this component_link object
        \-- formula_map - @return array with all fields names of this formula object
    \-- all_fields
        \-- verb - get a list of database field names, values and types that have been updated
\-- related
    \-- reload_phrases
    ...
    \-- reload_col_sub_phrase
        \-- component - load the phrase that should be used for the columns of a table
    \-- reload_wrd_col2
        \-- component - TODO Prio 1 add $dto cache to reduce db loading
    \-- reload_formula
        \-- component - TODO Prio 1 add $dto cache to reduce db loading
    \-- reload_objects
        \-- component_link - to load the related objects if the link object is loaded by an external query like in user_
                display to show the sandbox
    \-- expression
        \-- formula_map - @param term_list|null $trm_lst a list of preloaded terms that should be used for the transform
                ation
    \-- reload_wrd
...
\-- info
    \-- 2
        \-- formula_map - if the formula uses the verb / predicate following
    \-- delta
        \-- component - Create an object where only the vars are set
        \-- component_link - Create an object where only the vars are set
        \-- formula_map - Create an object where only the vars are set
        \-- value - Create an object where only the vars are set
        \-- verb - Create an object where only the vars are set
        \-- view - Create an object where only the vars are set
    \-- 3
        \-- view - @return bool true if the view has at least one component
    \-- diff_msg
        \-- component - create human-readable messages of the differences between the objects
        \-- formula_map - create human-readable messages of the differences between the formula objects
        \-- view - create human-readable messages of the differences between the view objects
    \-- needs_db_update
        ...
        \-- view - check if the view in the database needs to be updated
    \-- next_nbr
...
\-- modify
    \-- fill
        ...
        \-- value - fill this sandbox object based on the given object
        \-- verb - fill this verb based on the given verb
        \-- view - fill this sandbox object based on the given object
    \-- move_up
        \-- component_link - create an array with the export json fields of this component
    \-- move_down
        \-- component_link - create an array with the export json fields of this component
...
\-- link
    ...
    \-- link_phrase
        \-- formula_map - add a phrase link to this formula object without updating the database
    \-- link_phrase_and_save
        \-- formula_map - add a phrase link to this formula object amd update the database
    \-- assign_phrase
        \-- formula_map - interface function to have a nicer name for link_phrase_and_save
    \-- unlink_phrase
...
\-- del
    \-- del_links
        ...
        \-- formula_map - remove depending on objects
    \-- del
        \-- verb - exclude or delete a verb
\-- sql write fields
    \-- db_fields_all
        \-- component - get a list of all database fields that might be changed
        \-- component_link - get a list of all database fields that might be changed
        \-- formula_map - get a list of all database fields that might be changed
        \-- verb - TODO Prio 2 maybe move to type object to allow at least admin users to add a type
        \-- view - get a list of all database fields that might be changed
    \-- db_fields_changed
        ...
        \-- formula_map - get a list of database field names, values and types that have been updated
        \-- verb - get a list of database field names, values and types that have been updated
        \-- view - get a list of database field names, values and types that have been updated
\-- debug
    \-- assigned_msk_ids
        \-- component - @return array with all view ids that are directly assigned to this view component
    \-- dsp_id
        \-- component_link - @returns string a programmer readable description of the link for unique identification
        \-- verb - @return string display the unique id fields (used also for debugging)
    \-- name
        \-- component_link - @return string|null the name of the two linked objects e.g. for the change log
        \-- verb - @return string display the unique id fields (used also for debugging)
\-- save
    \-- get_similar
    ...
    \-- is_used
        \-- formula_map - @param user_message $msg to enrich with problems and suggested solutions
    \-- not_used
        \-- formula_map - @param user_message $msg to enrich with problems and suggested solutions
    \-- is_valid
        \-- verb - @return bool true if the verb object probably has been added to the database
    \-- save
        \-- verb - TODO return a user message object,
                 so that messages to the user like "use another name" does not case a error log entry
        \-- view - add or update a view in the database or create a user view
    \-- save_component_links
        \-- view - add or update the component links of this view in the database or create a user view
    \-- load_sql_user_changes
        \-- view - create an SQL statement to retrieve the user changes of the current view
\-- message
...
\-- assign
    ...
    \-- assign_phr_ulst
        \-- formula - the user-specific list of a phrases assigned to a formula
    \-- add_term_db
        \-- view - link this view to the given term and save to the database
    \-- add_term
        \-- view - add the term link to this view object
    \-- del_term
        \-- view - unlink this view from the given term
\-- result
    \-- delete_results
...
\-- calc
    ...
    \-- to_num_new
        \-- formula - fill the formula in the reference format with numbers based on the data preloaded by load_data_for
                _calc;
    \-- fill_element_group
        \-- formula - replace one element group's symbol with the matching figure number(s) in the result list
    \-- fill_results_with_one_figure
        \-- formula - fill the single figure into each result of the list
    \-- fill_results_with_figures
        \-- formula - replicate the results and fill each with one of the multiple figures
    \-- fill_first_figure
        \-- formula - fill the first figure into the result, splitting off a standard result if needed
    \-- fill_next_figure
        \-- formula - clone the master result and fill it with a following figure,
                 splitting off a standard result if needed
    \-- switch_off_incomplete_results
        \-- formula - switch off the results where a needed value is missing
    \-- calc_results
        \-- formula - calculate the final numeric result for each result in the list
    \-- calc_result
        \-- formula - calculate the numeric result of a single result if it needs an update
    \-- result_can_calc
        \-- formula - @param result $res the result whose figures are checked for completeness
    \-- load_all_terms
...
\-- check
    \-- can_be_ready
        \-- formula_map - returns an ok message if this formula can be added to the database if the related terms are ad
                ded
...
\-- cast
    \-- term
        \-- formula_map - @returns term the formula object cast into a term object
        \-- verb - @returns term the formula object cast into a term object
\-- true if no other user has modified the formula
    \-- not_changed
        \-- formula_map - true if no other user has modified the formula
    \-- not_changed_sql
...
\-- save helper
    ...
    \-- delete_elements
        \-- formula_map - delete all elements related to this formula e.g. if the formula is supposed to be deleted
    \-- load_element_list
        \-- formula_map - @return element_list with the element linked to this formula according to the database
    \-- elements
        \-- formula_map - get the list of elements used in this formula
    \-- elements_incl_result_phrases
        \-- formula_map - get an element list with all formula elements
    \-- formula_word
        \-- formula_map - create the corresponding name word object for the formula name
    \-- wrd_add
        \-- formula_map - add the corresponding name word for the formula name to the database
    \-- wrd_rename
        \-- formula_map - rename the corresponding name word if the formula is renamed
    \-- wrd_del
        \-- formula_map - remove the corresponding name word if the formula is deleted
    \-- wrd_add_fix
        \-- formula_map - add the corresponding name word for the formula name to the database without similar check
    \-- del_links
        \-- view - delete the view component links of linked to this view
\-- sandbox
    \-- not_used_sql
        \-- verb - @param user_message $msg to enrich with problems and suggested solutions
    \-- can_change
        \-- verb - true if no other user has modified the verb
\-- similar
    \-- get_similar
        \-- verb - check if a verb is already in the database that have at least one common unique key with this verb
\-- db helper
    \-- check
        \-- verb - check if the verb exists and is valid or if the user can add this object to the database
\-- load related
    \-- load_components
...
\-- load helper
    \-- name_field
        \-- view - @return string the field name of the name db field as a function for complex overwrites
    \-- all_sandbox_fields
        \-- view - @return array with all db field names as a function for complex overwrites
    \-- set_join
        \-- view - @param sql_creator $sc the sql creator without view joins
\-- components
    \-- add_component
        \-- view - add a new component to this view
    \-- entry_up
        \-- view - move one view component one place up
    \-- entry_down
        \-- view - move one view component one place down
```
...
\-- component_link_list
    \-- load_by_ids - section for function load_by_ids is expected to be load in /component/component_link_list.php
    \-- add_by_key - section for function add_by_key not yet defined that it should be modify in /component/component_li
            nk_list.php
\-- component_list
    \-- order error - order of section load sql has difference at load_sql should be before load_sql_by_view_id
\-- sql_creator
    ...
    \-- par_values - section for function par_values not yet defined that it should be set and get in /db/sql_creator.ph
            p
    \-- table_id - section for function table_id not yet defined that it should be set and get in /db/sql_creator.php
    \-- sql_par - section for function sql_par not yet defined that it should be basic interface function for the privat
            e class parameter in /db/sql_creator.php
    ...
    \-- name - section for function name is expected to be debug in /db/sql_creator.php
    ...
    \-- set_fields_num_dummy - section for function set_fields_num_dummy is expected to be set and get in /db/sql_creato
            r.php
    \-- set_fields_date_dummy - section for function set_fields_date_dummy is expected to be set and get in /db/sql_crea
            tor.php
    ...
    \-- set_usr_num_fields - section for function set_usr_num_fields is expected to be set and get in /db/sql_creator.ph
            p
    \-- set_usr_geo_fields - section for function set_usr_geo_fields is expected to be set and get in /db/sql_creator.ph
            p
    \-- set_usr_only_fields - section for function set_usr_only_fields is expected to be set and get in /db/sql_creator.
            php
    ...
    \-- set_join_usr_fields - section for function set_join_usr_fields is expected to be set and get in /db/sql_creator.
            php
    \-- set_join_usr_num_fields - section for function set_join_usr_num_fields is expected to be set and get in /db/sql_
            creator.php
    \-- set_join_usr_geo_fields - section for function set_join_usr_geo_fields is expected to be set and get in /db/sql_
            creator.php
    \-- add_where_fvt - section for function add_where_fvt not yet defined that it should be where in /db/sql_creator.ph
            p
    \-- add_where - section for function add_where not yet defined that it should be where in /db/sql_creator.php
    \-- add_where_par - section for function add_where_par not yet defined that it should be where in /db/sql_creator.ph
            p
    ...
    \-- create_sql_insert - section for function create_sql_insert not yet defined that it should be statement in /db/sq
            l_creator.php
    \-- create_sql_update - section for function create_sql_update not yet defined that it should be statement in /db/sq
            l_creator.php
    \-- create_sql_update_fvt - section for function create_sql_update_fvt not yet defined that it should be statement i
            n /db/sql_creator.php
    \-- sql_func_start - section for function sql_func_start not yet defined that it should be statement in /db/sql_crea
            tor.php
    \-- sql_func_end - section for function sql_func_end not yet defined that it should be statement in /db/sql_creator.
            php
    \-- sql_func_log - section for function sql_func_log not yet defined that it should be statement in /db/sql_creator.
            php
    \-- sql_func_log_update - section for function sql_func_log_update not yet defined that it should be statement in /d
            b/sql_creator.php
    \-- sql_func_log_link - section for function sql_func_log_link not yet defined that it should be statement in /db/sq
            l_creator.php
    \-- sql_func_log_user_link - section for function sql_func_log_user_link not yet defined that it should be statement
             in /db/sql_creator.php
    \-- sql_func_log_value - section for function sql_func_log_value not yet defined that it should be statement in /db/
            sql_creator.php
    \-- sql_call - section for function sql_call not yet defined that it should be statement in /db/sql_creator.php
    \-- var_name_row_id - section for function var_name_row_id not yet defined that it should be statement in /db/sql_cr
            eator.php
    \-- var_name_new_id - section for function var_name_new_id not yet defined that it should be statement in /db/sql_cr
            eator.php
    \-- create_sql_delete_fvt - section for function create_sql_delete_fvt not yet defined that it should be statement i
            n /db/sql_creator.php
    \-- create_sql_delete_fvt_new - section for function create_sql_delete_fvt_new not yet defined that it should be sta
            tement in /db/sql_creator.php
    \-- create_sql_delete - section for function create_sql_delete not yet defined that it should be statement in /db/sq
            l_creator.php
    ...
    \-- par_count - section for function par_count not yet defined that it should be internal where in /db/sql_creator.p
            hp
    \-- prepare_sql - section for function prepare_sql not yet defined that it should be internal where in /db/sql_creat
            or.php
    \-- table_create - section for function table_create not yet defined that it should be internal where in /db/sql_cre
            ator.php
    \-- index_create - section for function index_create not yet defined that it should be internal where in /db/sql_cre
            ator.php
    \-- foreign_key_create - section for function foreign_key_create not yet defined that it should be internal where in
             /db/sql_creator.php
    \-- sql_separator - section for function sql_separator not yet defined that it should be internal where in /db/sql_c
            reator.php
    \-- sql_view_header - section for function sql_view_header not yet defined that it should be internal where in /db/s
            ql_creator.php
    ...
    \-- count_sql - section for function count_sql not yet defined that it should be internal where in /db/sql_creator.p
            hp
    \-- move_where_to_sub - section for function move_where_to_sub not yet defined that it should be internal where in /
            db/sql_creator.php
    \-- select_by_id_not_owner - section for function select_by_id_not_owner not yet defined that it should be internal 
            where in /db/sql_creator.php
    \-- name_sql_esc - section for function name_sql_esc not yet defined that it should be public sql helpers in /db/sql
            _creator.php
    ...
    \-- fix_table_name - section for function fix_table_name not yet defined that it should be final exception correctio
            n of the table name in /db/sql_creator.php
    \-- par_name - section for function par_name not yet defined that it should be final exception correction of the tab
            le name in /db/sql_creator.php
    \-- par_value - section for function par_value not yet defined that it should be final exception correction of the t
            able name in /db/sql_creator.php
    \-- par_type_to_postgres - section for function par_type_to_postgres not yet defined that it should be final excepti
            on correction of the table name in /db/sql_creator.php
    \-- load_sql_not_changed_multi - section for function load_sql_not_changed_multi is expected to be load sql in /db/s
            ql_creator.php
    \-- load_sql_not_changed - section for function load_sql_not_changed is expected to be load sql in /db/sql_creator.p
            hp
    ...
    \-- create_db_role - section for function create_db_role not yet defined that it should be db roles in /db/sql_creat
            or.php
    \-- class_to_name - section for function class_to_name not yet defined that it should be internal helper in /db/sql_
            creator.php
    \-- is_user - section for function is_user is expected to be info in /db/sql_creator.php
    \-- is_MySQL - section for function is_MySQL is expected to be info in /db/sql_creator.php
    \-- id_field - section for function id_field not yet defined that it should be internal helper in /db/sql_creator.ph
            p
    \-- id_field_name - section for function id_field_name not yet defined that it should be internal helper in /db/sql_
            creator.php
...
\-- sql_db
    ...
    \-- open - section for function open not yet defined that it should be open/close the connection to MySQL in /db/sql
            _db.php
    \-- open_via_db_admin - section for function open_via_db_admin not yet defined that it should be open/close the conn
            ection to MySQL in /db/sql_db.php
    \-- is_open - section for function is_open is expected to be info in /db/sql_db.php
    \-- open_with_retry - section for function open_with_retry not yet defined that it should be open/close the connecti
            on to MySQL in /db/sql_db.php
    \-- close - section for function close not yet defined that it should be open/close the connection to MySQL in /db/s
            ql_db.php
    \-- setup - section for function setup is expected to be set and get in /db/sql_db.php
    \-- setup_db_zukunft_user_via_db_admin - section for function setup_db_zukunft_user_via_db_admin is expected to be s
            et and get in /db/sql_db.php
    \-- setup_db - section for function setup_db is expected to be set and get in /db/sql_db.php
    \-- reset_db_core - section for function reset_db_core not yet defined that it should be open/close the connection t
            o MySQL in /db/sql_db.php
    \-- run_db_truncate - section for function run_db_truncate not yet defined that it should be open/close the connecti
            on to MySQL in /db/sql_db.php
    \-- truncate_cache - section for function truncate_cache not yet defined that it should be open/close the connection
             to MySQL in /db/sql_db.php
    \-- connected - section for function connected not yet defined that it should be open/close the connection to MySQL 
            in /db/sql_db.php
    \-- db_check_missing_owner - section for function db_check_missing_owner not yet defined that it should be open/clos
            e the connection to MySQL in /db/sql_db.php
    \-- db_fill_code_links - section for function db_fill_code_links not yet defined that it should be open/close the co
            nnection to MySQL in /db/sql_db.php
    \-- db_log_code_links - section for function db_log_code_links not yet defined that it should be open/close the conn
            ection to MySQL in /db/sql_db.php
    \-- load_db_code_link_file - section for function load_db_code_link_file is expected to be load in /db/sql_db.php
    \-- db_fill_code_link_sql - section for function db_fill_code_link_sql not yet defined that it should be open/close 
            the connection to MySQL in /db/sql_db.php
    ...
    \-- add_par - section for function add_par not yet defined that it should be basic interface function for the privat
            e class parameter in /db/sql_db.php
    \-- par_name - section for function par_name not yet defined that it should be basic interface function for the priv
            ate class parameter in /db/sql_db.php
    \-- par_value - section for function par_value not yet defined that it should be basic interface function for the pr
            ivate class parameter in /db/sql_db.php
    ...
    \-- set_join_usr_num_fields - section for function set_join_usr_num_fields is expected to be set and get in /db/sql_
            db.php
    \-- set_join_usr_count_fields - section for function set_join_usr_count_fields is expected to be set and get in /db/
            sql_db.php
    \-- class_to_name - section for function class_to_name not yet defined that it should be basic interface function fo
            r the private class parameter in /db/sql_db.php
    ...
    \-- exe_try - section for function exe_try not yet defined that it should be the main database call function includi
            ng an automatic error tracking in /db/sql_db.php
    \-- exe_par - section for function exe_par not yet defined that it should be the main database call function includi
            ng an automatic error tracking in /db/sql_db.php
    \-- exe_par_msg - section for function exe_par_msg not yet defined that it should be the main database call function
             including an automatic error tracking in /db/sql_db.php
    \-- exe_prepare - section for function exe_prepare not yet defined that it should be the main database call function
             including an automatic error tracking in /db/sql_db.php
    \-- exe_direct - section for function exe_direct not yet defined that it should be TODO Prio 2 active if requested o
            r needed in /db/sql_db.php
    \-- exe - section for function exe not yet defined that it should be TODO Prio 2 active if requested or needed in /d
            b/sql_db.php
    \-- exe_script - section for function exe_script not yet defined that it should be TODO Prio 2 active if requested o
            r needed in /db/sql_db.php
    \-- exe_mysql - section for function exe_mysql not yet defined that it should be TODO Prio 2 active if requested or 
            needed in /db/sql_db.php
    \-- has_query - section for function has_query not yet defined that it should be TODO Prio 2 active if requested or 
            needed in /db/sql_db.php
    \-- mysql_array_to_types - section for function mysql_array_to_types not yet defined that it should be TODO Prio 2 a
            ctive if requested or needed in /db/sql_db.php
    \-- debug_msg - section for function debug_msg not yet defined that it should be TODO Prio 2 active if requested or 
            needed in /db/sql_db.php
    \-- get_old - section for function get_old is expected to be set and get in /db/sql_db.php
    \-- get - section for function get not yet defined that it should be TODO Prio 2 active if requested or needed in /d
            b/sql_db.php
    \-- get_internal - section for function get_internal is expected to be set and get in /db/sql_db.php
    \-- get1_internal - section for function get1_internal not yet defined that it should be TODO Prio 2 active if reque
            sted or needed in /db/sql_db.php
    \-- get1 - section for function get1 not yet defined that it should be TODO Prio 2 active if requested or needed in 
            /db/sql_db.php
    \-- get1_int - section for function get1_int not yet defined that it should be TODO Prio 2 active if requested or ne
            eded in /db/sql_db.php
    \-- get_value_2key - section for function get_value_2key is expected to be set and get in /db/sql_db.php
    \-- where_par - section for function where_par not yet defined that it should be TODO Prio 2 active if requested or 
            needed in /db/sql_db.php
    ...
    \-- set_where_link_no_fld - section for function set_where_link_no_fld is expected to be set and get in /db/sql_db.p
            hp
    ...
    \-- select_all - section for function select_all not yet defined that it should be because the object name can be us
            er-specific, in /db/sql_db.php
    \-- select_by_set_id - section for function select_by_set_id not yet defined that it should be because the object na
            me can be user-specific, in /db/sql_db.php
    \-- select_by_code_id - section for function select_by_code_id not yet defined that it should be because the object 
            name can be user-specific, in /db/sql_db.php
    \-- select_by_field - section for function select_by_field not yet defined that it should be because the object name
             can be user-specific, in /db/sql_db.php
    \-- select_by_field_list - section for function select_by_field_list not yet defined that it should be because the o
            bject name can be user-specific, in /db/sql_db.php
    \-- select_by_id_not_owner - section for function select_by_id_not_owner not yet defined that it should be because t
            he object name can be user-specific, in /db/sql_db.php
    \-- select_value_by_id_not_owner - section for function select_value_by_id_not_owner not yet defined that it should 
            be because the object name can be user-specific, in /db/sql_db.php
    \-- select_union - section for function select_union not yet defined that it should be because the object name can b
            e user-specific, in /db/sql_db.php
    \-- count - section for function count not yet defined that it should be because the object name can be user-specifi
            c, in /db/sql_db.php
    \-- par_types_to_postgres - section for function par_types_to_postgres not yet defined that it should be because the
             object name can be user-specific, in /db/sql_db.php
    \-- prepare_sql - section for function prepare_sql not yet defined that it should be because the object name can be 
            user-specific, in /db/sql_db.php
    \-- end_sql - section for function end_sql not yet defined that it should be because the object name can be user-spe
            cific, in /db/sql_db.php
    \-- select_by - section for function select_by not yet defined that it should be because the object name can be user
            -specific, in /db/sql_db.php
    \-- missing_owner_sql - section for function missing_owner_sql not yet defined that it should be because the object 
            name can be user-specific, in /db/sql_db.php
    \-- missing_owner - section for function missing_owner not yet defined that it should be because the object name can
             be user-specific, in /db/sql_db.php
    \-- set_default_owner - section for function set_default_owner is expected to be set and get in /db/sql_db.php
    \-- insert - section for function insert not yet defined that it should be because the object name can be user-speci
            fic, in /db/sql_db.php
    \-- update - section for function update not yet defined that it should be because the object name can be user-speci
            fic, in /db/sql_db.php
    \-- delete - section for function delete is expected to be del in /db/sql_db.php
    \-- name_sql_esc - section for function name_sql_esc not yet defined that it should be private supporting functions 
            in /db/sql_db.php
    \-- sf - section for function sf not yet defined that it should be private supporting functions in /db/sql_db.php
    \-- postgres_format - section for function postgres_format not yet defined that it should be private supporting func
            tions in /db/sql_db.php
    \-- mysqli_format - section for function mysqli_format not yet defined that it should be private supporting function
            s in /db/sql_db.php
    \-- sql_escape - section for function sql_escape not yet defined that it should be private supporting functions in /
            db/sql_db.php
    \-- seq_reset - section for function seq_reset not yet defined that it should be private supporting functions in /db
            /sql_db.php
    \-- has_table - section for function has_table not yet defined that it should be private supporting functions in /db
            /sql_db.php
    \-- has_column - section for function has_column not yet defined that it should be private supporting functions in /
            db/sql_db.php
    ...
    \-- add_missing_prepared - section for function add_missing_prepared not yet defined that it should be private suppo
            rting functions in /db/sql_db.php
    \-- get_prepared - section for function get_prepared is expected to be set and get in /db/sql_db.php
    \-- get_functions - section for function get_functions is expected to be set and get in /db/sql_db.php
    \-- resource_file - section for function resource_file not yet defined that it should be private supporting function
            s in /db/sql_db.php
    \-- has_key - section for function has_key not yet defined that it should be private supporting functions in /db/sql
            _db.php
    \-- add_foreign_key - section for function add_foreign_key not yet defined that it should be private supporting func
            tions in /db/sql_db.php
    \-- add_column - section for function add_column not yet defined that it should be private supporting functions in /
            db/sql_db.php
    \-- del_field - section for function del_field is expected to be del in /db/sql_db.php
    \-- change_column_name - section for function change_column_name not yet defined that it should be private supportin
            g functions in /db/sql_db.php
    \-- change_table_name - section for function change_table_name not yet defined that it should be private supporting 
            functions in /db/sql_db.php
    \-- column_allow_null - section for function column_allow_null not yet defined that it should be private supporting 
            functions in /db/sql_db.php
    \-- column_force_not_null - section for function column_force_not_null not yet defined that it should be private sup
            porting functions in /db/sql_db.php
    \-- remove_prefix_sql - section for function remove_prefix_sql not yet defined that it should be private supporting 
            functions in /db/sql_db.php
    \-- remove_prefix - section for function remove_prefix not yet defined that it should be private supporting function
            s in /db/sql_db.php
    \-- change_code_id - section for function change_code_id not yet defined that it should be private supporting functi
            ons in /db/sql_db.php
    \-- get_column_names - section for function get_column_names is expected to be set and get in /db/sql_db.php
    \-- check_column_names - section for function check_column_names not yet defined that it should be private supportin
            g functions in /db/sql_db.php
    \-- sql_setup_header - section for function sql_setup_header not yet defined that it should be private supporting fu
            nctions in /db/sql_db.php
    \-- sql_setup_footer - section for function sql_setup_footer not yet defined that it should be private supporting fu
            nctions in /db/sql_db.php
    \-- sql_separator_index - section for function sql_separator_index not yet defined that it should be private support
            ing functions in /db/sql_db.php
    \-- sql_separator_foreign_key - section for function sql_separator_foreign_key not yet defined that it should be pri
            vate supporting functions in /db/sql_db.php
    \-- sql_creator - section for function sql_creator not yet defined that it should be private supporting functions in
             /db/sql_db.php
    \-- path - section for function path not yet defined that it should be private supporting functions in /db/sql_db.ph
            p
    \-- ext - section for function ext not yet defined that it should be private supporting functions in /db/sql_db.php
    \-- truncate_table_all - section for function truncate_table_all not yet defined that it should be private supportin
            g functions in /db/sql_db.php
    \-- truncate_table - section for function truncate_table not yet defined that it should be private supporting functi
            ons in /db/sql_db.php
    \-- drop_table - section for function drop_table not yet defined that it should be private supporting functions in /
            db/sql_db.php
    \-- drop_view - section for function drop_view not yet defined that it should be private supporting functions in /db
            /sql_db.php
    \-- reset_seq_all - section for function reset_seq_all not yet defined that it should be private supporting function
            s in /db/sql_db.php
    \-- reset_seq - section for function reset_seq not yet defined that it should be private supporting functions in /db
            /sql_db.php
    \-- load_user_profiles - section for function load_user_profiles is expected to be load in /db/sql_db.php
    \-- reset_config - section for function reset_config not yet defined that it should be private supporting functions 
            in /db/sql_db.php
    \-- import_system_users - section for function import_system_users not yet defined that it should be private support
            ing functions in /db/sql_db.php
    \-- add_admin_users_from_env - section for function add_admin_users_from_env not yet defined that it should be priva
            te supporting functions in /db/sql_db.php
    \-- import_verbs - section for function import_verbs not yet defined that it should be private supporting functions 
            in /db/sql_db.php
    \-- create_internal_words - section for function create_internal_words not yet defined that it should be private sup
            porting functions in /db/sql_db.php
    \-- import_system_views - section for function import_system_views not yet defined that it should be private support
            ing functions in /db/sql_db.php
    \-- csv_from_class - section for function csv_from_class not yet defined that it should be private supporting functi
            ons in /db/sql_db.php
    \-- order error - order of section basic interface function for the private class parameter has difference at set_na
            me should be before set_usr
\-- sql_field_list
    ...
    \-- name - section for function name is expected to be debug in /db/sql_field_list.php
...
\-- sql_message
    \-- __construct - section for function __construct is expected to be construct and map in /db/sql_message.php
    \-- reset - section for function reset is expected to be construct and map in /db/sql_message.php
    \-- clone_reset - section for function clone_reset missing in /db/sql_message.php
    \-- url - section for function url not yet defined that it should be set and get in /db/sql_message.php
    \-- checksum - section for function checksum not yet defined that it should be set and get in /db/sql_message.php
    \-- db_row_id_lst - section for function db_row_id_lst not yet defined that it should be set and get in /db/sql_mess
            age.php
    \-- added_depending - section for function added_depending not yet defined that it should be set and get in /db/sql_
            message.php
    \-- api_array - section for function api_array not yet defined that it should be api in /db/sql_message.php
    \-- api_json - section for function api_json not yet defined that it should be api in /db/sql_message.php
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /db/sql_message.php
    \-- add_info_with_vars - section for function add_info_with_vars not yet defined that it should be add in /db/sql_me
            ssage.php
    \-- add_warning_with_vars - section for function add_warning_with_vars not yet defined that it should be add in /db/
            sql_message.php
    \-- add_type_message - section for function add_type_message not yet defined that it should be add in /db/sql_messag
            e.php
    \-- add_message_text - section for function add_message_text not yet defined that it should be add in /db/sql_messag
            e.php
    \-- add_warning_text - section for function add_warning_text not yet defined that it should be add in /db/sql_messag
            e.php
    \-- add_info_text - section for function add_info_text not yet defined that it should be add in /db/sql_message.php
    \-- merge - section for function merge not yet defined that it should be add in /db/sql_message.php
    \-- add_list_name_id - section for function add_list_name_id not yet defined that it should be add in /db/sql_messag
            e.php
    \-- set_added_depending - section for function set_added_depending is expected to be set and get in /db/sql_message.
            php
    \-- unset_added_depending - section for function unset_added_depending not yet defined that it should be add in /db/
            sql_message.php
    \-- is_ok - section for function is_ok is expected to be info in /db/sql_message.php
    \-- all_info_text - section for function all_info_text not yet defined that it should be get in /db/sql_message.php
    \-- all_message_text - section for function all_message_text not yet defined that it should be get in /db/sql_messag
            e.php
...
\-- sql_par_field_list
    ...
    \-- add_id_link_and_user - section for function add_id_link_and_user missing in /db/sql_par_field_list.php
    ...
    \-- is_empty - section for function is_empty is expected to be info in /db/sql_par_field_list.php
    \-- is_empty_except_internal_fields - section for function is_empty_except_internal_fields is expected to be info in
             /db/sql_par_field_list.php
    \-- is_empty_except_id_and_internal_fields - section for function is_empty_except_id_and_internal_fields is expected
             to be info in /db/sql_par_field_list.php
    ...
    \-- order error - order of section  has difference at get should be before types
\-- sql_par_list
    ...
    \-- is_empty - section for function is_empty is expected to be info in /db/sql_par_list.php
    \-- exe - section for function exe missing in /db/sql_par_list.php
    \-- exe_direct - section for function exe_direct missing in /db/sql_par_list.php
    ...
    \-- sql_functions_missing - section for function sql_functions_missing not yet defined that it should be filter in /
            db/sql_par_list.php
    \-- order error - order of section  has difference at names should be before add_by_name
\-- 
    \-- echo_timestamped - section for function echo_timestamped missing in /log_text/text_log_functions.php
    \-- php_error_label - section for function php_error_label missing in /log_text/text_log_functions.php
    \-- log_php_error_timestamped - section for function log_php_error_timestamped is expected to be log in /log_text/te
            xt_log_functions.php
    \-- log_php_exception_timestamped - section for function log_php_exception_timestamped is expected to be log in /log
            _text/text_log_functions.php
    \-- log_php_exception_to_error_log - section for function log_php_exception_to_error_log is expected to be log in /l
            og_text/text_log_functions.php
    ...
    \-- log_err_msg - section for function log_err_msg is expected to be log in /log_text/text_log_functions.php
    \-- log_err_msg_ui - section for function log_err_msg_ui is expected to be log in /log_text/text_log_functions.php
    \-- log_warning_msg - section for function log_warning_msg is expected to be log in /log_text/text_log_functions.php
    \-- log_missing_overwrite - section for function log_missing_overwrite is expected to be log in /log_text/text_log_f
            unctions.php
    \-- log_missing_overwrite_warning - section for function log_missing_overwrite_warning is expected to be log in /log
            _text/text_log_functions.php
    \-- missing_overwrite_text - section for function missing_overwrite_text missing in /log_text/text_log_functions.php
    \-- log_warning_msg_ui - section for function log_warning_msg_ui is expected to be log in /log_text/text_log_functio
            ns.php
    ...
    \-- critical_error_html - section for function critical_error_html missing in /log_text/text_log_functions.php
    \-- sys_log_insert_allowed - section for function sys_log_insert_allowed missing in /log_text/text_log_functions.php
...
\-- sql_type_list
    ...
    \-- no_log - section for function no_log not yet defined that it should be info sql type in /db/sql_type_list.php
    \-- no_id_field - section for function no_id_field not yet defined that it should be info sql type in /db/sql_type_l
            ist.php
    ...
    \-- value_table_type - section for function value_table_type not yet defined that it should be info for value table 
            selection in /db/sql_type_list.php
    \-- is_usr_tbl - section for function is_usr_tbl is expected to be info in /db/sql_type_list.php
    \-- is_usr_tbl_and_select - section for function is_usr_tbl_and_select is expected to be info in /db/sql_type_list.p
            hp
    \-- is_norm - section for function is_norm is expected to be info in /db/sql_type_list.php
    \-- is_standard - section for function is_standard is expected to be info in /db/sql_type_list.php
    \-- get_all - section for function get_all is expected to be set and get in /db/sql_type_list.php
    \-- is_geo - section for function is_geo is expected to be info in /db/sql_type_list.php
    \-- is_sub_tbl - section for function is_sub_tbl is expected to be info in /db/sql_type_list.php
\-- element
    \-- clone_all - section for function clone_all not yet defined that it should be construct and map in /element/eleme
            nt.php
    \-- name - section for function name is expected to be debug in /element/element.php
    \-- trm_id - section for function trm_id not yet defined that it should be set and get in /element/element.php
    \-- term - section for function term is expected to be cast in /element/element.php
    \-- type - section for function type not yet defined that it should be set and get in /element/element.php
    ...
    \-- is_excluded - section for function is_excluded is expected to be info in /element/element.php
    \-- is_word - section for function is_word is expected to be info in /element/element.php
    \-- is_triple - section for function is_triple is expected to be info in /element/element.php
    \-- is_verb - section for function is_verb is expected to be info in /element/element.php
    ...
    \-- validate_type - section for function validate_type not yet defined that it should be validate in /element/elemen
            t.php
    \-- sql_update - section for function sql_update not yet defined that it should be sql write in /element/element.php
    \-- sql_prepare - section for function sql_prepare not yet defined that it should be sql write in /element/element.p
            hp
    \-- sql_delete - section for function sql_delete not yet defined that it should be sql write in /element/element.php
\-- element_group
    \-- api_json_array - section for function api_json_array is expected to be api in /element/element_group.php
    ...
    \-- build_symbol - section for function build_symbol not yet defined that it should be display in /element/element_g
            roup.php
...
\-- element_list
    \-- term_list - section for function term_list not yet defined that it should be set and get in /element/element_lis
            t.php
    \-- load_sql_by_frm_id - section for function load_sql_by_frm_id is expected to be load sql in /element/element_list
            .php
    \-- load_sql_by_frm_and_type_id - section for function load_sql_by_frm_and_type_id is expected to be load sql in /el
            ement/element_list.php
    \-- get_by_link_id - section for function get_by_link_id is expected to be set and get in /element/element_list.php
    \-- ids - section for function ids not yet defined that it should be info in /element/element_list.php
    \-- add_by_link - section for function add_by_link not yet defined that it should be modify in /element/element_list
            .php
    \-- add - section for function add not yet defined that it should be modify in /element/element_list.php
    \-- merge - section for function merge not yet defined that it should be modify in /element/element_list.php
    \-- diff - section for function diff not yet defined that it should be filter in /element/element_list.php
    \-- predefined_following - section for function predefined_following not yet defined that it should be filter in /el
            ement/element_list.php
    \-- unique - section for function unique not yet defined that it should be filter in /element/element_list.php
\-- export
    \-- get - section for function get not yet defined that it should be set and get in /export/export.php
\-- export_type_list
    \-- __construct - section for function __construct is expected to be construct and map in /export/export_type_list.p
            hp
...
\-- expression
    \-- term_id_list - section for function term_id_list not yet defined that it should be id lists in /formula/expressi
            on.php
    \-- phrase_id_list - section for function phrase_id_list not yet defined that it should be id lists in /formula/expr
            ession.php
    \-- term_id_list_all - section for function term_id_list_all not yet defined that it should be id lists in /formula/
            expression.php
    \-- element_list - section for function element_list not yet defined that it should be objects in /formula/expressio
            n.php
    \-- elements_incl_result_phrases - section for function elements_incl_result_phrases not yet defined that it should 
            be objects in /formula/expression.php
    \-- result_phrases - section for function result_phrases not yet defined that it should be objects in /formula/expre
            ssion.php
    \-- terms - section for function terms not yet defined that it should be objects in /formula/expression.php
    \-- phrases - section for function phrases not yet defined that it should be filter in /formula/expression.php
    \-- is_valid - section for function is_valid is expected to be check in /formula/expression.php
    ...
    \-- terms_missing - section for function terms_missing not yet defined that it should be info in /formula/expression
            .php
    \-- terms_following - section for function terms_following not yet defined that it should be info in /formula/expres
            sion.php
    \-- load_result_phrases - section for function load_result_phrases is expected to be load in /formula/expression.php
    \-- element_special_following_frm - section for function element_special_following_frm not yet defined that it shoul
            d be filter elements in /formula/expression.php
    \-- phr_id_lst - section for function phr_id_lst not yet defined that it should be internal in /formula/expression.p
            hp
    \-- phr_id_lst_as_phr_lst - section for function phr_id_lst_as_phr_lst not yet defined that it should be internal in
             /formula/expression.php
    \-- get_usr_names - section for function get_usr_names is expected to be set and get in /formula/expression.php
    \-- element_part_list_old - section for function element_part_list_old not yet defined that it should be extract hel
            per in /formula/expression.php
    \-- get_ref_id - section for function get_ref_id is expected to be set and get in /formula/expression.php
    \-- phr_verb_lst - section for function phr_verb_lst not yet defined that it should be to review in /formula/express
            ion.php
    \-- get_triple_symbol - section for function get_triple_symbol is expected to be set and get in /formula/expression.
            php
    \-- load_verb - section for function load_verb is expected to be load in /formula/expression.php
    \-- element_grp_lst - section for function element_grp_lst not yet defined that it should be review in /formula/expr
            ession.php
\-- fig_ids
    \-- order error - order of section  has difference at count should be before __construct
\-- figure
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /formula/fig
            ure.php
    ...
    \-- is_readable_by - section for function is_readable_by is expected to be info in /formula/figure.php
    \-- number - section for function number not yet defined that it should be set and get in /formula/figure.php
    \-- last_update - section for function last_update not yet defined that it should be set and get in /formula/figure.
            php
    \-- is_std - section for function is_std is expected to be info in /formula/figure.php
    \-- is_result - section for function is_result is expected to be info in /formula/figure.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper
\-- figure_list
    ...
    \-- filter_readable_by - section for function filter_readable_by not yet defined that it should be modify in /formul
            a/figure_list.php
...
\-- formula_link_list
    ...
    \-- load_sql_by_frm_id - section for function load_sql_by_frm_id is expected to be load sql in /formula/formula_link
            _list.php
    \-- load_sql_by_ids - section for function load_sql_by_ids is expected to be load sql in /formula/formula_link_list.
            php
    \-- phrase_ids - section for function phrase_ids not yet defined that it should be load in /formula/formula_link_lis
            t.php
    \-- del_without_log - section for function del_without_log is expected to be del in /formula/formula_link_list.php
\-- formula_link_type
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
             in /formula/formula_link_type.php
...
\-- formula_list
    ...
    \-- load_sql_by_names - section for function load_sql_by_names is expected to be load sql in /formula/formula_list.p
            hp
    ...
    \-- load_sql_by_phr_lst - section for function load_sql_by_phr_lst is expected to be load sql in /formula/formula_li
            st.php
    \-- load_sql_by_ref - section for function load_sql_by_ref is expected to be load sql in /formula/formula_list.php
    \-- load_sql_by_word_ref - section for function load_sql_by_word_ref is expected to be load sql in /formula/formula_
            list.php
    \-- load_sql_by_triple_ref - section for function load_sql_by_triple_ref is expected to be load sql in /formula/form
            ula_list.php
    \-- load_sql_by_verb_ref - section for function load_sql_by_verb_ref is expected to be load sql in /formula/formula_
            list.php
    \-- load_sql_by_formula_ref - section for function load_sql_by_formula_ref is expected to be load sql in /formula/fo
            rmula_list.php
    ...
    \-- remove - section for function remove not yet defined that it should be select in /formula/formula_list.php
    \-- count_db - section for function count_db not yet defined that it should be info in /formula/formula_list.php
    \-- term_lst_of_names - section for function term_lst_of_names not yet defined that it should be info in /formula/fo
            rmula_list.php
    \-- db_ref_refresh - section for function db_ref_refresh not yet defined that it should be upgrade functions in /for
            mula/formula_list.php
    \-- name - section for function name is expected to be debug in /formula/formula_list.php
    \-- names - section for function names is expected to be info in /formula/formula_list.php
    \-- calc_blocks - section for function calc_blocks not yet defined that it should be display in /formula/formula_lis
            t.php
    \-- save_with_cache - section for function save_with_cache is expected to be save in /formula/formula_list.php
    \-- term_list - section for function term_list not yet defined that it should be convert in /formula/formula_list.ph
            p
    \-- missing_ids - section for function missing_ids not yet defined that it should be convert in /formula/formula_lis
            t.php
    \-- save_with_cache_slow - section for function save_with_cache_slow is expected to be save in /formula/formula_list
            .php
    \-- get_ready - section for function get_ready is expected to be save helper in /formula/formula_list.php
    \-- fill_by_name - section for function fill_by_name not yet defined that it should be convert in /formula/formula_l
            ist.php
    \-- order error - order of section load has difference at load_by_ids should be before load_sql_by_names
\-- group_id
    \-- get_id - section for function get_id is expected to be set and get in /group/group_id.php
    \-- max_number_of_phrase - section for function max_number_of_phrase not yet defined that it should be database link
             in /group/group_id.php
    ...
    \-- is_valid - section for function is_valid is expected to be check in /group/group_id.php
    \-- table_extension - section for function table_extension not yet defined that it should be database link in /group
            /group_id.php
    \-- table_type - section for function table_type not yet defined that it should be database link in /group/group_id.
            php
    \-- table_extension_list - section for function table_extension_list not yet defined that it should be database link
             in /group/group_id.php
    \-- is_prime - section for function is_prime is expected to be info in /group/group_id.php
...
\-- group_list
    ...
    \-- load_sql_by_phr_single - section for function load_sql_by_phr_single is expected to be load sql in /group/group_
            list.php
    ...
    \-- get_by_val_special - section for function get_by_val_special is expected to be set and get in /group/group_list.
            php
    \-- get_by_res_with_one_phr_each - section for function get_by_res_with_one_phr_each is expected to be set and get i
            n /group/group_list.php
    \-- get_by_res_special - section for function get_by_res_special is expected to be set and get in /group/group_list.
            php
    \-- remove_wrd_lst - section for function remove_wrd_lst not yet defined that it should be add in /group/group_list.
            php
    \-- common_phrases - section for function common_phrases not yet defined that it should be info in /group/group_list
            .php
...
\-- combine_named
    ...
    \-- name - section for function name is expected to be debug in /helper/combine_named.php
    \-- type_id - section for function type_id not yet defined that it should be set and get in /helper/combine_named.ph
            p
    \-- exclude - section for function exclude not yet defined that it should be set and get in /helper/combine_named.ph
            p
    \-- include - section for function include not yet defined that it should be set and get in /helper/combine_named.ph
            p
    \-- is_excluded - section for function is_excluded is expected to be info in /helper/combine_named.php
    \-- is_exclusion_set - section for function is_exclusion_set is expected to be info in /helper/combine_named.php
    \-- sql_view - section for function sql_view not yet defined that it should be SQL creation in /helper/combine_named
            .php
    \-- sql_create_view - section for function sql_create_view not yet defined that it should be SQL creation in /helper
            /combine_named.php
\-- combine_object
    ...
    \-- db_ready - section for function db_ready is expected to be check in /helper/combine_object.php
\-- config_numbers
    \-- fill_from_cache_json - section for function fill_from_cache_json not yet defined that it should be load in /help
            er/config_numbers.php
    \-- default_json - section for function default_json not yet defined that it should be default in /helper/config_num
            bers.php
    \-- language - section for function language not yet defined that it should be predefined in /helper/config_numbers.
            php
    \-- cache_allowed - section for function cache_allowed not yet defined that it should be predefined in /helper/confi
            g_numbers.php
...
\-- data_object
    ...
    \-- word_list - section for function word_list not yet defined that it should be set and get in /helper/data_object.
            php
    \-- verb_list - section for function verb_list not yet defined that it should be set and get in /helper/data_object.
            php
    \-- triple_list - section for function triple_list not yet defined that it should be set and get in /helper/data_obj
            ect.php
    ...
    \-- reference_list - section for function reference_list not yet defined that it should be set and get in /helper/da
            ta_object.php
    \-- value_list - section for function value_list is expected to be related in /helper/data_object.php
    \-- formula_list - section for function formula_list not yet defined that it should be set and get in /helper/data_o
            bject.php
    \-- formula_link_list - section for function formula_link_list not yet defined that it should be set and get in /hel
            per/data_object.php
    \-- result_list - section for function result_list not yet defined that it should be set and get in /helper/data_obj
            ect.php
    \-- result_check_list - section for function result_check_list not yet defined that it should be set and get in /hel
            per/data_object.php
    \-- view_list - section for function view_list not yet defined that it should be set and get in /helper/data_object.
            php
    \-- component_list - section for function component_list not yet defined that it should be set and get in /helper/da
            ta_object.php
    \-- term_view_list - section for function term_view_list not yet defined that it should be set and get in /helper/da
            ta_object.php
    \-- user_list - section for function user_list not yet defined that it should be set and get in /helper/data_object.
            php
    \-- ip_range_list - section for function ip_range_list not yet defined that it should be set and get in /helper/data
            _object.php
    \-- view_relation_types - section for function view_relation_types not yet defined that it should be set and get in 
            /helper/data_object.php
    \-- get_object_by_name - section for function get_object_by_name is expected to be set and get in /helper/data_objec
            t.php
    ...
    \-- get_phrase_by_name - section for function get_phrase_by_name is expected to be set and get in /helper/data_objec
            t.php
    \-- get_source_by_name - section for function get_source_by_name is expected to be set and get in /helper/data_objec
            t.php
    \-- get_formula_by_id - section for function get_formula_by_id is expected to be set and get in /helper/data_object.
            php
    \-- get_formula_by_name - section for function get_formula_by_name is expected to be set and get in /helper/data_obj
            ect.php
    \-- get_term_by_name - section for function get_term_by_name is expected to be set and get in /helper/data_object.ph
            p
    \-- get_view_by_name - section for function get_view_by_name is expected to be set and get in /helper/data_object.ph
            p
    \-- load - section for function load not yet defined that it should be load in /helper/data_object.php
    \-- has_view_list - section for function has_view_list not yet defined that it should be info in /helper/data_object
            .php
    ...
    \-- add_reference - section for function add_reference not yet defined that it should be modify in /helper/data_obje
            ct.php
    \-- add_formula - section for function add_formula not yet defined that it should be modify in /helper/data_object.p
            hp
    \-- add_formula_without_ready_check - section for function add_formula_without_ready_check not yet defined that it s
            hould be modify in /helper/data_object.php
    ...
    \-- add_component - section for function add_component not yet defined that it should be modify in /helper/data_obje
            ct.php
    \-- add_term_view - section for function add_term_view not yet defined that it should be modify in /helper/data_obje
            ct.php
    \-- add_user - section for function add_user not yet defined that it should be modify in /helper/data_object.php
    \-- add_ip_range - section for function add_ip_range not yet defined that it should be modify in /helper/data_object
            .php
    ...
    \-- add_calc_validation - section for function add_calc_validation not yet defined that it should be modify in /help
            er/data_object.php
    ...
    \-- validate_results - section for function validate_results not yet defined that it should be export in /helper/dat
            a_object.php
    \-- add_message - section for function add_message not yet defined that it should be export in /helper/data_object.p
            hp
    \-- get_component_by_name - section for function get_component_by_name is expected to be set and get in /helper/data
            _object.php
    \-- get_value_by_names - section for function get_value_by_names is expected to be set and get in /helper/data_objec
            t.php
    \-- expected_word_import_time - section for function expected_word_import_time not yet defined that it should be exp
            ort in /helper/data_object.php
    \-- expected_triple_import_time - section for function expected_triple_import_time not yet defined that it should be
             export in /helper/data_object.php
    \-- expected_value_import_time - section for function expected_value_import_time not yet defined that it should be e
            xport in /helper/data_object.php
    \-- expected_total_import_time - section for function expected_total_import_time not yet defined that it should be e
            xport in /helper/data_object.php
    ...
    \-- order error - order of section api has difference at api_array should be before api_json
\-- db_cache
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /helper/db_c
            ache.php
    \-- load_sql_by_type_id - section for function load_sql_by_type_id is expected to be load sql in /helper/db_cache.ph
            p
...
\-- db_id_object_non_sandbox
    ...
    \-- is_value_obj - section for function is_value_obj is expected to be info in /helper/db_id_object_non_sandbox.php
    \-- sql_delete - section for function sql_delete not yet defined that it should be sql in /helper/db_id_object_non_s
            andbox.php
    \-- load_by_ip - section for function load_by_ip is expected to be load in /helper/db_id_object_non_sandbox.php
    \-- load_by_email - section for function load_by_email is expected to be load in /helper/db_id_object_non_sandbox.ph
            p
    \-- key_field - section for function key_field not yet defined that it should be overwrite in /helper/db_id_object_n
            on_sandbox.php
    \-- import_mapper - section for function import_mapper is expected to be construct and map in /helper/db_id_object_n
            on_sandbox.php
\-- db_object
    \-- sql_table_create - section for function sql_table_create not yet defined that it should be sql create in /helper
            /db_object.php
    \-- sql_truncate_create - section for function sql_truncate_create not yet defined that it should be sql create in /
            helper/db_object.php
    \-- sql_index_create - section for function sql_index_create not yet defined that it should be sql create in /helper
            /db_object.php
    \-- sql_foreign_key_create - section for function sql_foreign_key_create not yet defined that it should be sql creat
            e in /helper/db_object.php
    \-- row_mapper - section for function row_mapper not yet defined that it should be map in /helper/db_object.php
    ...
    \-- log_name_field - section for function log_name_field is expected to be log in /helper/db_object.php
\-- db_object_key
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /helper/db_o
            bject_key.php
    \-- sql_table_create - section for function sql_table_create not yet defined that it should be sql create in /helper
            /db_object_key.php
    \-- sql_truncate_create - section for function sql_truncate_create not yet defined that it should be sql create in /
            helper/db_object_key.php
    \-- sql_index_create - section for function sql_index_create not yet defined that it should be sql create in /helper
            /db_object_key.php
    \-- sql_foreign_key_create - section for function sql_foreign_key_create not yet defined that it should be sql creat
            e in /helper/db_object_key.php
    ...
    \-- load_sql_by_id_str - section for function load_sql_by_id_str is expected to be load sql in /helper/db_object_key
            .php
    \-- id_field - section for function id_field not yet defined that it should be info in /helper/db_object_key.php
\-- db_object_multi
    \-- row_mapper_multi - section for function row_mapper_multi not yet defined that it should be construct and map in 
            /helper/db_object_multi.php
    ...
    \-- load_by_id_with_related - section for function load_by_id_with_related is expected to be load in /helper/db_obje
            ct_multi.php
\-- db_object_multi_user
    \-- dsp_id_user - section for function dsp_id_user not yet defined that it should be debug in /helper/db_object_mult
            i_user.php
\-- db_object_no_id
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /helper/db_o
            bject_no_id.php
    \-- sql_table_create - section for function sql_table_create not yet defined that it should be sql create in /helper
            /db_object_no_id.php
    \-- sql_truncate_create - section for function sql_truncate_create not yet defined that it should be sql create in /
            helper/db_object_no_id.php
    \-- sql_index_create - section for function sql_index_create not yet defined that it should be sql create in /helper
            /db_object_no_id.php
    \-- sql_foreign_key_create - section for function sql_foreign_key_create not yet defined that it should be sql creat
            e in /helper/db_object_no_id.php
    ...
    \-- load_sql_by_id_str - section for function load_sql_by_id_str is expected to be load sql in /helper/db_object_no_
            id.php
    \-- id_field - section for function id_field not yet defined that it should be info in /helper/db_object_no_id.php
\-- db_object_seq_id
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /helper/db_o
            bject_seq_id.php
    \-- sql_table - section for function sql_table not yet defined that it should be sql create in /helper/db_object_seq
            _id.php
    \-- sql_index - section for function sql_index not yet defined that it should be sql create in /helper/db_object_seq
            _id.php
    \-- sql_foreign_key - section for function sql_foreign_key not yet defined that it should be sql create in /helper/d
            b_object_seq_id.php
    ...
    \-- import_mapper - section for function import_mapper is expected to be construct and map in /helper/db_object_seq_
            id.php
    \-- has_id - section for function has_id not yet defined that it should be info in /helper/db_object_seq_id.php
    \-- delta - section for function delta is expected to be del in /helper/db_object_seq_id.php
    \-- name - section for function name is expected to be debug in /helper/db_object_seq_id.php
    \-- name_or_null - section for function name_or_null not yet defined that it should be overwrite in /helper/db_objec
            t_seq_id.php
    ...
    \-- db_add - section for function db_add not yet defined that it should be save in /helper/db_object_seq_id.php
    \-- db_update - section for function db_update not yet defined that it should be save in /helper/db_object_seq_id.ph
            p
    \-- db_update_row - section for function db_update_row not yet defined that it should be save in /helper/db_object_s
            eq_id.php
    \-- del - section for function del is expected to be del in /helper/db_object_seq_id.php
    \-- sql_update - section for function sql_update not yet defined that it should be sql write in /helper/db_object_se
            q_id.php
    \-- sql_delete - section for function sql_delete not yet defined that it should be sql write in /helper/db_object_se
            q_id.php
    \-- sql_write - section for function sql_write not yet defined that it should be sql write in /helper/db_object_seq_
            id.php
    \-- sql_write_log - section for function sql_write_log not yet defined that it should be sql write in /helper/db_obj
            ect_seq_id.php
    \-- sql_write_update - section for function sql_write_update not yet defined that it should be sql write in /helper/
            db_object_seq_id.php
    \-- sql_write_call - section for function sql_write_call not yet defined that it should be sql write in /helper/db_o
            bject_seq_id.php
    \-- sql_write_no_log - section for function sql_write_no_log not yet defined that it should be sql write in /helper/
            db_object_seq_id.php
    \-- has_db_id - section for function has_db_id not yet defined that it should be db helper in /helper/db_object_seq_
            id.php
    \-- can_be_added_by - section for function can_be_added_by not yet defined that it should be db helper in /helper/db
            _object_seq_id.php
    \-- can_be_changed_by - section for function can_be_changed_by not yet defined that it should be db helper in /helpe
            r/db_object_seq_id.php
    \-- can_be_deleted_by - section for function can_be_deleted_by not yet defined that it should be db helper in /helpe
            r/db_object_seq_id.php
    \-- get_similar - section for function get_similar is expected to be save in /helper/db_object_seq_id.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper
\-- db_object_seq_id_user
    \-- clone_all - section for function clone_all not yet defined that it should be construct and map in /helper/db_obj
            ect_seq_id_user.php
    \-- clone_reset - section for function clone_reset not yet defined that it should be construct and map in /helper/db
            _object_seq_id_user.php
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /helper/db_o
            bject_seq_id_user.php
    \-- delta - section for function delta is expected to be del in /helper/db_object_seq_id_user.php
    \-- dsp_id_user - section for function dsp_id_user not yet defined that it should be debug in /helper/db_object_seq_
            id_user.php
    \-- order error - order of section construct and map has difference at row_mapper should be before clone_reset,
            order of section info has difference at delta should be before diff_msg
\-- object_mapper
    \-- get_term - section for function get_term is expected to be set and get in /helper/object_mapper.php
    \-- get_view - section for function get_view is expected to be set and get in /helper/object_mapper.php
    \-- get_source - section for function get_source is expected to be set and get in /helper/object_mapper.php
\-- system_object
    \-- user_log - section for function user_log not yet defined that it should be user in /helper/system_object.php
    \-- view_relation_types - section for function view_relation_types not yet defined that it should be interface in /h
            elper/system_object.php
    \-- view_relation_name - section for function view_relation_name not yet defined that it should be interface in /hel
            per/system_object.php
    \-- view_relation_code_id - section for function view_relation_code_id not yet defined that it should be interface i
            n /helper/system_object.php
    ...
    \-- admin_user - section for function admin_user not yet defined that it should be interface in /helper/system_objec
            t.php
    \-- add_verb - section for function add_verb not yet defined that it should be modify in /helper/system_object.php
\-- type_list
    \-- get_or_insert - section for function get_or_insert is expected to be set and get in /helper/type_list.php
    ...
    \-- class_to_type_object - section for function class_to_type_object not yet defined that it should be database (dao
            ) functions in /helper/type_list.php
    \-- fill_from_api_rows - section for function fill_from_api_rows not yet defined that it should be database (dao) fu
            nctions in /helper/type_list.php
    \-- load - section for function load not yet defined that it should be database (dao) functions in /helper/type_list
            .php
    ...
    \-- id_by_name - section for function id_by_name not yet defined that it should be im- and export in /helper/type_li
            st.php
    \-- name - section for function name is expected to be debug in /helper/type_list.php
    \-- name_or_null - section for function name_or_null not yet defined that it should be im- and export in /helper/typ
            e_list.php
    \-- code_id - section for function code_id not yet defined that it should be im- and export in /helper/type_list.php
    \-- has - section for function has not yet defined that it should be info in /helper/type_list.php
    ...
    \-- view_id_list - section for function view_id_list not yet defined that it should be unit test support functions i
            n /helper/type_list.php
    \-- component_id_list - section for function component_id_list not yet defined that it should be unit test support f
            unctions in /helper/type_list.php
\-- type_lists
    \-- from_cache - section for function from_cache not yet defined that it should be load in /helper/type_lists.php
    \-- reload_if_cache_denied - section for function reload_if_cache_denied is expected to be related in /helper/type_l
            ists.php
    \-- fill_from_api_json - section for function fill_from_api_json not yet defined that it should be load in /helper/t
            ype_lists.php
...
\-- type_object
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
             in /helper/type_object.php
    \-- name - section for function name is expected to be debug in /helper/type_object.php
    \-- load_by_name - section for function load_by_name is expected to be load in /helper/type_object.php
    \-- load_by_code_id - section for function load_by_code_id is expected to be load in /helper/type_object.php
    \-- load_sql_by_id - section for function load_sql_by_id is expected to be load sql in /helper/type_object.php
    \-- load_sql_by_id_fwd - section for function load_sql_by_id_fwd is expected to be load sql in /helper/type_object.p
            hp
    \-- load_sql_by_name - section for function load_sql_by_name is expected to be load sql in /helper/type_object.php
    \-- load_sql_by_code_id - section for function load_sql_by_code_id is expected to be load sql in /helper/type_object
            .php
    \-- get_similar - section for function get_similar is expected to be save in /helper/type_object.php
    \-- similar_message - section for function similar_message not yet defined that it should be similar in /helper/type
            _object.php
    \-- is_similar - section for function is_similar is expected to be info in /helper/type_object.php
    \-- id_used_msg - section for function id_used_msg not yet defined that it should be similar in /helper/type_object.
            php
    \-- is_same - section for function is_same is expected to be info in /helper/type_object.php
    \-- no_diff - section for function no_diff not yet defined that it should be compare in /helper/type_object.php
    \-- no_non_id_diff - section for function no_non_id_diff not yet defined that it should be compare in /helper/type_o
            bject.php
    \-- delta - section for function delta is expected to be del in /helper/type_object.php
    \-- sql_table - section for function sql_table not yet defined that it should be sql create in /helper/type_object.p
            hp
    \-- sql_index - section for function sql_index not yet defined that it should be sql create in /helper/type_object.p
            hp
    \-- sql_write - section for function sql_write not yet defined that it should be sql write in /helper/type_object.ph
            p
    \-- check - section for function check not yet defined that it should be db helper in /helper/type_object.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper_typ_ob
            j,order of section set and get has difference at set_description should be before set_from_api
...
\-- import
    ...
    \-- display_progress - section for function display_progress not yet defined that it should be use to apply the time
             of the parent process for continuous timestamp reporting in /import/import.php
    \-- put_yaml - section for function put_yaml not yet defined that it should be use to apply the time of the parent p
            rocess for continuous timestamp reporting in /import/import.php
    \-- put_json - section for function put_json not yet defined that it should be use to apply the time of the parent p
            rocess for continuous timestamp reporting in /import/import.php
    \-- put_json_direct - section for function put_json_direct not yet defined that it should be use to apply the time o
            f the parent process for continuous timestamp reporting in /import/import.php
    \-- get_data_object - section for function get_data_object is expected to be set and get in /import/import.php
    \-- step_main_start - section for function step_main_start not yet defined that it should be use to apply the time o
            f the parent process for continuous timestamp reporting in /import/import.php
    \-- step_main_end - section for function step_main_end not yet defined that it should be use to apply the time of th
            e parent process for continuous timestamp reporting in /import/import.php
    \-- step_start - section for function step_start not yet defined that it should be use to apply the time of the pare
            nt process for continuous timestamp reporting in /import/import.php
    \-- step_end - section for function step_end not yet defined that it should be use to apply the time of the parent p
            rocess for continuous timestamp reporting in /import/import.php
    \-- calc_total_time - section for function calc_total_time not yet defined that it should be use to apply the time o
            f the parent process for continuous timestamp reporting in /import/import.php
    \-- end - section for function end not yet defined that it should be use to apply the time of the parent process for
             continuous timestamp reporting in /import/import.php
    \-- get_data_object_yaml - section for function get_data_object_yaml is expected to be set and get in /import/import
            .php
    \-- yaml_data_object_map_triple - section for function yaml_data_object_map_triple not yet defined that it should be
             use to apply the time of the parent process for continuous timestamp reporting in /import/import.php
    \-- status_text - section for function status_text not yet defined that it should be use to apply the time of the pa
            rent process for continuous timestamp reporting in /import/import.php
    \-- summary - section for function summary not yet defined that it should be use to apply the time of the parent pro
            cess for continuous timestamp reporting in /import/import.php
    \-- seq_id - section for function seq_id not yet defined that it should be use to apply the time of the parent proce
            ss for continuous timestamp reporting in /import/import.php
\-- import_convert_xbrl
    \-- unzip - section for function unzip missing in /import/import_convert_xbrl.php
    \-- read_instance_xml - section for function read_instance_xml missing in /import/import_convert_xbrl.php
    \-- read_instance_xml_from_folder - section for function read_instance_xml_from_folder missing in /import/import_con
            vert_xbrl.php
    \-- instance_file_name - section for function instance_file_name missing in /import/import_convert_xbrl.php
    \-- year_of_file_name - section for function year_of_file_name missing in /import/import_convert_xbrl.php
    \-- extract_segment_sales - section for function extract_segment_sales missing in /import/import_convert_xbrl.php
    \-- calculation_file_name - section for function calculation_file_name missing in /import/import_convert_xbrl.php
    \-- extract_fact - section for function extract_fact missing in /import/import_convert_xbrl.php
    \-- extract_fact_currency - section for function extract_fact_currency missing in /import/import_convert_xbrl.php
    \-- extract_calculation_arcs - section for function extract_calculation_arcs missing in /import/import_convert_xbrl.
            php
    \-- extract_concepts - section for function extract_concepts missing in /import/import_convert_xbrl.php
    \-- concept_tokens - section for function concept_tokens missing in /import/import_convert_xbrl.php
    \-- extract_facts - section for function extract_facts missing in /import/import_convert_xbrl.php
    \-- build_data - section for function build_data missing in /import/import_convert_xbrl.php
    \-- convert - section for function convert missing in /import/import_convert_xbrl.php
    \-- convert_folder - section for function convert_folder missing in /import/import_convert_xbrl.php
    \-- convert_to_file - section for function convert_to_file missing in /import/import_convert_xbrl.php
    \-- convert_folder_to_file - section for function convert_folder_to_file missing in /import/import_convert_xbrl.php
    \-- convert_facts - section for function convert_facts missing in /import/import_convert_xbrl.php
    \-- convert_facts_to_file - section for function convert_facts_to_file missing in /import/import_convert_xbrl.php
\-- import_file
    \-- __construct - section for function __construct is expected to be construct and map in /import/import_file.php
    \-- json_file - section for function json_file not yet defined that it should be set and get in /import/import_file.
            php
    \-- yaml_file - section for function yaml_file not yet defined that it should be set and get in /import/import_file.
            php
    \-- import_config_yaml - section for function import_config_yaml not yet defined that it should be set and get in /i
            mport/import_file.php
    \-- import_system_data - section for function import_system_data not yet defined that it should be set and get in /i
            mport/import_file.php
    \-- import_pod_config - section for function import_pod_config not yet defined that it should be set and get in /imp
            ort/import_file.php
    \-- import_sample_view_data - section for function import_sample_view_data not yet defined that it should be set and
...
\-- import_wikidata
    \-- get_entity_json - section for function get_entity_json is expected to be set and get in /import/import_wikidata.
            php
    \-- get_property_json - section for function get_property_json is expected to be set and get in /import/import_wikid
            ata.php
    \-- store_json - section for function store_json missing in /import/import_wikidata.php
    \-- store_text - section for function store_text missing in /import/import_wikidata.php
    \-- convert - section for function convert not yet defined that it should be convert in /import/import_wikidata.php
    \-- convert_to_file - section for function convert_to_file not yet defined that it should be convert in /import/impo
            rt_wikidata.php
    \-- cleanup_file - section for function cleanup_file not yet defined that it should be convert in /import/import_wik
            idata.php
\-- language
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
...
\-- language_form
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
             in /language/language_form.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper_typ_ob
            j
\-- change
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /log/change.
            php
    ...
    \-- db_field_values_types - section for function db_field_values_types not yet defined that it should be sql write f
            ields in /log/change.php
    ...
    \-- date_time_format - section for function date_time_format not yet defined that it should be format in /log/change
            .php
\-- change_field
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
             in /log/change_field.php
    \-- load_sql_by_name_and_table_id - section for function load_sql_by_name_and_table_id is expected to be load sql in
             /log/change_field.php
\-- change_link
    \-- row_mapper - section for function row_mapper not yet defined that it should be database link in /log/change_link
            .php
    ...
    \-- add_link_ref - section for function add_link_ref not yet defined that it should be api in /log/change_link.php
    \-- dsp_last - section for function dsp_last not yet defined that it should be api in /log/change_link.php
    \-- add - section for function add not yet defined that it should be api in /log/change_link.php
    \-- sql_insert_link - section for function sql_insert_link not yet defined that it should be sql write in /log/chang
            e_link.php
    \-- db_field_values_link_types - section for function db_field_values_link_types not yet defined that it should be s
            ql write fields in /log/change_link.php
    \-- db_fields - section for function db_fields not yet defined that it should be sql write fields in /log/change_lin
            k.php
    \-- db_values - section for function db_values not yet defined that it should be sql write fields in /log/change_lin
            k.php
\-- change_log
    ...
    \-- sql_foreign_key - section for function sql_foreign_key not yet defined that it should be sql create in /log/chan
            ge_log.php
    \-- create_log_references - section for function create_log_references not yet defined that it should be init in /lo
            g/change_log.php
    \-- load_sql_by_field_row - section for function load_sql_by_field_row is expected to be load sql in /log/change_log
            .php
    ...
    \-- sql_insert_log - section for function sql_insert_log not yet defined that it should be sql write in /log/change_
            log.php
    \-- sql_type - section for function sql_type not yet defined that it should be sql write in /log/change_log.php
    \-- sql_sub_type - section for function sql_sub_type not yet defined that it should be sql write in /log/change_log.
            php
    \-- sql_insert_link - section for function sql_insert_link not yet defined that it should be sql write in /log/chang
            e_log.php
    \-- db_field_values_types - section for function db_field_values_types not yet defined that it should be sql write f
            ields in /log/change_log.php
    \-- add - section for function add not yet defined that it should be save in /log/change_log.php
    \-- db_fields - section for function db_fields not yet defined that it should be sql write fields in /log/change_log
            .php
    \-- db_values - section for function db_values not yet defined that it should be sql write fields in /log/change_log
            .php
\-- change_log_link_list
    \-- load_sql_by_obj - section for function load_sql_by_obj is expected to be load sql in /log/change_log_link_list.p
            hp
...
\-- change_table_field
    \-- sql_view_link - section for function sql_view_link not yet defined that it should be SQL creation in /log/change
            _table_field.php
\-- change_value
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /log/change_
            value.php
    ...
    \-- db_field_values_types - section for function db_field_values_types not yet defined that it should be sql write f
            ields in /log/change_value.php
    \-- db_fields - section for function db_fields not yet defined that it should be sql write fields in /log/change_val
            ue.php
    \-- db_values - section for function db_values not yet defined that it should be sql write fields in /log/change_val
            ue.php
\-- change_value_geo
    \-- load_sql - section for function load_sql is expected to be load sql in /log/change_value_geo.php
    \-- db_field_values_types - section for function db_field_values_types not yet defined that it should be sql write f
            ields in /log/change_value_geo.php
\-- change_value_text
    \-- load_sql - section for function load_sql is expected to be load sql in /log/change_value_text.php
    \-- db_field_values_types - section for function db_field_values_types not yet defined that it should be sql write f
            ields in /log/change_value_text.php
\-- change_value_time
    \-- load_sql - section for function load_sql is expected to be load sql in /log/change_value_time.php
    \-- db_field_values_types - section for function db_field_values_types not yet defined that it should be sql write f
            ields in /log/change_value_time.php
\-- text_log
    \-- start_time - section for function start_time not yet defined that it should be set and get in /log_text/text_log
            .php
    \-- echo_text_log - section for function echo_text_log not yet defined that it should be display in /log_text/text_l
            og.php
    \-- echo_log - section for function echo_log not yet defined that it should be display in /log_text/text_log.php
    \-- echo_lines - section for function echo_lines not yet defined that it should be display in /log_text/text_log.php
    \-- time_stamp_lines - section for function time_stamp_lines not yet defined that it should be display in /log_text/
            text_log.php
\-- phr_ids
    ...
    \-- order error - order of section  has difference at count should be before __construct
\-- phrase
    \-- clone_reset - section for function clone_reset not yet defined that it should be construct and map in /phrase/ph
            rase.php
    \-- obj - section for function obj not yet defined that it should be set and get in /phrase/phrase.php
    \-- is_readable_by - section for function is_readable_by is expected to be info in /phrase/phrase.php
    ...
    \-- protection_id - section for function protection_id not yet defined that it should be set and get in /phrase/phra
            se.php
    \-- from_id - section for function from_id not yet defined that it should be set and get in /phrase/phrase.php
    \-- name_given - section for function name_given not yet defined that it should be set and get in /phrase/phrase.php
    \-- to_id - section for function to_id not yet defined that it should be set and get in /phrase/phrase.php
    ...
    \-- is_similar - section for function is_similar is expected to be info in /phrase/phrase.php
    \-- is_same - section for function is_same is expected to be info in /phrase/phrase.php
    ...
    \-- name - section for function name is expected to be debug in /phrase/phrase.php
    \-- type_name - section for function type_name is expected to be preloaded in /phrase/phrase.php
    \-- can_be_ready - section for function can_be_ready is expected to be check in /phrase/phrase.php
    \-- db_ready - section for function db_ready is expected to be check in /phrase/phrase.php
    \-- is_valid - section for function is_valid is expected to be check in /phrase/phrase.php
    \-- fob - section for function fob not yet defined that it should be set and get in /phrase/phrase.php
    \-- tob - section for function tob not yet defined that it should be set and get in /phrase/phrase.php
    \-- from_empty - section for function from_empty not yet defined that it should be set and get in /phrase/phrase.php
    \-- to_empty - section for function to_empty not yet defined that it should be set and get in /phrase/phrase.php
    ...
    \-- related_now - section for function related_now not yet defined that it should be load related in /phrase/phrase.
            php
    ...
    \-- all_parents - section for function all_parents not yet defined that it should be data retrieval in /phrase/phras
            e.php
    \-- all_children - section for function all_children not yet defined that it should be data retrieval in /phrase/phr
            ase.php
    \-- all_related - section for function all_related not yet defined that it should be data retrieval in /phrase/phras
            e.php
    ...
    \-- direct_children - section for function direct_children not yet defined that it should be data retrieval in /phra
            se/phrase.php
    ...
    \-- is_formula - section for function is_formula is expected to be info in /phrase/phrase.php
    \-- no_id_but_name - section for function no_id_but_name not yet defined that it should be info in /phrase/phrase.ph
            p
    \-- sql_list - section for function sql_list not yet defined that it should be info in /phrase/phrase.php
    \-- is_year - section for function is_year is expected to be info in /phrase/phrase.php
    \-- is_mainly - section for function is_mainly is expected to be foaf in /phrase/phrase.php
    \-- is_time - section for function is_time is expected to be info in /phrase/phrase.php
    \-- is_measure - section for function is_measure is expected to be info in /phrase/phrase.php
    \-- is_scaling - section for function is_scaling is expected to be info in /phrase/phrase.php
    \-- is_percent - section for function is_percent is expected to be info in /phrase/phrase.php
    \-- next - section for function next is expected to be foaf in /phrase/phrase.php
    \-- prior - section for function prior is expected to be foaf in /phrase/phrase.php
    ...
    \-- dsp_time_selector - section for function dsp_time_selector not yet defined that it should be display functions i
            n /phrase/phrase.php
    \-- predicate_id - section for function predicate_id not yet defined that it should be display functions in /phrase/
            phrase.php
    \-- order error - order of section construct and map has difference at row_mapper_sandbox should be before clone_res
            et,order of section set and get has difference at get_description should be before get_user_id,
...
\-- phrase_list
    ...
    \-- load_names_sql_by_ids - section for function load_names_sql_by_ids is expected to be load in /phrase/phrase_list
            .php
    \-- load_sql_by_phr_lst - section for function load_sql_by_phr_lst is expected to be load sql in /phrase/phrase_list
            .php
    ...
    \-- fill_missing_verbs - section for function fill_missing_verbs not yet defined that it should be set and get in /p
            hrase/phrase_list.php
    \-- name_pos_lst - section for function name_pos_lst not yet defined that it should be set and get in /phrase/phrase
            _list.php
    \-- max_impact - section for function max_impact not yet defined that it should be set and get in /phrase/phrase_lis
            t.php
    \-- import_lst - section for function import_lst not yet defined that it should be im- and export in /phrase/phrase_
            list.php
    \-- import_map_names - section for function import_map_names not yet defined that it should be im- and export in /ph
            rase/phrase_list.php
    \-- import_names - section for function import_names not yet defined that it should be im- and export in /phrase/phr
            ase_list.php
    \-- import_context - section for function import_context not yet defined that it should be im- and export in /phrase
            /phrase_list.php
    \-- load_linked_phrases - section for function load_linked_phrases is expected to be load in /phrase/phrase_list.php
    \-- load_linking_triples - section for function load_linking_triples is expected to be load in /phrase/phrase_list.p
            hp
    \-- parents - section for function parents is expected to be foaf in /phrase/phrase_list.php
    \-- all_children - section for function all_children not yet defined that it should be im- and export in /phrase/phr
            ase_list.php
    \-- foaf_children - section for function foaf_children not yet defined that it should be im- and export in /phrase/p
            hrase_list.php
    \-- foaf_parents - section for function foaf_parents not yet defined that it should be im- and export in /phrase/phr
            ase_list.php
    \-- foaf_related - section for function foaf_related not yet defined that it should be im- and export in /phrase/phr
            ase_list.php
    ...
    \-- are_and_contains - section for function are_and_contains is expected to be foaf in /phrase/phrase_list.php
    \-- differentiators - section for function differentiators not yet defined that it should be select in /phrase/phras
            e_list.php
    \-- differentiators_all - section for function differentiators_all not yet defined that it should be select in /phra
            se/phrase_list.php
    \-- differentiators_filtered - section for function differentiators_filtered not yet defined that it should be selec
            t in /phrase/phrase_list.php
    \-- best_matching_time - section for function best_matching_time not yet defined that it should be select in /phrase
            /phrase_list.php
    \-- get_year - section for function get_year is expected to be set and get in /phrase/phrase_list.php
    \-- add_wrd_lst - section for function add_wrd_lst not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- add_trp_lst - section for function add_trp_lst not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    ...
    \-- merge_by_name - section for function merge_by_name not yet defined that it should be modify in /phrase/phrase_li
            st.php
    \-- del_list - section for function del_list is expected to be del in /phrase/phrase_list.php
    \-- filter_by_ids - section for function filter_by_ids not yet defined that it should be modify in /phrase/phrase_li
            st.php
    \-- filter_valid - section for function filter_valid not yet defined that it should be modify in /phrase/phrase_list
            .php
    \-- get_diff - section for function get_diff is expected to be set and get in /phrase/phrase_list.php
    \-- remove - section for function remove not yet defined that it should be modify in /phrase/phrase_list.php
    \-- remove_terms - section for function remove_terms not yet defined that it should be modify in /phrase/phrase_list
            .php
    \-- not_in - section for function not_in not yet defined that it should be modify in /phrase/phrase_list.php
    \-- diff_by_ids - section for function diff_by_ids not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- keep_only_specific - section for function keep_only_specific not yet defined that it should be modify in /phrase
            /phrase_list.php
    \-- has_time - section for function has_time not yet defined that it should be modify in /phrase/phrase_list.php
    \-- has_measure - section for function has_measure not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- has_scaling - section for function has_scaling not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- has_percent - section for function has_percent not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- time_lst_old - section for function time_lst_old not yet defined that it should be modify in /phrase/phrase_list
            .php
    \-- time_word_list - section for function time_word_list not yet defined that it should be modify in /phrase/phrase_
            list.php
    ...
    \-- get_names_by_type - section for function get_names_by_type is expected to be set and get in /phrase/phrase_list.
            php
    \-- time_useful - section for function time_useful not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- assume_time - section for function assume_time not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- measure_lst - section for function measure_lst not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    \-- scaling_lst - section for function scaling_lst not yet defined that it should be modify in /phrase/phrase_list.p
            hp
    ...
    \-- sort_rev_by_id - section for function sort_rev_by_id not yet defined that it should be modify in /phrase/phrase_
            list.php
    ...
    \-- concat_unique - section for function concat_unique not yet defined that it should be modify in /phrase/phrase_li
            st.php
    \-- val_lst - section for function val_lst not yet defined that it should be data request function in /phrase/phrase
            _list.php
    \-- frm_lst - section for function frm_lst not yet defined that it should be data request function in /phrase/phrase
            _list.php
    \-- value - section for function value not yet defined that it should be data request function in /phrase/phrase_lis
            t.php
    \-- value_scaled - section for function value_scaled not yet defined that it should be data request function in /phr
            ase/phrase_list.php
    \-- name_linked - section for function name_linked not yet defined that it should be display in /phrase/phrase_list.
            php
    \-- dsp_name - section for function dsp_name not yet defined that it should be display in /phrase/phrase_list.php
    \-- name - section for function name is expected to be debug in /phrase/phrase_list.php
    \-- names - section for function names is expected to be info in /phrase/phrase_list.php
    \-- does_contain - section for function does_contain not yet defined that it should be display in /phrase/phrase_lis
            t.php
    ...
    \-- load_sql_linked_phrases - section for function load_sql_linked_phrases is expected to be load sql in /phrase/phr
            ase_list.php
    \-- wrd_lst_all - section for function wrd_lst_all not yet defined that it should be if ($pos > 0) { in /phrase/phra
            se_list.php
    \-- words - section for function words not yet defined that it should be if ($pos > 0) { in /phrase/phrase_list.php
    \-- triples - section for function triples not yet defined that it should be if ($pos > 0) { in /phrase/phrase_list.
            php
    \-- triples_by_name - section for function triples_by_name not yet defined that it should be if ($pos > 0) { in /phr
            ase/phrase_list.php
    \-- order error - order of section modify has difference at remove should be before del
\-- phrase_type
    \-- get_code_id - section for function get_code_id is expected to be set and get in /phrase/phrase_type.php
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
...
\-- term
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /phrase/term
            .php
    \-- clone_reset - section for function clone_reset not yet defined that it should be construct and map in /phrase/te
            rm.php
    ...
    \-- protection_id - section for function protection_id not yet defined that it should be set and get in /phrase/term
            .php
    \-- is_similar - section for function is_similar is expected to be info in /phrase/term.php
    \-- is_same - section for function is_same is expected to be info in /phrase/term.php
    ...
    \-- is_readable_by - section for function is_readable_by is expected to be info in /phrase/term.php
    ...
    \-- load_sql_standard_by_name - section for function load_sql_standard_by_name is expected to be load sql in /phrase
            /term.php
    ...
    \-- load_standard_by_name - section for function load_standard_by_name is expected to be load in /phrase/term.php
    ...
    \-- is_word - section for function is_word is expected to be info in /phrase/term.php
    \-- is_triple - section for function is_triple is expected to be info in /phrase/term.php
    \-- is_formula - section for function is_formula is expected to be info in /phrase/term.php
    \-- is_verb - section for function is_verb is expected to be info in /phrase/term.php
    ...
    \-- id_used_msg - section for function id_used_msg not yet defined that it should be user interface language specifi
            c functions in /phrase/term.php
    \-- id_used_msg_text - section for function id_used_msg_text not yet defined that it should be user interface langua
            ge specific functions in /phrase/term.php
    \-- is_time - section for function is_time is expected to be info in /phrase/term.php
    \-- can_be_ready - section for function can_be_ready is expected to be check in /phrase/term.php
    \-- db_ready - section for function db_ready is expected to be check in /phrase/term.php
    \-- is_valid - section for function is_valid is expected to be check in /phrase/term.php
    \-- import_mapper - section for function import_mapper is expected to be construct and map in /phrase/term.php
    \-- order error - order of section construct and map has difference at row_mapper_sandbox should be before row_mappe
            r,order of section set and get has difference at id should be before get_user_id,
            order of section info has difference at is_valid should be before db_ready,
            order of section im- and export has difference at export_json should be before import_mapper
\-- term_list
    \-- name_pos_lst - section for function name_pos_lst not yet defined that it should be set and get in /phrase/term_l
            ist.php
    ...
    \-- term_by_obj_id - section for function term_by_obj_id not yet defined that it should be get function in /phrase/t
            erm_list.php
    \-- get_by_ids - section for function get_by_ids is expected to be set and get in /phrase/term_list.php
    \-- word_by_id - section for function word_by_id not yet defined that it should be get function in /phrase/term_list
            .php
    \-- triple_by_id - section for function triple_by_id not yet defined that it should be get function in /phrase/term_
            list.php
    \-- formula_by_id - section for function formula_by_id not yet defined that it should be get function in /phrase/ter
            m_list.php
    \-- verb_by_id - section for function verb_by_id not yet defined that it should be get function in /phrase/term_list
            .php
    ...
    \-- merge_by_name - section for function merge_by_name not yet defined that it should be modify in /phrase/term_list
            .php
    \-- filter_valid - section for function filter_valid not yet defined that it should be modify in /phrase/term_list.p
            hp
    \-- dsp_id - section for function dsp_id is expected to be debug in /phrase/term_list.php
    \-- dsp_name - section for function dsp_name not yet defined that it should be display functions in /phrase/term_lis
            t.php
    \-- name - section for function name is expected to be debug in /phrase/term_list.php
...
\-- ref_list
    ...
    \-- filter_readable_by - section for function filter_readable_by not yet defined that it should be save in /ref/ref_
            list.php
\-- ref_type
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
             in /ref/ref_type.php
...
\-- ref_type_list
    ...
    \-- default_id - section for function default_id not yet defined that it should be database link in /ref/ref_type_li
            st.php
\-- source_list
...
\-- source_type_list
    ...
    \-- default_id - section for function default_id not yet defined that it should be database link in /ref/source_type
            _list.php
    \-- get - section for function get not yet defined that it should be database link in /ref/source_type_list.php
    \-- get_source_type - section for function get_source_type is expected to be set and get in /ref/source_type_list.ph
            p
    \-- get_source_type_id - section for function get_source_type_id is expected to be set and get in /ref/source_type_l
            ist.php
    \-- get_source_type_by_id - section for function get_source_type_by_id is expected to be set and get in /ref/source_
            type_list.php
\-- result_list
    \-- load - section for function load not yet defined that it should be load in /result/result_list.php
    \-- load_sql_by_phr_lst - section for function load_sql_by_phr_lst is expected to be load sql in /result/result_list
            .php
    \-- load_sql_by_frm - section for function load_sql_by_frm is expected to be load sql in /result/result_list.php
    \-- load_sql_by_formula - section for function load_sql_by_formula is expected to be load sql in /result/result_list
            .php
    \-- load_sql_by_phrase - section for function load_sql_by_phrase is expected to be load sql in /result/result_list.p
            hp
    \-- load_sql_by_src - section for function load_sql_by_src is expected to be load sql in /result/result_list.php
    \-- load_sql_by_frm_single - section for function load_sql_by_frm_single is expected to be load sql in /result/resul
            t_list.php
    ...
    \-- load_sql_by_src_grp - section for function load_sql_by_src_grp is expected to be load sql in /result/result_list
            .php
    \-- load_sql_by_obj_old - section for function load_sql_by_obj_old is expected to be load sql in /result/result_list
            .php
    ...
    \-- name - section for function name is expected to be debug in /result/result_list.php
    \-- names - section for function names is expected to be info in /result/result_list.php
    \-- add_frm_val - section for function add_frm_val not yet defined that it should be TODO check in /result/result_li
            st.php
    \-- frm_upd_lst_usr - section for function frm_upd_lst_usr not yet defined that it should be TODO check in /result/r
            esult_list.php
    \-- frm_upd_lst - section for function frm_upd_lst not yet defined that it should be get the result that needs to be
             recalculated if one formula has been updated in /result/result_list.php
    \-- get_first - section for function get_first is expected to be set and get in /result/result_list.php
    \-- val_upd_lst - section for function val_upd_lst not yet defined that it should be get the result that needs to be
             recalculated if one formula has been updated in /result/result_list.php
    \-- load_by_val - section for function load_by_val is expected to be load in /result/result_list.php
    \-- add - section for function add not yet defined that it should be get the result that needs to be recalculated if
             one formula has been updated in /result/result_list.php
    \-- add_result_direct - section for function add_result_direct not yet defined that it should be get the result that
             needs to be recalculated if one formula has been updated in /result/result_list.php
    \-- save - section for function save is expected to be save in /result/result_list.php
    \-- merge - section for function merge not yet defined that it should be get the result that needs to be recalculate
            d if one formula has been updated in /result/result_list.php
    \-- order error - order of section load has difference at load_sql_by_ids should be before load
\-- sandbox
    \-- row_mapper_usr - section for function row_mapper_usr not yet defined that it should be construct and map in /san
            dbox/sandbox.php
    \-- row_mapper_std - section for function row_mapper_std not yet defined that it should be construct and map in /san
            dbox/sandbox.php
    \-- load_changes_related - section for function load_changes_related is expected to be load in /sandbox/sandbox.php
    \-- user_overwrites_api_array - section for function user_overwrites_api_array not yet defined that it should be api
             in /sandbox/sandbox.php
    \-- other_overwrites_api_array - section for function other_overwrites_api_array not yet defined that it should be a
            pi in /sandbox/sandbox.php
    ...
    \-- is_exclusion_set - section for function is_exclusion_set is expected to be info in /sandbox/sandbox.php
    ...
    \-- owner_api_name - section for function owner_api_name not yet defined that it should be set and get in /sandbox/s
            andbox.php
    \-- share_id - section for function share_id not yet defined that it should be set and get in /sandbox/sandbox.php
    \-- protection_id - section for function protection_id not yet defined that it should be set and get in /sandbox/san
            dbox.php
    \-- delta - section for function delta is expected to be del in /sandbox/sandbox.php
    \-- share_type_code_id - section for function share_type_code_id not yet defined that it should be preloaded in /san
            dbox/sandbox.php
    \-- share_type_name - section for function share_type_name not yet defined that it should be preloaded in /sandbox/s
            andbox.php
    \-- is_readable_by - section for function is_readable_by is expected to be info in /sandbox/sandbox.php
    \-- protection_type_code_id - section for function protection_type_code_id not yet defined that it should be preload
            ed in /sandbox/sandbox.php
    \-- protection_type_name - section for function protection_type_name not yet defined that it should be preloaded in 
            /sandbox/sandbox.php
    \-- type_name_field - section for function type_name_field is expected to be sql fields in /sandbox/sandbox.php
    ...
    \-- reload_objects - section for function reload_objects is expected to be related in /sandbox/sandbox.php
    \-- load_sql_median_user - section for function load_sql_median_user is expected to be load sql in /sandbox/sandbox.
            php
    \-- median_user - section for function median_user not yet defined that it should be info in /sandbox/sandbox.php
    \-- check_protection_change - section for function check_protection_change not yet defined that it should be owner a
            nd access in /sandbox/sandbox.php
    \-- take_ownership - section for function take_ownership not yet defined that it should be owner and access in /sand
            box/sandbox.php
    \-- set_owner - section for function set_owner is expected to be set and get in /sandbox/sandbox.php
    \-- not_changed - section for function not_changed is expected to be sandbox in /sandbox/sandbox.php
    \-- not_used - section for function not_used is expected to be sandbox in /sandbox/sandbox.php
    \-- changer - section for function changer not yet defined that it should be owner and access in /sandbox/sandbox.ph
            p
    \-- load_sql_changer - section for function load_sql_changer is expected to be load sql in /sandbox/sandbox.php
    \-- changed_by - section for function changed_by not yet defined that it should be owner and access in /sandbox/sand
            box.php
    ...
    \-- fix_user_overwrites_after_rename - section for function fix_user_overwrites_after_rename not yet defined that it
             should be save fields in /sandbox/sandbox.php
    \-- update_standard_fields - section for function update_standard_fields not yet defined that it should be save fiel
            ds in /sandbox/sandbox.php
    ...
    \-- no_non_id_diff - section for function no_non_id_diff not yet defined that it should be save fields in /sandbox/s
            andbox.php
    \-- get_obj_with_same_id_fields - section for function get_obj_with_same_id_fields is expected to be set and get in 
            /sandbox/sandbox.php
    \-- msg_id_already_used - section for function msg_id_already_used not yet defined that it should be save id in /san
            dbox/sandbox.php
    \-- delete_old_key_row - section for function delete_old_key_row is expected to be del in /sandbox/sandbox.php
    ...
    \-- is_similar_std - section for function is_similar_std is expected to be info in /sandbox/sandbox.php
    ...
    \-- merged_info_message - section for function merged_info_message not yet defined that it should be delete in /sand
            box/sandbox.php
    ...
    \-- sql_write_prepared - section for function sql_write_prepared not yet defined that it should be sql write in /san
            dbox/sandbox.php
    \-- db_fields_all_sandbox - section for function db_fields_all_sandbox not yet defined that it should be sql write f
            ields in /sandbox/sandbox.php
    \-- db_changed_sandbox_list - section for function db_changed_sandbox_list not yet defined that it should be sql wri
            te fields in /sandbox/sandbox.php
    ...
    \-- sql_foreign_key - section for function sql_foreign_key not yet defined that it should be sql create in /sandbox/
            sandbox.php
    \-- sql_insert_switch - section for function sql_insert_switch not yet defined that it should be sql write in /sandb
            ox/sandbox.php
    \-- sql_insert_with_log - section for function sql_insert_with_log not yet defined that it should be sql write in /s
            andbox/sandbox.php
    \-- sql_update_switch - section for function sql_update_switch not yet defined that it should be sql write in /sandb
            ox/sandbox.php
    \-- sql_key_fields_text - section for function sql_key_fields_text not yet defined that it should be sql write in /s
            andbox/sandbox.php
    \-- sql_key_fields_text_old - section for function sql_key_fields_text_old not yet defined that it should be sql wri
            te in /sandbox/sandbox.php
    \-- sql_key_fields_id - section for function sql_key_fields_id not yet defined that it should be sql write in /sandb
            ox/sandbox.php
    \-- sql_key_fields_id_old - section for function sql_key_fields_id_old not yet defined that it should be sql write i
            n /sandbox/sandbox.php
    \-- db_fields_changed - section for function db_fields_changed is expected to be sql write fields in /sandbox/sandbo
            x.php
    \-- sql_extension - section for function sql_extension not yet defined that it should be sql helper in /sandbox/sand
            box.php
    \-- fld_id - section for function fld_id not yet defined that it should be internal check in /sandbox/sandbox.php
    \-- fld_name - section for function fld_name not yet defined that it should be internal check in /sandbox/sandbox.ph
            p
    \-- is_named_obj - section for function is_named_obj is expected to be info in /sandbox/sandbox.php
    \-- is_link_obj - section for function is_link_obj is expected to be info in /sandbox/sandbox.php
    \-- is_link_type_obj - section for function is_link_type_obj is expected to be info in /sandbox/sandbox.php
    \-- is_value_obj - section for function is_value_obj is expected to be info in /sandbox/sandbox.php
    \-- set_code_id - section for function set_code_id is expected to be set and get in /sandbox/sandbox.php
    \-- get_code_id - section for function get_code_id is expected to be set and get in /sandbox/sandbox.php
    \-- set_ui_msg_code_id - section for function set_ui_msg_code_id is expected to be set and get in /sandbox/sandbox.p
            hp
    \-- get_ui_msg_code_id - section for function get_ui_msg_code_id is expected to be set and get in /sandbox/sandbox.p
            hp
    \-- set_ui_msg_code_id_vars - section for function set_ui_msg_code_id_vars is expected to be set and get in /sandbox
            /sandbox.php
    \-- get_ui_msg_code_id_vars - section for function get_ui_msg_code_id_vars is expected to be set and get in /sandbox
            /sandbox.php
    \-- set_ui_msg_code_id_exception - section for function set_ui_msg_code_id_exception is expected to be set and get i
            n /sandbox/sandbox.php
    \-- get_ui_msg_code_id_exception - section for function get_ui_msg_code_id_exception is expected to be set and get i
            n /sandbox/sandbox.php
    \-- set_ui_msg_value_exception - section for function set_ui_msg_value_exception is expected to be set and get in /s
            andbox/sandbox.php
    \-- get_ui_msg_value_exception - section for function get_ui_msg_value_exception is expected to be set and get in /s
            andbox/sandbox.php
    \-- chk_owner - section for function chk_owner not yet defined that it should be check functions in /sandbox/sandbox
            .php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper_usr,
            order of section set and get has difference at set_share should be before set_from_api,
            order of section info has difference at delta should be before diff_msg
\-- sandbox_code_id
    \-- delta - section for function delta is expected to be del in /sandbox/sandbox_code_id.php
    \-- order error - order of section info has difference at diff_msg should be before is_similar
\-- sandbox_link
    \-- fob - section for function fob not yet defined that it should be set and get in /sandbox/sandbox_link.php
    \-- from_id - section for function from_id not yet defined that it should be set and get in /sandbox/sandbox_link.ph
            p
    \-- from_name - section for function from_name not yet defined that it should be set and get in /sandbox/sandbox_lin
            k.php
    \-- from_id_or_name - section for function from_id_or_name not yet defined that it should be set and get in /sandbox
            /sandbox_link.php
    \-- from_empty - section for function from_empty not yet defined that it should be set and get in /sandbox/sandbox_l
            ink.php
    \-- predicate_id - section for function predicate_id not yet defined that it should be set and get in /sandbox/sandb
            ox_link.php
    \-- predicate_name - section for function predicate_name is expected to be preloaded in /sandbox/sandbox_link.php
    \-- verb_empty - section for function verb_empty not yet defined that it should be set and get in /sandbox/sandbox_l
            ink.php
    ...
    \-- to_name - section for function to_name not yet defined that it should be set and get in /sandbox/sandbox_link.ph
            p
    \-- to_id_or_name - section for function to_id_or_name not yet defined that it should be set and get in /sandbox/san
            dbox_link.php
    \-- to_empty - section for function to_empty not yet defined that it should be set and get in /sandbox/sandbox_link.
            php
    ...
    \-- load_sql_standard_by_link - section for function load_sql_standard_by_link is expected to be load sql in /sandbo
            x/sandbox_link.php
    \-- load_sql_standard_by_type_link - section for function load_sql_standard_by_type_link is expected to be load sql 
            in /sandbox/sandbox_link.php
    ...
    \-- db_ready - section for function db_ready is expected to be check in /sandbox/sandbox_link.php
    \-- is_valid - section for function is_valid is expected to be check in /sandbox/sandbox_link.php
    \-- fill_api_obj - section for function fill_api_obj not yet defined that it should be set the vars of the minimal a
            pi object based on this link object in /sandbox/sandbox_link.php
    \-- delta - section for function delta is expected to be del in /sandbox/sandbox_link.php
    \-- add - section for function add not yet defined that it should be save in /sandbox/sandbox_link.php
    \-- is_id_updated_link - section for function is_id_updated_link is expected to be info in /sandbox/sandbox_link.php
    \-- msg_id_already_used - section for function msg_id_already_used not yet defined that it should be save in /sandbo
            x/sandbox_link.php
    \-- is_same_std - section for function is_same_std is expected to be info in /sandbox/sandbox_link.php
    \-- id_used_msg - section for function id_used_msg not yet defined that it should be save in /sandbox/sandbox_link.p
            hp
    \-- get_obj_with_same_id_fields - section for function get_obj_with_same_id_fields is expected to be set and get in 
            /sandbox/sandbox_link.php
    \-- sql_key_fields_text - section for function sql_key_fields_text not yet defined that it should be sql write in /s
            andbox/sandbox_link.php
    \-- sql_key_fields_text_old - section for function sql_key_fields_text_old not yet defined that it should be sql wri
            te in /sandbox/sandbox_link.php
    \-- sql_key_fields_id - section for function sql_key_fields_id not yet defined that it should be sql write in /sandb
            ox/sandbox_link.php
    \-- sql_key_fields_id_old - section for function sql_key_fields_id_old not yet defined that it should be sql write i
            n /sandbox/sandbox_link.php
    \-- merged_info_message - section for function merged_info_message not yet defined that it should be sql write in /s
            andbox/sandbox_link.php
    \-- del_links - section for function del_links is expected to be del in /sandbox/sandbox_link.php
    \-- db_all_fields_link - section for function db_all_fields_link not yet defined that it should be sql write fields 
            in /sandbox/sandbox_link.php
    ...
    \-- sql_update - section for function sql_update not yet defined that it should be sql write in /sandbox/sandbox_lin
            k.php
    \-- link_id - section for function link_id is expected to be link in /sandbox/sandbox_link.php
    \-- order error - order of section info has difference at is_valid should be before db_ready
\-- sandbox_link_list
    \-- add - section for function add not yet defined that it should be modify in /sandbox/sandbox_link_list.php
    \-- add_link - section for function add_link not yet defined that it should be modify in /sandbox/sandbox_link_list.
            php
    \-- add_link_by_key - section for function add_link_by_key not yet defined that it should be modify in /sandbox/sand
            box_link_list.php
\-- sandbox_link_named
    \-- name - section for function name is expected to be debug in /sandbox/sandbox_link_named.php
    \-- name_or_null - section for function name_or_null not yet defined that it should be set and get in /sandbox/sandb
            ox_link_named.php
    \-- name_field - section for function name_field is expected to be sql fields in /sandbox/sandbox_link_named.php
    \-- cloned_named - section for function cloned_named not yet defined that it should be set and get in /sandbox/sandb
            ox_link_named.php
    \-- type_id - section for function type_id not yet defined that it should be set and get in /sandbox/sandbox_link_na
            med.php
    \-- fill_api_obj - section for function fill_api_obj not yet defined that it should be cast in /sandbox/sandbox_link
            _named.php
    \-- delta - section for function delta is expected to be del in /sandbox/sandbox_link_named.php
    \-- no_id_but_name - section for function no_id_but_name not yet defined that it should be info in /sandbox/sandbox_
            link_named.php
    \-- is_key_updated - section for function is_key_updated is expected to be info in /sandbox/sandbox_link_named.php
    \-- is_id_key_updated - section for function is_id_key_updated is expected to be info in /sandbox/sandbox_link_named
            .php
    \-- is_similar_named - section for function is_similar_named is expected to be info in /sandbox/sandbox_link_named.p
            hp
    ...
    \-- log_last_field_msg - section for function log_last_field_msg is expected to be log in /sandbox/sandbox_link_name
            d.php
    \-- is_named_obj - section for function is_named_obj is expected to be info in /sandbox/sandbox_link_named.php
    \-- order error - order of section set and get has difference at set_description should be before name_or_null
\-- sandbox_list
    ...
    \-- table_extension - section for function table_extension not yet defined that it should be sql_type_list in /sandb
            ox/sandbox_list.php
\-- sandbox_list_named
    \-- name_pos_lst - section for function name_pos_lst not yet defined that it should be set and get in /sandbox/sandb
            ox_list_named.php
    \-- name_pos_lst_all - section for function name_pos_lst_all not yet defined that it should be set and get in /sandb
            ox/sandbox_list_named.php
    \-- load_sql_by_names - section for function load_sql_by_names is expected to be load sql in /sandbox/sandbox_list_n
            amed.php
    \-- load_sql_by_code_id_list - section for function load_sql_by_code_id_list is expected to be load sql in /sandbox/
            sandbox_list_named.php
    \-- missing_ids - section for function missing_ids not yet defined that it should be info in /sandbox/sandbox_list_n
            amed.php
    \-- add - section for function add not yet defined that it should be modify in /sandbox/sandbox_list_named.php
    \-- add_by_key - section for function add_by_key not yet defined that it should be modify in /sandbox/sandbox_list_n
            amed.php
    \-- add_by_name_direct - section for function add_by_name_direct not yet defined that it should be modify in /sandbo
            x/sandbox_list_named.php
    \-- fill_by_id - section for function fill_by_id not yet defined that it should be modify in /sandbox/sandbox_list_n
            amed.php
    \-- fill_by_name - section for function fill_by_name not yet defined that it should be modify in /sandbox/sandbox_li
            st_named.php
    \-- add_id_by_name - section for function add_id_by_name not yet defined that it should be modify in /sandbox/sandbo
            x_list_named.php
    ...
    \-- filter_by_name - section for function filter_by_name not yet defined that it should be search in /sandbox/sandbo
            x_list_named.php
    \-- select_by_name - section for function select_by_name not yet defined that it should be search in /sandbox/sandbo
            x_list_named.php
    \-- add_obj - section for function add_obj not yet defined that it should be modify in /sandbox/sandbox_list_named.p
            hp
    \-- sort_by_name - section for function sort_by_name not yet defined that it should be modify in /sandbox/sandbox_li
            st_named.php
    \-- name_id_list - section for function name_id_list not yet defined that it should be modify in /sandbox/sandbox_li
            st_named.php
    \-- code_id_list - section for function code_id_list not yet defined that it should be modify in /sandbox/sandbox_li
            st_named.php
    \-- update_list - section for function update_list not yet defined that it should be select in /sandbox/sandbox_list
            _named.php
    ...
    \-- sql_insert - section for function sql_insert is expected to be sql write in /sandbox/sandbox_list_named.php
    \-- sql_update - section for function sql_update not yet defined that it should be save in /sandbox/sandbox_list_nam
            ed.php
    \-- sql_delete - section for function sql_delete not yet defined that it should be save in /sandbox/sandbox_list_nam
            ed.php
    \-- sql_update_call_with_par - section for function sql_update_call_with_par not yet defined that it should be save 
            in /sandbox/sandbox_list_named.php
    \-- sql_delete_call_with_par - section for function sql_delete_call_with_par not yet defined that it should be save 
            in /sandbox/sandbox_list_named.php
    ...
    \-- filter_readable_by - section for function filter_readable_by not yet defined that it should be debug in /sandbox
            /sandbox_list_named.php
    \-- order error - order of section modify has difference at add_by_key should be before add
\-- sandbox_multi
    \-- row_mapper_sandbox_multi - section for function row_mapper_sandbox_multi not yet defined that it should be const
            ruct and map in /sandbox/sandbox_multi.php
    \-- row_mapper_usr - section for function row_mapper_usr not yet defined that it should be construct and map in /san
            dbox/sandbox_multi.php
    \-- row_mapper_std - section for function row_mapper_std not yet defined that it should be construct and map in /san
            dbox/sandbox_multi.php
    \-- load_changes_related - section for function load_changes_related is expected to be load in /sandbox/sandbox_mult
            i.php
    \-- user_overwrites_api_array - section for function user_overwrites_api_array not yet defined that it should be api
             in /sandbox/sandbox_multi.php
    \-- other_overwrites_api_array - section for function other_overwrites_api_array not yet defined that it should be a
            pi in /sandbox/sandbox_multi.php
    \-- exclude - section for function exclude not yet defined that it should be set and get in /sandbox/sandbox_multi.p
            hp
    \-- include - section for function include not yet defined that it should be set and get in /sandbox/sandbox_multi.p
            hp
    \-- is_excluded - section for function is_excluded is expected to be info in /sandbox/sandbox_multi.php
    \-- grp - section for function grp not yet defined that it should be set and get in /sandbox/sandbox_multi.php
    \-- owner_id - section for function owner_id not yet defined that it should be set and get in /sandbox/sandbox_multi
            .php
    \-- owner - section for function owner not yet defined that it should be set and get in /sandbox/sandbox_multi.php
    \-- share_id - section for function share_id not yet defined that it should be set and get in /sandbox/sandbox_multi
            .php
    \-- protection_id - section for function protection_id not yet defined that it should be set and get in /sandbox/san
            dbox_multi.php
    \-- source_id - section for function source_id not yet defined that it should be set and get in /sandbox/sandbox_mul
            ti.php
    ...
    \-- load_sql_usr_num - section for function load_sql_usr_num is expected to be load sql in /sandbox/sandbox_multi.ph
            p
    \-- load_sql_obj_vars - section for function load_sql_obj_vars is expected to be load sql in /sandbox/sandbox_multi.
            php
    ...
    \-- chk_owner - section for function chk_owner not yet defined that it should be check functions in /sandbox/sandbox
            _multi.php
    \-- share_type_code_id - section for function share_type_code_id not yet defined that it should be load types in /sa
            ndbox/sandbox_multi.php
    \-- share_type_name - section for function share_type_name not yet defined that it should be load types in /sandbox/
            sandbox_multi.php
    \-- is_readable_by - section for function is_readable_by is expected to be info in /sandbox/sandbox_multi.php
    \-- protection_type_code_id - section for function protection_type_code_id not yet defined that it should be load ty
            pes in /sandbox/sandbox_multi.php
    \-- protection_type_name - section for function protection_type_name not yet defined that it should be load types in
             /sandbox/sandbox_multi.php
    \-- check_protection_change - section for function check_protection_change not yet defined that it should be load ty
            pes in /sandbox/sandbox_multi.php
    \-- load_sql_median_user - section for function load_sql_median_user is expected to be load sql in /sandbox/sandbox_
            multi.php
    \-- median_user - section for function median_user not yet defined that it should be info in /sandbox/sandbox_multi.
            php
    \-- is_saved - section for function is_saved is expected to be info in /sandbox/sandbox_multi.php
    \-- set_saved - section for function set_saved is expected to be set and get in /sandbox/sandbox_multi.php
    \-- needs_similar_check - section for function needs_similar_check not yet defined that it should be save helper - o
            wnership and access in /sandbox/sandbox_multi.php
    \-- take_ownership - section for function take_ownership not yet defined that it should be save helper - ownership a
            nd access in /sandbox/sandbox_multi.php
    \-- set_owner - section for function set_owner is expected to be set and get in /sandbox/sandbox_multi.php
    \-- not_changed - section for function not_changed is expected to be sandbox in /sandbox/sandbox_multi.php
    \-- not_used - section for function not_used is expected to be sandbox in /sandbox/sandbox_multi.php
    \-- changer_sql - section for function changer_sql not yet defined that it should be save helper - ownership and acc
            ess in /sandbox/sandbox_multi.php
    \-- changer - section for function changer not yet defined that it should be save helper - ownership and access in /
            sandbox/sandbox_multi.php
    \-- load_sql_of_users_that_changed - section for function load_sql_of_users_that_changed is expected to be load sql 
            in /sandbox/sandbox_multi.php
    \-- changed_by - section for function changed_by not yet defined that it should be save helper - ownership and acces
            s in /sandbox/sandbox_multi.php
    \-- used_by_someone_else - section for function used_by_someone_else not yet defined that it should be save helper -
             ownership and access in /sandbox/sandbox_multi.php
    \-- can_change - section for function can_change is expected to be sandbox in /sandbox/sandbox_multi.php
    \-- is_numeric - section for function is_numeric is expected to be info in /sandbox/sandbox_multi.php
    \-- is_time_value - section for function is_time_value is expected to be info in /sandbox/sandbox_multi.php
    \-- is_text_value - section for function is_text_value is expected to be info in /sandbox/sandbox_multi.php
    \-- is_geo_value - section for function is_geo_value is expected to be info in /sandbox/sandbox_multi.php
    \-- has_usr_cfg - section for function has_usr_cfg not yet defined that it should be save helper - user sandbox in /
            sandbox/sandbox_multi.php
    ...
    \-- usr_cfg_cleanup - section for function usr_cfg_cleanup not yet defined that it should be save helper - user sand
            box in /sandbox/sandbox_multi.php
    ...
    \-- sql_update_multi - section for function sql_update_multi not yet defined that it should be save helper - save fi
            elds in /sandbox/sandbox_multi.php
    ...
    \-- get_obj_with_same_id_fields - section for function get_obj_with_same_id_fields is expected to be set and get in 
            /sandbox/sandbox_multi.php
    \-- msg_id_already_used - section for function msg_id_already_used not yet defined that it should be save helper - c
            heck id in /sandbox/sandbox_multi.php
    ...
    \-- sql_write - section for function sql_write not yet defined that it should be delete in /sandbox/sandbox_multi.ph
            p
    \-- sql_write_with_log - section for function sql_write_with_log not yet defined that it should be delete in /sandbo
            x/sandbox_multi.php
    \-- id_fvt_lst - section for function id_fvt_lst not yet defined that it should be delete in /sandbox/sandbox_multi.
            php
    \-- no_diff - section for function no_diff not yet defined that it should be delete in /sandbox/sandbox_multi.php
    \-- no_non_id_diff - section for function no_non_id_diff not yet defined that it should be delete in /sandbox/sandbo
            x_multi.php
    \-- sql_insert_switch - section for function sql_insert_switch not yet defined that it should be sql write fields in
             /sandbox/sandbox_multi.php
    \-- sql_update_switch - section for function sql_update_switch not yet defined that it should be sql write fields in
             /sandbox/sandbox_multi.php
    \-- sql_insert_key_field - section for function sql_insert_key_field is expected to be sql write in /sandbox/sandbox
            _multi.php
    \-- id_used_msg - section for function id_used_msg not yet defined that it should be sql write fields in /sandbox/sa
            ndbox_multi.php
    ...
    \-- id_names - section for function id_names not yet defined that it should be sql write fields in /sandbox/sandbox_
            multi.php
    \-- id_lst - section for function id_lst not yet defined that it should be sql write fields in /sandbox/sandbox_mult
            i.php
    \-- id_or_lst - section for function id_or_lst not yet defined that it should be sql write fields in /sandbox/sandbo
            x_multi.php
    \-- del_links - section for function del_links is expected to be del in /sandbox/sandbox_multi.php
    \-- db_changed_sandbox_list - section for function db_changed_sandbox_list not yet defined that it should be sql wri
            te fields in /sandbox/sandbox_multi.php
    \-- type_name - section for function type_name is expected to be preloaded in /sandbox/sandbox_multi.php
    \-- db_fields_all_sandbox - section for function db_fields_all_sandbox not yet defined that it should be sql write f
            ields in /sandbox/sandbox_multi.php
    \-- db_fields_changed_sandbox - section for function db_fields_changed_sandbox not yet defined that it should be sql
             write fields in /sandbox/sandbox_multi.php
    \-- table_type - section for function table_type not yet defined that it should be sql helper in /sandbox/sandbox_mu
            lti.php
    \-- value_type - section for function value_type not yet defined that it should be sql helper in /sandbox/sandbox_mu
            lti.php
    \-- table_extension - section for function table_extension not yet defined that it should be sql helper in /sandbox/
            sandbox_multi.php
    \-- id_field_type - section for function id_field_type not yet defined that it should be sql helper in /sandbox/sand
            box_multi.php
    \-- id_field_group - section for function id_field_group not yet defined that it should be sql helper in /sandbox/sa
            ndbox_multi.php
    \-- is_named_obj - section for function is_named_obj is expected to be info in /sandbox/sandbox_multi.php
    \-- is_link_obj - section for function is_link_obj is expected to be info in /sandbox/sandbox_multi.php
    \-- is_value_obj - section for function is_value_obj is expected to be info in /sandbox/sandbox_multi.php
    \-- fld_id - section for function fld_id not yet defined that it should be internal check in /sandbox/sandbox_multi.
            php
    \-- fld_usr_id - section for function fld_usr_id not yet defined that it should be internal check in /sandbox/sandbo
            x_multi.php
    \-- fld_name - section for function fld_name not yet defined that it should be internal check in /sandbox/sandbox_mu
            lti.php
    \-- fill_api_obj - section for function fill_api_obj not yet defined that it should be internal check in /sandbox/sa
            ndbox_multi.php
    \-- fill_ui_obj - section for function fill_ui_obj not yet defined that it should be internal check in /sandbox/sand
            box_multi.php
    \-- load - section for function load not yet defined that it should be internal check in /sandbox/sandbox_multi.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper_sandbo
            x_multi,order of section set and get has difference at exclude should be before set_from_api,
            order of section info has difference at diff_msg should be before has_id
\-- sandbox_named
    ...
    \-- delta - section for function delta is expected to be del in /sandbox/sandbox_named.php
    \-- get_term - section for function get_term is expected to be set and get in /sandbox/sandbox_named.php
    \-- fill_api_obj - section for function fill_api_obj not yet defined that it should be cast in /sandbox/sandbox_name
            d.php
    \-- load_standard_by_name - section for function load_standard_by_name is expected to be load in /sandbox/sandbox_na
            med.php
    \-- can_be_ready - section for function can_be_ready is expected to be check in /sandbox/sandbox_named.php
    \-- db_ready - section for function db_ready is expected to be check in /sandbox/sandbox_named.php
    \-- is_valid - section for function is_valid is expected to be check in /sandbox/sandbox_named.php
    \-- no_id_but_name - section for function no_id_but_name not yet defined that it should be info in /sandbox/sandbox_
            named.php
    ...
    \-- msg_id_already_used - section for function msg_id_already_used not yet defined that it should be save helper in 
            /sandbox/sandbox_named.php
    ...
    \-- id_used_msg - section for function id_used_msg not yet defined that it should be save helper in /sandbox/sandbox
            _named.php
    \-- get_obj_with_same_id_fields - section for function get_obj_with_same_id_fields is expected to be set and get in 
            /sandbox/sandbox_named.php
    \-- merged_info_message - section for function merged_info_message not yet defined that it should be save helper in 
            /sandbox/sandbox_named.php
    \-- sql_insert_switch - section for function sql_insert_switch not yet defined that it should be sql write in /sandb
            ox/sandbox_named.php
    \-- is_named_obj - section for function is_named_obj is expected to be info in /sandbox/sandbox_named.php
    \-- order error - order of section set and get has difference at set_description should be before name_or_null,
            order of section info has difference at db_ready should be before diff_msg
\-- sandbox_related
    \-- views_array - section for function views_array not yet defined that it should be api in /sandbox/sandbox_related
            .php
    \-- changes_array - section for function changes_array not yet defined that it should be api in /sandbox/sandbox_rel
            ated.php
    \-- load_changes - section for function load_changes is expected to be load in /sandbox/sandbox_related.php
    \-- overwrites_array - section for function overwrites_array not yet defined that it should be api in /sandbox/sandb
            ox_related.php
    \-- user_overwrites - section for function user_overwrites not yet defined that it should be api in /sandbox/sandbox
            _related.php
    \-- other_overwrites - section for function other_overwrites not yet defined that it should be api in /sandbox/sandb
            ox_related.php
\-- sandbox_typed
    \-- type_id - section for function type_id not yet defined that it should be set and get in /sandbox/sandbox_typed.p
            hp
    \-- fill_api_obj - section for function fill_api_obj not yet defined that it should be cast in /sandbox/sandbox_type
            d.php
    \-- delta - section for function delta is expected to be del in /sandbox/sandbox_typed.php
    \-- order error - order of section set and get has difference at set_type should be before set_type_id
\-- sandbox_value
    \-- clone_all - section for function clone_all not yet defined that it should be construct and map in /sandbox/sandb
            ox_value.php
    \-- set_grp_by_row - section for function set_grp_by_row is expected to be set and get in /sandbox/sandbox_value.php
    \-- row_mapper_multi - section for function row_mapper_multi not yet defined that it should be construct and map in 
            /sandbox/sandbox_value.php
    ...
    \-- phrase_list - section for function phrase_list is expected to be cast in /sandbox/sandbox_value.php
    \-- ids - section for function ids not yet defined that it should be set and get in /sandbox/sandbox_value.php
    \-- is_id_set - section for function is_id_set is expected to be info in /sandbox/sandbox_value.php
    \-- number - section for function number not yet defined that it should be set and get in /sandbox/sandbox_value.php
    \-- impact - section for function impact not yet defined that it should be set and get in /sandbox/sandbox_value.php
    \-- last_update - section for function last_update not yet defined that it should be set and get in /sandbox/sandbox
            _value.php
    \-- table_type - section for function table_type not yet defined that it should be set and get in /sandbox/sandbox_v
            alue.php
    \-- value_type - section for function value_type not yet defined that it should be set and get in /sandbox/sandbox_v
            alue.php
    \-- is_numeric - section for function is_numeric is expected to be info in /sandbox/sandbox_value.php
    \-- is_time_value - section for function is_time_value is expected to be info in /sandbox/sandbox_value.php
    \-- is_text_value - section for function is_text_value is expected to be info in /sandbox/sandbox_value.php
    ...
    \-- is_main - section for function is_main is expected to be info in /sandbox/sandbox_value.php
    \-- is_big - section for function is_big is expected to be info in /sandbox/sandbox_value.php
    \-- is_text - section for function is_text is expected to be info in /sandbox/sandbox_value.php
    \-- is_time - section for function is_time is expected to be info in /sandbox/sandbox_value.php
    \-- is_geo - section for function is_geo is expected to be info in /sandbox/sandbox_value.php
    \-- id_lst - section for function id_lst not yet defined that it should be forward group get in /sandbox/sandbox_val
            ue.php
    \-- sql_table - section for function sql_table not yet defined that it should be sql create in /sandbox/sandbox_valu
            e.php
    \-- sql_index - section for function sql_index not yet defined that it should be sql create in /sandbox/sandbox_valu
            e.php
    \-- sql_foreign_key - section for function sql_foreign_key not yet defined that it should be sql create in /sandbox/
            sandbox_value.php
    ...
    \-- load_sql_user_changes - section for function load_sql_user_changes is expected to be load sql in /sandbox/sandbo
            x_value.php
    \-- load_sql_changer - section for function load_sql_changer is expected to be load sql in /sandbox/sandbox_value.ph
            p
    \-- changer - section for function changer not yet defined that it should be load in /sandbox/sandbox_value.php
    \-- load_sql_standard - section for function load_sql_standard is expected to be load sql in /sandbox/sandbox_value.
            php
    \-- load_sql_median_user - section for function load_sql_median_user is expected to be load sql in /sandbox/sandbox_
            value.php
    \-- match_all - section for function match_all not yet defined that it should be select in /sandbox/sandbox_value.ph
            p
    \-- matches_context - section for function matches_context not yet defined that it should be select in /sandbox/sand
            box_value.php
    \-- delta - section for function delta is expected to be del in /sandbox/sandbox_value.php
    \-- id_fvt_lst - section for function id_fvt_lst not yet defined that it should be info in /sandbox/sandbox_value.ph
            p
    \-- id_field - section for function id_field not yet defined that it should be info in /sandbox/sandbox_value.php
    \-- id_fields_both - section for function id_fields_both not yet defined that it should be info in /sandbox/sandbox_
            value.php
    \-- id_fields_prime - section for function id_fields_prime not yet defined that it should be info in /sandbox/sandbo
            x_value.php
    \-- id_fields_main - section for function id_fields_main not yet defined that it should be info in /sandbox/sandbox_
            value.php
    \-- id_field_list - section for function id_field_list not yet defined that it should be info in /sandbox/sandbox_va
            lue.php
    ...
    \-- sql_update - section for function sql_update not yet defined that it should be sql write in /sandbox/sandbox_val
            ue.php
    \-- sql_update_fields - section for function sql_update_fields not yet defined that it should be sql write in /sandb
            ox/sandbox_value.php
    \-- sql_delete - section for function sql_delete not yet defined that it should be sql write in /sandbox/sandbox_val
            ue.php
    \-- db_changed - section for function db_changed not yet defined that it should be TODO check if sandbox named funct
            ion match this logic in /sandbox/sandbox_value.php
    \-- db_fields_changed_value - section for function db_fields_changed_value not yet defined that it should be TODO ch
            eck if sandbox named function match this logic in /sandbox/sandbox_value.php
    \-- db_values_changed_value - section for function db_values_changed_value not yet defined that it should be TODO ch
            eck if sandbox named function match this logic in /sandbox/sandbox_value.php
    ...
    \-- is_value_obj - section for function is_value_obj is expected to be info in /sandbox/sandbox_value.php
    \-- is_named_obj - section for function is_named_obj is expected to be info in /sandbox/sandbox_value.php
    \-- dsp_id_short - section for function dsp_id_short not yet defined that it should be debug in /sandbox/sandbox_val
            ue.php
...
\-- sandbox_value_list
    \-- name_lst - section for function name_lst not yet defined that it should be set and get in /sandbox/sandbox_value
            _list.php
    \-- load_sql_by_phr_lst_multi - section for function load_sql_by_phr_lst_multi is expected to be load sql in /sandbo
            x/sandbox_value_list.php
    \-- load_sql_by_phr_lst_single - section for function load_sql_by_phr_lst_single is expected to be load sql in /sand
            box/sandbox_value_list.php
    \-- load_sql_init - section for function load_sql_init is expected to be load sql in /sandbox/sandbox_value_list.php
    \-- get_by_names_and_context - section for function get_by_names_and_context is expected to be set and get in /sandb
            ox/sandbox_value_list.php
    \-- id_lst - section for function id_lst not yet defined that it should be info in /sandbox/sandbox_value_list.php
    \-- add_by_group - section for function add_by_group not yet defined that it should be modify in /sandbox/sandbox_va
            lue_list.php
    \-- add - section for function add not yet defined that it should be modify in /sandbox/sandbox_value_list.php
    \-- filter_readable_by - section for function filter_readable_by not yet defined that it should be modify in /sandbo
            x/sandbox_value_list.php
\-- ip_range
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /system/ip_r
            ange.php
    ...
    \-- diff_msg - section for function diff_msg is expected to be info in /system/ip_range.php
...
\-- ip_range_list
    ...
    \-- load_sql_obj_vars - section for function load_sql_obj_vars is expected to be load sql in /system/ip_range_list.p
            hp
    \-- load - section for function load not yet defined that it should be loading in /system/ip_range_list.php
    \-- includes - section for function includes not yet defined that it should be using ip range list in /system/ip_ran
            ge_list.php
\-- job
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /system/job.
            php
    ...
    \-- order error - order of section set and get has difference at set_type should be before type_id
\-- job_cache_refresh implements job_exe
    \-- type_code_id - section for function type_code_id is expected to be preloaded in /system/job_cache_refresh.php
    \-- execute - section for function execute not yet defined that it should be interface in /system/job_cache_refresh.
            php
\-- job_db_cleanup implements job_exe
    \-- type_code_id - section for function type_code_id is expected to be preloaded in /system/job_db_cleanup.php
    \-- execute - section for function execute not yet defined that it should be interface in /system/job_db_cleanup.php
\-- job_list
...
\-- job_runner
    \-- __construct - section for function __construct is expected to be construct and map in /system/job_runner.php
    \-- run - section for function run not yet defined that it should be run in /system/job_runner.php
    \-- due_jobs - section for function due_jobs not yet defined that it should be run in /system/job_runner.php
    \-- run_job - section for function run_job not yet defined that it should be run internal in /system/job_runner.php
\-- job_status
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
             in /system/job_status.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper_typ_ob
            j
\-- list_db_read
    \-- api_lst - section for function api_lst not yet defined that it should be set and get in /system/list_db_read.php
    \-- offset - section for function offset not yet defined that it should be set and get in /system/list_db_read.php
    \-- lst_key - section for function lst_key not yet defined that it should be set and get in /system/list_db_read.php
    \-- api_json - section for function api_json not yet defined that it should be api in /system/list_db_read.php
\-- list_db_write
    \-- db_insert_no_log - section for function db_insert_no_log not yet defined that it should be db add in /system/lis
            t_db_write.php
    \-- db_delete_no_log - section for function db_delete_no_log not yet defined that it should be db del in /system/lis
            t_db_write.php
    \-- sql_insert_call_with_par - section for function sql_insert_call_with_par not yet defined that it should be db he
            lper in /system/list_db_write.php
    \-- sql_insert_no_log - section for function sql_insert_no_log not yet defined that it should be db helper in /syste
            m/list_db_write.php
    \-- sql_delete_call_with_par - section for function sql_delete_call_with_par not yet defined that it should be db he
            lper in /system/list_db_write.php
    \-- sql_delete_no_log - section for function sql_delete_no_log not yet defined that it should be db helper in /syste
            m/list_db_write.php
    \-- select_by_name - section for function select_by_name not yet defined that it should be db helper in /system/list
            _db_write.php
    \-- diff - section for function diff not yet defined that it should be filter in /system/list_db_write.php
\-- sys_log
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /system/sys_
            log.php
    \-- status_name - section for function status_name not yet defined that it should be preloaded in /system/sys_log.ph
            p
    ...
    \-- sql_foreign_key - section for function sql_foreign_key not yet defined that it should be sql create in /system/s
            ys_log.php
    ...
    \-- insert - section for function insert not yet defined that it should be save in /system/sys_log.php
    \-- order error - order of section set and get has difference at get_user should be before set_user_id,
...
\-- sys_log_list
    ...
    \-- load - section for function load not yet defined that it should be loading / database access object (DAO) functi
            ons in /system/sys_log_list.php
    \-- load_all - section for function load_all is expected to be load in /system/sys_log_list.php
    \-- add - section for function add not yet defined that it should be loading / database access object (DAO) function
            s in /system/sys_log_list.php
\-- sys_log_status
    \-- row_mapper_typ_obj - section for function row_mapper_typ_obj not yet defined that it should be construct and map
             in /system/sys_log_status.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper_typ_ob
            j
\-- system_time_list
    ...
    \-- show_total - section for function show_total not yet defined that it should be interface in /system/system_time_
            list.php
    \-- section_report - section for function section_report not yet defined that it should be interface in /system/syst
            em_time_list.php
    \-- reset_section - section for function reset_section not yet defined that it should be interface in /system/system
            _time_list.php
...
\-- user_list
    ...
    \-- load_sql_by_profile_and_higher - section for function load_sql_by_profile_and_higher is expected to be load sql 
            in /user/user_list.php
    \-- load_sql_count_changes - section for function load_sql_count_changes is expected to be load sql in /user/user_li
            st.php
    \-- load_sql_count_user_rows - section for function load_sql_count_user_rows is expected to be load sql in /user/use
            r_list.php
    \-- count_user_rows - section for function count_user_rows not yet defined that it should be load in /user/user_list
            .php
    ...
    \-- get - section for function get not yet defined that it should be set and get in /user/user_list.php
    \-- load_dummy - section for function load_dummy is expected to be load in /user/user_list.php
    \-- load_fallback - section for function load_fallback is expected to be load in /user/user_list.php
    ...
    \-- get_by_id - section for function get_by_id is expected to be set and get in /user/user_list.php
    \-- get_by_code_id - section for function get_by_code_id is expected to be set and get in /user/user_list.php
    \-- order error - order of section set and get has difference at id should be before name_lst,
            order of section load has difference at load_by_ids should be before load_sql_by_code_id
\-- user_message
    ...
    \-- clone_reset - section for function clone_reset missing in /user/user_message.php
    ...
    \-- db_row_id_lst - section for function db_row_id_lst not yet defined that it should be set and get in /user/user_m
            essage.php
    \-- added_depending - section for function added_depending not yet defined that it should be set and get in /user/us
            er_message.php
    ...
    \-- add_info_with_vars - section for function add_info_with_vars not yet defined that it should be add in /user/user
            _message.php
    \-- add_warning_with_vars - section for function add_warning_with_vars not yet defined that it should be add in /use
            r/user_message.php
    \-- add_type_message - section for function add_type_message not yet defined that it should be add in /user/user_mes
            sage.php
    \-- add_message_text - section for function add_message_text not yet defined that it should be add in /user/user_mes
            sage.php
    \-- add_warning_text - section for function add_warning_text not yet defined that it should be add in /user/user_mes
            sage.php
    \-- add_info_text - section for function add_info_text not yet defined that it should be add in /user/user_message.p
            hp
    \-- merge - section for function merge not yet defined that it should be add in /user/user_message.php
    \-- add_list_name_id - section for function add_list_name_id not yet defined that it should be add in /user/user_mes
            sage.php
    \-- set_added_depending - section for function set_added_depending is expected to be set and get in /user/user_messa
            ge.php
    \-- unset_added_depending - section for function unset_added_depending not yet defined that it should be add in /use
            r/user_message.php
    \-- is_ok - section for function is_ok is expected to be info in /user/user_message.php
    \-- all_info_text - section for function all_info_text not yet defined that it should be get in /user/user_message.p
            hp
    \-- all_message_text - section for function all_message_text not yet defined that it should be get in /user/user_mes
            sage.php
...
\-- user_profile
    ...
    \-- row_mapper - section for function row_mapper not yet defined that it should be construct and map in /user/user_p
            rofile.php
    \-- order error - order of section construct and map has difference at api_mapper should be before row_mapper_typ_ob
            j
\-- value_base
    \-- row_mapper_sandbox_multi - section for function row_mapper_sandbox_multi not yet defined that it should be const
            ruct and map in /value/value_base.php
    \-- id - section for function id not yet defined that it should be set and get in /value/value_base.php
    \-- source_id - section for function source_id not yet defined that it should be set and get in /value/value_base.ph
            p
    ...
    \-- delta - section for function delta is expected to be del in /value/value_base.php
    \-- name - section for function name is expected to be debug in /value/value_base.php
    ...
    \-- scale_new - section for function scale_new not yet defined that it should be TODO activate in /value/value_base.
            php
    \-- scale - section for function scale not yet defined that it should be TODO activate in /value/value_base.php
    \-- scale_calc - section for function scale_calc not yet defined that it should be TODO activate in /value/value_bas
            e.php
    \-- import_phrase_value - section for function import_phrase_value not yet defined that it should be im- and export 
            in /value/value_base.php
    \-- save_from_api_msg - section for function save_from_api_msg is expected to be save in /value/value_base.php
    \-- figure - section for function figure not yet defined that it should be get functions that return other linked ob
            jects in /value/value_base.php
    \-- convert - section for function convert not yet defined that it should be get functions that return other linked 
            objects in /value/value_base.php
    \-- res_lst_depending - section for function res_lst_depending not yet defined that it should be Select functions in
             /value/value_base.php
    \-- used - section for function used not yet defined that it should be @param user_message $msg to enrich with probl
            ems and suggested solutions in /value/value_base.php
    \-- not_used - section for function not_used is expected to be sandbox in /value/value_base.php
    \-- not_changed - section for function not_changed is expected to be sandbox in /value/value_base.php
    \-- not_changed_sql - section for function not_changed_sql is expected to be sandbox in /value/value_base.php
    ...
    \-- is_std - section for function is_std is expected to be info in /value/value_base.php
    \-- has_usr_cfg - section for function has_usr_cfg not yet defined that it should be @param user_message $msg to enr
            ich with problems and suggested solutions in /value/value_base.php
    ...
    \-- add_wrd - section for function add_wrd not yet defined that it should be @param user_message $msg to enrich with
             problems and suggested solutions in /value/value_base.php
    \-- del_wrd - section for function del_wrd is expected to be del in /value/value_base.php
    \-- save_field_trigger_update - section for function save_field_trigger_update is expected to be save in /value/valu
            e_base.php
    \-- save_set_log_id - section for function save_set_log_id is expected to be save in /value/value_base.php
    \-- add - section for function add not yet defined that it should be @param user_message $msg to enrich with problem
            s and suggested solutions in /value/value_base.php
...
\-- value_list
    ...
    \-- time_list - section for function time_list not yet defined that it should be data retrieval functions in /value/
            value_list.php
    \-- phr_lst - section for function phr_lst not yet defined that it should be data retrieval functions in /value/valu
            e_list.php
    \-- phr_lst_all - section for function phr_lst_all not yet defined that it should be data retrieval functions in /va
            lue/value_list.php
    \-- wrd_lst - section for function wrd_lst not yet defined that it should be data retrieval functions in /value/valu
            e_list.php
    \-- source_lst - section for function source_lst not yet defined that it should be data retrieval functions in /valu
            e/value_list.php
    \-- numbers - section for function numbers not yet defined that it should be data retrieval functions in /value/valu
            e_list.php
    \-- fill_phrase_ids_by_names - section for function fill_phrase_ids_by_names not yet defined that it should be data 
            retrieval functions in /value/value_list.php
    \-- sort - section for function sort not yet defined that it should be filter and select functions in /value/value_l
            ist.php
    \-- keep_most_relevant - section for function keep_most_relevant not yet defined that it should be filter and select
             functions in /value/value_list.php
    \-- filter_by_time - section for function filter_by_time not yet defined that it should be filter and select functio
            ns in /value/value_list.php
    \-- filter_by_phrase_lst - section for function filter_by_phrase_lst not yet defined that it should be filter and se
            lect functions in /value/value_list.php
    \-- filter_by_phrase - section for function filter_by_phrase not yet defined that it should be filter and select fun
            ctions in /value/value_list.php
    ...
    \-- has_values - section for function has_values not yet defined that it should be filter and select functions in /v
            alue/value_list.php
    \-- remove_list - section for function remove_list not yet defined that it should be filter and select functions in 
            /value/value_list.php
    \-- phrase_groups - section for function phrase_groups not yet defined that it should be convert in /value/value_lis
            t.php
    \-- common_phrases - section for function common_phrases not yet defined that it should be convert in /value/value_l
            ist.php
    \-- check_all - section for function check_all not yet defined that it should be check / database consistency functi
            ons in /value/value_list.php
    \-- del - section for function del is expected to be del in /value/value_list.php
    \-- order error - order of section load has difference at load_sql_by_ids should be before load_by_id
\-- value_text
...
\-- value_time_series
    ...
    \-- load_sql_by_grp - section for function load_sql_by_grp is expected to be load sql in /value/value_time_series.ph
            p
...
\-- value_ts_data
    \-- sql_table - section for function sql_table not yet defined that it should be sql create in /value/value_ts_data.
            php
    \-- sql_index - section for function sql_index not yet defined that it should be sql create in /value/value_ts_data.
            php
    \-- sql_foreign_key - section for function sql_foreign_key not yet defined that it should be sql create in /value/va
            lue_ts_data.php
\-- verb_list
    \-- load_by_linked_phrases_sql - section for function load_by_linked_phrases_sql is expected to be load in /verb/ver
            b_list.php
    \-- load_by_linked_phrases - section for function load_by_linked_phrases is expected to be load in /verb/verb_list.p
            hp
    \-- fill_from_api_rows - section for function fill_from_api_rows not yet defined that it should be loading in /verb/
            verb_list.php
    ...
    \-- term_lst_of_names - section for function term_lst_of_names not yet defined that it should be info in /verb/verb_
            list.php
    \-- add_verb - section for function add_verb not yet defined that it should be modify in /verb/verb_list.php
    \-- calc_usage - section for function calc_usage is expected to be ui support in /verb/verb_list.php
    ...
    \-- selector_list - section for function selector_list not yet defined that it should be extract in /verb/verb_list.
            php
\-- term_view_list
...
\-- view_list
    ...
    \-- load_sql_by_component_id - section for function load_sql_by_component_id is expected to be load sql in /view/vie
            w_list.php
    \-- load_sql_by_pattern - section for function load_sql_by_pattern is expected to be load sql in /view/view_list.php
...
\-- triple_list
    ...
    \-- load_sql_by_verb - section for function load_sql_by_verb is expected to be load sql in /word/triple_list.php
    \-- load_sql_by_phr_lst - section for function load_sql_by_phr_lst is expected to be load sql in /word/triple_list.p
            hp
    \-- load_sql - section for function load_sql is expected to be load sql in /word/triple_list.php
    \-- has_values - section for function has_values not yet defined that it should be information in /word/triple_list.
            php
    ...
    \-- sort_by_impact - section for function sort_by_impact not yet defined that it should be sort in /word/triple_list
            .php
    \-- phrase_list - section for function phrase_list is expected to be cast in /word/triple_list.php
    \-- phrase_lst_of_names - section for function phrase_lst_of_names not yet defined that it should be convert in /wor
            d/triple_list.php
    \-- triples_to_add_to_db - section for function triples_to_add_to_db not yet defined that it should be convert in /w
            ord/triple_list.php
    \-- phrase_parts - section for function phrase_parts not yet defined that it should be parts in /word/triple_list.ph
            p
    \-- missing_ids - section for function missing_ids not yet defined that it should be parts in /word/triple_list.php
    \-- get_link_conflict - section for function get_link_conflict is expected to be set and get in /word/triple_list.ph
            p
    \-- rename_link_conflicts - section for function rename_link_conflicts not yet defined that it should be parts in /w
            ord/triple_list.php
    \-- fill_by_name - section for function fill_by_name not yet defined that it should be save in /word/triple_list.php
    \-- fill_missing_verbs - section for function fill_missing_verbs not yet defined that it should be save in /word/tri
            ple_list.php
    \-- get_ready - section for function get_ready is expected to be save helper in /word/triple_list.php
    \-- order error - order of section load has difference at load_by_ids should be before load_names
\-- word_list
    ...
    \-- foaf_parents - section for function foaf_parents not yet defined that it should be im- and export in /word/word_
            list.php
    \-- parents - section for function parents is expected to be foaf in /word/word_list.php
    \-- children - section for function children is expected to be foaf in /word/word_list.php
    \-- direct_children - section for function direct_children not yet defined that it should be im- and export in /word
            /word_list.php
    \-- is - section for function is not yet defined that it should be im- and export in /word/word_list.php
    \-- are - section for function are is expected to be foaf in /word/word_list.php
    \-- contains - section for function contains not yet defined that it should be im- and export in /word/word_list.php
    \-- are_and_contains - section for function are_and_contains is expected to be foaf in /word/word_list.php
    \-- differentiators - section for function differentiators not yet defined that it should be im- and export in /word
            /word_list.php
    \-- differentiators_all - section for function differentiators_all not yet defined that it should be im- and export 
            in /word/word_list.php
    \-- differentiators_filtered - section for function differentiators_filtered not yet defined that it should be im- a
            nd export in /word/word_list.php
    \-- keep_only_specific - section for function keep_only_specific not yet defined that it should be im- and export in
             /word/word_list.php
    ...
    \-- remove - section for function remove not yet defined that it should be modify in /word/word_list.php
    ...
    \-- phrase_list - section for function phrase_list is expected to be cast in /word/word_list.php
    \-- phrase_lst_of_names - section for function phrase_lst_of_names not yet defined that it should be convert in /wor
            d/word_list.php
    \-- value - section for function value not yet defined that it should be convert in /word/word_list.php
    \-- value_scaled - section for function value_scaled not yet defined that it should be convert in /word/word_list.ph
            p
    ...
    \-- max_time - section for function max_time not yet defined that it should be select functions - predefined data re
            trieval in /word/word_list.php
    \-- max_val_time - section for function max_val_time not yet defined that it should be select functions - predefined
             data retrieval in /word/word_list.php
    \-- assume_time - section for function assume_time not yet defined that it should be select functions - predefined d
            ata retrieval in /word/word_list.php
    \-- order error - order of section load has difference at load_by_ids should be before load_like,
...
\-- 
    ...
    \-- load_dummy
        ...
        \-- db_cache_status_list - adding the db_cache type used for unit tests to a dummy list
        \-- db_cache_type_list - adding the db_cache type used for unit tests to a dummy list
    ...
    \-- default_id
        ...
        \-- db_cache_status_list - return the database id of the default db_cache type
        \-- db_cache_type_list - return the database id of the default db_cache type
        ...
        \-- sys_log_level_list - return the database id of the default system log status
        ...
        \-- user_status_list - return the database id of the default user status
        \-- user_type_list - return the database id of the default user profile
    ...
    \-- __construct
        \-- sql_message - assumes that normally everything is fine
        ...
        \-- import - 
        \-- import_file - 
        \-- user_message - assumes that normally everything is fine
        \-- view_sys_list - 
    \-- reset
        \-- sql_message - clear the accumulated messages so the object can be reused for the next change request
        \-- user_message - clear the accumulated messages so the object can be reused for the next change request
    \-- clone_reset
        \-- sql_message - create user message list without errors but with the original user
        \-- user_message - create user message list without errors but with the original user
    \-- has_par
    ...
    \-- api_json_array
        \-- element_group - create an array for the api json message
    ...
    \-- 14
        \-- import_convert_xbrl - build the complete zukunft.com style data array from the extracted facts.
    \-- convert
        \-- convert_wikipedia_table - convert a wikipedia table to a zukunft.com json string
        \-- import_convert_xbrl - end-to-end conversion: read the zip, extract the sales, build the data,
    \-- convert_wiki_json
        \-- convert_wikipedia_table - convert a wikitable2json to a zukunft.com json
    \-- convert_folder
        \-- import_convert_xbrl - convert an unpacked XBRL fileset folder into the zukunft.com import JSON.
    \-- convert_to_file
        \-- import_convert_xbrl - convert the XBRL zip into a JSON file. Replaces the CLI main() of the
    \-- convert_folder_to_file
        \-- import_convert_xbrl - convert an unpacked XBRL fileset folder into a JSON file saved in the same folder
    \-- convert_facts
        \-- import_convert_xbrl - convert XBRL facts into the zukunft.com import JSON
    \-- convert_facts_to_file
        \-- import_convert_xbrl - convert an XBRL facts file into an import JSON file saved in the same folder
    \-- get_entity_json
        \-- import_wikidata - retrieve the entity data json from wikidata for the given wikidata id e.g. "Q167" for Pi
    \-- get_property_json
        \-- import_wikidata - retrieve the property data json from wikidata for the given property id e.g. "P2284" for p
                rice
    \-- store_json
        \-- import_wikidata - retrieve and store the json received from wikidata for the given entity or property id as 
                a test resource file
    \-- store_text
        \-- import_wikidata - store the given json for the given wikidata id as a formatted test resource file
    \-- echo_timestamped
...
\-- load
    ...
    \-- 1
        ...
        \-- db_object_key - parent function to create the common part of an SQL statement for group,
                 value and result tables
        \-- db_object_no_id - parent function to create the common part of an SQL statement for group,
                 value and result tables
        \-- change - load the last change of given user
        \-- view_sys_list - set the SQL query parameters to load a list of views from the database that have a used code
                 id
    \-- load_sql
        ...
        \-- group_link - create the common part of an SQL statement to get the phrase group triple link from the databas
                e
        \-- db_cache - create the common part of an SQL statement to retrieve the parameters of a batch db_cache from th
                e database
        ...
        \-- change_value_geo - create the common part of an SQL statement to retrieve the parameters of the value change
                 log
        \-- change_value_text - create the common part of an SQL statement to retrieve the parameters of the value chang
                e log
        \-- change_value_time - create the common part of an SQL statement to retrieve the parameters of the value chang
                e log
    \-- load_obj_by_id
    ...
    \-- load_sql_by_id
        ...
        \-- db_object_multi - create an SQL statement to retrieve a user sandbox object by id from the database
    \-- load_by_frm
    ...
    \-- load_sql_by_frm_and_type_id
        \-- element_list - set the SQL query parameters to load a list of formula elements by the formula id and filter 
                by the element type
    \-- get_by_link_id
        \-- element_list - set the SQL query parameters to load a list of formula elements by the formula id and filter 
                by the element type
    \-- 5
        ...
        \-- sandbox_value_list - get the first value or result of the list that is related to all given phrase names
    \-- load_phrases
        \-- figure_list - set the SQL query parameters to load a list of figure objects
    ...
    \-- load_by_frm_id
        \-- formula_link_list - load a list of formula links with the direct linked phrases related to the given formula
                 id
    \-- load_sql_by_ids
        \-- formula_link_list - set the SQL query parameters to load a list of formula links by the formula link ids
    ...
    \-- fill_from_cache_json
        \-- config_numbers - build the complete config value objects from the cached json
    \-- load_frontend_cfg
    ...
    \-- load_by_url
        \-- db_cache_page - load a cached html page from the database selected by url
    \-- html_by_url
        \-- db_cache_page - get the cached html page for the given url
    \-- load_by_key
    ...
    \-- load_type_lists_cached
        \-- system_object - load the type lists from the cached types json with one database read
    \-- load_cache_type
        \-- system_object - load the cache types and statuum upfront from the database
    \-- load_system_users
        \-- system_object - load all system users that have a code id
    \-- load_from_csv_resource
        \-- type_list - TODO Prio 1 check if the overwrites can be removed
    \-- load_cached
        \-- type_lists - load the type lists from the cached types json with one database read
    \-- from_cache
        \-- type_lists - @return bool true if the type lists have been filled from the cached types json
    \-- reload_if_cache_denied
        \-- type_lists - reload the type lists from the database if the pod switch denies the types cache
    \-- fill_from_api_json
    ...
    \-- load_log_if_empty
        \-- type_lists - reload the cache used for logging the changes
    \-- load_log
        \-- type_lists - reload the cache used for logging the changes
    \-- load_core
        \-- type_lists - load the core type lists needed for the api
    \-- load_backend_only
        \-- type_lists - load the backend-only type lists
    \-- load_sql_by_user
    ...
    \-- load_sql_old
        \-- change - create the SQL statement to retrieve the parameters of the change log by name
    \-- load_by_name_and_table_id
        \-- change_field - load the change log table field from the database selected by the table id and the field name
    \-- load_sql_by_name_and_table_id
        \-- change_field - create an SQL statement to retrieve a type object by code id from the database
    \-- load_by_field_row
    ...
    \-- load_by_obj
        \-- change_log_link_list - load the link changes related to one object e.g. all links added to or removed from a
                 word
    \-- load_sql_by_obj
        \-- change_log_link_list - create the SQL statement to load the link changes related to one object from the chan
                ge_links table
    \-- add
        \-- change_log_link_list - add one link change to the list
    \-- load_by_user
        \-- change_log_list - load the changes of one user including the value changes,
                 which are logged in one table per
    \-- load_obj_last
    ...
    \-- load_names
        \-- term_list - load a list of term names
    \-- load_like
    ...
    \-- load_sbx_names
        \-- sandbox_list - load only the id and name of sandbox objects (e.g. phrases or values) based on the given quer
                y parameters
    \-- load_user_changes
...
\-- load sql
    ...
    \-- load_by_ids
        ...
        \-- view_relation_list - load a list of view relations by the given view relation ids
    \-- load_sql
        \-- component_link_list - set the common part of the SQL query component links
        \-- db_cache_page - create the common part of an SQL statement to retrieve a cached html page from the database
        \-- ip_range - create the common part of an SQL statement to retrieve an ip range from the database
    ...
    \-- load_sql_by_user_value
        \-- change_log_list - create an SQL statement to retrieve the value overwrites done by the given user from one o
                f
    \-- load_sql_like
        \-- term_list - create an SQL statement to retrieve a list of terms from the database
    \-- load_sql_by_phr_id
...
\-- im- and export
    \-- 1
        \-- ip_range - import an ip range from an imported json object
    \-- export_json
        \-- component_link_list - create an array with the export json fields
        \-- ref_type - create an array with the export json fields
        \-- sandbox_list - create an array with one export json array for each list item
        \-- ip_range - create an array with the export json fields
    ...
    \-- id
        \-- type_list - return the database row id based on the code_id,
    \-- id_by_name
        \-- type_list - return the database row id based on the name
    \-- name
        \-- type_list - return a user-specific type name based on the database row id
    \-- name_or_null
        \-- type_list - return a user-specific type name based on the database row id
    \-- code_id
        \-- type_list - return a user-specific type name based on the database row id
\-- modify
    ...
    \-- 1
        \-- element_list - add an object to the list that does
        \-- term_list - removes all terms from this list that are not in the given list
    ...
    \-- add
        ...
        \-- figure_list - add one figure to the figure list, but only if it is not yet part of the figure list
    ...
    \-- remove
        ...
        \-- term_list - remove all terms from the given list from this list
    \-- merge
        \-- element_list - add one formula element to the list and keep the order (contrary to the parent function)
        \-- type_list - return a user-specific type name based on the database row id
        \-- job_list - merge all jobs of the given batch job list to this list
    \-- filter_readable_by
        \-- figure_list - drop the figures the requesting user may not read, so a figure list returned by the api never
        \-- sandbox_value_list - drop the values or results the requesting user may not read,
                 so a list returned by the api
    \-- 2
    ...
    \-- del
        \-- db_cache - remove this cache entry from the database (used by the cache refresh job to invalidate an outdate
                d entry)
        \-- ref_list - add a reference to the list that does not yet have an id but has the phrase name,
                 the type and the external key set
    ...
    \-- fill
        ...
        \-- value_geo - fill this sandbox object based on the given object
        \-- value_text - fill this sandbox object based on the given object
        \-- value_time - fill this sandbox object based on the given object
    \-- add_verb
        \-- system_object - create a fallback user only in development to allow testing without a fully seeded DB
        \-- verb_list - add a verb to the list
    \-- query_extension
        \-- value_type_list - 
    \-- dsp_last
    ...
    \-- use_type_id
        \-- change_log - display the last change related to one object (word, formula, value, verb, ...)
    \-- merge_by_name
        \-- term_list - add the terms of the given list to this list
    \-- filter_valid
        \-- term_list - leave only the valid words, triples, verbs and formulas in this list
    \-- add_link
    ...
    \-- add_obj
        \-- sandbox_list - add one object to the list of user sandbox objects,
                 but only if it is not yet part of the list
    \-- add_by_name
        \-- verb_list - add a verb to the list that does not yet have an id but has a name
    \-- calc_usage
        \-- verb_list - calculates how many times a word is used, because this can be helpful for sorting
\-- del
    \-- del
    ...
    \-- del_without_log
        \-- element_list - remove all duplicate links from this list
    \-- del_sql_without_log
...
\-- info
    ...
    \-- ids
        \-- element_list - get the first ids from the list e.g. to show it to humans
    \-- is_valid
        \-- expression - @return bool true if the formula expression is valid
    \-- has_ref
        \-- expression - @returns bool true if the formula contains a word, verb or formula link
    \-- symbols
        \-- expression - array with all term symbols use in the formula
    \-- terms_missing
        \-- expression - get a term id of terms that are not part of the given term list
    \-- terms_following
    ...
    \-- is_outdated
        \-- db_cache - @return bool true if this cache entry has no data or is older than the max cache age
    \-- log_name_field
        \-- db_object - name of log entry used shown to the user which entry has been deleted
    \-- delta
        \-- db_object_multi - Create an object where only the vars are set
        \-- value_geo - Create an object where only the vars are set
        \-- value_text - Create an object where only the vars are set
        \-- value_time - Create an object where only the vars are set
    \-- isset
        \-- db_object_multi - @return bool true if the object has a valid database id
    \-- diff_msg
        \-- db_object_multi - create human-readable messages of the differences between the db id objects
    ...
    \-- term_lst_of_names
        \-- verb_list - convert this verb list object into a term list object
\-- save
    \-- 1
    ...
    \-- save
        ...
        \-- ref_list - store all references from this list in the database using grouped calls of predefined sql functio
                ns
        \-- ip_range - update an ip range in the database or update the existing
        \-- ip_range_list - store all ip ranges from this list in the database using grouped calls of predefined sql fun
                ctions
        \-- verb_list - simple loop to save all verbs of the list
...
\-- sql fields
    ...
    \-- name_field
        \-- view_style - 
        \-- db_cache - get a list of database field names, values and types that have been updated
...
\-- construct and map
    \-- __construct
        ...
        \-- db_cache - always set the status
        \-- db_object_multi - reset the id to null to indicate that the database object has not been loaded
        \-- db_object_multi_user - @param user $usr the user how has requested to see his view on the object
        \-- system_object - always set the user because someone must always have requested to create the list
        \-- type_list - @param bool $usr_can_add true if some types might not yet have a code id
        \-- type_lists - 
        ...
        \-- value_time_series - set the user sandbox type for a value time series object and set the user,
                 which is needed in all cases
        \-- verb_list - define the settings for this verb list object
    \-- reset
        \-- element - reset the vars of this element
        \-- combine_named - set the object vars of a phrase or term to the neutral initial value
        \-- db_cache - clear all cache object values e.g. to detect the changed fields
        ...
        \-- value_time_series - set the user sandbox type for a value time series object and set the user,
                 which is needed in all cases
    \-- clone_all
        \-- element - clone this object and all linked objects
    \-- row_mapper_sandbox
    ...
    \-- api_mapper
        ...
        \-- figure_list - map a figure list api json to this model figure list object
    ...
    \-- row_mapper
        \-- db_cache - map the database fields to one change log entry to this log object
        \-- db_cache_page - map the database fields to this cached html page object
        ...
        \-- ip_range - map the database fields to this ip range object
    \-- row_mapper_multi
        \-- db_object_multi - map the database fields to the object fields
    \-- row_mapper_typ_obj
        \-- change_field - fill the change field object vars based on an array of fields from the database
    ...
    \-- import_mapper
        \-- ref_type - function to import the core reference type values from a json string
        \-- ip_range - set the vars of this ip range object based on the given json without writing to the database
\-- set and get
    \-- set_db_type
    ...
    \-- set_id_field_usr_dummy
        \-- sql_creator - set a dummy id field for a union query
    \-- set_par_list
        \-- sql_creator - set the complete par list e.g. for union queries to get the parameters from the previous union
                 part
    \-- par_list
        \-- sql_creator - set the complete par list e.g. for union queries to get the parameters from the previous union
                 part
    ...
    \-- set_url
        \-- sql_message - @param string $url the url used to trace to progress
        \-- user_message - @param string $url the url used to trace to progress
    \-- url
        \-- sql_message - @param string $url the url used to trace to progress
        \-- user_message - @param string $url the url used to trace to progress
    \-- set_checksum
        \-- sql_message - set a simple checksum e.g. for a fast import validation
        \-- user_message - set a simple checksum e.g. for a fast import validation
    \-- checksum
        \-- sql_message - @return int|null the number of values that have been expected to be imported
        \-- user_message - @return int|null the number of values that have been expected to be imported
    \-- db_row_id_lst
        \-- sql_message - @return int|null the number of values that have been expected to be imported
        \-- user_message - @return int|null the number of values that have been expected to be imported
    \-- added_depending
    ...
    \-- set_object_by_id
        \-- element - set the element object by the id and the type id
    \-- trm_id
        \-- element - @return int|null the database id of the related object
    \-- term
        \-- element - @return int|null the database id of the related object
    \-- set_type
        \-- element - set the element type based on the given term or the already set element object
        \-- db_cache - map the database fields to one change log entry to this log object
    \-- type
        \-- element - set the element type based on the given term or the already set element object
    \-- term_list
    ...
    \-- set_share
        \-- combine_named - @param string|null $code_id the code id of the target share type or null to remove the paren
                t overwrite
    \-- set_protection
        \-- combine_named - @param string|null $code_id the code id of the target protection or null to remove the paren
                t overwrite
    \-- type_id
    ...
    \-- set_plural
        \-- combine_named - @param string|null $plural the code id of the target protection or null to remove the parent
                 overwrite
    \-- set_obj
        \-- combine_object - a combine object always covers an existing object
    \-- obj
    ...
    \-- get_by_names
        \-- config_numbers - get the first config value that is assigned to all given phrase names
    \-- set_cache_json
        \-- config_numbers - use the cached config json for the value lookups of this request (see get_by_names),
    \-- unique_value
    ...
    \-- set_user
        ...
        \-- verb_list - set the user of the verb list
    ...
    \-- get_user
        ...
        \-- verb_list - @return user|null the person who wants to see the verbs
    ...
    \-- import_system_data
        \-- import_file - TODO fill a user_message with the warning and error messages and return true if successful
    \-- import_pod_config
        \-- import_file - import the default pod base configuration json files
    \-- import_sample_view_data
    ...
    \-- key
        \-- ip_range - @return string|null the unique key of the ip range
    \-- api_lst
        \-- list_db_read - @return array with the API object of the values
    \-- set_offset
        \-- list_db_read - @return array with the API object of the values
    \-- offset
        \-- list_db_read - @return array with the API object of the values
    \-- lst_key
        \-- list_db_read - @returns array with the names on the db keys
    \-- set_value
...
\-- basic interface function for the private class parameter
    ...
    \-- set_fields_dummy
        \-- sql_creator - define the fields that should be returned in a select query with dummy values for a union quer
                y
    ...
    \-- set_usr_num_fields
        \-- sql_creator - set the SQL statement for the numeric user sandbox fields that should be returned in a select 
                query
    \-- set_usr_geo_fields
        \-- sql_creator - set the SQL statement for the geo point user sandbox fields that should be returned in a selec
                t query
    \-- set_usr_only_fields
        \-- sql_creator - set the SQL statement for the geo point user sandbox fields that should be returned in a selec
                t query
...
\-- internal where
    ...
    \-- get_page
        \-- sql_creator - @return string the page statement that needs to be created after all other parameter have been
                 requested
    \-- par_count
    ...
    \-- sql_view_header
        \-- sql_creator - @return string a sql separator just to improve formatting
    \-- get_par
        \-- sql_creator - @return array with the parameter values in the same order as the given SQL parameter placehold
                ers
    \-- get_par_types
        \-- sql_creator - @return array with the parameter values in the same order as the given SQL parameter placehold
                ers
...
\-- private sql helpers
    \-- get_table
        \-- sql_creator - @return string the name of the table as defined by set_table,
                 so including the prefix and extension
...
\-- field, value and sql field type list
    \-- get_fields
        \-- sql_creator - @param array $fld_val_typ_lst an array with an array of the field name,
                 value and the sql field type
    \-- get_values
        \-- sql_creator - @param array $fld_val_typ_lst an array with an array of the field name,
                 value and the sql field type
    \-- get_types
...
\-- api
    \-- api_array
        \-- sql_message - create a json array to send the messages to the frontend
        \-- user_message - create a json array to send the messages to the frontend
    \-- api_json
        \-- sql_message - @return string the json message to the backend as a string
        \-- combine_object - create the api json message string of this combine object for the frontend
        \-- db_object_multi - create the api json message string of this database object based on more than one table fo
                r the frontend
        \-- type_list - create the api json message string for this list
        \-- type_lists - create the api message based on the loaded types
        \-- list_db_read - create the api json message string for this list
        \-- user_message - @return string the json message to the backend as a string
    \-- api_mapper
        \-- sql_message - fill the vars with this database message object based on the given api json array
        \-- ref_type - function to import the core reference type values from a json string
        \-- user_message - fill the vars with this database message object based on the given api json array
    \-- api_json_array
        \-- element - create an array for the api json creation
        \-- combine_object - create an array for the api json message
        \-- db_cache - create an array for the api json creation
        \-- db_cache_page - create an array for the api json creation
        \-- db_object_multi - create an array for the api json creation
        \-- type_list - create the api json message string for this list
        \-- type_lists - @return array with all preloaded types
        \-- change - create an array for the api json message
    ...
    \-- load_dummy
        \-- type_lists - set all type list to dummy fallback values
    \-- load_sql_by_user
    ...
    \-- add_link_ref
        \-- change_link - load the name of the changed word to show it in the change log
    \-- dsp_last
    ...
    \-- changes_array
        \-- sandbox_related - the changes of the given object for the changes tab of the object page
    \-- load_changes
        \-- sandbox_related - fill changes_related of the given object for changes_array()
    \-- overwrites_array
        \-- sandbox_related - the user sandbox overwrites of the given object for the 'my' and 'others' tab
    \-- user_overwrites
        \-- sandbox_related - the fields that the user of the given object has overwritten in the user sandbox (overlay)
    \-- other_overwrites
        \-- sandbox_related - the fields that users other than the user of the given object have overwritten in the user
\-- add
    \-- add_info_with_vars
        \-- sql_message - add an info message id and a list of related variables
        \-- user_message - add an info message id and a list of related variables
    \-- add_warning_with_vars
        \-- sql_message - add a warning message with variables
        \-- user_message - add a warning message with variables
    \-- add_type_message
        \-- sql_message - to offer the user to see more details without a retry,
        \-- user_message - to offer the user to see more details without a retry,
    \-- add_message_text
        \-- sql_message - to offer the user to see more details without a retry
        \-- user_message - to offer the user to see more details without a retry
    \-- add_warning_text
        \-- sql_message - show the warning message to the user without interrupting the process
        \-- user_message - show the warning message to the user without interrupting the process
    \-- add_info_text
        \-- sql_message - show the info message to the user without interrupting the process
        \-- user_message - show the info message to the user without interrupting the process
    \-- merge
        \-- sql_message - combine the given message with this message
        \-- user_message - combine the given message with this message
    \-- add_list_name_id
    ...
    \-- get_by_val_with_one_phr_each
        \-- group_list - query to get the value or formula result phrase groups and time words that contains at least on
                e phrase of two lists based on the user sandbox
    \-- get_by_val_special
        \-- group_list - query to get the value or formula result phrase groups and time words that contains at least on
                e phrase of two lists based on the user sandbox
...
\-- get
    \-- is_ok
        \-- sql_message - @return bool true if user does not need to be informed
        \-- user_message - @return bool true if user does not need to be informed
    \-- all_info_text
        \-- sql_message - return the info only message text with all messages
        \-- user_message - return the info only message text with all messages
    \-- all_message_text
        \-- sql_message - return the translated message text with all messages
        \-- user_message - return the translated message text with all messages
    \-- get_message
        \-- sql_message - simple return the message text
        \-- user_message - simple return the message text
    \-- get_last_message
    ...
    \-- has_msg
        \-- sql_message - @return bool true if any message has been added to this user message
        \-- user_message - @return bool true if any message has been added to this user message
    \-- has_row
        \-- sql_message - @return bool true if the message is linked to a valid database row of just a database row has 
                been created
...
\-- debug
    \-- dsp_id
        ...
        \-- figure_list - create a text that describes the figures for unique identification
        \-- group_list - @param term_list|null $trm_lst a cached list of terms
        \-- db_cache - 
        \-- db_cache_page - check if the cached html page can be added to the database
        \-- db_object - TODO Prio 1 make sure that this function is always called before tying to update a database row
        \-- db_object_multi - @return string with the unique database id mainly for child dsp_id() functions
        \-- type_list - @return string the verb list with the internal database ids for debugging
    ...
    \-- name
        ...
        \-- db_cache - check if the database cache can be added to the database
        \-- db_cache_page - check if the cached html page can be added to the database
    ...
    \-- ids_txt
        \-- figure_list - return a list of the figure list ids as sql compatible text
    \-- names
    ...
    \-- check
        \-- group_list - return a list of the word names
    \-- dsp_id_user
        \-- db_object_multi_user - @returns string best possible identification for this object mainly used for debuggin
                g
\-- info sql type
    \-- do_log
        \-- sql_type_list - @return bool true if the changes should be added to the change log
    \-- no_log
        \-- sql_type_list - @return bool true if the changes should never be added to the change log
    \-- no_id_field
        \-- sql_type_list - @return bool true if the field list should not include the id field e.g. because the field l
                ist is used for a pure insert statement
    \-- is_call_only
...
\-- info for value table selection
    \-- is_most
        \-- sql_type_list - @return bool true to select the table for values and results linked to an average number of 
                phrases
    \-- is_main
        \-- sql_type_list - @return bool true to select the table for values and results linked to an a bit more number 
                of phrases
    \-- is_prime
...
\-- info for sql functions
    ...
    \-- is_usr_tbl_and_select
        \-- sql_type_list - @return bool true if sql should point to the user sandbox table and only the values for the 
                given user should be selected
    \-- is_norm
        \-- sql_type_list - @return bool true if sql should return the normal values and not the user-specific
    \-- is_standard
        \-- sql_type_list - @return bool true if only the value without the sandbox parameters like share and protection
                 should be saved
    \-- get_all
...
\-- forward
    ...
    \-- is_formula
        \-- element - create an SQL statement to retrieve a formula element by id from the database
    \-- db_ready
        \-- element - checks if the element object can be added to the database
\-- validate
    \-- validate_type
        \-- element - check if the object contradicts the element type
\-- sql write
    \-- sql_insert
    ...
    \-- sql_prepare
        \-- element - create the sql statement to update a word in the database
    \-- sql_delete
        \-- element - create the sql statement to delete or exclude a named sandbox object e.g. word to the database
    \-- 1
    ...
    \-- sql_type
        ...
        \-- change_log - @return sql_type the sql type of the change e.g. if a value is changes it returns sql_type::UPD
                ATE
        \-- change_value - @return sql_type the sql type of the change e.g. if a value is changes it returns sql_type::U
                PDATE
    \-- sql_sub_type
        \-- change - @return sql_type an addition sql type for the change e.g. if the phrase type is changed REF is adde
                d
        \-- change_log - @return sql_type an addition sql type for the change e.g. if the phrase type is changed REF is 
                added
    \-- sql_insert_link
    ...
    \-- sql_insert_key_field
        \-- ip_range - create the sql statement to add a object e.g. word to the database
\-- sql write fields
    \-- db_fields_all
        \-- element - to get a list of all database fields that might be changed,
        \-- db_cache - get a list of all database fields that might be changed
...
\-- display
    ...
    \-- build_symbol
        \-- element_group - show the element group name to the user in the most simple form (without any ids)
    \-- figures
        \-- element_group - get a list of figures related to the formula element group and a context defined by a list o
                f words
    \-- echo_text_log
    ...
    \-- echo_log
        \-- text_log - write a test result text or a log entry text to the standard io
    \-- echo_lines
        \-- text_log - the single place that writes text to the standard io with the runtime timestamp
    \-- time_stamp_lines
        \-- text_log - put the runtime timestamp in front of every physical line of the given text
\-- filter
    \-- diff
        \-- element_list - get all objects that are not in the given list
        \-- list_db_write - get all objects that are not in the given list
    \-- predefined_following
        \-- element_list - get the formula elements from this list that use the verb following
    \-- unique
        \-- element_list - remove all duplicate links from this list
    \-- phrases
...
\-- id lists
    \-- term_id_list
        \-- expression - get a term list with all term ids used in the formula expression
    \-- phrase_id_list
        \-- expression - get a phrase list with all phrase ids used for the formula result
    \-- term_id_list_all
        \-- expression - get a term list with all term ids used in the formula expression including the result phrases
\-- objects
    \-- element_list
        \-- expression - get a list with all formula elements used for the calculation of the expression result
    \-- elements_incl_result_phrases
        \-- expression - get an element list with all formula elements
    \-- result_phrases
        \-- expression - get a list of the phrases that should be added to the result
    \-- terms
        \-- expression - get a term list with all term ids used in the formula expression
\-- to deprecate
    \-- load_result_phrases
...
\-- database link
    ...
    \-- is_valid
        \-- group_id - test if the group id can be used to save a value or result in the database
    \-- table_extension
...
\-- predefined
    ...
    \-- cache_allowed
        \-- config_numbers - the pod setting that decides if the given database cache is used
    \-- page_cache_allowed
...
\-- sql
    \-- sql_delete
        \-- db_id_object_non_sandbox - create the sql statement to delete or exclude a named sandbox object e.g. word to
                 the database
\-- sql create
    \-- sql_table_create
...
\-- map
    \-- row_mapper
        \-- db_object - just reset the modified flag; the field mapping is done by the child objects
\-- dummy functions that should always be overwritten by the child
    \-- name
        \-- db_object_multi - get the name of the database object (only used by named objects)
    \-- load_by_id
        \-- db_object_multi - load a row from the database selected by id
    \-- load_by_id_with_related
        \-- db_object_multi - load a row by id like load_by_id, but also populate the "most often used related
\-- json
    \-- get_term
        \-- object_mapper - get or create a word, verb,
                 triple or formula by the name or the json array from this cache object
\-- TODO Prio 2 activate
    \-- get_view
        \-- object_mapper - get or create a view by the name or the json array from this cache object
    \-- get_source
        \-- object_mapper - get or create a source by the name or the json array from this cache object
\-- user
    \-- user_log
        \-- system_object - load all system users that have a code id
\-- interface
    ...
    \-- admin_user
        \-- system_object - get a preloaded admin user
    \-- type_code_id
        \-- job_cache_refresh implements job_exe - @return string the code id of the job type this handler executes
        \-- job_db_cleanup implements job_exe - @return string the code id of the job type this handler executes
    \-- execute
        \-- job_cache_refresh implements job_exe - invalidate every outdated system cache so the next request regenerate
                s a fresh, warm entry
        \-- job_db_cleanup implements job_exe - remove the completed jobs whose end time is older than the retention per
                iod
    \-- switch
...
\-- interface set and get
    \-- get_or_insert
        \-- type_list - get the type object with this name from the list
    \-- add
        \-- type_list - get the type object with this name from the list
\-- database (dao) functions
    \-- load_sql
        \-- type_list - set the common part of the sql parameters to load all rows of one 'type of database type'
    \-- load_sql_all
        \-- type_list - the sql parameters to load all rows of one 'type of database type'
    \-- class_to_type_object
        \-- type_list - get the type object for a given type class
    \-- fill_from_api_rows
        \-- type_list - fill this list from the api json rows of the cached types message
    \-- load
        \-- type_list - reload a type list from the database e.g. because a translation has changed and fill the hash ta
                ble
\-- unit test support functions
    \-- load_dummy
        \-- type_list - create a dummy type list for the unit tests without database connection
    \-- view_id_list
        \-- type_list - @param array $code_id_list with the code ids that should be converted
    \-- component_id_list
        \-- type_list - @param array $code_id_list with the code ids that should be converted
...
\-- convert
    \-- convert
        \-- import_wikidata - create a zukunft.com import json array from a wikidata entity json and a wikidata property
                 json
    \-- convert_to_file
        \-- import_wikidata - convert the given wikidata entity and property json to a zukunft.com import json and write
                 it to the cache folder
    \-- cleanup_file
        \-- import_wikidata - remove a cache file created by convert_to_file,
                 e.g. as an optional cleanup after the import
\-- format
    \-- dsp
...
\-- get function
    ...
    \-- ids_txt
        \-- term_list - return a list of the term list ids as sql compatible text
    \-- term_ids
        \-- term_list - @return trm_ids with the sorted term ids where a triple has a negative id
    \-- term_by_obj_id
        \-- term_list - get a term from the term list selected by the word, triple, formula or verb id
    \-- get_by_ids
        \-- term_list - get the terms of the list selected by the given ids
    \-- word_by_id
        \-- term_list - get a word from the term list selected by the word id
    \-- triple_by_id
        \-- term_list - get a triple from the term list selected by the triple id
    \-- formula_by_id
        \-- term_list - get a formula from the term list selected by the formula id
    \-- verb_by_id
        \-- term_list - get a verb from the term list selected by the verb id
\-- cast
    \-- phrase_list
        \-- term_list - get the phrases out of a term list
    \-- triple_list
        \-- term_list - get the triples out of a term list
    \-- verb_list
        \-- term_list - get the verbs out of a term list
    \-- formula_list
        \-- term_list - get the formulas out of a term list
    \-- term_list
        \-- verb_list - adding the verbs used for unit tests to the dummy list
\-- display functions
    \-- dsp_id
        \-- term_list - @param term_list|null $trm_lst a cached list of terms
    \-- dsp_name
        \-- term_list - @return string with all names of the list
    \-- name
        \-- term_list - @return string with all names of the list
    \-- names
        \-- term_list - @return array a sorted list of the term names
\-- extract
    \-- 1
        \-- verb_list - @returns array with the names on the db keys
    \-- ids
        \-- ref_list - @param ?int $limit the max number of ids to show
        \-- verb_list - @param ?int $limit the max number of ids to show
    \-- get_verb
        \-- verb_list - get a single verb from this list selected by the code id
    \-- get_verb_by_id
        \-- verb_list - get a single verb from this list
    \-- selector_list
        \-- verb_list - get a single verb from this list
\-- check
    \-- same_user
    ...
    \-- includes
        \-- ip_range - check if an ip address is within this range
\-- sql_type_list
    \-- table_extension
...
\-- sql helper
    \-- diff_msg
        \-- ip_range - create human-readable messages of the differences between the ip range objects
    \-- needs_db_update
...
\-- loading
    ...
    \-- load_by_linked_phrases_sql
        \-- verb_list - create the SQL to load a list of verbs by the object vars which means uds or wrb and direction
    \-- load_by_linked_phrases
        \-- verb_list - load a list of verbs that are used by a given word
    \-- fill_from_api_rows
        \-- verb_list - fill this list from the api json rows of the cached types message
    \-- load_dummy
        \-- verb_list - adding the verbs used for unit tests to the dummy list
\-- using ip range list
    \-- includes
...
\-- run
    \-- run
        \-- job_runner - load the pending jobs and execute the due ones in priority order until the time budget is spent
    \-- due_jobs
        \-- job_runner - select the jobs that are due at the given reference time and return them in execution order
\-- run internal
    \-- run_job
        \-- job_runner - execute a single job, update its status and log the start, the end and any error
\-- db add
    \-- db_insert_no_log
        \-- list_db_write - add all list objects to the database using grouped calls of prepared SQL statements
\-- db del
    \-- db_delete_no_log
        \-- list_db_write - delete all list objects from the database using grouped calls of predefined sql functions
\-- db helper
    \-- sql_insert_call_with_par
        \-- list_db_write - get a list of all sql function names that are needed to add all objects of this list to the 
                database
    \-- sql_insert_no_log
        \-- list_db_write - get a list of all sql function names that are needed to add all objects of this list to the 
                database
    \-- sql_delete_call_with_par
        \-- list_db_write - get a list of all sql function names that are needed to delete all objects of this list from
                 the database
    \-- sql_delete_no_log
        \-- list_db_write - get a list of all sql function names that are needed to delete all objects of this list from
                 the database
...
\-- database load functions that reads the object from the database
    ...
    \-- load_sql
        \-- value_time_series - create the common part of an SQL statement to retrieve the parameters of a time series f
                rom the database
    \-- load_sql_multi
        \-- value_time_series - create the common part of an SQL statement to retrieve the parameters of a value time se
                ries
    \-- load_sql_by_grp
...
\-- component
    ...
    \-- load_by_id_with_related - section for function load_by_id_with_related is expected to be load in /component/comp
            onent.php
    \-- name_link - section for function name_link not yet defined that it should be base in /component/component.php
    \-- component_type_selector - section for function component_type_selector not yet defined that it should be select 
            in /component/component.php
    \-- type_code_id - section for function type_code_id is expected to be preloaded in /component/component.php
    \-- pos_type_code_id - section for function pos_type_code_id not yet defined that it should be info in /component/co
            mponent.php
    \-- get_style_id - section for function get_style_id is expected to be set and get in /component/component.php
    \-- style_text - section for function style_text not yet defined that it should be info in /component/component.php
    \-- style_code_id - section for function style_code_id not yet defined that it should be info in /component/componen
            t.php
    \-- no_row_style - section for function no_row_style not yet defined that it should be info in /component/component.
            php
    \-- needs_row_components - section for function needs_row_components not yet defined that it should be info in /comp
            onent/component.php
    \-- type_selector - section for function type_selector not yet defined that it should be select in /component/compon
            ent.php
    \-- style_selector - section for function style_selector not yet defined that it should be select in /component/comp
            onent.php
    ...
    \-- word_name - section for function word_name not yet defined that it should be to review in /component/component.p
            hp
    \-- btn_unlink - section for function btn_unlink not yet defined that it should be to review in /component/component
            .php
    \-- dsp_hist - section for function dsp_hist not yet defined that it should be to review in /component/component.php
    \-- dsp_hist_links - section for function dsp_hist_links not yet defined that it should be to review in /component/c
            omponent.php
    \-- log_err - section for function log_err is expected to be log in /component/component.php
    \-- log_debug - section for function log_debug is expected to be log in /component/component.php
    \-- phrase_selector - section for function phrase_selector not yet defined that it should be to review in /component
            /component.php
\-- component_exe
    \-- dsp_entries - section for function dsp_entries not yet defined that it should be display in /component/component
            _exe.php
\-- component_link
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /component/c
            omponent_link.php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be construct and map in /compo
            nent/component_link.php
    \-- api_array - section for function api_array not yet defined that it should be api in /component/component_link.ph
            p
    \-- set_view_id - section for function set_view_id is expected to be set and get in /component/component_link.php
    \-- set_view - section for function set_view is expected to be set and get in /component/component_link.php
    \-- set_component_id - section for function set_component_id is expected to be set and get in /component/component_l
            ink.php
    \-- set_component - section for function set_component is expected to be set and get in /component/component_link.ph
            p
    \-- set_predicate_id - section for function set_predicate_id is expected to be set and get in /component/component_l
            ink.php
    \-- link_type - section for function link_type is expected to be link in /component/component_link.php
    \-- get_style_id - section for function get_style_id is expected to be set and get in /component/component_link.php
    \-- name - section for function name is expected to be debug in /component/component_link.php
    \-- name_linked - section for function name_linked not yet defined that it should be display in /component/component
            _link.php
    \-- get_view - section for function get_view is expected to be set and get in /component/component_link.php
    \-- get_component - section for function get_component is expected to be set and get in /component/component_link.ph
            p
    \-- order error - order of section construct and map has difference at db_fld_to_url should be before url_mapper
\-- component_list
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /component/component_list.ph
            p
...
\-- system_form
    ...
    \-- title_triple - section for function title_triple missing in /component/execute/system_form.php
    \-- title_link - section for function title_link missing in /component/execute/system_form.php
    \-- title_phrase - section for function title_phrase missing in /component/execute/system_form.php
    \-- title_formula - section for function title_formula missing in /component/execute/system_form.php
    \-- title_value - section for function title_value missing in /component/execute/system_form.php
    \-- form_back - section for function form_back missing in /component/execute/system_form.php
    \-- form_confirm - section for function form_confirm missing in /component/execute/system_form.php
    ...
    \-- admin_form_user_password - section for function admin_form_user_password missing in /component/execute/system_fo
            rm.php
    \-- admin_form_user_uses_sandbox - section for function admin_form_user_uses_sandbox not yet defined that it should 
            be optional with show password but without auto fill in /component/execute/system_form.php
    \-- admin_form_language_symbol - section for function admin_form_language_symbol not yet defined that it should be o
            ptional with show password but without auto fill in /component/execute/system_form.php
    \-- show_language_symbol - section for function show_language_symbol not yet defined that it should be optional with
             show password but without auto fill in /component/execute/system_form.php
    \-- show_name - section for function show_name not yet defined that it should be optional with show password but wit
            hout auto fill in /component/execute/system_form.php
    \-- show_name_big - section for function show_name_big not yet defined that it should be optional with show password
             but without auto fill in /component/execute/system_form.php
    \-- show_description - section for function show_description not yet defined that it should be optional with show pa
            ssword but without auto fill in /component/execute/system_form.php
    \-- show_plural - section for function show_plural not yet defined that it should be optional with show password but
             without auto fill in /component/execute/system_form.php
    \-- show_reverse - section for function show_reverse not yet defined that it should be optional with show password b
    ...
    \-- show_col_phrase - section for function show_col_phrase not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    \-- show_col_sub_phrase - section for function show_col_sub_phrase not yet defined that it should be optional with s
            how password but without auto fill in /component/execute/system_form.php
    \-- show_owner - section for function show_owner not yet defined that it should be optional with show password but w
            ithout auto fill in /component/execute/system_form.php
    \-- show_phrase_type - section for function show_phrase_type not yet defined that it should be optional with show pa
            ssword but without auto fill in /component/execute/system_form.php
    \-- show_ref_type - section for function show_ref_type not yet defined that it should be optional with show password
             but without auto fill in /component/execute/system_form.php
    \-- show_ref_key - section for function show_ref_key not yet defined that it should be optional with show password b
            ut without auto fill in /component/execute/system_form.php
    \-- show_ref_source - section for function show_ref_source not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    ...
    \-- show_parent_view - section for function show_parent_view not yet defined that it should be optional with show pa
            ssword but without auto fill in /component/execute/system_form.php
    \-- show_child_view - section for function show_child_view not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    \-- show_link_type - section for function show_link_type not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- show_start_pos - section for function show_start_pos not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- show_order_nbr - section for function show_order_nbr not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- result - section for function result not yet defined that it should be optional with show password but without a
            uto fill in /component/execute/system_form.php
    \-- used_as_text - section for function used_as_text not yet defined that it should be optional with show password b
            ut without auto fill in /component/execute/system_form.php
    \-- used_as_text_link - section for function used_as_text_link not yet defined that it should be optional with show 
            password but without auto fill in /component/execute/system_form.php
    ...
    \-- form_field_reverse - section for function form_field_reverse not yet defined that it should be optional with sho
            w password but without auto fill in /component/execute/system_form.php
    \-- form_field_plural_reverse - section for function form_field_plural_reverse not yet defined that it should be opt
            ional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_name_in_formulas - section for function form_field_name_in_formulas not yet defined that it should be
             optional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_ref_key - section for function form_field_ref_key not yet defined that it should be optional with sho
            w password but without auto fill in /component/execute/system_form.php
    \-- form_field_weight - section for function form_field_weight not yet defined that it should be optional with show 
            password but without auto fill in /component/execute/system_form.php
    ...
    \-- form_field_doi - section for function form_field_doi not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- form_field_group_name - section for function form_field_group_name not yet defined that it should be optional wi
            th show password but without auto fill in /component/execute/system_form.php
    \-- form_field_source_group_name - section for function form_field_source_group_name not yet defined that it should 
            be optional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_group_or_phrases - section for function form_field_group_or_phrases not yet defined that it should be
             optional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_source_group_or_phrases - section for function form_field_source_group_or_phrases not yet defined tha
            t it should be optional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_formula_link_priority - section for function form_field_formula_link_priority not yet defined that it
             should be optional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_view_link_priority - section for function form_field_view_link_priority not yet defined that it shoul
            d be optional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_component_link_order_number - section for function form_field_component_link_order_number not yet def
            ined that it should be optional with show password but without auto fill in /component/execute/system_form.p
            hp
    \-- form_view_relation_pos - section for function form_view_relation_pos not yet defined that it should be optional 
            with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_selection_name - section for function form_field_selection_name not yet defined that it should be opt
            ional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_selection_description - section for function form_field_selection_description not yet defined that it
             should be optional with show password but without auto fill in /component/execute/system_form.php
    \-- form_field_selection_text - section for function form_field_selection_text not yet defined that it should be opt
            ional with show password but without auto fill in /component/execute/system_form.php
    \-- form_phrase - section for function form_phrase not yet defined that it should be optional with show password but
             without auto fill in /component/execute/system_form.php
    \-- form_phrases - section for function form_phrases not yet defined that it should be optional with show password b
            ut without auto fill in /component/execute/system_form.php
    \-- form_term - section for function form_term not yet defined that it should be optional with show password but wit
            hout auto fill in /component/execute/system_form.php
    \-- form_terms - section for function form_terms not yet defined that it should be optional with show password but w
            ithout auto fill in /component/execute/system_form.php
    \-- form_verb - section for function form_verb not yet defined that it should be optional with show password but wit
            hout auto fill in /component/execute/system_form.php
    \-- form_verbs - section for function form_verbs not yet defined that it should be optional with show password but w
            ithout auto fill in /component/execute/system_form.php
    \-- form_source - section for function form_source not yet defined that it should be optional with show password but
             without auto fill in /component/execute/system_form.php
    \-- form_sources - section for function form_sources not yet defined that it should be optional with show password b
            ut without auto fill in /component/execute/system_form.php
    \-- form_ref - section for function form_ref not yet defined that it should be optional with show password but witho
            ut auto fill in /component/execute/system_form.php
    \-- form_refs - section for function form_refs not yet defined that it should be optional with show password but wit
            hout auto fill in /component/execute/system_form.php
    \-- form_value - section for function form_value not yet defined that it should be optional with show password but w
            ithout auto fill in /component/execute/system_form.php
    \-- form_values - section for function form_values not yet defined that it should be optional with show password but
             without auto fill in /component/execute/system_form.php
    \-- form_result - section for function form_result not yet defined that it should be optional with show password but
             without auto fill in /component/execute/system_form.php
    \-- form_results - section for function form_results not yet defined that it should be optional with show password b
            ut without auto fill in /component/execute/system_form.php
    \-- form_formula - section for function form_formula not yet defined that it should be optional with show password b
            ut without auto fill in /component/execute/system_form.php
    \-- form_formulas - section for function form_formulas not yet defined that it should be optional with show password
             but without auto fill in /component/execute/system_form.php
    \-- form_view - section for function form_view not yet defined that it should be optional with show password but wit
            hout auto fill in /component/execute/system_form.php
    \-- form_parent_view - section for function form_parent_view not yet defined that it should be optional with show pa
            ssword but without auto fill in /component/execute/system_form.php
    \-- form_child_view - section for function form_child_view not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    \-- form_view_default - section for function form_view_default not yet defined that it should be optional with show 
            password but without auto fill in /component/execute/system_form.php
    \-- form_views - section for function form_views not yet defined that it should be optional with show password but w
            ithout auto fill in /component/execute/system_form.php
    \-- form_component - section for function form_component not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- form_components - section for function form_components not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    \-- form_phrase_type - section for function form_phrase_type not yet defined that it should be optional with show pa
            ssword but without auto fill in /component/execute/system_form.php
    \-- form_source_type - section for function form_source_type not yet defined that it should be optional with show pa
            ssword but without auto fill in /component/execute/system_form.php
    \-- form_ref_type - section for function form_ref_type not yet defined that it should be optional with show password
             but without auto fill in /component/execute/system_form.php
    \-- form_value_type - section for function form_value_type not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    \-- form_formula_type - section for function form_formula_type not yet defined that it should be optional with show 
            password but without auto fill in /component/execute/system_form.php
    \-- form_view_type - section for function form_view_type not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- form_view_style - section for function form_view_style not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    \-- form_component_type - section for function form_component_type not yet defined that it should be optional with s
            how password but without auto fill in /component/execute/system_form.php
    \-- form_component_style - section for function form_component_style not yet defined that it should be optional with
             show password but without auto fill in /component/execute/system_form.php
    \-- form_view_relation_type - section for function form_view_relation_type not yet defined that it should be optiona
            l with show password but without auto fill in /component/execute/system_form.php
    \-- form_formula_link_type - section for function form_formula_link_type not yet defined that it should be optional 
            with show password but without auto fill in /component/execute/system_form.php
    \-- form_view_link_type - section for function form_view_link_type not yet defined that it should be optional with s
            how password but without auto fill in /component/execute/system_form.php
    \-- form_component_link_type - section for function form_component_link_type not yet defined that it should be optio
            nal with show password but without auto fill in /component/execute/system_form.php
    \-- form_component_pos_type - section for function form_component_pos_type not yet defined that it should be optiona
            l with show password but without auto fill in /component/execute/system_form.php
    \-- form_share_type - section for function form_share_type not yet defined that it should be optional with show pass
            word but without auto fill in /component/execute/system_form.php
    \-- form_protection_type - section for function form_protection_type not yet defined that it should be optional with
             show password but without auto fill in /component/execute/system_form.php
    \-- form_table_linked_view - section for function form_table_linked_view not yet defined that it should be optional 
            with show password but without auto fill in /component/execute/system_form.php
    \-- form_formula_expression - section for function form_formula_expression not yet defined that it should be optiona
            l with show password but without auto fill in /component/execute/system_form.php
    \-- form_formula_latex - section for function form_formula_latex not yet defined that it should be optional with sho
            w password but without auto fill in /component/execute/system_form.php
    \-- form_formula_all_fields - section for function form_formula_all_fields not yet defined that it should be optiona
            l with show password but without auto fill in /component/execute/system_form.php
    \-- button_cancel - section for function button_cancel not yet defined that it should be optional with show password
             but without auto fill in /component/execute/system_form.php
    \-- button_save - section for function button_save not yet defined that it should be optional with show password but
             without auto fill in /component/execute/system_form.php
    \-- button_confirm - section for function button_confirm not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- button_del - section for function button_del not yet defined that it should be optional with show password but w
            ithout auto fill in /component/execute/system_form.php
    \-- button_import - section for function button_import not yet defined that it should be optional with show password
             but without auto fill in /component/execute/system_form.php
    \-- button_export - section for function button_export not yet defined that it should be optional with show password
             but without auto fill in /component/execute/system_form.php
    \-- button_request - section for function button_request not yet defined that it should be optional with show passwo
            rd but without auto fill in /component/execute/system_form.php
    \-- form_end - section for function form_end not yet defined that it should be optional with show password but witho
            ut auto fill in /component/execute/system_form.php
    \-- row_start - section for function row_start not yet defined that it should be optional with show password but wit
            hout auto fill in /component/execute/system_form.php
    \-- row_right - section for function row_right not yet defined that it should be optional with show password but wit
            hout auto fill in /component/execute/system_form.php
    \-- row_center - section for function row_center not yet defined that it should be optional with show password but w
            ithout auto fill in /component/execute/system_form.php
    \-- row_end - section for function row_end not yet defined that it should be optional with show password but without
             auto fill in /component/execute/system_form.php
\-- system_page
    ...
    \-- about_body - section for function about_body missing in /component/execute/system_page.php
    \-- setup_body - section for function setup_body is expected to be set and get in /component/execute/system_page.php
    \-- signup_body - section for function signup_body missing in /component/execute/system_page.php
    \-- login_body - section for function login_body missing in /component/execute/system_page.php
    \-- activate_body - section for function activate_body missing in /component/execute/system_page.php
    \-- reset_body - section for function reset_body missing in /component/execute/system_page.php
    \-- logout_body - section for function logout_body missing in /component/execute/system_page.php
    \-- body_search - section for function body_search missing in /component/execute/system_page.php
    \-- body_search_full - section for function body_search_full missing in /component/execute/system_page.php
    \-- value_details - section for function value_details missing in /component/execute/system_page.php
    \-- result_explain - section for function result_explain missing in /component/execute/system_page.php
    \-- formula_test - section for function formula_test missing in /component/execute/system_page.php
    \-- sandbox - section for function sandbox missing in /component/execute/system_page.php
    \-- undo - section for function undo missing in /component/execute/system_page.php
    \-- user_setting - section for function user_setting missing in /component/execute/system_page.php
    ...
    \-- admin_login_fails - section for function admin_login_fails missing in /component/execute/system_page.php
    \-- admin_errors_unassigned - section for function admin_errors_unassigned missing in /component/execute/system_page
            .php
    \-- admin_errors_delayed_fix - section for function admin_errors_delayed_fix missing in /component/execute/system_pa
            ge.php
    \-- admin_jobs_delayed - section for function admin_jobs_delayed missing in /component/execute/system_page.php
\-- ui_base
    \-- phrase_name - section for function phrase_name missing in /component/execute/ui_base.php
    \-- verb_name - section for function verb_name missing in /component/execute/ui_base.php
    \-- triple_name - section for function triple_name missing in /component/execute/ui_base.php
    \-- value_name - section for function value_name missing in /component/execute/ui_base.php
    \-- group_name - section for function group_name missing in /component/execute/ui_base.php
    \-- num_value - section for function num_value missing in /component/execute/ui_base.php
    \-- main_value - section for function main_value missing in /component/execute/ui_base.php
    \-- source_name - section for function source_name missing in /component/execute/ui_base.php
    \-- source_doi_link - section for function source_doi_link missing in /component/execute/ui_base.php
    \-- source_url_link - section for function source_url_link missing in /component/execute/ui_base.php
    \-- reference_name - section for function reference_name missing in /component/execute/ui_base.php
    \-- language_name - section for function language_name missing in /component/execute/ui_base.php
    \-- table - section for function table missing in /component/execute/ui_base.php
    \-- all - section for function all missing in /component/execute/ui_base.php
    \-- expression - section for function expression missing in /component/execute/ui_base.php
    \-- expression_latex_link - section for function expression_latex_link missing in /component/execute/ui_base.php
    \-- expression_latex_link_form - section for function expression_latex_link_form missing in /component/execute/ui_ba
            se.php
    \-- expression_link - section for function expression_link missing in /component/execute/ui_base.php
    \-- name - section for function name is expected to be debug in /component/execute/ui_base.php
\-- ui_im_export
    \-- select_file - section for function select_file missing in /component/execute/ui_im_export.php
    \-- select_export_format - section for function select_export_format missing in /component/execute/ui_im_export.php
    \-- json_export - section for function json_export missing in /component/execute/ui_im_export.php
    \-- xml_export - section for function xml_export missing in /component/execute/ui_im_export.php
    \-- csv_export - section for function csv_export missing in /component/execute/ui_im_export.php
    \-- ods_export - section for function ods_export missing in /component/execute/ui_im_export.php
\-- ui_list
    \-- parents_of_word - section for function parents_of_word missing in /component/execute/ui_list.php
    \-- children_of_word - section for function children_of_word missing in /component/execute/ui_list.php
    \-- phrase_aliases - section for function phrase_aliases missing in /component/execute/ui_list.php
    \-- phrase_symbols - section for function phrase_symbols missing in /component/execute/ui_list.php
    \-- phrases_related_ex_symbols - section for function phrases_related_ex_symbols missing in /component/execute/ui_li
            st.php
    \-- phrases_related_ex_subtitle - section for function phrases_related_ex_subtitle missing in /component/execute/ui_
            list.php
    \-- phrases_of_formula - section for function phrases_of_formula missing in /component/execute/ui_list.php
    \-- triple_list - section for function triple_list missing in /component/execute/ui_list.php
    ...
    \-- value_chart - section for function value_chart missing in /component/execute/ui_list.php
    \-- values_by_word - section for function values_by_word missing in /component/execute/ui_list.php
    \-- values_most_relevant - section for function values_most_relevant missing in /component/execute/ui_list.php
    \-- values_in_columns - section for function values_in_columns missing in /component/execute/ui_list.php
    ...
    \-- results - section for function results missing in /component/execute/ui_list.php
    \-- results_related - section for function results_related missing in /component/execute/ui_list.php
    \-- phrases_related - section for function phrases_related missing in /component/execute/ui_list.php
    \-- list_sort - section for function list_sort missing in /component/execute/ui_list.php
    \-- start_list - section for function start_list missing in /component/execute/ui_list.php
    \-- result_changes - section for function result_changes missing in /component/execute/ui_list.php
\-- ui_log
    \-- system_change_log - section for function system_change_log not yet defined that it should be display in /compone
            nt/execute/ui_log.php
    \-- change_log_table_pure - section for function change_log_table_pure not yet defined that it should be display in 
            /component/execute/ui_log.php
    \-- user_overwrites_table_pure - section for function user_overwrites_table_pure not yet defined that it should be d
            isplay in /component/execute/ui_log.php
    \-- all_user_overwrites - section for function all_user_overwrites not yet defined that it should be display in /com
            ponent/execute/ui_log.php
    \-- user_system_errors - section for function user_system_errors not yet defined that it should be display in /compo
            nent/execute/ui_log.php
\-- ui_preview
    \-- view_after - section for function view_after missing in /component/execute/ui_preview.php
    \-- view_before - section for function view_before missing in /component/execute/ui_preview.php
    \-- paste_table - section for function paste_table missing in /component/execute/ui_preview.php
    \-- table_body - section for function table_body missing in /component/execute/ui_preview.php
    \-- selection_text - section for function selection_text missing in /component/execute/ui_preview.php
    \-- popup_title - section for function popup_title missing in /component/execute/ui_preview.php
    \-- popup_class - section for function popup_class missing in /component/execute/ui_preview.php
    \-- popup_changes - section for function popup_changes missing in /component/execute/ui_preview.php
    \-- user_overwrites_table - section for function user_overwrites_table missing in /component/execute/ui_preview.php
    \-- other_overwrites_table - section for function other_overwrites_table missing in /component/execute/ui_preview.ph
            p
    \-- popup_impact - section for function popup_impact missing in /component/execute/ui_preview.php
    \-- view_diff - section for function view_diff missing in /component/execute/ui_preview.php
\-- ui_select
    \-- phrase_select - section for function phrase_select missing in /component/execute/ui_select.php
...
\-- element
    ...
    \-- name - section for function name is expected to be debug in /element/element.php
    \-- link - section for function link is expected to be link in /element/element.php
\-- element_group
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /element/element_group.php
    \-- name - section for function name is expected to be debug in /element/element_group.php
    \-- id - section for function id not yet defined that it should be display in /element/element_group.php
    \-- dsp_names - section for function dsp_names not yet defined that it should be display in /element/element_group.p
            hp
    \-- figures - section for function figures not yet defined that it should be display in /element/element_group.php
    \-- build_symbol - section for function build_symbol not yet defined that it should be repeat from backend in /eleme
            nt/element_group.php
    \-- dsp_values_old - section for function dsp_values_old not yet defined that it should be deprecate in /element/ele
            ment_group.php
\-- figure
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /figure/figure.php
    \-- id - section for function id not yet defined that it should be set and get in /figure/figure.php
    \-- obj_id - section for function obj_id not yet defined that it should be set and get in /figure/figure.php
    \-- grp - section for function grp not yet defined that it should be set and get in /figure/figure.php
    \-- number - section for function number not yet defined that it should be set and get in /figure/figure.php
    \-- api_array - section for function api_array not yet defined that it should be interface in /figure/figure.php
    \-- is_result - section for function is_result is expected to be info in /figure/figure.php
    \-- val_formatted - section for function val_formatted not yet defined that it should be base in /figure/figure.php
    \-- name_linked - section for function name_linked not yet defined that it should be base in /figure/figure.php
    \-- display - section for function display not yet defined that it should be base in /figure/figure.php
    \-- display_linked - section for function display_linked not yet defined that it should be base in /figure/figure.ph
            p
\-- figure_list
    \-- add - section for function add not yet defined that it should be modify in /figure/figure_list.php
    \-- display - section for function display not yet defined that it should be base in /figure/figure_list.php
    \-- display_linked - section for function display_linked not yet defined that it should be base in /figure/figure_li
            st.php
    \-- names_linked - section for function names_linked not yet defined that it should be base in /figure/figure_list.p
            hp
\-- expression
...
\-- formula
    ...
    \-- sandbox_fld_order - section for function sandbox_fld_order not yet defined that it should be construct and map i
            n /formula/formula.php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be construct and map in /formu
            la/formula.php
    \-- to_url_array - section for function to_url_array not yet defined that it should be construct and map in /formula
            /formula.php
    \-- ref_text - section for function ref_text not yet defined that it should be set and get in /formula/formula.php
    \-- impact - section for function impact not yet defined that it should be set and get in /formula/formula.php
    \-- has_verb - section for function has_verb not yet defined that it should be set and get in /formula/formula.php
    ...
    \-- dsp_type_selector - section for function dsp_type_selector not yet defined that it should be select in /formula/
            formula.php
    \-- user_expression - section for function user_expression not yet defined that it should be overwrites in /formula/
            formula.php
    \-- load_by_id_with_related - section for function load_by_id_with_related is expected to be load in /formula/formul
            a.php
    ...
    \-- dsp_used4words - section for function dsp_used4words not yet defined that it should be to review in /formula/for
            mula.php
    \-- dsp_test_and_samples - section for function dsp_test_and_samples not yet defined that it should be to review in 
            /formula/formula.php
    \-- expression - section for function expression not yet defined that it should be to review in /formula/formula.php
    \-- direct_assigned_phrases - section for function direct_assigned_phrases not yet defined that it should be to revi
...
\-- formula_link
    ...
    \-- get_description - section for function get_description is expected to be set and get in /formula/formula_link.ph
            p
    \-- formula_name - section for function formula_name not yet defined that it should be interface in /formula/formula
            _link.php
    \-- phrase_name - section for function phrase_name not yet defined that it should be interface in /formula/formula_l
            ink.php
    \-- display - section for function display not yet defined that it should be display in /formula/formula_link.php
\-- formula_link_list
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /formula/formula_link_list.p
            hp
    \-- get_phrase_list - section for function get_phrase_list is expected to be set and get in /formula/formula_link_li
            st.php
    \-- get_formula_list - section for function get_formula_list is expected to be set and get in /formula/formula_link_
            list.php
    \-- name_tip - section for function name_tip not yet defined that it should be display in /formula/formula_link_list
            .php
\-- formula_list
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /formula/formula_list.php
    \-- default_id - section for function default_id not yet defined that it should be info in /formula/formula_list.php
    \-- get_by_verb - section for function get_by_verb is expected to be set and get in /formula/formula_list.php
    \-- name_tip - section for function name_tip not yet defined that it should be display in /formula/formula_list.php
    \-- sort_by_impact - section for function sort_by_impact not yet defined that it should be display in /formula/formu
            la_list.php
    \-- name_link - section for function name_link not yet defined that it should be display in /formula/formula_list.ph
            p
    \-- tbl - section for function tbl not yet defined that it should be display in /formula/formula_list.php
    \-- display_old - section for function display_old not yet defined that it should be display in /formula/formula_lis
            t.php
    \-- order error - order of section display has difference at name_link should be before name_tip
\-- frontend
    \-- start - section for function start not yet defined that it should be session in /frontend.php
    \-- start_ui - section for function start_ui not yet defined that it should be session in /frontend.php
    \-- end - section for function end not yet defined that it should be session in /frontend.php
    \-- load_cache - section for function load_cache is expected to be load in /frontend.php
    \-- set_cache - section for function set_cache is expected to be set and get in /frontend.php
    \-- load_dummy_cache_from_test_resources - section for function load_dummy_cache_from_test_resources is expected to 
            be load in /frontend.php
    \-- set_type_cache - section for function set_type_cache is expected to be set and get in /frontend.php
    \-- set_view_cache - section for function set_view_cache is expected to be set and get in /frontend.php
    ...
    \-- cached_page_or_null - section for function cached_page_or_null not yet defined that it should be cached page in 
            /frontend.php
    ...
    \-- url_to_back_url - section for function url_to_back_url not yet defined that it should be execute in /frontend.ph
            p
    \-- api_get - section for function api_get not yet defined that it should be api in /frontend.php
\-- group
    \-- unset_name_tip_dirty - section for function unset_name_tip_dirty not yet defined that it should be set and get i
            n /group/group.php
    \-- unset_name_link_dirty - section for function unset_name_link_dirty not yet defined that it should be set and get
             in /group/group.php
    \-- lst - section for function lst not yet defined that it should be set and get in /group/group.php
    \-- phr_lst - section for function phr_lst not yet defined that it should be set and get in /group/group.php
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /group/group.php
    \-- url_mapper - section for function url_mapper not yet defined that it should be api in /group/group.php
    \-- api_array - section for function api_array not yet defined that it should be api in /group/group.php
...
\-- group_list
    ...
    \-- common_phrases - section for function common_phrases not yet defined that it should be get functions in /group/g
            roup_list.php
...
\-- config
    ...
    \-- thousand_sep - section for function thousand_sep not yet defined that it should be interface in /helper/config.p
            hp
    \-- date_time_format - section for function date_time_format not yet defined that it should be interface in /helper/
            config.php
    \-- load - section for function load not yet defined that it should be load in /helper/config.php
    \-- get_by - section for function get_by is expected to be set and get in /helper/config.php
\-- data_object
    \-- refresh_words_via_api - section for function refresh_words_via_api not yet defined that it should be set and get
             in /helper/data_object.php
    \-- word_list - section for function word_list not yet defined that it should be set and get in /helper/data_object.
            php
    \-- triple_list - section for function triple_list not yet defined that it should be set and get in /helper/data_obj
            ect.php
    ...
    \-- source_list - section for function source_list not yet defined that it should be set and get in /helper/data_obj
            ect.php
    \-- ref_list - section for function ref_list not yet defined that it should be set and get in /helper/data_object.ph
            p
    \-- value_list - section for function value_list is expected to be related in /helper/data_object.php
    \-- formula_link_list - section for function formula_link_list not yet defined that it should be set and get in /hel
            per/data_object.php
    ...
    \-- formula_list - section for function formula_list not yet defined that it should be set and get in /helper/data_o
            bject.php
    \-- merge_view_list - section for function merge_view_list not yet defined that it should be set and get in /helper/
            data_object.php
    \-- view_list - section for function view_list not yet defined that it should be set and get in /helper/data_object.
            php
    \-- has_view_list - section for function has_view_list not yet defined that it should be set and get in /helper/data
            _object.php
    \-- file_list - section for function file_list not yet defined that it should be set and get in /helper/data_object.
            php
    \-- has_file_list - section for function has_file_list not yet defined that it should be set and get in /helper/data
            _object.php
    \-- component_list - section for function component_list not yet defined that it should be set and get in /helper/da
            ta_object.php
    \-- has_phrases - section for function has_phrases not yet defined that it should be set and get in /helper/data_obj
            ect.php
    \-- add_phrases - section for function add_phrases not yet defined that it should be set and get in /helper/data_obj
            ect.php
    \-- ref_list_cloned - section for function ref_list_cloned not yet defined that it should be set and get in /helper/
            data_object.php
    \-- value_list_cloned - section for function value_list_cloned not yet defined that it should be set and get in /hel
            per/data_object.php
    \-- has_changes - section for function has_changes not yet defined that it should be set and get in /helper/data_obj
            ect.php
    \-- add_changes - section for function add_changes not yet defined that it should be set and get in /helper/data_obj
            ect.php
    \-- change_log - section for function change_log not yet defined that it should be set and get in /helper/data_objec
            t.php
    \-- has_sys_log - section for function has_sys_log not yet defined that it should be set and get in /helper/data_obj
            ect.php
    \-- sys_log_list - section for function sys_log_list not yet defined that it should be set and get in /helper/data_o
            bject.php
    \-- add_id_to_views - section for function add_id_to_views not yet defined that it should be fill in /helper/data_ob
            ject.php
...
\-- url_mapper
    ...
    \-- standard_url_to_pod - section for function standard_url_to_pod missing in /helper/url_mapper.php
    \-- human_url_to_json - section for function human_url_to_json missing in /helper/url_mapper.php
    \-- name_to_human - section for function name_to_human missing in /helper/url_mapper.php
    \-- array_to_url - section for function array_to_url missing in /helper/url_mapper.php
\-- button
    \-- __construct - section for function __construct is expected to be construct and map in /html/button.php
    \-- set - section for function set is expected to be set and get in /html/button.php
    \-- add - section for function add not yet defined that it should be HTML code in /html/button.php
    \-- edit - section for function edit not yet defined that it should be HTML code in /html/button.php
    \-- del - section for function del is expected to be del in /html/button.php
    \-- undo - section for function undo not yet defined that it should be HTML code in /html/button.php
    \-- find - section for function find not yet defined that it should be HTML code in /html/button.php
    \-- un_filter - section for function un_filter not yet defined that it should be HTML code in /html/button.php
    \-- back_img - section for function back_img not yet defined that it should be HTML code in /html/button.php
    \-- back - section for function back not yet defined that it should be HTML code in /html/button.php
    \-- confirm - section for function confirm not yet defined that it should be HTML code in /html/button.php
    \-- yes_no - section for function yes_no not yet defined that it should be HTML code in /html/button.php
    \-- add_value - section for function add_value not yet defined that it should be HTML code in /html/button.php
    \-- add_value_fast - section for function add_value_fast not yet defined that it should be HTML code in /html/button
            .php
    \-- edit_value - section for function edit_value not yet defined that it should be HTML code in /html/button.php
    \-- del_value - section for function del_value is expected to be del in /html/button.php
    \-- btn_add - section for function btn_add not yet defined that it should be HTML code in /html/button.php
    \-- btn_edit - section for function btn_edit not yet defined that it should be HTML code in /html/button.php
    \-- btn_del - section for function btn_del not yet defined that it should be HTML code in /html/button.php
    \-- btn_undo - section for function btn_undo not yet defined that it should be HTML code in /html/button.php
    \-- btn_find - section for function btn_find not yet defined that it should be HTML code in /html/button.php
    \-- btn_unfilter - section for function btn_unfilter not yet defined that it should be HTML code in /html/button.php
    \-- btn_yesno - section for function btn_yesno not yet defined that it should be HTML code in /html/button.php
    \-- btn_back - section for function btn_back not yet defined that it should be HTML code in /html/button.php
    \-- btn_add_value - section for function btn_add_value not yet defined that it should be HTML code in /html/button.p
            hp
    \-- btn_add_value_fast - section for function btn_add_value_fast not yet defined that it should be HTML code in /htm
            l/button.php
\-- display_list
...
\-- html_base
    ...
    \-- header_html - section for function header_html not yet defined that it should be header & footer in /html/html_b
            ase.php
    \-- main_body - section for function main_body not yet defined that it should be header & footer in /html/html_base.
            php
    \-- footer_html - section for function footer_html not yet defined that it should be header & footer in /html/html_b
            ase.php
    ...
    \-- dsp_notification - section for function dsp_notification not yet defined that it should be header & footer in /h
            tml/html_base.php
    \-- dsp_notification_html - section for function dsp_notification_html not yet defined that it should be header & fo
            oter in /html/html_base.php
    \-- footer - section for function footer not yet defined that it should be header & footer in /html/html_base.php
    \-- ref - section for function ref not yet defined that it should be wrapper for the basic html elements used in /ht
            ml/html_base.php
    \-- ref_view - section for function ref_view not yet defined that it should be wrapper for the basic html elements u
            sed in /html/html_base.php
    \-- img - section for function img not yet defined that it should be wrapper for the basic html elements used in /ht
            ml/html_base.php
    \-- esc - section for function esc not yet defined that it should be wrapper for the basic html elements used in /ht
            ml/html_base.php
    \-- span - section for function span not yet defined that it should be wrapper for the basic html elements used in /
            html/html_base.php
    ...
    \-- pre_url_part - section for function pre_url_part not yet defined that it should be wrapper for internal referenc
    ...
    \-- th - section for function th not yet defined that it should be the HTML table functions used in zukunft.com in /
            html/html_base.php
    \-- lf - section for function lf not yet defined that it should be the HTML table functions used in zukunft.com in /
            html/html_base.php
    \-- th_row - section for function th_row not yet defined that it should be the HTML table functions used in zukunft.
            com in /html/html_base.php
    \-- tr - section for function tr not yet defined that it should be the HTML table functions used in zukunft.com in /
            html/html_base.php
    \-- td - section for function td not yet defined that it should be the HTML table functions used in zukunft.com in /
            html/html_base.php
    \-- thead - section for function thead not yet defined that it should be the HTML table functions used in zukunft.co
            m in /html/html_base.php
    \-- tbody - section for function tbody not yet defined that it should be the HTML table functions used in zukunft.co
            m in /html/html_base.php
    \-- tbl - section for function tbl not yet defined that it should be the HTML table functions used in zukunft.com in
             /html/html_base.php
    \-- tbl_start_half - section for function tbl_start_half not yet defined that it should be the HTML table functions 
            used in zukunft.com in /html/html_base.php
    \-- tbl_start_hist - section for function tbl_start_hist not yet defined that it should be the HTML table functions 
            used in zukunft.com in /html/html_base.php
    \-- tbl_start_pur - section for function tbl_start_pur not yet defined that it should be the HTML table functions us
            ed in zukunft.com in /html/html_base.php
    \-- tbl_start_borderless_grey - section for function tbl_start_borderless_grey not yet defined that it should be the
             HTML table functions used in zukunft.com in /html/html_base.php
    \-- tbl_start_select - section for function tbl_start_select not yet defined that it should be the HTML table functi
            ons used in zukunft.com in /html/html_base.php
    \-- form - section for function form not yet defined that it should be the form HTML elements used in zukunft.com in
             /html/html_base.php
    \-- fr - section for function fr not yet defined that it should be the form HTML elements used in zukunft.com in /ht
            ml/html_base.php
    \-- form_text - section for function form_text not yet defined that it should be the form HTML elements used in zuku
            nft.com in /html/html_base.php
    \-- form_hidden - section for function form_hidden not yet defined that it should be the form HTML elements used in 
            zukunft.com in /html/html_base.php
    \-- form_session_token - section for function form_session_token not yet defined that it should be the form HTML ele
            ments used in zukunft.com in /html/html_base.php
    \-- form_end_with_submit - section for function form_end_with_submit not yet defined that it should be the form HTML
             elements used in zukunft.com in /html/html_base.php
    \-- button_submit - section for function button_submit not yet defined that it should be the form HTML elements used
             in zukunft.com in /html/html_base.php
    \-- form_submit - section for function form_submit not yet defined that it should be the form HTML elements used in 
            zukunft.com in /html/html_base.php
    \-- form_input - section for function form_input not yet defined that it should be the form HTML elements used in zu
            kunft.com in /html/html_base.php
    \-- form_input_password - section for function form_input_password not yet defined that it should be the form HTML e
            lements used in zukunft.com in /html/html_base.php
    \-- input_password - section for function input_password not yet defined that it should be the form HTML elements us
            ed in zukunft.com in /html/html_base.php
    \-- about_page - section for function about_page not yet defined that it should be the form HTML elements used in zu
            kunft.com in /html/html_base.php
    \-- about_body - section for function about_body not yet defined that it should be the form HTML elements used in zu
            kunft.com in /html/html_base.php
    \-- edit_url - section for function edit_url not yet defined that it should be output device specific support functi
            ons for the pure HTML version in /html/html_base.php
    \-- list_sort - section for function list_sort not yet defined that it should be output device specific support func
            tions for the pure HTML version in /html/html_base.php
    \-- list - section for function list not yet defined that it should be output device specific support functions for 
            the pure HTML version in /html/html_base.php
    \-- dsp_tbl_width - section for function dsp_tbl_width not yet defined that it should be to dismiss / replace in /ht
            ml/html_base.php
    \-- dsp_tbl_width_half - section for function dsp_tbl_width_half not yet defined that it should be to dismiss / repl
            ace in /html/html_base.php
    \-- dsp_line_small - section for function dsp_line_small not yet defined that it should be to dismiss / replace in /
            html/html_base.php
    \-- dsp_text_h1 - section for function dsp_text_h1 not yet defined that it should be to dismiss / replace in /html/h
            tml_base.php
    \-- dsp_text_h2 - section for function dsp_text_h2 not yet defined that it should be to dismiss / replace in /html/h
            tml_base.php
    \-- dsp_text_h3 - section for function dsp_text_h3 not yet defined that it should be to dismiss / replace in /html/h
            tml_base.php
    \-- dsp_go_back - section for function dsp_go_back not yet defined that it should be to dismiss / replace in /html/h
            tml_base.php
    \-- dsp_btn_text - section for function dsp_btn_text not yet defined that it should be to dismiss / replace in /html
            /html_base.php
    \-- dsp_err - section for function dsp_err not yet defined that it should be to dismiss / replace in /html/html_base
            .php
    \-- dsp_link_hist_box - section for function dsp_link_hist_box not yet defined that it should be to dismiss / replac
    ...
    \-- dsp_tbl_start_half - section for function dsp_tbl_start_half not yet defined that it should be to dismiss / repl
            ace in /html/html_base.php
    \-- dsp_tbl_start_hist - section for function dsp_tbl_start_hist not yet defined that it should be to dismiss / repl
            ace in /html/html_base.php
    \-- dsp_tbl_start_select - section for function dsp_tbl_start_select not yet defined that it should be to dismiss / 
            replace in /html/html_base.php
    \-- dsp_tbl_end - section for function dsp_tbl_end not yet defined that it should be to dismiss / replace in /html/h
            tml_base.php
    \-- dsp_form_start - section for function dsp_form_start not yet defined that it should be to dismiss / replace in /
            html/html_base.php
    \-- dsp_form_end - section for function dsp_form_end not yet defined that it should be to dismiss / replace in /html
            /html_base.php
    \-- div_center - section for function div_center not yet defined that it should be to dismiss / replace in /html/htm
            l_base.php
    \-- dsp_form_center - section for function dsp_form_center not yet defined that it should be to dismiss / replace in
             /html/html_base.php
    \-- dsp_form_id - section for function dsp_form_id not yet defined that it should be to dismiss / replace in /html/h
            tml_base.php
    \-- dsp_form_hidden - section for function dsp_form_hidden not yet defined that it should be to dismiss / replace in
             /html/html_base.php
    \-- dsp_form_text - section for function dsp_form_text not yet defined that it should be to dismiss / replace in /ht
            ml/html_base.php
    \-- dsp_form_text_big - section for function dsp_form_text_big not yet defined that it should be to dismiss / replac
            e in /html/html_base.php
    \-- dsp_form_fld_checkbox - section for function dsp_form_fld_checkbox not yet defined that it should be to dismiss 
            / replace in /html/html_base.php
    \-- dsp_form_file_select - section for function dsp_form_file_select not yet defined that it should be to dismiss / 
            replace in /html/html_base.php
    ...
    \-- form_field_id - section for function form_field_id not yet defined that it should be base elements - functions f
            or all html elements used in zukunft.com in /html/html_base.php
    \-- input - section for function input not yet defined that it should be base elements - functions for all html elem
            ents used in zukunft.com in /html/html_base.php
    \-- div_form - section for function div_form not yet defined that it should be base elements - functions for all htm
            l elements used in zukunft.com in /html/html_base.php
    \-- div_row - section for function div_row not yet defined that it should be base elements - functions for all html 
            elements used in zukunft.com in /html/html_base.php
    \-- div_col_min_width - section for function div_col_min_width not yet defined that it should be base elements - fun
            ctions for all html elements used in zukunft.com in /html/html_base.php
    \-- div_row_wrapping_cols - section for function div_row_wrapping_cols not yet defined that it should be base elemen
            ts - functions for all html elements used in zukunft.com in /html/html_base.php
    \-- add_style - section for function add_style not yet defined that it should be base elements - functions for all h
            tml elements used in zukunft.com in /html/html_base.php
    \-- get_style_code - section for function get_style_code is expected to be set and get in /html/html_base.php
    \-- form_start - section for function form_start not yet defined that it should be base elements - functions for all
             html elements used in zukunft.com in /html/html_base.php
    \-- form_simple - section for function form_simple not yet defined that it should be base elements - functions for a
            ll html elements used in zukunft.com in /html/html_base.php
    \-- form_field - section for function form_field not yet defined that it should be base elements - functions for all
             html elements used in zukunft.com in /html/html_base.php
    \-- form_end - section for function form_end not yet defined that it should be base elements - functions for all htm
            l elements used in zukunft.com in /html/html_base.php
    \-- row_start - section for function row_start not yet defined that it should be base elements - functions for all h
            tml elements used in zukunft.com in /html/html_base.php
    \-- row_right - section for function row_right not yet defined that it should be base elements - functions for all h
            tml elements used in zukunft.com in /html/html_base.php
    \-- row_center - section for function row_center not yet defined that it should be base elements - functions for all
             html elements used in zukunft.com in /html/html_base.php
    \-- row_end - section for function row_end not yet defined that it should be base elements - functions for all html 
            elements used in zukunft.com in /html/html_base.php
    ...
    \-- echo_html - section for function echo_html not yet defined that it should be display interface in /html/html_bas
            e.php
    \-- echo - section for function echo not yet defined that it should be display interface in /html/html_base.php
    \-- ui_progress - section for function ui_progress not yet defined that it should be display interface in /html/html
            _base.php
    ...
    \-- concat_entry_text - section for function concat_entry_text not yet defined that it should be internal in /html/h
            tml_base.php
    \-- concat_category_text - section for function concat_category_text not yet defined that it should be internal in /
            html/html_base.php
    \-- concat_title_text - section for function concat_title_text not yet defined that it should be internal in /html/h
            tml_base.php
...
\-- rest_call
    ...
    \-- api_curl_call - section for function api_curl_call missing in /html/rest_call.php
    \-- api_call - section for function api_call missing in /html/rest_call.php
\-- sheet
...
\-- change_log_link_list
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /log/change_log_link_list.ph
            p
    \-- tbl - section for function tbl not yet defined that it should be table in /log/change_log_link_list.php
\-- change_log_list
    ...
    \-- filter_admin_fields - section for function filter_admin_fields not yet defined that it should be filter in /log/
            change_log_list.php
    \-- filter_user_overwrites - section for function filter_user_overwrites not yet defined that it should be filter in
    ...
    \-- tbl_when_who_what - section for function tbl_when_who_what not yet defined that it should be table in /log/chang
            e_log_list.php
\-- change_log_named
    ...
    \-- field_name - section for function field_name not yet defined that it should be helpers in /log/change_log_named.
            php
...
\-- log
    ...
    \-- user_id - section for function user_id not yet defined that it should be set and get in /log/log.php
    \-- user_name - section for function user_name not yet defined that it should be set and get in /log/log.php
    \-- text - section for function text not yet defined that it should be set and get in /log/log.php
    \-- status - section for function status not yet defined that it should be set and get in /log/log.php
    \-- api_array - section for function api_array not yet defined that it should be interface in /log/log.php
\-- user_log_display
    \-- __construct - section for function __construct is expected to be construct and map in /log/user_log_display.php
    \-- dsp_hist - section for function dsp_hist missing in /log/user_log_display.php
    \-- dsp_hist_links - section for function dsp_hist_links missing in /log/user_log_display.php
\-- phrase
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /phrase/phra
            se.php
    \-- api_array - section for function api_array not yet defined that it should be api in /phrase/phrase.php
    \-- set_from_json - section for function set_from_json is expected to be set and get in /phrase/phrase.php
    \-- id - section for function id not yet defined that it should be set and get in /phrase/phrase.php
    ...
    \-- main_word - section for function main_word not yet defined that it should be to review in /phrase/phrase.php
    \-- dsp_link_style - section for function dsp_link_style not yet defined that it should be to review in /phrase/phra
            se.php
    \-- display - section for function display not yet defined that it should be to review in /phrase/phrase.php
    \-- display_linked - section for function display_linked not yet defined that it should be to review in /phrase/phra
            se.php
    \-- name_linked - section for function name_linked not yet defined that it should be to review in /phrase/phrase.php
    \-- btn_add - section for function btn_add not yet defined that it should be to review in /phrase/phrase.php
    \-- button_add_triple - section for function button_add_triple not yet defined that it should be to review in /phras
            e/phrase.php
    \-- wrd_lst - section for function wrd_lst not yet defined that it should be to review in /phrase/phrase.php
    \-- dsp_tbl - section for function dsp_tbl not yet defined that it should be to review in /phrase/phrase.php
    \-- order error - order of section set and get has difference at id should be before set_id
\-- phrase_list
    ...
    \-- parent_triples - section for function parent_triples not yet defined that it should be select in /phrase/phrase_
            list.php
    \-- parent_triples_ex_verbs - section for function parent_triples_ex_verbs not yet defined that it should be select 
            in /phrase/phrase_list.php
    \-- assume_time - section for function assume_time not yet defined that it should be select in /phrase/phrase_list.p
            hp
    \-- wrd_lst_all - section for function wrd_lst_all not yet defined that it should be select in /phrase/phrase_list.p
            hp
    \-- word_list - section for function word_list not yet defined that it should be select in /phrase/phrase_list.php
    \-- triple_list - section for function triple_list not yet defined that it should be select in /phrase/phrase_list.p
            hp
    \-- sort_by_impact - section for function sort_by_impact not yet defined that it should be sort in /phrase/phrase_li
            st.php
    \-- max_impact - section for function max_impact not yet defined that it should be sort in /phrase/phrase_list.php
    \-- name_link_by_impact - section for function name_link_by_impact not yet defined that it should be display in /phr
            ase/phrase_list.php
    \-- name_link_grouped_by_verb - section for function name_link_grouped_by_verb not yet defined that it should be dis
    ...
    \-- id_url_long - section for function id_url_long not yet defined that it should be display in /phrase/phrase_list.
            php
    \-- measure_list - section for function measure_list not yet defined that it should be filter in /phrase/phrase_list
            .php
    \-- ex_measure_list - section for function ex_measure_list not yet defined that it should be filter in /phrase/phras
            e_list.php
    \-- scaling_list - section for function scaling_list not yet defined that it should be filter in /phrase/phrase_list
            .php
    \-- ex_scaling_list - section for function ex_scaling_list not yet defined that it should be filter in /phrase/phras
            e_list.php
    ...
    \-- remove - section for function remove not yet defined that it should be modify in /phrase/phrase_list.php
    \-- dsp_name - section for function dsp_name not yet defined that it should be modify in /phrase/phrase_list.php
    \-- common - section for function common not yet defined that it should be modify in /phrase/phrase_list.php
    \-- get_grp_id - section for function get_grp_id is expected to be set and get in /phrase/phrase_list.php
    \-- btn_add_value - section for function btn_add_value not yet defined that it should be to review in /phrase/phrase
            _list.php
    \-- dsp_graph - section for function dsp_graph not yet defined that it should be to review in /phrase/phrase_list.ph
            p
\-- term
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /phrase/term.php
    \-- id - section for function id not yet defined that it should be set and get in /phrase/term.php
    \-- obj_id - section for function obj_id not yet defined that it should be set and get in /phrase/term.php
    \-- set_id_from_obj - section for function set_id_from_obj is expected to be set and get in /phrase/term.php
    \-- api_array - section for function api_array not yet defined that it should be interface in /phrase/term.php
    \-- is_word - section for function is_word is expected to be info in /phrase/term.php
    \-- is_triple - section for function is_triple is expected to be info in /phrase/term.php
    \-- is_verb - section for function is_verb is expected to be info in /phrase/term.php
    \-- is_formula - section for function is_formula is expected to be info in /phrase/term.php
    ...
    \-- get_formula - section for function get_formula is expected to be set and get in /phrase/term.php
    \-- get_verb - section for function get_verb is expected to be set and get in /phrase/term.php
    \-- dsp_id - section for function dsp_id is expected to be debug in /phrase/term.php
    \-- name_tip - section for function name_tip not yet defined that it should be display in /phrase/term.php
    \-- get_impact - section for function get_impact is expected to be set and get in /phrase/term.php
    \-- name_link - section for function name_link not yet defined that it should be display in /phrase/term.php
    \-- edit_link - section for function edit_link not yet defined that it should be display in /phrase/term.php
    \-- dsp_tbl_cell - section for function dsp_tbl_cell not yet defined that it should be display in /phrase/term.php
    \-- dsp_unlink - section for function dsp_unlink not yet defined that it should be display in /phrase/term.php
    \-- dsp_selector - section for function dsp_selector not yet defined that it should be display in /phrase/term.php
    \-- display - section for function display not yet defined that it should be display in /phrase/term.php
    \-- order error - order of section set and get has difference at id should be before set_term_obj,
...
\-- term_list
    ...
    \-- word_by_id - section for function word_by_id not yet defined that it should be set and get in /phrase/term_list.
            php
    \-- triple_by_id - section for function triple_by_id not yet defined that it should be set and get in /phrase/term_l
            ist.php
    \-- formula_by_id - section for function formula_by_id not yet defined that it should be set and get in /phrase/term
            _list.php
    \-- verb_by_id - section for function verb_by_id not yet defined that it should be set and get in /phrase/term_list.
            php
    \-- sort_by_impact - section for function sort_by_impact not yet defined that it should be sort in /phrase/term_list
            .php
    \-- name_link_by_impact - section for function name_link_by_impact not yet defined that it should be display in /phr
            ase/term_list.php
    \-- links_with_context - section for function links_with_context is expected to be link in /phrase/term_list.php
    \-- term_by_obj_id - section for function term_by_obj_id not yet defined that it should be base in /phrase/term_list
            .php
\-- ref
    ...
    \-- phrase - section for function phrase is expected to be cast in /ref/ref.php
    \-- source - section for function source not yet defined that it should be set and get in /ref/ref.php
    \-- source_name - section for function source_name not yet defined that it should be set and get in /ref/ref.php
    \-- type_name - section for function type_name is expected to be preloaded in /ref/ref.php
    \-- type_url - section for function type_url not yet defined that it should be set and get in /ref/ref.php
    \-- type_id - section for function type_id not yet defined that it should be set and get in /ref/ref.php
    \-- used_url - section for function used_url not yet defined that it should be set and get in /ref/ref.php
    ...
    \-- has_phrase - section for function has_phrase not yet defined that it should be info in /ref/ref.php
...
\-- ref_list
    ...
    \-- sort_by_impact_and_type - section for function sort_by_impact_and_type not yet defined that it should be display
             in /ref/ref_list.php
\-- source
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /ref/source.
            php
    \-- url - section for function url not yet defined that it should be set and get in /ref/source.php
    \-- doi - section for function doi not yet defined that it should be set and get in /ref/source.php
    \-- doi_url - section for function doi_url not yet defined that it should be set and get in /ref/source.php
    \-- sandbox_fld_order - section for function sandbox_fld_order not yet defined that it should be set and get in /ref
            /source.php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be set and get in /ref/source.
            php
    ...
    \-- source_selector - section for function source_selector not yet defined that it should be select in /ref/source.p
            hp
    \-- source_type_selector - section for function source_type_selector not yet defined that it should be select in /re
            f/source.php
    \-- order error - order of section api has difference at api_mapper should be before load_by_id_with_related
\-- result
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /result/result.php
    \-- formula_id - section for function formula_id not yet defined that it should be set and get in /result/result.php
    \-- calculated_by_formula - section for function calculated_by_formula not yet defined that it should be set and get
    ...
    \-- order error - order of section display has difference at name should be before display
\-- result_list
    ...
    \-- display_old - section for function display_old not yet defined that it should be display in /result/result_list.
            php
    \-- frm_links_html - section for function frm_links_html not yet defined that it should be create the pure html (5) 
            code for all formula links related to this value list in /result/result_list.php
\-- ListBase
    \-- api_mapper_list - section for function api_mapper_list not yet defined that it should be construct and map in /s
            andbox/ListBase.php
    \-- lst_key - section for function lst_key not yet defined that it should be set and get in /sandbox/ListBase.php
    \-- reload - section for function reload not yet defined that it should be load in /sandbox/ListBase.php
    \-- api_json - section for function api_json not yet defined that it should be api in /sandbox/ListBase.php
    \-- api_array - section for function api_array not yet defined that it should be api in /sandbox/ListBase.php
    \-- merge - section for function merge not yet defined that it should be modify in /sandbox/ListBase.php
    \-- add - section for function add not yet defined that it should be modify in /sandbox/ListBase.php
    \-- id_lst - section for function id_lst not yet defined that it should be info in /sandbox/ListBase.php
    \-- list - section for function list not yet defined that it should be html in /sandbox/ListBase.php
    \-- lst_key_sort_by_name - section for function lst_key_sort_by_name not yet defined that it should be html in /sand
            box/ListBase.php
    \-- name_text - section for function name_text not yet defined that it should be html in /sandbox/ListBase.php
...
\-- combine_named
    ...
    \-- name - section for function name is expected to be debug in /sandbox/combine_named.php
    \-- name_or_null - section for function name_or_null not yet defined that it should be set and get in /sandbox/combi
            ne_named.php
    \-- type_id - section for function type_id not yet defined that it should be set and get in /sandbox/combine_named.p
            hp
    \-- api_array - section for function api_array not yet defined that it should be interface in /sandbox/combine_named
            .php
\-- combine_object
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /sandbox/combine_object.php
    \-- order error - order of section set and get has difference at api_mapper should be before set_from_json
\-- db_object
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /sandbox/db_
            object.php
    \-- pre_value - section for function pre_value not yet defined that it should be construct and map in /sandbox/db_ob
            ject.php
    \-- input_valid - section for function input_valid not yet defined that it should be construct and map in /sandbox/d
            b_object.php
    \-- url_is_add_action - section for function url_is_add_action not yet defined that it should be construct and map i
            n /sandbox/db_object.php
    \-- to_url_array - section for function to_url_array not yet defined that it should be construct and map in /sandbox
            /db_object.php
    \-- sandbox_fld_order - section for function sandbox_fld_order not yet defined that it should be construct and map i
            n /sandbox/db_object.php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be construct and map in /sandb
            ox/db_object.php
    ...
    \-- btn_add_sbx - section for function btn_add_sbx not yet defined that it should be buttons in /sandbox/db_object.p
            hp
    \-- btn_edit_sbx - section for function btn_edit_sbx not yet defined that it should be buttons in /sandbox/db_object
            .php
    \-- btn_del_sbx - section for function btn_del_sbx not yet defined that it should be buttons in /sandbox/db_object.p
            hp
    ...
    \-- plural_reverse - section for function plural_reverse not yet defined that it should be dummy functions to preven
            t polymorph warning in /sandbox/db_object.php
    \-- formula_name - section for function formula_name not yet defined that it should be dummy functions to prevent po
            lymorph warning in /sandbox/db_object.php
    \-- phrase_name - section for function phrase_name not yet defined that it should be dummy functions to prevent poly
            morph warning in /sandbox/db_object.php
    \-- value - section for function value not yet defined that it should be dummy functions to prevent polymorph warnin
            g in /sandbox/db_object.php
    \-- get_usage - section for function get_usage is expected to be set and get in /sandbox/db_object.php
    \-- phrase - section for function phrase is expected to be cast in /sandbox/db_object.php
    \-- term - section for function term is expected to be cast in /sandbox/db_object.php
    \-- user_expression - section for function user_expression not yet defined that it should be dummy functions to prev
            ent polymorph warning in /sandbox/db_object.php
    \-- need_all - section for function need_all not yet defined that it should be dummy functions to prevent polymorph 
            warning in /sandbox/db_object.php
    \-- view_list - section for function view_list not yet defined that it should be load in /sandbox/db_object.php
    \-- add_via_api - section for function add_via_api not yet defined that it should be crud in /sandbox/db_object.php
    \-- update - section for function update not yet defined that it should be TODO Prio 2 activate api call in /sandbox
            /db_object.php
    \-- del - section for function del is expected to be del in /sandbox/db_object.php
    \-- url - section for function url not yet defined that it should be dummy function to be overwritten by the child o
            bjects in /sandbox/db_object.php
    \-- doi - section for function doi not yet defined that it should be dummy function to be overwritten by the child o
            bjects in /sandbox/db_object.php
    \-- phrase_selector - section for function phrase_selector not yet defined that it should be dummy function to be ov
...
\-- list_named
    \-- name_link - section for function name_link not yet defined that it should be base in /sandbox/list_named.php
    \-- names_linked - section for function names_linked not yet defined that it should be base in /sandbox/list_named.p
            hp
    \-- name_tip - section for function name_tip not yet defined that it should be base in /sandbox/list_named.php
    \-- names - section for function names is expected to be info in /sandbox/list_named.php
\-- sandbox
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /sandbox/sandbox.php
    \-- url_mapper - section for function url_mapper not yet defined that it should be set and get in /sandbox/sandbox.p
            hp
    \-- to_url_array - section for function to_url_array not yet defined that it should be set and get in /sandbox/sandb
            ox.php
    \-- owner_name - section for function owner_name not yet defined that it should be set and get in /sandbox/sandbox.p
            hp
    \-- view_id - section for function view_id not yet defined that it should be set and get in /sandbox/sandbox.php
    \-- api_array - section for function api_array not yet defined that it should be api in /sandbox/sandbox.php
    \-- share_id - section for function share_id not yet defined that it should be set and get in /sandbox/sandbox.php
    \-- protection_id - section for function protection_id not yet defined that it should be set and get in /sandbox/san
            dbox.php
    \-- is_excluded - section for function is_excluded is expected to be info in /sandbox/sandbox.php
...
\-- sandbox_link
    ...
    \-- name_linked - section for function name_linked not yet defined that it should be display in /sandbox/sandbox_lin
            k.php
\-- sandbox_list
    \-- sort_by_relevance - section for function sort_by_relevance not yet defined that it should be sort in /sandbox/sa
            ndbox_list.php
    \-- name_pur - section for function name_pur not yet defined that it should be debug in /sandbox/sandbox_list.php
    \-- names - section for function names is expected to be info in /sandbox/sandbox_list.php
\-- sandbox_list_named
    \-- name_tip - section for function name_tip not yet defined that it should be base in /sandbox/sandbox_list_named.p
            hp
    \-- name_link - section for function name_link not yet defined that it should be base in /sandbox/sandbox_list_named
            .php
    \-- add - section for function add not yet defined that it should be modify in /sandbox/sandbox_list_named.php
    \-- add_by_key - section for function add_by_key not yet defined that it should be modify in /sandbox/sandbox_list_n
            amed.php
    ...
    \-- sort_by_name - section for function sort_by_name not yet defined that it should be modify in /sandbox/sandbox_li
            st_named.php
    \-- get_by_name - section for function get_by_name is expected to be set and get in /sandbox/sandbox_list_named.php
    \-- get_by_pattern - section for function get_by_pattern is expected to be set and get in /sandbox/sandbox_list_name
            d.php
    \-- order error - order of section base has difference at name_link should be before name_tip
\-- sandbox_named
    \-- name - section for function name is expected to be debug in /sandbox/sandbox_named.php
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /sandbox/sandbox_named.php
    \-- api_array - section for function api_array not yet defined that it should be api in /sandbox/sandbox_named.php
    \-- input_valid - section for function input_valid not yet defined that it should be api in /sandbox/sandbox_named.p
            hp
    \-- url_mapper - section for function url_mapper not yet defined that it should be api in /sandbox/sandbox_named.php
    \-- to_url_array - section for function to_url_array not yet defined that it should be api in /sandbox/sandbox_named
            .php
...
\-- job
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /system/job.php
    \-- request_time - section for function request_time not yet defined that it should be set and get in /system/job.ph
            p
    \-- start_time - section for function start_time not yet defined that it should be set and get in /system/job.php
    \-- end_time - section for function end_time not yet defined that it should be set and get in /system/job.php
    \-- user_id - section for function user_id not yet defined that it should be set and get in /system/job.php
...
\-- language
    ...
    \-- select_list_item - section for function select_list_item not yet defined that it should be selectors in /system/
            language.php
...
\-- sys_log
    ...
    \-- prg_part - section for function prg_part not yet defined that it should be set and get in /system/sys_log.php
    \-- owner_id - section for function owner_id not yet defined that it should be set and get in /system/sys_log.php
    \-- api_array - section for function api_array not yet defined that it should be interface in /system/sys_log.php
    \-- display - section for function display not yet defined that it should be display in /system/sys_log.php
    \-- page_view - section for function page_view not yet defined that it should be display in /system/sys_log.php
    \-- display_admin - section for function display_admin not yet defined that it should be display in /system/sys_log.
            php
    \-- header - section for function header not yet defined that it should be display in /system/sys_log.php
    \-- header_admin - section for function header_admin not yet defined that it should be display in /system/sys_log.ph
            p
    \-- get_html - section for function get_html is expected to be set and get in /system/sys_log.php
    \-- user - section for function user not yet defined that it should be display in /system/sys_log.php
    \-- owner - section for function owner not yet defined that it should be display in /system/sys_log.php
    \-- owner_name - section for function owner_name not yet defined that it should be display in /system/sys_log.php
    \-- status_name - section for function status_name not yet defined that it should be display in /system/sys_log.php
    \-- order error - order of section display has difference at header should be before page_view
\-- sys_log_list
    ...
    \-- head - section for function head not yet defined that it should be modify in /system/sys_log_list.php
    \-- display - section for function display not yet defined that it should be display in /system/sys_log_list.php
    \-- display_admin - section for function display_admin not yet defined that it should be display in /system/sys_log_
            list.php
...
\-- type_list
    \-- reset - section for function reset is expected to be construct and map in /types/type_list.php
    \-- set_from_json_array - section for function set_from_json_array is expected to be set and get in /types/type_list
            .php
    \-- lst_key - section for function lst_key missing in /types/type_list.php
    \-- lst_key_sort_by_name - section for function lst_key_sort_by_name missing in /types/type_list.php
    \-- lst - section for function lst missing in /types/type_list.php
    \-- db_id_list - section for function db_id_list missing in /types/type_list.php
    \-- id - section for function id missing in /types/type_list.php
    \-- get_code_id - section for function get_code_id is expected to be set and get in /types/type_list.php
    \-- name - section for function name is expected to be debug in /types/type_list.php
    ...
    \-- name_tip - section for function name_tip not yet defined that it should be display in /types/type_list.php
    \-- name_link - section for function name_link not yet defined that it should be display in /types/type_list.php
    \-- sort_by_name - section for function sort_by_name not yet defined that it should be display in /types/type_list.p
            hp
    ...
    \-- order error - order of section  has difference at name should be before reset,
            order of section display has difference at name_link should be before name_tip
\-- type_lists
...
\-- type_object
    ...
    \-- description - section for function description not yet defined that it should be set and get in /types/type_obje
            ct.php
    \-- impact - section for function impact not yet defined that it should be set and get in /types/type_object.php
    \-- name_tip - section for function name_tip not yet defined that it should be set and get in /types/type_object.php
    \-- name_link - section for function name_link not yet defined that it should be set and get in /types/type_object.p
            hp
    \-- select_list_item - section for function select_list_item not yet defined that it should be selectors in /types/t
            ype_object.php
    \-- url_mapper - section for function url_mapper not yet defined that it should be api in /types/type_object.php
    \-- api_mapper - section for function api_mapper is expected to be construct and map in /types/type_object.php
    \-- api_array - section for function api_array not yet defined that it should be api in /types/type_object.php
    \-- type_phrases - section for function type_phrases not yet defined that it should be fixed in /types/type_object.p
            hp
    \-- order error - order of section set and get has difference at id should be before set_description
\-- user
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /user/user.p
            hp
    \-- name_or_null - section for function name_or_null not yet defined that it should be set and get in /user/user.php
    \-- name - section for function name is expected to be debug in /user/user.php
    ...
    \-- display - section for function display not yet defined that it should be to review in /user/user.php
    \-- order error - order of section construct and map has difference at url_mapper should be before reset,
            order of section set and get has difference at name should be before name_or_null
\-- user_message
    \-- __construct - section for function __construct is expected to be construct and map in /user/user_message.php
    \-- reset - section for function reset is expected to be construct and map in /user/user_message.php
    \-- api_array - section for function api_array not yet defined that it should be api in /user/user_message.php
    ...
    \-- add_err_with_vars - section for function add_err_with_vars not yet defined that it should be add in /user/user_m
            essage.php
    \-- add_warning_with_vars - section for function add_warning_with_vars not yet defined that it should be add in /use
            r/user_message.php
    \-- add_error_text - section for function add_error_text not yet defined that it should be add in /user/user_message
            .php
...
\-- value
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /value/value
            .php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be construct and map in /value
            /value.php
    \-- source_id - section for function source_id not yet defined that it should be set and get in /value/value.php
    \-- get - section for function get not yet defined that it should be set and get in /value/value.php
    \-- api_array - section for function api_array not yet defined that it should be api in /value/value.php
    \-- match_all - section for function match_all not yet defined that it should be select in /value/value.php
    ...
    \-- btn_undo_add_value - section for function btn_undo_add_value not yet defined that it should be to review in /val
            ue/value.php
    \-- dsp_tbl_std - section for function dsp_tbl_std not yet defined that it should be to review in /value/value.php
    \-- dsp_tbl_usr - section for function dsp_tbl_usr not yet defined that it should be to review in /value/value.php
    \-- dsp_tbl - section for function dsp_tbl not yet defined that it should be to review in /value/value.php
    \-- dsp_hist - section for function dsp_hist not yet defined that it should be to review in /value/value.php
    \-- dsp_hist_links - section for function dsp_hist_links not yet defined that it should be to review in /value/value
            .php
    \-- dsp_samples - section for function dsp_samples not yet defined that it should be TODO recreate based on the grou
            p in /value/value.php
    \-- dsp_add_fast - section for function dsp_add_fast not yet defined that it should be TODO recreate based on the gr
            oup in /value/value.php
    \-- dsp_edit - section for function dsp_edit not yet defined that it should be TODO recreate based on the group in /
            value/value.php
    \-- display - section for function display not yet defined that it should be TODO recreate based on the group in /va
            lue/value.php
    \-- order error - order of section construct and map has difference at db_fld_to_url should be before url_mapper,
...
\-- value_list
    ...
    \-- sort_by_impact - section for function sort_by_impact not yet defined that it should be modify in /value/value_li
            st.php
    \-- list - section for function list not yet defined that it should be display in /value/value_list.php
    \-- list_most_relevant - section for function list_most_relevant not yet defined that it should be display in /value
            /value_list.php
    \-- columns_by_phrase - section for function columns_by_phrase not yet defined that it should be display in /value/v
            alue_list.php
    ...
    \-- common_phrases - section for function common_phrases not yet defined that it should be info in /value/value_list
            .php
    \-- phrase_groups - section for function phrase_groups not yet defined that it should be info in /value/value_list.p
            hp
...
\-- verb
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /verb/verb.p
            hp
    \-- type_id - section for function type_id not yet defined that it should be set and get in /verb/verb.php
    \-- reverse - section for function reverse not yet defined that it should be set and get in /verb/verb.php
    \-- plural_reverse - section for function plural_reverse not yet defined that it should be set and get in /verb/verb
            .php
    ...
    \-- order error - order of section set and get has difference at get_plural should be before type_id,
            order of section api has difference at api_array should be before load_by_id_with_related
\-- verb_list
...
\-- term_view
    ...
    \-- link_type - section for function link_type is expected to be link in /view/term_view.php
    \-- name - section for function name is expected to be debug in /view/term_view.php
    \-- name_linked - section for function name_linked not yet defined that it should be display in /view/term_view.php
    \-- get_description - section for function get_description is expected to be set and get in /view/term_view.php
...
\-- view
    ...
    \-- dsp_navbar_no_view - section for function dsp_navbar_no_view not yet defined that it should be api in /view/view
            .php
    \-- dsp_navbar_simple - section for function dsp_navbar_simple not yet defined that it should be api in /view/view.p
            hp
    \-- dsp_navbar_html_no_view - section for function dsp_navbar_html_no_view not yet defined that it should be to revi
            ew / deprecate in /view/view.php
    \-- dsp_edit - section for function dsp_edit not yet defined that it should be to review in /view/view.php
    \-- dsp_hist - section for function dsp_hist not yet defined that it should be to review in /view/view.php
    \-- dsp_hist_links - section for function dsp_hist_links not yet defined that it should be to review in /view/view.p
            hp
...
\-- view_base
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /view/view_b
            ase.php
    ...
    \-- order error - order of section construct and map has difference at url_mapper should be before __construct
\-- view_exe
    \-- show - section for function show not yet defined that it should be execute in /view/view_exe.php
    \-- dsp_edit - section for function dsp_edit not yet defined that it should be to review in /view/view_exe.php
    \-- dsp_hist - section for function dsp_hist not yet defined that it should be to review in /view/view_exe.php
    \-- dsp_hist_links - section for function dsp_hist_links not yet defined that it should be to review in /view/view_e
            xe.php
    \-- selector_page - section for function selector_page not yet defined that it should be to review in /view/view_exe
            .php
\-- view_list
    ...
    \-- order error - order of section base has difference at name_link should be before name_tip
\-- view_relation
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /view/view_r
            elation.php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be construct and map in /view/
            view_relation.php
    \-- api_array - section for function api_array not yet defined that it should be api in /view/view_relation.php
    \-- name - section for function name is expected to be debug in /view/view_relation.php
    \-- name_linked - section for function name_linked not yet defined that it should be display in /view/view_relation.
            php
    ...
    \-- order error - order of section construct and map has difference at db_fld_to_url should be before url_mapper
\-- triple
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /word/triple
            .php
    \-- input_valid - section for function input_valid not yet defined that it should be construct and map in /word/trip
            le.php
    \-- is_in_use - section for function is_in_use is expected to be info in /word/triple.php
    \-- sandbox_fld_order - section for function sandbox_fld_order not yet defined that it should be construct and map i
            n /word/triple.php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be construct and map in /word/
            triple.php
    \-- load_by_id_with_related - section for function load_by_id_with_related is expected to be load in /word/triple.ph
            p
    \-- api_array - section for function api_array not yet defined that it should be api in /word/triple.php
    \-- to_url_array - section for function to_url_array not yet defined that it should be api in /word/triple.php
    \-- type - section for function type not yet defined that it should be set and get in /word/triple.php
    \-- impact - section for function impact not yet defined that it should be set and get in /word/triple.php
    ...
    \-- is_info - section for function is_info is expected to be info in /word/triple.php
    \-- tr - section for function tr not yet defined that it should be table in /word/triple.php
    \-- td - section for function td not yet defined that it should be table in /word/triple.php
    \-- dsp_tbl - section for function dsp_tbl not yet defined that it should be table in /word/triple.php
    \-- get_link_by_verb - section for function get_link_by_verb is expected to be set and get in /word/triple.php
    \-- display - section for function display not yet defined that it should be to review in /word/triple.php
    \-- dsp_r - section for function dsp_r not yet defined that it should be to review in /word/triple.php
    \-- dsp_del - section for function dsp_del not yet defined that it should be to review in /word/triple.php
    \-- display_linked - section for function display_linked not yet defined that it should be to review in /word/triple
            .php
    \-- order error - order of section construct and map has difference at db_fld_to_url should be before input_valid,
            order of section set and get has difference at get_plural should be before set
\-- triple_list
    ...
    \-- display - section for function display not yet defined that it should be display in /word/triple_list.php
    \-- names_linked - section for function names_linked not yet defined that it should be display in /word/triple_list.
            php
    \-- tbl - section for function tbl not yet defined that it should be display in /word/triple_list.php
    \-- graph - section for function graph not yet defined that it should be display in /word/triple_list.php
    \-- time_lst - section for function time_lst not yet defined that it should be select in /word/triple_list.php
    \-- measure_lst - section for function measure_lst not yet defined that it should be select in /word/triple_list.php
    \-- scaling_lst - section for function scaling_lst not yet defined that it should be select in /word/triple_list.php
    \-- measure_scale_lst - section for function measure_scale_lst not yet defined that it should be select in /word/tri
            ple_list.php
    \-- percent_lst - section for function percent_lst not yet defined that it should be select in /word/triple_list.php
    \-- ex_measure_and_time_lst - section for function ex_measure_and_time_lst not yet defined that it should be select 
            in /word/triple_list.php
    \-- ex_time - section for function ex_time not yet defined that it should be select in /word/triple_list.php
    \-- ex_measure - section for function ex_measure not yet defined that it should be select in /word/triple_list.php
    \-- ex_scaling - section for function ex_scaling not yet defined that it should be select in /word/triple_list.php
    \-- ex_percent - section for function ex_percent not yet defined that it should be select in /word/triple_list.php
    \-- phrase_list - section for function phrase_list is expected to be cast in /word/triple_list.php
    \-- from_phrase_list - section for function from_phrase_list not yet defined that it should be select in /word/tripl
            e_list.php
    \-- to_phrase_list - section for function to_phrase_list not yet defined that it should be select in /word/triple_li
            st.php
    \-- suggested - section for function suggested not yet defined that it should be select in /word/triple_list.php
    \-- names - section for function names is expected to be info in /word/triple_list.php
\-- word
    \-- url_mapper - section for function url_mapper not yet defined that it should be construct and map in /word/word.p
            hp
    \-- input_valid - section for function input_valid not yet defined that it should be construct and map in /word/word
            .php
    \-- is_in_use - section for function is_in_use is expected to be info in /word/word.php
    \-- to_url_array - section for function to_url_array not yet defined that it should be construct and map in /word/wo
            rd.php
    \-- sandbox_fld_order - section for function sandbox_fld_order not yet defined that it should be construct and map i
            n /word/word.php
    \-- db_fld_to_url - section for function db_fld_to_url not yet defined that it should be construct and map in /word/
            word.php
    \-- api_array - section for function api_array not yet defined that it should be api in /word/word.php
    \-- impact - section for function impact not yet defined that it should be set and get in /word/word.php
    ...
    \-- dsp_type_selector - section for function dsp_type_selector not yet defined that it should be select in /word/wor
            d.php
    \-- th - section for function th not yet defined that it should be table in /word/word.php
    \-- tr - section for function tr not yet defined that it should be table in /word/word.php
    \-- td - section for function td not yet defined that it should be table in /word/word.php
    \-- dsp_del - section for function dsp_del not yet defined that it should be change action in /word/word.php
    \-- dsp_unlink - section for function dsp_unlink not yet defined that it should be change action in /word/word.php
    \-- is_type - section for function is_type is expected to be info in /word/word.php
    \-- is_time - section for function is_time is expected to be info in /word/word.php
    \-- is_time_jump - section for function is_time_jump is expected to be info in /word/word.php
    \-- is_measure - section for function is_measure is expected to be info in /word/word.php
...
\-- word_list
    ...
    \-- selector - section for function selector not yet defined that it should be select in /word/word_list.php
    \-- assume_time - section for function assume_time not yet defined that it should be select in /word/word_list.php
    \-- has_time - section for function has_time not yet defined that it should be select in /word/word_list.php
    \-- max_val_time - section for function max_val_time not yet defined that it should be select in /word/word_list.php
    \-- max_time - section for function max_time not yet defined that it should be select in /word/word_list.php
    \-- time_lst - section for function time_lst not yet defined that it should be select in /word/word_list.php
    \-- measure_lst - section for function measure_lst not yet defined that it should be select in /word/word_list.php
    \-- scaling_lst - section for function scaling_lst not yet defined that it should be select in /word/word_list.php
    \-- measure_scale_lst - section for function measure_scale_lst not yet defined that it should be select in /word/wor
            d_list.php
    \-- percent_lst - section for function percent_lst not yet defined that it should be select in /word/word_list.php
    \-- ex_measure_and_time_lst - section for function ex_measure_and_time_lst not yet defined that it should be select 
            in /word/word_list.php
    \-- ex_time - section for function ex_time not yet defined that it should be select in /word/word_list.php
    \-- ex_measure - section for function ex_measure not yet defined that it should be select in /word/word_list.php
    \-- ex_scaling - section for function ex_scaling not yet defined that it should be select in /word/word_list.php
    \-- ex_percent - section for function ex_percent not yet defined that it should be select in /word/word_list.php
    \-- order error - order of section select has difference at time_lst should be before has_time
```
...
\-- api
    \-- api_mapper
        ...
        \-- element - set the vars of this element object based on the api json array
        \-- change_log - set the vars of this object bases on the api json array
        \-- change_log_named - set the vars of this object bases on the api json array
    \-- 1
        \-- sys_log_list - create the api json message string of this list that can be sent to the backend
    \-- api_array
        \-- component - TODO all set_from_json_array functions should only use json_fields not api::FLD
...
\-- base
    \-- name_link
        \-- component - create the html code to show the component name with the link to change the component parameters
        \-- list_named - @param user_message $msg to collect the error messages
    \-- val_formatted
        \-- figure - @return bool true if this figure has been calculated based on other numbers
    \-- name_linked
    ...
    \-- term_by_obj_id
        \-- term_list - get a term from the term list selected by the word, triple, formula or verb id
    \-- name_tip
        \-- list_named - to show the list name to the user in the most simple form (without any ids)
    \-- names
        \-- list_named - @param ?int $limit the max number of ids to show
\-- select
    \-- component_type_selector
        \-- component - create the HTML code to select a component type
    \-- type_selector
        \-- component - create the HTML code to select a view type
    \-- style_selector
    ...
    \-- assume_time
        \-- phrase_list - get the most useful time for the given phrases
    \-- wrd_lst_all
        \-- phrase_list - build a word list including the triple words or in other words flatten the list e.g. for paren
                t inclusions
    \-- word_list
        \-- phrase_list - get the words from the phrase list
    \-- triple_list
        \-- phrase_list - get the triples from the phrase list
    \-- time_lst
        \-- triple_list - get all time triples from this list of triples
    \-- measure_lst
        \-- triple_list - get all measure triples from this list of triples
    \-- scaling_lst
        \-- triple_list - get all scaling triples from this list of triples
    \-- measure_scale_lst
        \-- triple_list - get all measure and scaling triples from this list of triples
    \-- percent_lst
        \-- triple_list - get all measure triples from this list of triples
    \-- ex_measure_and_time_lst
        \-- triple_list - like names_linked, but without measure and time triples
    \-- ex_time
        \-- triple_list - Exclude all time triples from this triple list
    \-- ex_measure
        \-- triple_list - Exclude all measure triples from this triple list
    \-- ex_scaling
        \-- triple_list - Exclude all measure triples from this triple list
    \-- ex_percent
        \-- triple_list - Exclude all measure triples from this triple list
    \-- phrase_list
        \-- triple_list - @return phrase_list_ui with all from phrases
    \-- from_phrase_list
        \-- triple_list - @return phrase_list_ui with all from phrases
    \-- to_phrase_list
        \-- triple_list - @return phrase_list_ui with all from phrases
    \-- suggested
        \-- triple_list - @return phrase_list_ui with all from phrases
    \-- names
        \-- triple_list - @return array with all triple names in alphabetic order
\-- info
    \-- type_code_id
        \-- component - TODO Prio 1 apply this error handling to similar functions
    \-- pos_type_code_id
        \-- component - TODO Prio 1 apply this error handling to similar functions
    \-- get_style_id
        \-- component - @return int|null the id of the display style of this component or null if no style is set
    \-- style_text
        \-- component - @return int|null the id of the display style of this component or null if no style is set
    \-- style_code_id
        \-- component - get the code id that is used for the unique selection of the style and is also the actual html c
                ode to use
    \-- is_button
        \-- component - @return bool true if the component is a system form button
    \-- is_hidden
        \-- component - @return bool true if the component is a hidden system form element
    \-- is_list_group
        \-- component - TODO Prio 1 can be removed due to the explicit combine position type
    \-- no_row_style
...
\-- to review
    ...
    \-- text
        \-- component - @return string a fixed text
    \-- word_name
    ...
    \-- get_html_footer
        \-- sys_log_list - @return string the HTML code for the table headline
    \-- selector_page
        \-- view_exe - create a selection page where the user can select a view
\-- display
    \-- dsp_entries
        \-- component_exe - create the html code of this component filled with the data from the given database object (
                $dbo)
    \-- name_link
    ...
    \-- change_log_table_pure
        \-- ui_log - the pure (borderless) change log table of the given object with the three columns
    \-- user_overwrites_table_pure
        \-- ui_log - the borderless when / who / what table of the session user's own overwrites of the given
    \-- all_user_overwrites
        \-- ui_log - the fixed column of the user page with all changes the shown user has written to the user
    \-- user_system_errors
        \-- ui_log - show the most relevant open system errors related to the user
    \-- name
        \-- element_group - show the element group name to the user in the most simple form (without any ids)
    \-- id
        \-- element_group - show the element group name to the user in the most simple form (without any ids)
    \-- dsp_names
        \-- element_group - list of the formula element names independent of the element type
    \-- figures
        \-- element_group - get a list of figures related to the formula element group and a context defined by a list o
                f words
    \-- display
        \-- formula_link - @return string that best describes this object
        \-- result_list - @return string with a list of the result names with html links
    ...
    \-- dsp_id
        \-- group_list - @return string with to identify the phrase group list
    \-- header
        \-- text_log - write a header text to the standard io
    \-- subheader
        \-- text_log - write a subheader text to the standard io
    \-- name_link_by_impact
        \-- phrase_list - create the html code to display the phrases sorted with the highest impact first
        \-- term_list - create the html links of the terms ordered by impact, highest impact first
    \-- name_link_grouped_by_verb
    ...
    \-- links_with_context
        \-- term_list - create the html term links in three columns that have more or less the same number of items
    \-- list
    ...
    \-- graph
        \-- triple_list - TODO move the relevant parts to other functions
\-- set and get
    \-- 1
        \-- phrase_list - set the vars of this phrase list frontend object based on the url array
        \-- combine_named - @param int $id the id of the object
    \-- api_mapper
        \-- component_list - set the vars of these list display objects bases on the api json array
        \-- figure - set the vars of this figure html display object bases on the api message
        \-- formula_link_list - set the vars of a formula object based on the given json
        \-- change_log_link_list - set the vars of this list based on the given api json
        \-- change_log_list - set the vars of a word object based on the given json
        \-- log - set the vars of this log html object bases on the api json array
        \-- phrase_list - set the vars of a phrase list based on the given json
        \-- term_list - set the vars of a term object based on the given json
        \-- ref_list - set the vars of a source object based on the given json
        \-- source_list - set the vars of a source object based on the given json
        \-- result_list - set the vars of a result object based on the given json
        \-- sandbox - set the vars of this sandbox object bases on the api json array
    ...
    \-- refresh_words_via_api
        \-- data_object - set the vars of these list display objects bases on the api message
    \-- word_list
        \-- data_object - @return word_list with the words of this data object
    \-- triple_list
        \-- data_object - @return triple_list with the triples of this data object
    \-- phrase_list
        \-- data_object - @return phrase_list with the phrases of this data object
    \-- set_source_list
        \-- data_object - set the source_list of this data object
    \-- source_list
        \-- data_object - @return source_list with the sources of this data object
    \-- set_ref_list
        \-- data_object - set the ref_list of this data object
    \-- ref_list
        \-- data_object - @return ref_list with the refs of this data object
    \-- set_value_list
        \-- data_object - set the value_list of this data object
    \-- value_list
        \-- data_object - @return value_list with the value of this data object
    \-- set_formula_link_list
        \-- data_object - set the formula_link_list of this data object
    \-- formula_link_list
        \-- data_object - @return formula_link_list with the formula links of this data object
    \-- set_result_list
        \-- data_object - set the result_list of this data object
    \-- result_list
        \-- data_object - @return result_list with the results of this data object
    \-- set_formula_list
        \-- data_object - set the formula_list of this data object
    \-- formula_list
    ...
    \-- file_list
        \-- data_object - @return array with a list of suggested im- and export file names
    \-- has_file_list
        \-- data_object - @return bool true if this context object contains a list of suggested im- and export file name
                s
    \-- set_component_list
        \-- data_object - set the component_list of this data object
    \-- component_list
        \-- data_object - @return component_list with the components of this data object
    \-- has_phrases
        \-- data_object - @return bool true if this context object contains at least some phrases
    \-- add_phrases
        \-- data_object - @return bool true if this context object contains at least some phrases
    \-- ref_list_cloned
        \-- data_object - @return bool true if this context object contains at least some phrases
    ...
    \-- add_changes
        \-- data_object - @return bool true if this context object contains at least some phrases
    \-- change_log
        \-- data_object - @return change_log_list the cache of the relevant change log entries
    \-- has_sys_log
        \-- data_object - @return bool true if this context object contains at least one system log entry
    \-- sys_log_list
        \-- data_object - @return sys_log_list the cache of the open system errors related to the session user
    \-- set_time
        \-- log - set the vars of this log html object bases on the api json array
    \-- time
        \-- log - set the vars of this log html object bases on the api json array
    ...
    \-- verb_by_id
        \-- term_list - get a verb from the term list selected by the verb id
    \-- get_by_phrase
        \-- ref_list - select the references that are linked to the given phrase
    \-- set_name
        \-- combine_named - @param string $name the name of the word, triple, formula or verb
    \-- name
        \-- combine_named - @return string the name of the word, triple, formula or verb
    \-- name_or_null
        \-- combine_named - @return string|null the name of the word, triple, formula or verb
    \-- set_description
        \-- combine_named - @param string|null $description the description of the word, triple, formula or verb
    ...
    \-- to_url_array
        \-- sandbox - @return array parent url array extended with the share and protection of this sandbox object
    \-- set_owner_name
        \-- sandbox - set the owner by the user name e.g. as sent by the api message or the page url
    \-- owner_name
        \-- sandbox - @return string the name of the user who owns the object or an empty string if not known
    \-- view_id
        \-- sandbox - @return string the name of the user who owns the object or an empty string if not known
    \-- share_id
        \-- sandbox - @return array the json message array to send the updated data to the backend
    ...
    \-- default_id
        ...
        \-- ref_type_list - create the HTML code to select a reference type
        \-- share - create the HTML code to select a share type
        \-- source_type_list - create the HTML code to select a source type
        \-- user_profile - create the HTML code to select a user profile
        \-- verbs - create the HTML code to select a verb
...
\-- load
    ...
    \-- load_by_object
        \-- change_log_link_list - load the link change history of one object from the backend via the api
    \-- load_api_by_object
    ...
    \-- load_by
        \-- result_list - get a list of results via api from the backend
    \-- load_by_name
...
\-- 
    ...
    \-- title_named
        \-- system_form - page title of named object with explaining subtitle
    \-- title_triple
        \-- system_form - the page title for a triple: show the triple name big as the title (not as a link)
    \-- title_link
        \-- system_form - the page title for a link object (formula link, term view, component link or view relation):
    \-- title_phrase
        \-- system_form - the page title for a phrase: a triple gets the triple title (name plus the from, verb and to
    \-- title_formula
        \-- system_form - the page title for a formula: like the named title (formula name big plus the edit link),
    \-- title_value
        \-- system_form - the page title for a value: unlike a named object, the heading is not a plain
    \-- form_back
        \-- system_form - create the HTML code to select this and the previous views
    \-- form_confirm
        \-- system_form - // TODO Prio 2 review
    \-- admin_form_username
        \-- system_form - @return string the html code so that an admin user can overwrite the username
    \-- admin_form_user_email
    ...
    \-- admin_login_fails
        \-- system_page - @return string with the HTML code that contains the last failed user logins
    \-- admin_errors_unassigned
        \-- system_page - @return string with the HTML code that all internal system errors that are not yet assigned to
                 a developer
    \-- admin_errors_delayed_fix
        \-- system_page - @return string with the HTML code that all internal system errors that have not been updated s
                ince a some time (as defined in the system config)
    \-- admin_jobs_delayed
        \-- system_page - render an HTML table of all not-yet-closed system jobs ordered by the longest delay first;
    \-- phrase_name
        \-- ui_base - @return string the name of a phrase and give the user the possibility to change the phrase name
    \-- verb_name
        \-- ui_base - TODO move to a component exe part class
    \-- triple_name
        \-- ui_base - TODO move to a component exe part class
    \-- value_name
        \-- ui_base - TODO move to a component exe part class
    ...
    \-- num_value
        \-- ui_base - TODO move to a component exe part class
    \-- main_value
        \-- ui_base - TODO Prio 0 fill with real code
    \-- source_name
        \-- ui_base - @param db_object|type_object|null $dbo the source whose name should be shown
    \-- source_doi_link
        \-- ui_base - @param source|db_object|null $dbo the source whose doi should be shown
    \-- source_url_link
        \-- ui_base - @param source|db_object|null $dbo the source whose url should be shown
    \-- reference_name
        \-- ui_base - @param db_object|type_object|null $dbo the reference whose name should be shown
    \-- language_name
        \-- ui_base - @param db_object|type_object|null $dbo the language whose name should be shown
    \-- table
        \-- ui_base - TODO move code from component_dsp_old
    \-- all
        \-- ui_base - TODO move code from component_dsp_old
    \-- expression
        \-- ui_base - @param db_object|null $dbo the formula whose expression should be displayed
    \-- expression_latex_link
        \-- ui_base - @param db_object|null $dbo the formula whose latex should be displayed
    \-- expression_latex_link_form
        \-- ui_base - @param db_object|null $dbo the formula whose latex should be displayed
    \-- expression_link
        \-- ui_base - @param db_object|null $dbo the formula whose expression should be displayed
    \-- name
    ...
    \-- word_parents
        \-- ui_foaf - TODO move code from component_dsp_old
    \-- select_file
        \-- ui_im_export - the html code to select a filename e.g. to upload the file
    \-- select_export_format
        \-- ui_im_export - the html code to select a filename e.g. to upload the file
    \-- json_export
        \-- ui_im_export - TODO move code from component_dsp_old
    \-- xml_export
        \-- ui_im_export - TODO move code from component_dsp_old
    \-- csv_export
        \-- ui_im_export - TODO move code from component_dsp_old
    \-- ods_export
        \-- ui_im_export - TODO move code from component_dsp_old
    \-- phrase_link
        \-- ui_link - @return string show a list of phrases with a suggested link type that might be linked to the objec
                t
    \-- parents_of_word
        \-- ui_list - HTML for a list of words or triples
    \-- children_of_word
        \-- ui_list - HTML for a list of words or triples
    \-- phrase_aliases
        \-- ui_list - HTML for the phrases that are an alias of the given phrase
    \-- phrase_symbols
        \-- ui_list - HTML for the symbols of the given phrase
    \-- phrases_related_ex_symbols
        \-- ui_list - HTML for the phrases related to the given phrase excluding the alias and symbol entries
    \-- phrases_related_ex_subtitle
        \-- ui_list - HTML for the phrases related to the given phrase excluding the alias, symbol and "is a"
    \-- phrases_of_formula
    ...
    \-- ref_list_word
        \-- ui_list - show a list of references related to the given object
    \-- views_related
    ...
    \-- value_chart
        \-- ui_list - HTML for a chart of the most relevant values of the given word, shown on top of the
    \-- values_by_word
        \-- ui_list - show a list of values related to the given object
    \-- values_most_relevant
        \-- ui_list - show the values related to the given object grouped for a quick overview: the newest time period
    \-- values_in_columns
        \-- ui_list - show the values related to the given phrase in up to four columns that are shown side by side
    \-- table_with_related_columns
    ...
    \-- results_by_word
        \-- ui_list - show a list of values related to the given object
    \-- result_list
        \-- ui_list - the results of the given formula as a comma separated list of the result names with a
    \-- results
        \-- ui_list - TODO move code from component_dsp_old
    \-- results_related
    ...
    \-- view_after
        \-- ui_preview - show a preview of a view if the changes are confirmed
    \-- view_before
        \-- ui_preview - show the view as miniature to compare the view with the view_after and the changes highlighted
    \-- paste_table
        \-- ui_preview - title for the table drop zone
    \-- table_body
        \-- ui_preview - show a drop zone for a table file upload
    \-- selection_text
    ...
    \-- view_diff
        \-- ui_preview - show the changes in a short form in a popup
    \-- system_phrases
        \-- ui_rank - the triple names that are used by the system
    \-- ranking_parameters
        \-- ui_rank - TODO Prio 0 fill with real code
    \-- ranking_list
        \-- ui_rank - TODO Prio 0 fill with real code
    \-- phrase_select
        \-- ui_select - @return string the name of a phrase and give the user the possibility to change the phrase name
    \-- view_select
        \-- ui_select - the html code to select the view for the given object
    \-- view_list_for
    ...
    \-- api_put
        \-- rest_call - create and execute an api put call update an object to the database based on the given json
    \-- api_del
        \-- rest_call - create and execute an api delete call to exclude an object from the database selected by the giv
                en json with the id
    \-- api_curl_call
        \-- rest_call - create and execute an api get, post, put or delete call for a database object
    \-- api_call
        \-- rest_call - execute an api call
    \-- calc_sheet
        \-- sheet - TODO fill it based on the parameters
    \-- __construct
        \-- table - 
    ...
    \-- selector
        ...
        \-- user_profile - create the HTML code to select a user profile
        \-- verbs - create the HTML code to select a verb
        \-- view_link_type_list - create the HTML code to select a view link type
        \-- view_relation_type_list - create the HTML code to select a view relation type
        \-- view_style_list - create the HTML code to select a view style
        \-- view_type_list - create the HTML code to select a view type
...
\-- optional with show password but without auto fill
    ...
    \-- show_col_phrase
        \-- system_form - @param component|db_object $dbo the component whose column phrase is shown
    \-- show_col_sub_phrase
        \-- system_form - @param component|db_object $dbo the component whose sub column phrase is shown
    \-- show_owner
        \-- system_form - @param sandbox|db_object $dbo the object whose owner is shown
    \-- show_phrase_type
        \-- system_form - @param word|db_object $dbo the word
    \-- show_ref_type
    ...
    \-- form_field_doi
        \-- system_form - @return string the html code to request a doi from the user
...
\-- html
    \-- name
        \-- element - create an api json array for the backend based on this frontend object
    \-- link
        \-- element - return the HTML code for the element name including a link to inspect the element
\-- repeat from backend
    \-- build_symbol
        \-- element_group - recreate the element group symbol based on the element list ($this->lst)
\-- deprecate
    \-- dsp_values_old
        \-- element_group - the HTML code to display a figure list
\-- interface
    \-- api_array
        \-- figure - @return array the json message array to send the updated data to the backend
...
\-- modify
    \-- add
        \-- figure_list - add a figure to the list
        \-- sys_log_list - add a system log entry to the list
    \-- intersect
        \-- phrase_list - removes all terms from this list that are not in the given list
    \-- mainly
        \-- phrase_list - @return phrase|null the dominate phrase of the list
    \-- add_phrase
        \-- phrase_list - add a phrase to the list
    \-- remove
        \-- phrase_list - remove all phrases of the given list from this list
    \-- dsp_name
    ...
    \-- get_by_formula
        \-- result_list - add a formula result to the list
    \-- filter
        \-- result_list - get a list with the results related directly to the given formula, word, triple or value
    \-- is_empty
        \-- sys_log_list - @return bool true when the list contains no entries; mirrors the ListBase API so callers
    \-- head
        \-- sys_log_list - @param int $limit the maximal number of log entries to keep
\-- object vars
    \-- name
...
\-- related
    ...
    \-- assigned_subtitle
        \-- phrase_list - subtitle for a formula page: the assigned phrases as a plain comma-separated list of
\-- session
    \-- start
    ...
    \-- end
        \-- frontend - write the execution time if it took too long
    \-- load_cache
    ...
    \-- set_view_cache
        \-- frontend - set the frontend view cache once upfront base on the api message
\-- user
    \-- get_user
        \-- frontend - set the frontend view cache once upfront base on the api message
\-- execute
    \-- url_to_action
        \-- frontend - execute the user request e.g. a database update and create the url for the next page
    \-- url_to_back_url
        \-- frontend - the previous page of a url built from its '9'-prefixed back targets, ready to be used directly as
    \-- show
        \-- view_exe - create the html code to view a sandbox object
\-- view
    \-- url_to_html
...
\-- log
    \-- log_info
        \-- frontend - send a log message to the system log server
\-- get functions
    \-- common_phrases
...
\-- HTML code
    ...
    \-- yes_no
        \-- button - the old zuh_btn_confirm without description, replace with zuh_btn_confirm
    \-- add_value
        \-- button - display a button to add a value
    \-- add_value_fast
        \-- button - similar to btn_add_value, but uses a simple modal box
    \-- edit_value
        \-- button - display a button to adjust a value
    \-- del_value
...
\-- the HTML table functions used in zukunft.com
    ...
    \-- lf
        \-- html_base - @return string with the html code for a line feed
    \-- th_row
        \-- html_base - create a header column text for each string of the given array
    \-- tr
        \-- html_base - show the html code as a table row
    \-- td
        \-- html_base - show a text of link within a table cell
    \-- thead
        \-- html_base - add the table header html maker around the give html code
    \-- tbody
        \-- html_base - add the table body html maker around the give html code
    \-- tbl
        \-- html_base - create the html code to display a table
    \-- tbl_start_half
        \-- html_base - create the html code to display a table
    \-- tbl_start_hist
        \-- html_base - create the html code to display a table
    \-- tbl_start_pur
        \-- html_base - create the html code to display a table
    \-- tbl_start_borderless_grey
        \-- html_base - create the html code to display a table
    \-- tbl_start_select
        \-- html_base - a table for a list of selectors
\-- the form HTML elements used in zukunft.com
    \-- form
        \-- html_base - create the html code to display a table
    \-- fr
        \-- html_base - @param string $row_text the html code that should be wrapped into a form row
    \-- form_text
    ...
    \-- about_page
        \-- html_base - @param user_message|Message $msg to colle
    \-- about_body
        \-- html_base - @param user_message|Message $msg to colle
\-- output device specific support functions for the pure HTML version
    \-- edit_url
        \-- html_base - converts object class name to an edit php script name
    \-- list_sort
...
\-- to dismiss / replace
    ...
    \-- dsp_form_text_big
        \-- html_base - html hidden field
    \-- dsp_form_fld_checkbox
        \-- html_base - add the field to a form
...
\-- base elements - functions for all html elements used in zukunft.com
    ...
    \-- form_field_id
        \-- html_base - @param string $url_id the url id of the input field e.g. url_var::LATEX
    \-- input
    ...
    \-- div_row
        \-- html_base - create the HTML code for an input field
    \-- div_col_min_width
        \-- html_base - a column of a row that is moved below the previous column on small screens
    \-- div_row_wrapping_cols
        \-- html_base - combine the given columns to one row that shows them side by side on wide screens
    \-- add_style
        \-- html_base - combine the given columns to one row that shows them side by side on wide screens
    \-- get_style_code
        \-- html_base - combine the given columns to one row that shows them side by side on wide screens
    ...
    \-- row_start
        \-- html_base - @return string html code to combine the next elements to one row
    \-- row_right
        \-- html_base - @return string html code to combine the next elements to one row and align to the right
    \-- row_center
        \-- html_base - @return string html code to combine the next elements to one row and center them
    \-- row_end
        \-- html_base - @return string html code to end a row div
\-- display interface
    \-- echo_html
    ...
    \-- echo
        \-- html_base - display a message immediately to the user
    \-- ui_progress
        \-- html_base - 
\-- internal
    \-- main
    ...
    \-- concat_text
        \-- html_base - concatenate two text snippets with the given separator if both are set
    \-- concat_entry_text
...
\-- table
    ...
    \-- tbl_when_who_what
        \-- change_log_list - the borderless change log table with the three columns when, who and what;
\-- helpers
    \-- th
    ...
    \-- field_name
        \-- change_log_named - the translated name of the changed field on its own (no value),
                 with the reference (id) suffix
    \-- entry
        \-- change_log_named - the human-readable text of this change without the change time, also used to sort changes
    \-- what
        \-- change_log_named - the change as the 'what' column of the change log table pure: the action and the old and
    \-- what_text
    ...
    \-- tr_when_who_what
        \-- change_log_named - one row of the change log table pure with the three columns when, who and what
\-- filter
    \-- filter
    ...
    \-- filter_user_overwrites
        \-- change_log_list - keep only the changes that the given user has written to a user sandbox (overlay) table,
    \-- measure_list
    ...
    \-- info_list
        \-- phrase_list - @return phrase_list list of information only phrases
    \-- ex_info_list
        \-- phrase_list - @return phrase_list list of phrases without the info phrases e.g. without 1967 (year of defini
                tion)
    \-- get_by_verb
        \-- triple_list - select the references that are linked to the given phrase
\-- list
...
\-- sort
    \-- sort_by_impact
        \-- phrase_list - sort this phrase list in place so that the phrase with the highest impact is first
        \-- term_list - sort this term list in place so that the term with the highest impact is first
    \-- max_impact
        \-- phrase_list - @return float the highest system calculated impact of the phrases in this list (0.0 if the lis
                t is empty)
    \-- sort_by_number
...
\-- repeat backend
    \-- get_grp_id
        \-- phrase_list - TODO Prio 1 review
\-- create the pure html (5) code for all formula links related to this value list
    \-- frm_links_html
        \-- result_list - create the pure html (5) code for all formula links related to this value list
\-- debug
    \-- name
        \-- sandbox_list - to show the list name to the user in the most simple form (without any ids)
    \-- name_pur
