...
$app = new frontend();
global $sys, $cac, $cfg;
$db_con = $app->start($sys, "value_edit", $cac, $cfg);
$html = new html_base();
...
if ($usr->id() > 0) {
    ...
    $val = new value();
    $val->load_by_id($_GET[url_var::ID]); // to load any missing parameters of the edit view like the group and phrases from the database
